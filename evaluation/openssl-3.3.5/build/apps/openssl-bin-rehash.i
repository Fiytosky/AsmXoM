...
# 41 "../include/internal/o_dir.h"
        


# 43 "../include/internal/o_dir.h"
...
# 157 "../apps/rehash.c"
        ...
        *ep = nilhentry;
        ep->old_id = ~0;
        ep->filename = CRYPTO_strdup(filename, "../apps/rehash.c", 167);
        if (ep->filename == 
# 168 "../apps/rehash.c" 3 4
                           ((void *)0)
# 168 "../apps/rehash.c"
                               ) {
            CRYPTO_free(ep, "../apps/rehash.c", 169);
            ep = 
# 170 "../apps/rehash.c" 3 4
                ((void *)0)
# 170 "../apps/rehash.c"
                    ;
...
# 205 "../apps/rehash.c"
    ...
    return add_entry(type, hash, linktarget, 
# 228 "../apps/rehash.c" 3 4
                                            ((void *)0)
# 228 "../apps/rehash.c"
                                                , 0, id);
}
...
# 236 "../apps/rehash.c" 3 4
                               ((void *)0)
# 236 "../apps/rehash.c"
                                   ;
    X509_INFO *x;
    const X509_NAME *name = 
# 238 "../apps/rehash.c" 3 4
                           ((void *)0)
# 238 "../apps/rehash.c"
                               ;
    BIO *b;
...
# 246 "../apps/rehash.c"
    ...
    if ((b = BIO_new_file(fullpath, "r")) == 
# 256 "../apps/rehash.c" 3 4
                                            ((void *)0)
# 256 "../apps/rehash.c"
                                                ) {
    ...
    inf = PEM_X509_INFO_read_bio(b, 
# 262 "../apps/rehash.c" 3 4
                                   ((void *)0)
# 262 "../apps/rehash.c"
                                       , 
# 262 "../apps/rehash.c" 3 4
...
# 262 "../apps/rehash.c"
    ...
    BIO_free(b);
    if (inf == 
# 264 "../apps/rehash.c" 3 4
              ((void *)0)
# 264 "../apps/rehash.c"
                  )
        goto end;

    if (OPENSSL_sk_num(ossl_check_const_X509_INFO_sk_type(inf)) != 1) {
        BIO_printf(bio_err,
    ...
    x = ((X509_INFO *)OPENSSL_sk_value(ossl_check_const_X509_INFO_sk_type(inf), (0)));
    if (x->x509 != 
# 276 "../apps/rehash.c" 3 4
                  ((void *)0)
# 276 "../apps/rehash.c"
                      ) {
        type = TYPE_CERT;
        name = X509_get_subject_name(x->x509);
        if (!X509_digest(x->x509, evpmd, digest, 
# 279 "../apps/rehash.c" 3 4
                                                ((void *)0)
# 279 "../apps/rehash.c"
                                                    )) {
            BIO_printf(bio_err, "out of memory\n");
...
# 284 "../apps/rehash.c" 3 4
                        ((void *)0)
# 284 "../apps/rehash.c"
                            ) {
        type = TYPE_CRL;
        name = X509_CRL_get_issuer(x->crl);
        if (!X509_CRL_digest(x->crl, evpmd, digest, 
# 287 "../apps/rehash.c" 3 4
                                                   ((void *)0)
# 287 "../apps/rehash.c"
                                                       )) {
            BIO_printf(bio_err, "out of memory\n");
...
# 296 "../apps/rehash.c"
    ...
    OPENSSL_sk_pop_free(ossl_check_X509_INFO_sk_type(inf),ossl_check_X509_INFO_freefunc_type(X509_INFO_free));
    return errs;
}

static void str_free(char *s)
{
    CRYPTO_free(s, "../apps/rehash.c", 323);
}
...
# 359 "../apps/rehash.c"
                                 ;
    struct stack_st_OPENSSL_STRING *files = 
# 360 "../apps/rehash.c" 3 4
                                     ((void *)0)
# 360 "../apps/rehash.c"
                                         ;

    if (app_access(dirname, 
# 362 "../apps/rehash.c" 3 4
                           2
# 362 "../apps/rehash.c"
                               ) < 0) {
    ...
    if ((files = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new(ossl_check_OPENSSL_STRING_compfunc_type(sk_strcmp)))) == 
# 375 "../apps/rehash.c" 3 4
                                                     ((void *)0)
# 375 "../apps/rehash.c"
                                                         ) {
    ...
    while ((filename = OPENSSL_DIR_read(&d, dirname)) != 
# 380 "../apps/rehash.c" 3 4
                                                        ((void *)0)
# 380 "../apps/rehash.c"
                                                            ) {
        size_t fname_len = strlen(filename);

        if ((copy = CRYPTO_strdup(filename, "../apps/rehash.c", 383)) == 
# 383 "../apps/rehash.c" 3 4
                                                ((void *)0)
                
# 384 "../apps/rehash.c"
               || OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(files), ossl_check_OPENSSL_STRING_type(copy)) == 0) {
            CRYPTO_free(copy, "../apps/rehash.c", 385);
            OPENSSL_DIR_end(&d);
    ...
    OPENSSL_DIR_end(&d);
    OPENSSL_sk_sort(ossl_check_OPENSSL_STRING_sk_type(files));

    buflen = dirlen + fname_max_len + 1;
    buf = app_malloc(buflen, "filename buffer");

    numfiles = OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(files));
    for (n = 0; n < numfiles; ++n) {
        filename = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(files), (n)));
...
# 442 "../apps/rehash.c"
                        ...
                        BIO_printf(bio_err,
                                   "%s: Can't unlink %s, %s\n",
                                   opt_getprog(), buf, strerror(
# 445 "../apps/rehash.c" 3 4
                                                               (*__errno_location ())
# 445 "../apps/rehash.c"
                                                                    ));
                        errs++;
...
# 467 "../apps/rehash.c"
                ...
                CRYPTO_free(ep->filename, "../apps/rehash.c", 471);
                CRYPTO_free(ep, "../apps/rehash.c", 472);
            }
            CRYPTO_free(bp, "../apps/rehash.c", 474);
        }
        hash_table[i] = 
# 476 "../apps/rehash.c" 3 4
                       ((void *)0)
# 476 "../apps/rehash.c"
                           ;
    }
 ...
 err:
    OPENSSL_sk_pop_free(ossl_check_OPENSSL_STRING_sk_type(files),ossl_check_OPENSSL_STRING_freefunc_type(str_free));
    CRYPTO_free(buf, "../apps/rehash.c", 481);
    return errs;
}
...
int rehash_main(int argc, char **argv)
{
    ...
    if (*argv != 
# 556 "../apps/rehash.c" 3 4
                ((void *)0)
# 556 "../apps/rehash.c"
                    ) {
        while (*argv != 
# 557 "../apps/rehash.c" 3 4
                       ((void *)0)
# 557 "../apps/rehash.c"
                           )
            errs += do_dir(*argv++, h);
    } else if ((env = getenv(X509_get_default_cert_dir_env())) != 
# 559 "../apps/rehash.c" 3 4
                                                                 ((void *)0)
# 559 "../apps/rehash.c"
                                                                     ) {
        char lsc[2] = { ':', '\0' };
        m = CRYPTO_strdup(env, "../apps/rehash.c", 561);
        if (m == 
# 562 "../apps/rehash.c" 3 4
                ((void *)0)
# 562 "../apps/rehash.c"
                    ) {
            BIO_puts(bio_err, "out of memory\n");
        ...
        for (e = strtok(m, lsc); e != 
# 567 "../apps/rehash.c" 3 4
                                     ((void *)0)
# 567 "../apps/rehash.c"
                                         ; e = strtok(
# 567 "../apps/rehash.c" 3 4
...
# 567 "../apps/rehash.c"
                                                          , lsc))
            errs += do_dir(e, h);
        CRYPTO_free(m, "../apps/rehash.c", 569);
    } else {
