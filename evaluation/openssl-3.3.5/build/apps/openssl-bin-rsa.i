...
typedef enum OPTION_choice {
    ...
    OPT_PROV__FIRST=1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY, OPT_PROV__LAST, OPT_TRADITIONAL
} OPTION_CHOICE;
...
# 130 "../apps/rsa.c"
                                                                              ;
    int private = 0;
    int informat = 0, outformat = (5 | 0x8000), text = 0, check = 0;
...
# 389 "../apps/rsa.c"
    ...
    EVP_PKEY_free(pkey);
    EVP_CIPHER_free(enc);
    CRYPTO_free(passin, "../apps/rsa.c", 410);
    CRYPTO_free(passout, "../apps/rsa.c", 411);
    return ret;
}
