...
# 1 "../include/openssl/types.h" 1
# 23 "../include/openssl/encoder.h" 2
...
int i2b_PVK_bio_ex(BIO *out, const EVP_PKEY *pk, int enclevel,
                   pem_password_cb *cb, void *u,
                   OSSL_LIB_CTX *libctx, const char *propq);
# 22 "../include/openssl/store.h" 2
# 1 "../include/openssl/storeerr.h" 1
# 13 "../include/openssl/storeerr.h"
        
# 23 "../include/openssl/store.h" 2
...
OSSL_STORE_open_ex(const char *uri, OSSL_LIB_CTX *libctx, const char *propq,
                   ...
                   OSSL_STORE_post_process_info_fn post_process,
                   void *post_process_data);
# 73 "../include/openssl/store.h"
extern int OSSL_STORE_ctrl(OSSL_STORE_CTX *ctx, int cmd,
                                          ... );
extern int OSSL_STORE_vctrl(OSSL_STORE_CTX *ctx, int cmd,
                                           va_list args);
# 99 "../include/openssl/store.h"
...
int RAND_poll(void);
# 24 "../apps/list.c" 2
# 1 "../apps/include/apps.h" 1
# 13 "../apps/include/apps.h"
...
# 92 "../include/internal/sockets.h" 2
# 102 "../include/internal/sockets.h"
...
# 103 "../include/internal/sockets.h" 2
# 111 "../include/internal/sockets.h"
...
# 112 "../include/internal/sockets.h" 2
...
# 113 "../include/internal/sockets.h" 2
# 121 "../include/internal/sockets.h"
...
# 122 "../include/internal/sockets.h" 2
...
# 128 "../include/internal/sockets.h" 2
# 17 "../apps/include/apps.h" 2
# 1 "/usr/include/assert.h" 1 3 4
# 18 "../apps/include/apps.h" 2
...
# 24 "../apps/include/apps.h" 2



# 1 "../include/openssl/types.h" 1
# 28 "../apps/include/apps.h" 2



# 1 "../include/openssl/txt_db.h" 1
# 12 "../include/openssl/txt_db.h"
        
# 36 "../include/openssl/txt_db.h"

# 36 "../include/openssl/txt_db.h"
typedef OPENSSL_STRING *OPENSSL_PSTRING;
struct stack_st_OPENSSL_PSTRING; typedef int (*sk_OPENSSL_PSTRING_compfunc)(const OPENSSL_STRING * const *a, const OPENSSL_STRING *const *b); typedef void (*sk_OPENSSL_PSTRING_freefunc)(OPENSSL_STRING *a); typedef OPENSSL_STRING * (*sk_OPENSSL_PSTRING_copyfunc)(const OPENSSL_STRING *a); static __attribute__((unused)) inline int sk_OPENSSL_PSTRING_num(const struct stack_st_OPENSSL_PSTRING *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OPENSSL_STRING *sk_OPENSSL_PSTRING_value(const struct stack_st_OPENSSL_PSTRING *sk, int idx) { return (OPENSSL_STRING *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_OPENSSL_PSTRING *sk_OPENSSL_PSTRING_new(sk_OPENSSL_PSTRING_compfunc compare) { return (struct stack_st_OPENSSL_PSTRING *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_OPENSSL_PSTRING *sk_OPENSSL_PSTRING_new_null(void) { return (struct stack_st_OPENSSL_PSTRING *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_OPENSSL_PSTRING *sk_OPENSSL_PSTRING_new_reserve(sk_OPENSSL_PSTRING_compfunc compare, int n) { return (struct stack_st_OPENSSL_PSTRING *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_OPENSSL_PSTRING_reserve(struct stack_st_OPENSSL_PSTRING *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_OPENSSL_PSTRING_free(struct stack_st_OPENSSL_PSTRING *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_OPENSSL_PSTRING_zero(struct stack_st_OPENSSL_PSTRING *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OPENSSL_STRING *sk_OPENSSL_PSTRING_delete(struct stack_st_OPENSSL_PSTRING *sk, int i) { return (OPENSSL_STRING *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline OPENSSL_STRING *sk_OPENSSL_PSTRING_delete_ptr(struct stack_st_OPENSSL_PSTRING *sk, OPENSSL_STRING *ptr) { return (OPENSSL_STRING *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OPENSSL_PSTRING_push(struct stack_st_OPENSSL_PSTRING *sk, OPENSSL_STRING *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OPENSSL_PSTRING_unshift(struct stack_st_OPENSSL_PSTRING *sk, OPENSSL_STRING *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline OPENSSL_STRING *sk_OPENSSL_PSTRING_pop(struct stack_st_OPENSSL_PSTRING *sk) { return (OPENSSL_STRING *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OPENSSL_STRING *sk_OPENSSL_PSTRING_shift(struct stack_st_OPENSSL_PSTRING *sk) { return (OPENSSL_STRING *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_OPENSSL_PSTRING_pop_free(struct stack_st_OPENSSL_PSTRING *sk, sk_OPENSSL_PSTRING_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_OPENSSL_PSTRING_insert(struct stack_st_OPENSSL_PSTRING *sk, OPENSSL_STRING *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline OPENSSL_STRING *sk_OPENSSL_PSTRING_set(struct stack_st_OPENSSL_PSTRING *sk, int idx, OPENSSL_STRING *ptr) { return (OPENSSL_STRING *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_OPENSSL_PSTRING_find(struct stack_st_OPENSSL_PSTRING *sk, OPENSSL_STRING *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OPENSSL_PSTRING_find_ex(struct stack_st_OPENSSL_PSTRING *sk, OPENSSL_STRING *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OPENSSL_PSTRING_find_all(struct stack_st_OPENSSL_PSTRING *sk, OPENSSL_STRING *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_OPENSSL_PSTRING_sort(struct stack_st_OPENSSL_PSTRING *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_OPENSSL_PSTRING_is_sorted(const struct stack_st_OPENSSL_PSTRING *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_OPENSSL_PSTRING * sk_OPENSSL_PSTRING_dup(const struct stack_st_OPENSSL_PSTRING *sk) { return (struct stack_st_OPENSSL_PSTRING *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_OPENSSL_PSTRING *sk_OPENSSL_PSTRING_deep_copy(const struct stack_st_OPENSSL_PSTRING *sk, sk_OPENSSL_PSTRING_copyfunc copyfunc, sk_OPENSSL_PSTRING_freefunc freefunc) { return (struct stack_st_OPENSSL_PSTRING *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_OPENSSL_PSTRING_compfunc sk_OPENSSL_PSTRING_set_cmp_func(struct stack_st_OPENSSL_PSTRING *sk, sk_OPENSSL_PSTRING_compfunc compare) { return (sk_OPENSSL_PSTRING_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
# 64 "include/openssl/ocsp.h" 2

# 1 "../include/openssl/ocsperr.h" 1
# 13 "../include/openssl/ocsperr.h"
        
# 66 "include/openssl/ocsp.h" 2
...
# 267 "include/openssl/ocsp.h"
extern OCSP_CERTID *OCSP_CERTID_dup(const OCSP_CERTID *a);
...
extern OCSP_SINGLERESP *OCSP_SINGLERESP_new(void); extern void OCSP_SINGLERESP_free(OCSP_SINGLERESP *a); extern OCSP_SINGLERESP *d2i_OCSP_SINGLERESP(OCSP_SINGLERESP **a, const unsigned char **in, long len); extern int i2d_OCSP_SINGLERESP(const OCSP_SINGLERESP *a, unsigned char **out); extern const ASN1_ITEM * OCSP_SINGLERESP_it(void);
extern OCSP_CERTSTATUS *OCSP_CERTSTATUS_new(void); extern void OCSP_CERTSTATUS_free(OCSP_CERTSTATUS *a); extern OCSP_CERTSTATUS *d2i_OCSP_CERTSTATUS(OCSP_CERTSTATUS **a, const unsigned char **in, long len); extern int i2d_OCSP_CERTSTATUS(const OCSP_CERTSTATUS *a, unsigned char **out); extern const ASN1_ITEM * OCSP_CERTSTATUS_it(void);
extern OCSP_REVOKEDINFO *OCSP_REVOKEDINFO_new(void); extern void OCSP_REVOKEDINFO_free(OCSP_REVOKEDINFO *a); extern OCSP_REVOKEDINFO *d2i_OCSP_REVOKEDINFO(OCSP_REVOKEDINFO **a, const unsigned char **in, long len); extern int i2d_OCSP_REVOKEDINFO(const OCSP_REVOKEDINFO *a, unsigned char **out); extern const ASN1_ITEM * OCSP_REVOKEDINFO_it(void);
extern OCSP_BASICRESP *OCSP_BASICRESP_new(void); extern void OCSP_BASICRESP_free(OCSP_BASICRESP *a); extern OCSP_BASICRESP *d2i_OCSP_BASICRESP(OCSP_BASICRESP **a, const unsigned char **in, long len); extern int i2d_OCSP_BASICRESP(const OCSP_BASICRESP *a, unsigned char **out); extern const ASN1_ITEM * OCSP_BASICRESP_it(void);
extern OCSP_RESPDATA *OCSP_RESPDATA_new(void); extern void OCSP_RESPDATA_free(OCSP_RESPDATA *a); extern OCSP_RESPDATA *d2i_OCSP_RESPDATA(OCSP_RESPDATA **a, const unsigned char **in, long len); extern int i2d_OCSP_RESPDATA(const OCSP_RESPDATA *a, unsigned char **out); extern const ASN1_ITEM * OCSP_RESPDATA_it(void);
extern OCSP_RESPID *OCSP_RESPID_new(void); extern void OCSP_RESPID_free(OCSP_RESPID *a); extern OCSP_RESPID *d2i_OCSP_RESPID(OCSP_RESPID **a, const unsigned char **in, long len); extern int i2d_OCSP_RESPID(const OCSP_RESPID *a, unsigned char **out); extern const ASN1_ITEM * OCSP_RESPID_it(void);
extern OCSP_RESPONSE *OCSP_RESPONSE_new(void); extern void OCSP_RESPONSE_free(OCSP_RESPONSE *a); extern OCSP_RESPONSE *d2i_OCSP_RESPONSE(OCSP_RESPONSE **a, const unsigned char **in, long len); extern int i2d_OCSP_RESPONSE(const OCSP_RESPONSE *a, unsigned char **out); extern const ASN1_ITEM * OCSP_RESPONSE_it(void);
extern OCSP_RESPBYTES *OCSP_RESPBYTES_new(void); extern void OCSP_RESPBYTES_free(OCSP_RESPBYTES *a); extern OCSP_RESPBYTES *d2i_OCSP_RESPBYTES(OCSP_RESPBYTES **a, const unsigned char **in, long len); extern int i2d_OCSP_RESPBYTES(const OCSP_RESPBYTES *a, unsigned char **out); extern const ASN1_ITEM * OCSP_RESPBYTES_it(void);
extern OCSP_ONEREQ *OCSP_ONEREQ_new(void); extern void OCSP_ONEREQ_free(OCSP_ONEREQ *a); extern OCSP_ONEREQ *d2i_OCSP_ONEREQ(OCSP_ONEREQ **a, const unsigned char **in, long len); extern int i2d_OCSP_ONEREQ(const OCSP_ONEREQ *a, unsigned char **out); extern const ASN1_ITEM * OCSP_ONEREQ_it(void);
extern OCSP_CERTID *OCSP_CERTID_new(void); extern void OCSP_CERTID_free(OCSP_CERTID *a); extern OCSP_CERTID *d2i_OCSP_CERTID(OCSP_CERTID **a, const unsigned char **in, long len); extern int i2d_OCSP_CERTID(const OCSP_CERTID *a, unsigned char **out); extern const ASN1_ITEM * OCSP_CERTID_it(void);
extern OCSP_REQUEST *OCSP_REQUEST_new(void); extern void OCSP_REQUEST_free(OCSP_REQUEST *a); extern OCSP_REQUEST *d2i_OCSP_REQUEST(OCSP_REQUEST **a, const unsigned char **in, long len); extern int i2d_OCSP_REQUEST(const OCSP_REQUEST *a, unsigned char **out); extern const ASN1_ITEM * OCSP_REQUEST_it(void);
extern OCSP_SIGNATURE *OCSP_SIGNATURE_new(void); extern void OCSP_SIGNATURE_free(OCSP_SIGNATURE *a); extern OCSP_SIGNATURE *d2i_OCSP_SIGNATURE(OCSP_SIGNATURE **a, const unsigned char **in, long len); extern int i2d_OCSP_SIGNATURE(const OCSP_SIGNATURE *a, unsigned char **out); extern const ASN1_ITEM * OCSP_SIGNATURE_it(void);
extern OCSP_REQINFO *OCSP_REQINFO_new(void); extern void OCSP_REQINFO_free(OCSP_REQINFO *a); extern OCSP_REQINFO *d2i_OCSP_REQINFO(OCSP_REQINFO **a, const unsigned char **in, long len); extern int i2d_OCSP_REQINFO(const OCSP_REQINFO *a, unsigned char **out); extern const ASN1_ITEM * OCSP_REQINFO_it(void);
extern OCSP_CRLID *OCSP_CRLID_new(void); extern void OCSP_CRLID_free(OCSP_CRLID *a); extern OCSP_CRLID *d2i_OCSP_CRLID(OCSP_CRLID **a, const unsigned char **in, long len); extern int i2d_OCSP_CRLID(const OCSP_CRLID *a, unsigned char **out); extern const ASN1_ITEM * OCSP_CRLID_it(void);
extern OCSP_SERVICELOC *OCSP_SERVICELOC_new(void); extern void OCSP_SERVICELOC_free(OCSP_SERVICELOC *a); extern OCSP_SERVICELOC *d2i_OCSP_SERVICELOC(OCSP_SERVICELOC **a, const unsigned char **in, long len); extern int i2d_OCSP_SERVICELOC(const OCSP_SERVICELOC *a, unsigned char **out); extern const ASN1_ITEM * OCSP_SERVICELOC_it(void);
...
# 34 "../apps/include/apps.h" 2


# 1 "../apps/include/apps_ui.h" 1
# 15 "../apps/include/apps_ui.h"
...
# 38 "../apps/include/apps.h" 2
# 1 "../apps/include/fmt.h" 1
# 43 "../apps/include/fmt.h"
int FMT_istext(int format);
# 39 "../apps/include/apps.h" 2
# 1 "../apps/include/platform.h" 1
# 40 "../apps/include/apps.h" 2
# 1 "../apps/include/engine_loader.h" 1
# 18 "../apps/include/engine_loader.h"
int setup_engine_loader(void);
void destroy_engine_loader(void);
# 41 "../apps/include/apps.h" 2
# 1 "../apps/include/app_libctx.h" 1
# 13 "../apps/include/app_libctx.h"
# 1 "../include/openssl/types.h" 1
# 14 "../apps/include/app_libctx.h" 2

OSSL_LIB_CTX *app_create_libctx(void);
OSSL_LIB_CTX *app_get0_libctx(void);
int app_set_propq(const char *arg);
const char *app_get0_propq(void);
# 42 "../apps/include/apps.h" 2
# 50 "../apps/include/apps.h"
...
X509_REQ *load_csr_autofmt(const char *infile, int format,
                           struct stack_st_OPENSSL_STRING *vfyopts, const char *desc);
...
int load_cert_certs(const char *uri,
                    X509 **pcert, struct stack_st_X509 **pcerts,
                    int exclude_http, const char *pass, const char *desc,
                    X509_VERIFY_PARAM *vpm);
struct stack_st_X509 *load_certs_multifile(char *files, const char *pass,
                                     const char *desc, X509_VERIFY_PARAM *vpm);
X509_STORE *load_certstore(char *input, const char *pass, const char *desc,
                           X509_VERIFY_PARAM *vpm);
int load_certs(const char *uri, int maybe_stdin, struct stack_st_X509 **certs,
               const char *pass, const char *desc);
int load_crls(const char *uri, struct stack_st_X509_CRL **crls,
              const char *pass, const char *desc);
int load_key_certs_crls(const char *uri, int format, int maybe_stdin,
                        ...
                        EVP_PKEY **pparams,
                        X509 **pcert, struct stack_st_X509 **pcerts,
                        X509_CRL **pcrl, struct stack_st_X509_CRL **pcrls);
...
OCSP_RESPONSE *process_responder(OCSP_REQUEST *req, const char *host,
                                 ...
                                 const char *proxy, const char *no_proxy,
                                 int use_ssl, struct stack_st_CONF_VALUE *headers,
                                 int req_timeout);
...
int do_X509_sign(X509 *x, int force_v1, EVP_PKEY *pkey, const char *md,
                 struct stack_st_OPENSSL_STRING *sigopts, X509V3_CTX *ext_ctx);
int do_X509_verify(X509 *x, EVP_PKEY *pkey, struct stack_st_OPENSSL_STRING *vfyopts);
int do_X509_REQ_sign(X509_REQ *x, EVP_PKEY *pkey, const char *md,
                     struct stack_st_OPENSSL_STRING *sigopts);
int do_X509_REQ_verify(X509_REQ *x, EVP_PKEY *pkey,
                       struct stack_st_OPENSSL_STRING *vfyopts);
...
BIO *app_http_tls_cb(BIO *hbio, void *arg,
...
OSSL_PARAM *app_params_new_from_opts(struct stack_st_OPENSSL_STRING *opts,
                                     const OSSL_PARAM *paramdefs);
...
# 25 "../apps/list.c" 2
# 1 "../apps/include/app_params.h" 1
# 12 "../apps/include/app_params.h"
int print_param_types(const char *thing, const OSSL_PARAM *pdefs, int indent);
void print_param_value(const OSSL_PARAM *p, int indent);
# 26 "../apps/list.c" 2
# 1 "apps/progs.h" 1
# 13 "apps/progs.h"
# 1 "../apps/include/function.h" 1
# 18 "../apps/include/function.h"
...
struct lhash_st_FUNCTION { union lh_FUNCTION_dummy { void* d1; unsigned long d2; int d3; } dummy; }; static unsigned long lh_FUNCTION_hfn_thunk(const void *data, OPENSSL_LH_HASHFUNC hfn) { unsigned long (*hfn_conv)(const FUNCTION *) = (unsigned long (*)(const FUNCTION *))hfn; return hfn_conv((const FUNCTION *)data); } static int lh_FUNCTION_cfn_thunk(const void *da, const void *db, OPENSSL_LH_COMPFUNC cfn) { int (*cfn_conv)(const FUNCTION *, const FUNCTION *) = (int (*)(const FUNCTION *, const FUNCTION *))cfn; return cfn_conv((const FUNCTION *)da, (const FUNCTION *)db); } static __attribute__((unused)) inline void lh_FUNCTION_free(struct lhash_st_FUNCTION *lh) { OPENSSL_LH_free((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_FUNCTION_flush(struct lhash_st_FUNCTION *lh) { OPENSSL_LH_flush((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline FUNCTION * lh_FUNCTION_insert(struct lhash_st_FUNCTION *lh, FUNCTION *d) { return (FUNCTION *)OPENSSL_LH_insert((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline FUNCTION * lh_FUNCTION_delete(struct lhash_st_FUNCTION *lh, const FUNCTION *d) { return (FUNCTION *)OPENSSL_LH_delete((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline FUNCTION * lh_FUNCTION_retrieve(struct lhash_st_FUNCTION *lh, const FUNCTION *d) { return (FUNCTION *)OPENSSL_LH_retrieve((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline int lh_FUNCTION_error(struct lhash_st_FUNCTION *lh) { return OPENSSL_LH_error((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_FUNCTION_num_items(struct lhash_st_FUNCTION *lh) { return OPENSSL_LH_num_items((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_FUNCTION_get_down_load(struct lhash_st_FUNCTION *lh) { return OPENSSL_LH_get_down_load((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_FUNCTION_set_down_load(struct lhash_st_FUNCTION *lh, unsigned long dl) { OPENSSL_LH_set_down_load((OPENSSL_LHASH *)lh, dl); } static __attribute__((unused)) inline void lh_FUNCTION_doall_thunk(void *node, OPENSSL_LH_DOALL_FUNC doall) { void (*doall_conv)(FUNCTION *) = (void (*)(FUNCTION *))doall; doall_conv((FUNCTION *)node); } static __attribute__((unused)) inline void lh_FUNCTION_doall_arg_thunk(void *node, void *arg, OPENSSL_LH_DOALL_FUNCARG doall) { void (*doall_conv)(FUNCTION *, void *) = (void (*)(FUNCTION *, void *))doall; doall_conv((FUNCTION *)node, arg); } static __attribute__((unused)) inline void lh_FUNCTION_doall(struct lhash_st_FUNCTION *lh, void (*doall)(FUNCTION *)) { OPENSSL_LH_doall((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNC)doall); } static __attribute__((unused)) inline struct lhash_st_FUNCTION * lh_FUNCTION_new(unsigned long (*hfn)(const FUNCTION *), int (*cfn)(const FUNCTION *, const FUNCTION *)) { return (struct lhash_st_FUNCTION *)OPENSSL_LH_set_thunks(OPENSSL_LH_new((OPENSSL_LH_HASHFUNC)hfn, (OPENSSL_LH_COMPFUNC)cfn), lh_FUNCTION_hfn_thunk, lh_FUNCTION_cfn_thunk, lh_FUNCTION_doall_thunk, lh_FUNCTION_doall_arg_thunk); } static __attribute__((unused)) inline void lh_FUNCTION_doall_arg(struct lhash_st_FUNCTION *lh, void (*doallarg)(FUNCTION *, void *), void *arg) { OPENSSL_LH_doall_arg((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNCARG)doallarg, arg); } struct lhash_st_FUNCTION;
...
# 1 "../apps/include/opt.h" 1
# 28 "../apps/list.c" 2
# 1 "../apps/include/names.h" 1
# 13 "../apps/include/names.h"
int name_cmp(const char * const *a, const char * const *b);

void collect_names(const char *name, void *vdata);

void print_names(BIO *out, struct stack_st_OPENSSL_CSTRING *names);
# 29 "../apps/list.c" 2
...
# 31 "../apps/list.c"
                                    ;
# 50 "../apps/list.c"
static int is_cipher_fetchable(const EVP_CIPHER *alg) { EVP_CIPHER *impl; const char *propq = app_get0_propq(); OSSL_LIB_CTX *libctx = app_get0_libctx(); const char *name = EVP_CIPHER_get0_name(alg); ERR_set_mark(); impl = EVP_CIPHER_fetch(libctx, name, propq); ERR_pop_to_mark(); if (impl == 
# 50 "../apps/list.c" 3 4
((void *)0)
# 50 "../apps/list.c"
) return 0; EVP_CIPHER_free(impl); return 1; }
static int is_digest_fetchable(const EVP_MD *alg) { EVP_MD *impl; const char *propq = app_get0_propq(); OSSL_LIB_CTX *libctx = app_get0_libctx(); const char *name = EVP_MD_get0_name(alg); ERR_set_mark(); impl = EVP_MD_fetch(libctx, name, propq); ERR_pop_to_mark(); if (impl == 
# 51 "../apps/list.c" 3 4
((void *)0)
# 51 "../apps/list.c"
) return 0; EVP_MD_free(impl); return 1; }
static int is_mac_fetchable(const EVP_MAC *alg) { EVP_MAC *impl; const char *propq = app_get0_propq(); OSSL_LIB_CTX *libctx = app_get0_libctx(); const char *name = EVP_MAC_get0_name(alg); ERR_set_mark(); impl = EVP_MAC_fetch(libctx, name, propq); ERR_pop_to_mark(); if (impl == 
# 52 "../apps/list.c" 3 4
((void *)0)
# 52 "../apps/list.c"
) return 0; EVP_MAC_free(impl); return 1; }
static int is_kdf_fetchable(const EVP_KDF *alg) { EVP_KDF *impl; const char *propq = app_get0_propq(); OSSL_LIB_CTX *libctx = app_get0_libctx(); const char *name = EVP_KDF_get0_name(alg); ERR_set_mark(); impl = EVP_KDF_fetch(libctx, name, propq); ERR_pop_to_mark(); if (impl == 
# 53 "../apps/list.c" 3 4
((void *)0)
# 53 "../apps/list.c"
) return 0; EVP_KDF_free(impl); return 1; }
static int is_rand_fetchable(const EVP_RAND *alg) { EVP_RAND *impl; const char *propq = app_get0_propq(); OSSL_LIB_CTX *libctx = app_get0_libctx(); const char *name = EVP_RAND_get0_name(alg); ERR_set_mark(); impl = EVP_RAND_fetch(libctx, name, propq); ERR_pop_to_mark(); if (impl == 
# 54 "../apps/list.c" 3 4
((void *)0)
# 54 "../apps/list.c"
) return 0; EVP_RAND_free(impl); return 1; }
static int is_keymgmt_fetchable(const EVP_KEYMGMT *alg) { EVP_KEYMGMT *impl; const char *propq = app_get0_propq(); OSSL_LIB_CTX *libctx = app_get0_libctx(); const char *name = EVP_KEYMGMT_get0_name(alg); ERR_set_mark(); impl = EVP_KEYMGMT_fetch(libctx, name, propq); ERR_pop_to_mark(); if (impl == 
# 55 "../apps/list.c" 3 4
((void *)0)
# 55 "../apps/list.c"
) return 0; EVP_KEYMGMT_free(impl); return 1; }
static int is_signature_fetchable(const EVP_SIGNATURE *alg) { EVP_SIGNATURE *impl; const char *propq = app_get0_propq(); OSSL_LIB_CTX *libctx = app_get0_libctx(); const char *name = EVP_SIGNATURE_get0_name(alg); ERR_set_mark(); impl = EVP_SIGNATURE_fetch(libctx, name, propq); ERR_pop_to_mark(); if (impl == 
# 56 "../apps/list.c" 3 4
((void *)0)
# 56 "../apps/list.c"
) return 0; EVP_SIGNATURE_free(impl); return 1; }
static int is_kem_fetchable(const EVP_KEM *alg) { EVP_KEM *impl; const char *propq = app_get0_propq(); OSSL_LIB_CTX *libctx = app_get0_libctx(); const char *name = EVP_KEM_get0_name(alg); ERR_set_mark(); impl = EVP_KEM_fetch(libctx, name, propq); ERR_pop_to_mark(); if (impl == 
# 57 "../apps/list.c" 3 4
((void *)0)
# 57 "../apps/list.c"
) return 0; EVP_KEM_free(impl); return 1; }
static int is_asym_cipher_fetchable(const EVP_ASYM_CIPHER *alg) { EVP_ASYM_CIPHER *impl; const char *propq = app_get0_propq(); OSSL_LIB_CTX *libctx = app_get0_libctx(); const char *name = EVP_ASYM_CIPHER_get0_name(alg); ERR_set_mark(); impl = EVP_ASYM_CIPHER_fetch(libctx, name, propq); ERR_pop_to_mark(); if (impl == 
# 58 "../apps/list.c" 3 4
((void *)0)
# 58 "../apps/list.c"
) return 0; EVP_ASYM_CIPHER_free(impl); return 1; }
static int is_keyexch_fetchable(const EVP_KEYEXCH *alg) { EVP_KEYEXCH *impl; const char *propq = app_get0_propq(); OSSL_LIB_CTX *libctx = app_get0_libctx(); const char *name = EVP_KEYEXCH_get0_name(alg); ERR_set_mark(); impl = EVP_KEYEXCH_fetch(libctx, name, propq); ERR_pop_to_mark(); if (impl == 
# 59 "../apps/list.c" 3 4
((void *)0)
# 59 "../apps/list.c"
) return 0; EVP_KEYEXCH_free(impl); return 1; }
static int is_decoder_fetchable(const OSSL_DECODER *alg) { OSSL_DECODER *impl; const char *propq = app_get0_propq(); OSSL_LIB_CTX *libctx = app_get0_libctx(); const char *name = OSSL_DECODER_get0_name(alg); ERR_set_mark(); impl = OSSL_DECODER_fetch(libctx, name, propq); ERR_pop_to_mark(); if (impl == 
# 60 "../apps/list.c" 3 4
((void *)0)
# 60 "../apps/list.c"
) return 0; OSSL_DECODER_free(impl); return 1; }
static int is_encoder_fetchable(const OSSL_ENCODER *alg) { OSSL_ENCODER *impl; const char *propq = app_get0_propq(); OSSL_LIB_CTX *libctx = app_get0_libctx(); const char *name = OSSL_ENCODER_get0_name(alg); ERR_set_mark(); impl = OSSL_ENCODER_fetch(libctx, name, propq); ERR_pop_to_mark(); if (impl == 
# 61 "../apps/list.c" 3 4
((void *)0)
# 61 "../apps/list.c"
) return 0; OSSL_ENCODER_free(impl); return 1; }


static int include_legacy(void)
{
    return app_get0_propq() == 
# 66 "../apps/list.c" 3 4
                              ((void *)0)
# 66 "../apps/list.c"
                                  ;
...
struct stack_st_EVP_CIPHER; typedef int (*sk_EVP_CIPHER_compfunc)(const EVP_CIPHER * const *a, const EVP_CIPHER *const *b); typedef void (*sk_EVP_CIPHER_freefunc)(EVP_CIPHER *a); typedef EVP_CIPHER * (*sk_EVP_CIPHER_copyfunc)(const EVP_CIPHER *a); static __attribute__((unused)) inline int sk_EVP_CIPHER_num(const struct stack_st_EVP_CIPHER *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_CIPHER *sk_EVP_CIPHER_value(const struct stack_st_EVP_CIPHER *sk, int idx) { return (EVP_CIPHER *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_EVP_CIPHER *sk_EVP_CIPHER_new(sk_EVP_CIPHER_compfunc compare) { return (struct stack_st_EVP_CIPHER *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_EVP_CIPHER *sk_EVP_CIPHER_new_null(void) { return (struct stack_st_EVP_CIPHER *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_EVP_CIPHER *sk_EVP_CIPHER_new_reserve(sk_EVP_CIPHER_compfunc compare, int n) { return (struct stack_st_EVP_CIPHER *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_EVP_CIPHER_reserve(struct stack_st_EVP_CIPHER *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_EVP_CIPHER_free(struct stack_st_EVP_CIPHER *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_CIPHER_zero(struct stack_st_EVP_CIPHER *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_CIPHER *sk_EVP_CIPHER_delete(struct stack_st_EVP_CIPHER *sk, int i) { return (EVP_CIPHER *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline EVP_CIPHER *sk_EVP_CIPHER_delete_ptr(struct stack_st_EVP_CIPHER *sk, EVP_CIPHER *ptr) { return (EVP_CIPHER *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_CIPHER_push(struct stack_st_EVP_CIPHER *sk, EVP_CIPHER *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_CIPHER_unshift(struct stack_st_EVP_CIPHER *sk, EVP_CIPHER *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline EVP_CIPHER *sk_EVP_CIPHER_pop(struct stack_st_EVP_CIPHER *sk) { return (EVP_CIPHER *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_CIPHER *sk_EVP_CIPHER_shift(struct stack_st_EVP_CIPHER *sk) { return (EVP_CIPHER *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_CIPHER_pop_free(struct stack_st_EVP_CIPHER *sk, sk_EVP_CIPHER_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_EVP_CIPHER_insert(struct stack_st_EVP_CIPHER *sk, EVP_CIPHER *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline EVP_CIPHER *sk_EVP_CIPHER_set(struct stack_st_EVP_CIPHER *sk, int idx, EVP_CIPHER *ptr) { return (EVP_CIPHER *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_CIPHER_find(struct stack_st_EVP_CIPHER *sk, EVP_CIPHER *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_CIPHER_find_ex(struct stack_st_EVP_CIPHER *sk, EVP_CIPHER *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_CIPHER_find_all(struct stack_st_EVP_CIPHER *sk, EVP_CIPHER *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_EVP_CIPHER_sort(struct stack_st_EVP_CIPHER *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_EVP_CIPHER_is_sorted(const struct stack_st_EVP_CIPHER *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_CIPHER * sk_EVP_CIPHER_dup(const struct stack_st_EVP_CIPHER *sk) { return (struct stack_st_EVP_CIPHER *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_CIPHER *sk_EVP_CIPHER_deep_copy(const struct stack_st_EVP_CIPHER *sk, sk_EVP_CIPHER_copyfunc copyfunc, sk_EVP_CIPHER_freefunc freefunc) { return (struct stack_st_EVP_CIPHER *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_EVP_CIPHER_compfunc sk_EVP_CIPHER_set_cmp_func(struct stack_st_EVP_CIPHER *sk, sk_EVP_CIPHER_compfunc compare) { return (sk_EVP_CIPHER_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
{
    struct stack_st_EVP_CIPHER *cipher_stack = stack;
...
{
    struct stack_st_EVP_CIPHER *ciphers = sk_EVP_CIPHER_new(cipher_cmp);
    int i;
...
# 110 "../apps/list.c"
    ...
    for (i = 0; i < sk_EVP_CIPHER_num(ciphers); i++) {
        ...
        struct stack_st_OPENSSL_CSTRING *names = 
# 126 "../apps/list.c" 3 4
                                          ((void *)0)
# 126 "../apps/list.c"
                                              ;
...
# 128 "../apps/list.c" 3 4
                          ((void *)0) 
# 128 "../apps/list.c"
                               && !EVP_CIPHER_is_a(c, select_name))
            continue;

        names = ((struct stack_st_OPENSSL_CSTRING *)OPENSSL_sk_new(ossl_check_OPENSSL_CSTRING_compfunc_type(name_cmp)));
        if (names != 
# 132 "../apps/list.c" 3 4
                    ((void *)0) 
# 132 "../apps/list.c"
...
# 142 "../apps/list.c"
        ...
        OPENSSL_sk_free(ossl_check_OPENSSL_CSTRING_sk_type(names));
    }
...
struct stack_st_EVP_MD; typedef int (*sk_EVP_MD_compfunc)(const EVP_MD * const *a, const EVP_MD *const *b); typedef void (*sk_EVP_MD_freefunc)(EVP_MD *a); typedef EVP_MD * (*sk_EVP_MD_copyfunc)(const EVP_MD *a); static __attribute__((unused)) inline int sk_EVP_MD_num(const struct stack_st_EVP_MD *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_MD *sk_EVP_MD_value(const struct stack_st_EVP_MD *sk, int idx) { return (EVP_MD *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_EVP_MD *sk_EVP_MD_new(sk_EVP_MD_compfunc compare) { return (struct stack_st_EVP_MD *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_EVP_MD *sk_EVP_MD_new_null(void) { return (struct stack_st_EVP_MD *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_EVP_MD *sk_EVP_MD_new_reserve(sk_EVP_MD_compfunc compare, int n) { return (struct stack_st_EVP_MD *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_EVP_MD_reserve(struct stack_st_EVP_MD *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_EVP_MD_free(struct stack_st_EVP_MD *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_MD_zero(struct stack_st_EVP_MD *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_MD *sk_EVP_MD_delete(struct stack_st_EVP_MD *sk, int i) { return (EVP_MD *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline EVP_MD *sk_EVP_MD_delete_ptr(struct stack_st_EVP_MD *sk, EVP_MD *ptr) { return (EVP_MD *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_MD_push(struct stack_st_EVP_MD *sk, EVP_MD *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_MD_unshift(struct stack_st_EVP_MD *sk, EVP_MD *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline EVP_MD *sk_EVP_MD_pop(struct stack_st_EVP_MD *sk) { return (EVP_MD *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_MD *sk_EVP_MD_shift(struct stack_st_EVP_MD *sk) { return (EVP_MD *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_MD_pop_free(struct stack_st_EVP_MD *sk, sk_EVP_MD_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_EVP_MD_insert(struct stack_st_EVP_MD *sk, EVP_MD *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline EVP_MD *sk_EVP_MD_set(struct stack_st_EVP_MD *sk, int idx, EVP_MD *ptr) { return (EVP_MD *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_MD_find(struct stack_st_EVP_MD *sk, EVP_MD *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_MD_find_ex(struct stack_st_EVP_MD *sk, EVP_MD *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_MD_find_all(struct stack_st_EVP_MD *sk, EVP_MD *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_EVP_MD_sort(struct stack_st_EVP_MD *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_EVP_MD_is_sorted(const struct stack_st_EVP_MD *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_MD * sk_EVP_MD_dup(const struct stack_st_EVP_MD *sk) { return (struct stack_st_EVP_MD *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_MD *sk_EVP_MD_deep_copy(const struct stack_st_EVP_MD *sk, sk_EVP_MD_copyfunc copyfunc, sk_EVP_MD_freefunc freefunc) { return (struct stack_st_EVP_MD *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_EVP_MD_compfunc sk_EVP_MD_set_cmp_func(struct stack_st_EVP_MD *sk, sk_EVP_MD_compfunc compare) { return (sk_EVP_MD_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
{
    struct stack_st_EVP_MD *digest_stack = stack;
...
{
    struct stack_st_EVP_MD *digests = sk_EVP_MD_new(md_cmp);
    int i;
...
struct stack_st_EVP_MAC; typedef int (*sk_EVP_MAC_compfunc)(const EVP_MAC * const *a, const EVP_MAC *const *b); typedef void (*sk_EVP_MAC_freefunc)(EVP_MAC *a); typedef EVP_MAC * (*sk_EVP_MAC_copyfunc)(const EVP_MAC *a); static __attribute__((unused)) inline int sk_EVP_MAC_num(const struct stack_st_EVP_MAC *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_MAC *sk_EVP_MAC_value(const struct stack_st_EVP_MAC *sk, int idx) { return (EVP_MAC *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_EVP_MAC *sk_EVP_MAC_new(sk_EVP_MAC_compfunc compare) { return (struct stack_st_EVP_MAC *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_EVP_MAC *sk_EVP_MAC_new_null(void) { return (struct stack_st_EVP_MAC *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_EVP_MAC *sk_EVP_MAC_new_reserve(sk_EVP_MAC_compfunc compare, int n) { return (struct stack_st_EVP_MAC *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_EVP_MAC_reserve(struct stack_st_EVP_MAC *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_EVP_MAC_free(struct stack_st_EVP_MAC *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_MAC_zero(struct stack_st_EVP_MAC *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_MAC *sk_EVP_MAC_delete(struct stack_st_EVP_MAC *sk, int i) { return (EVP_MAC *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline EVP_MAC *sk_EVP_MAC_delete_ptr(struct stack_st_EVP_MAC *sk, EVP_MAC *ptr) { return (EVP_MAC *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_MAC_push(struct stack_st_EVP_MAC *sk, EVP_MAC *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_MAC_unshift(struct stack_st_EVP_MAC *sk, EVP_MAC *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline EVP_MAC *sk_EVP_MAC_pop(struct stack_st_EVP_MAC *sk) { return (EVP_MAC *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_MAC *sk_EVP_MAC_shift(struct stack_st_EVP_MAC *sk) { return (EVP_MAC *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_MAC_pop_free(struct stack_st_EVP_MAC *sk, sk_EVP_MAC_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_EVP_MAC_insert(struct stack_st_EVP_MAC *sk, EVP_MAC *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline EVP_MAC *sk_EVP_MAC_set(struct stack_st_EVP_MAC *sk, int idx, EVP_MAC *ptr) { return (EVP_MAC *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_MAC_find(struct stack_st_EVP_MAC *sk, EVP_MAC *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_MAC_find_ex(struct stack_st_EVP_MAC *sk, EVP_MAC *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_MAC_find_all(struct stack_st_EVP_MAC *sk, EVP_MAC *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_EVP_MAC_sort(struct stack_st_EVP_MAC *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_EVP_MAC_is_sorted(const struct stack_st_EVP_MAC *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_MAC * sk_EVP_MAC_dup(const struct stack_st_EVP_MAC *sk) { return (struct stack_st_EVP_MAC *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_MAC *sk_EVP_MAC_deep_copy(const struct stack_st_EVP_MAC *sk, sk_EVP_MAC_copyfunc copyfunc, sk_EVP_MAC_freefunc freefunc) { return (struct stack_st_EVP_MAC *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_EVP_MAC_compfunc sk_EVP_MAC_set_cmp_func(struct stack_st_EVP_MAC *sk, sk_EVP_MAC_compfunc compare) { return (sk_EVP_MAC_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
{
    struct stack_st_EVP_MAC *mac_stack = stack;
...
{
    struct stack_st_EVP_MAC *macs = sk_EVP_MAC_new(mac_cmp);
    int i;
...
struct stack_st_EVP_KDF; typedef int (*sk_EVP_KDF_compfunc)(const EVP_KDF * const *a, const EVP_KDF *const *b); typedef void (*sk_EVP_KDF_freefunc)(EVP_KDF *a); typedef EVP_KDF * (*sk_EVP_KDF_copyfunc)(const EVP_KDF *a); static __attribute__((unused)) inline int sk_EVP_KDF_num(const struct stack_st_EVP_KDF *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_KDF *sk_EVP_KDF_value(const struct stack_st_EVP_KDF *sk, int idx) { return (EVP_KDF *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_EVP_KDF *sk_EVP_KDF_new(sk_EVP_KDF_compfunc compare) { return (struct stack_st_EVP_KDF *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_EVP_KDF *sk_EVP_KDF_new_null(void) { return (struct stack_st_EVP_KDF *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_EVP_KDF *sk_EVP_KDF_new_reserve(sk_EVP_KDF_compfunc compare, int n) { return (struct stack_st_EVP_KDF *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_EVP_KDF_reserve(struct stack_st_EVP_KDF *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_EVP_KDF_free(struct stack_st_EVP_KDF *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_KDF_zero(struct stack_st_EVP_KDF *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_KDF *sk_EVP_KDF_delete(struct stack_st_EVP_KDF *sk, int i) { return (EVP_KDF *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline EVP_KDF *sk_EVP_KDF_delete_ptr(struct stack_st_EVP_KDF *sk, EVP_KDF *ptr) { return (EVP_KDF *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_KDF_push(struct stack_st_EVP_KDF *sk, EVP_KDF *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_KDF_unshift(struct stack_st_EVP_KDF *sk, EVP_KDF *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline EVP_KDF *sk_EVP_KDF_pop(struct stack_st_EVP_KDF *sk) { return (EVP_KDF *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_KDF *sk_EVP_KDF_shift(struct stack_st_EVP_KDF *sk) { return (EVP_KDF *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_KDF_pop_free(struct stack_st_EVP_KDF *sk, sk_EVP_KDF_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_EVP_KDF_insert(struct stack_st_EVP_KDF *sk, EVP_KDF *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline EVP_KDF *sk_EVP_KDF_set(struct stack_st_EVP_KDF *sk, int idx, EVP_KDF *ptr) { return (EVP_KDF *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_KDF_find(struct stack_st_EVP_KDF *sk, EVP_KDF *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_KDF_find_ex(struct stack_st_EVP_KDF *sk, EVP_KDF *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_KDF_find_all(struct stack_st_EVP_KDF *sk, EVP_KDF *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_EVP_KDF_sort(struct stack_st_EVP_KDF *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_EVP_KDF_is_sorted(const struct stack_st_EVP_KDF *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_KDF * sk_EVP_KDF_dup(const struct stack_st_EVP_KDF *sk) { return (struct stack_st_EVP_KDF *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_KDF *sk_EVP_KDF_deep_copy(const struct stack_st_EVP_KDF *sk, sk_EVP_KDF_copyfunc copyfunc, sk_EVP_KDF_freefunc freefunc) { return (struct stack_st_EVP_KDF *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_EVP_KDF_compfunc sk_EVP_KDF_set_cmp_func(struct stack_st_EVP_KDF *sk, sk_EVP_KDF_compfunc compare) { return (sk_EVP_KDF_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
{
    struct stack_st_EVP_KDF *kdf_stack = stack;
...
{
    struct stack_st_EVP_KDF *kdfs = sk_EVP_KDF_new(kdf_cmp);
    int i;
...
struct stack_st_EVP_RAND; typedef int (*sk_EVP_RAND_compfunc)(const EVP_RAND * const *a, const EVP_RAND *const *b); typedef void (*sk_EVP_RAND_freefunc)(EVP_RAND *a); typedef EVP_RAND * (*sk_EVP_RAND_copyfunc)(const EVP_RAND *a); static __attribute__((unused)) inline int sk_EVP_RAND_num(const struct stack_st_EVP_RAND *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_RAND *sk_EVP_RAND_value(const struct stack_st_EVP_RAND *sk, int idx) { return (EVP_RAND *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_EVP_RAND *sk_EVP_RAND_new(sk_EVP_RAND_compfunc compare) { return (struct stack_st_EVP_RAND *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_EVP_RAND *sk_EVP_RAND_new_null(void) { return (struct stack_st_EVP_RAND *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_EVP_RAND *sk_EVP_RAND_new_reserve(sk_EVP_RAND_compfunc compare, int n) { return (struct stack_st_EVP_RAND *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_EVP_RAND_reserve(struct stack_st_EVP_RAND *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_EVP_RAND_free(struct stack_st_EVP_RAND *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_RAND_zero(struct stack_st_EVP_RAND *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_RAND *sk_EVP_RAND_delete(struct stack_st_EVP_RAND *sk, int i) { return (EVP_RAND *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline EVP_RAND *sk_EVP_RAND_delete_ptr(struct stack_st_EVP_RAND *sk, EVP_RAND *ptr) { return (EVP_RAND *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_RAND_push(struct stack_st_EVP_RAND *sk, EVP_RAND *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_RAND_unshift(struct stack_st_EVP_RAND *sk, EVP_RAND *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline EVP_RAND *sk_EVP_RAND_pop(struct stack_st_EVP_RAND *sk) { return (EVP_RAND *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_RAND *sk_EVP_RAND_shift(struct stack_st_EVP_RAND *sk) { return (EVP_RAND *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_RAND_pop_free(struct stack_st_EVP_RAND *sk, sk_EVP_RAND_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_EVP_RAND_insert(struct stack_st_EVP_RAND *sk, EVP_RAND *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline EVP_RAND *sk_EVP_RAND_set(struct stack_st_EVP_RAND *sk, int idx, EVP_RAND *ptr) { return (EVP_RAND *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_RAND_find(struct stack_st_EVP_RAND *sk, EVP_RAND *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_RAND_find_ex(struct stack_st_EVP_RAND *sk, EVP_RAND *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_RAND_find_all(struct stack_st_EVP_RAND *sk, EVP_RAND *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_EVP_RAND_sort(struct stack_st_EVP_RAND *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_EVP_RAND_is_sorted(const struct stack_st_EVP_RAND *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_RAND * sk_EVP_RAND_dup(const struct stack_st_EVP_RAND *sk) { return (struct stack_st_EVP_RAND *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_RAND *sk_EVP_RAND_deep_copy(const struct stack_st_EVP_RAND *sk, sk_EVP_RAND_copyfunc copyfunc, sk_EVP_RAND_freefunc freefunc) { return (struct stack_st_EVP_RAND *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_EVP_RAND_compfunc sk_EVP_RAND_set_cmp_func(struct stack_st_EVP_RAND *sk, sk_EVP_RAND_compfunc compare) { return (sk_EVP_RAND_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
{
    struct stack_st_EVP_RAND *rand_stack = stack;
...
{
    struct stack_st_EVP_RAND *rands = sk_EVP_RAND_new(rand_cmp);
    int i;
...
# 464 "../apps/list.c"
                ...
                if (OPENSSL_strcasecmp(gettables->key, "state") == 0)
                    continue;

                if (gettables->data_type != 4
                        && gettables->data_type != 6
                        && !verbose)
                    continue;
                params->key = gettables->key;
                params->data_type = gettables->data_type;
                if (gettables->data_type == 2
                        || gettables->data_type == 1) {
                    params->data = &u;
...
{
    display_random("primary", RAND_get0_primary(
# 492 "../apps/list.c" 3 4
                                               ((void *)0)
# 492 "../apps/list.c"
                                                   ));
    display_random("public", RAND_get0_public(
# 493 "../apps/list.c" 3 4
                                             ((void *)0)
# 493 "../apps/list.c"
                                                 ));
    display_random("private", RAND_get0_private(
# 494 "../apps/list.c" 3 4
                                               ((void *)0)
# 494 "../apps/list.c"
                                                   ));
...
struct stack_st_OSSL_ENCODER; typedef int (*sk_OSSL_ENCODER_compfunc)(const OSSL_ENCODER * const *a, const OSSL_ENCODER *const *b); typedef void (*sk_OSSL_ENCODER_freefunc)(OSSL_ENCODER *a); typedef OSSL_ENCODER * (*sk_OSSL_ENCODER_copyfunc)(const OSSL_ENCODER *a); static __attribute__((unused)) inline int sk_OSSL_ENCODER_num(const struct stack_st_OSSL_ENCODER *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OSSL_ENCODER *sk_OSSL_ENCODER_value(const struct stack_st_OSSL_ENCODER *sk, int idx) { return (OSSL_ENCODER *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_OSSL_ENCODER *sk_OSSL_ENCODER_new(sk_OSSL_ENCODER_compfunc compare) { return (struct stack_st_OSSL_ENCODER *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_OSSL_ENCODER *sk_OSSL_ENCODER_new_null(void) { return (struct stack_st_OSSL_ENCODER *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_OSSL_ENCODER *sk_OSSL_ENCODER_new_reserve(sk_OSSL_ENCODER_compfunc compare, int n) { return (struct stack_st_OSSL_ENCODER *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_OSSL_ENCODER_reserve(struct stack_st_OSSL_ENCODER *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_OSSL_ENCODER_free(struct stack_st_OSSL_ENCODER *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_OSSL_ENCODER_zero(struct stack_st_OSSL_ENCODER *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OSSL_ENCODER *sk_OSSL_ENCODER_delete(struct stack_st_OSSL_ENCODER *sk, int i) { return (OSSL_ENCODER *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline OSSL_ENCODER *sk_OSSL_ENCODER_delete_ptr(struct stack_st_OSSL_ENCODER *sk, OSSL_ENCODER *ptr) { return (OSSL_ENCODER *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_ENCODER_push(struct stack_st_OSSL_ENCODER *sk, OSSL_ENCODER *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_ENCODER_unshift(struct stack_st_OSSL_ENCODER *sk, OSSL_ENCODER *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline OSSL_ENCODER *sk_OSSL_ENCODER_pop(struct stack_st_OSSL_ENCODER *sk) { return (OSSL_ENCODER *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OSSL_ENCODER *sk_OSSL_ENCODER_shift(struct stack_st_OSSL_ENCODER *sk) { return (OSSL_ENCODER *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_OSSL_ENCODER_pop_free(struct stack_st_OSSL_ENCODER *sk, sk_OSSL_ENCODER_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_OSSL_ENCODER_insert(struct stack_st_OSSL_ENCODER *sk, OSSL_ENCODER *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline OSSL_ENCODER *sk_OSSL_ENCODER_set(struct stack_st_OSSL_ENCODER *sk, int idx, OSSL_ENCODER *ptr) { return (OSSL_ENCODER *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_ENCODER_find(struct stack_st_OSSL_ENCODER *sk, OSSL_ENCODER *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_ENCODER_find_ex(struct stack_st_OSSL_ENCODER *sk, OSSL_ENCODER *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_ENCODER_find_all(struct stack_st_OSSL_ENCODER *sk, OSSL_ENCODER *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_OSSL_ENCODER_sort(struct stack_st_OSSL_ENCODER *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_OSSL_ENCODER_is_sorted(const struct stack_st_OSSL_ENCODER *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_OSSL_ENCODER * sk_OSSL_ENCODER_dup(const struct stack_st_OSSL_ENCODER *sk) { return (struct stack_st_OSSL_ENCODER *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_OSSL_ENCODER *sk_OSSL_ENCODER_deep_copy(const struct stack_st_OSSL_ENCODER *sk, sk_OSSL_ENCODER_copyfunc copyfunc, sk_OSSL_ENCODER_freefunc freefunc) { return (struct stack_st_OSSL_ENCODER *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_OSSL_ENCODER_compfunc sk_OSSL_ENCODER_set_cmp_func(struct stack_st_OSSL_ENCODER *sk, sk_OSSL_ENCODER_compfunc compare) { return (sk_OSSL_ENCODER_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
{
    struct stack_st_OSSL_ENCODER *encoder_stack = stack;
...
{
    struct stack_st_OSSL_ENCODER *encoders;
    int i;
...
# 536 "../apps/list.c" 3 4
                          ((void *)0) 
# 536 "../apps/list.c"
                               && !OSSL_ENCODER_is_a(k, select_name))
            continue;
...
{
    struct stack_st_OSSL_DECODER *decoder_stack = stack;
...
{
    struct stack_st_OSSL_DECODER *decoders;
    int i;
...
# 601 "../apps/list.c" 3 4
                          ((void *)0) 
# 601 "../apps/list.c"
                               && !OSSL_DECODER_is_a(k, select_name))
            continue;
...
{
    struct stack_st_EVP_KEYMGMT *km_stack = stack;
...
{
    int i;
    struct stack_st_EVP_KEYMGMT *km_stack = sk_EVP_KEYMGMT_new(keymanager_cmp);
...
# 657 "../apps/list.c" 3 4
                          ((void *)0) 
# 657 "../apps/list.c"
                               && !EVP_KEYMGMT_is_a(k, select_name))
            continue;
...
# 665 "../apps/list.c"
                ...
                BIO_printf(bio_out, "%s", ((const char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_CSTRING_sk_type(names), (0))));
            BIO_printf(bio_out, "\n");
...
struct stack_st_EVP_SIGNATURE; typedef int (*sk_EVP_SIGNATURE_compfunc)(const EVP_SIGNATURE * const *a, const EVP_SIGNATURE *const *b); typedef void (*sk_EVP_SIGNATURE_freefunc)(EVP_SIGNATURE *a); typedef EVP_SIGNATURE * (*sk_EVP_SIGNATURE_copyfunc)(const EVP_SIGNATURE *a); static __attribute__((unused)) inline int sk_EVP_SIGNATURE_num(const struct stack_st_EVP_SIGNATURE *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_SIGNATURE *sk_EVP_SIGNATURE_value(const struct stack_st_EVP_SIGNATURE *sk, int idx) { return (EVP_SIGNATURE *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_EVP_SIGNATURE *sk_EVP_SIGNATURE_new(sk_EVP_SIGNATURE_compfunc compare) { return (struct stack_st_EVP_SIGNATURE *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_EVP_SIGNATURE *sk_EVP_SIGNATURE_new_null(void) { return (struct stack_st_EVP_SIGNATURE *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_EVP_SIGNATURE *sk_EVP_SIGNATURE_new_reserve(sk_EVP_SIGNATURE_compfunc compare, int n) { return (struct stack_st_EVP_SIGNATURE *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_EVP_SIGNATURE_reserve(struct stack_st_EVP_SIGNATURE *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_EVP_SIGNATURE_free(struct stack_st_EVP_SIGNATURE *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_SIGNATURE_zero(struct stack_st_EVP_SIGNATURE *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_SIGNATURE *sk_EVP_SIGNATURE_delete(struct stack_st_EVP_SIGNATURE *sk, int i) { return (EVP_SIGNATURE *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline EVP_SIGNATURE *sk_EVP_SIGNATURE_delete_ptr(struct stack_st_EVP_SIGNATURE *sk, EVP_SIGNATURE *ptr) { return (EVP_SIGNATURE *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_SIGNATURE_push(struct stack_st_EVP_SIGNATURE *sk, EVP_SIGNATURE *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_SIGNATURE_unshift(struct stack_st_EVP_SIGNATURE *sk, EVP_SIGNATURE *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline EVP_SIGNATURE *sk_EVP_SIGNATURE_pop(struct stack_st_EVP_SIGNATURE *sk) { return (EVP_SIGNATURE *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_SIGNATURE *sk_EVP_SIGNATURE_shift(struct stack_st_EVP_SIGNATURE *sk) { return (EVP_SIGNATURE *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_SIGNATURE_pop_free(struct stack_st_EVP_SIGNATURE *sk, sk_EVP_SIGNATURE_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_EVP_SIGNATURE_insert(struct stack_st_EVP_SIGNATURE *sk, EVP_SIGNATURE *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline EVP_SIGNATURE *sk_EVP_SIGNATURE_set(struct stack_st_EVP_SIGNATURE *sk, int idx, EVP_SIGNATURE *ptr) { return (EVP_SIGNATURE *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_SIGNATURE_find(struct stack_st_EVP_SIGNATURE *sk, EVP_SIGNATURE *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_SIGNATURE_find_ex(struct stack_st_EVP_SIGNATURE *sk, EVP_SIGNATURE *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_SIGNATURE_find_all(struct stack_st_EVP_SIGNATURE *sk, EVP_SIGNATURE *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_EVP_SIGNATURE_sort(struct stack_st_EVP_SIGNATURE *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_EVP_SIGNATURE_is_sorted(const struct stack_st_EVP_SIGNATURE *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_SIGNATURE * sk_EVP_SIGNATURE_dup(const struct stack_st_EVP_SIGNATURE *sk) { return (struct stack_st_EVP_SIGNATURE *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_SIGNATURE *sk_EVP_SIGNATURE_deep_copy(const struct stack_st_EVP_SIGNATURE *sk, sk_EVP_SIGNATURE_copyfunc copyfunc, sk_EVP_SIGNATURE_freefunc freefunc) { return (struct stack_st_EVP_SIGNATURE *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_EVP_SIGNATURE_compfunc sk_EVP_SIGNATURE_set_cmp_func(struct stack_st_EVP_SIGNATURE *sk, sk_EVP_SIGNATURE_compfunc compare) { return (sk_EVP_SIGNATURE_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
{
    struct stack_st_EVP_SIGNATURE *sig_stack = stack;
...
{
    int i, count = 0;
    struct stack_st_EVP_SIGNATURE *sig_stack = sk_EVP_SIGNATURE_new(signature_cmp);
...
# 720 "../apps/list.c" 3 4
                          ((void *)0) 
# 720 "../apps/list.c"
                               && !EVP_SIGNATURE_is_a(k, select_name))
            continue;
...
struct stack_st_EVP_KEM; typedef int (*sk_EVP_KEM_compfunc)(const EVP_KEM * const *a, const EVP_KEM *const *b); typedef void (*sk_EVP_KEM_freefunc)(EVP_KEM *a); typedef EVP_KEM * (*sk_EVP_KEM_copyfunc)(const EVP_KEM *a); static __attribute__((unused)) inline int sk_EVP_KEM_num(const struct stack_st_EVP_KEM *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_KEM *sk_EVP_KEM_value(const struct stack_st_EVP_KEM *sk, int idx) { return (EVP_KEM *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_EVP_KEM *sk_EVP_KEM_new(sk_EVP_KEM_compfunc compare) { return (struct stack_st_EVP_KEM *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_EVP_KEM *sk_EVP_KEM_new_null(void) { return (struct stack_st_EVP_KEM *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_EVP_KEM *sk_EVP_KEM_new_reserve(sk_EVP_KEM_compfunc compare, int n) { return (struct stack_st_EVP_KEM *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_EVP_KEM_reserve(struct stack_st_EVP_KEM *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_EVP_KEM_free(struct stack_st_EVP_KEM *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_KEM_zero(struct stack_st_EVP_KEM *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_KEM *sk_EVP_KEM_delete(struct stack_st_EVP_KEM *sk, int i) { return (EVP_KEM *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline EVP_KEM *sk_EVP_KEM_delete_ptr(struct stack_st_EVP_KEM *sk, EVP_KEM *ptr) { return (EVP_KEM *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_KEM_push(struct stack_st_EVP_KEM *sk, EVP_KEM *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_KEM_unshift(struct stack_st_EVP_KEM *sk, EVP_KEM *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline EVP_KEM *sk_EVP_KEM_pop(struct stack_st_EVP_KEM *sk) { return (EVP_KEM *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_KEM *sk_EVP_KEM_shift(struct stack_st_EVP_KEM *sk) { return (EVP_KEM *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_KEM_pop_free(struct stack_st_EVP_KEM *sk, sk_EVP_KEM_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_EVP_KEM_insert(struct stack_st_EVP_KEM *sk, EVP_KEM *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline EVP_KEM *sk_EVP_KEM_set(struct stack_st_EVP_KEM *sk, int idx, EVP_KEM *ptr) { return (EVP_KEM *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_KEM_find(struct stack_st_EVP_KEM *sk, EVP_KEM *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_KEM_find_ex(struct stack_st_EVP_KEM *sk, EVP_KEM *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_KEM_find_all(struct stack_st_EVP_KEM *sk, EVP_KEM *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_EVP_KEM_sort(struct stack_st_EVP_KEM *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_EVP_KEM_is_sorted(const struct stack_st_EVP_KEM *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_KEM * sk_EVP_KEM_dup(const struct stack_st_EVP_KEM *sk) { return (struct stack_st_EVP_KEM *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_KEM *sk_EVP_KEM_deep_copy(const struct stack_st_EVP_KEM *sk, sk_EVP_KEM_copyfunc copyfunc, sk_EVP_KEM_freefunc freefunc) { return (struct stack_st_EVP_KEM *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_EVP_KEM_compfunc sk_EVP_KEM_set_cmp_func(struct stack_st_EVP_KEM *sk, sk_EVP_KEM_compfunc compare) { return (sk_EVP_KEM_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
{
    struct stack_st_EVP_KEM *kem_stack = stack;
...
{
    int i, count = 0;
    struct stack_st_EVP_KEM *kem_stack = sk_EVP_KEM_new(kem_cmp);
...
struct stack_st_EVP_ASYM_CIPHER; typedef int (*sk_EVP_ASYM_CIPHER_compfunc)(const EVP_ASYM_CIPHER * const *a, const EVP_ASYM_CIPHER *const *b); typedef void (*sk_EVP_ASYM_CIPHER_freefunc)(EVP_ASYM_CIPHER *a); typedef EVP_ASYM_CIPHER * (*sk_EVP_ASYM_CIPHER_copyfunc)(const EVP_ASYM_CIPHER *a); static __attribute__((unused)) inline int sk_EVP_ASYM_CIPHER_num(const struct stack_st_EVP_ASYM_CIPHER *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_ASYM_CIPHER *sk_EVP_ASYM_CIPHER_value(const struct stack_st_EVP_ASYM_CIPHER *sk, int idx) { return (EVP_ASYM_CIPHER *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_EVP_ASYM_CIPHER *sk_EVP_ASYM_CIPHER_new(sk_EVP_ASYM_CIPHER_compfunc compare) { return (struct stack_st_EVP_ASYM_CIPHER *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_EVP_ASYM_CIPHER *sk_EVP_ASYM_CIPHER_new_null(void) { return (struct stack_st_EVP_ASYM_CIPHER *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_EVP_ASYM_CIPHER *sk_EVP_ASYM_CIPHER_new_reserve(sk_EVP_ASYM_CIPHER_compfunc compare, int n) { return (struct stack_st_EVP_ASYM_CIPHER *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_EVP_ASYM_CIPHER_reserve(struct stack_st_EVP_ASYM_CIPHER *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_EVP_ASYM_CIPHER_free(struct stack_st_EVP_ASYM_CIPHER *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_ASYM_CIPHER_zero(struct stack_st_EVP_ASYM_CIPHER *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_ASYM_CIPHER *sk_EVP_ASYM_CIPHER_delete(struct stack_st_EVP_ASYM_CIPHER *sk, int i) { return (EVP_ASYM_CIPHER *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline EVP_ASYM_CIPHER *sk_EVP_ASYM_CIPHER_delete_ptr(struct stack_st_EVP_ASYM_CIPHER *sk, EVP_ASYM_CIPHER *ptr) { return (EVP_ASYM_CIPHER *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_ASYM_CIPHER_push(struct stack_st_EVP_ASYM_CIPHER *sk, EVP_ASYM_CIPHER *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_ASYM_CIPHER_unshift(struct stack_st_EVP_ASYM_CIPHER *sk, EVP_ASYM_CIPHER *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline EVP_ASYM_CIPHER *sk_EVP_ASYM_CIPHER_pop(struct stack_st_EVP_ASYM_CIPHER *sk) { return (EVP_ASYM_CIPHER *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_ASYM_CIPHER *sk_EVP_ASYM_CIPHER_shift(struct stack_st_EVP_ASYM_CIPHER *sk) { return (EVP_ASYM_CIPHER *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_ASYM_CIPHER_pop_free(struct stack_st_EVP_ASYM_CIPHER *sk, sk_EVP_ASYM_CIPHER_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_EVP_ASYM_CIPHER_insert(struct stack_st_EVP_ASYM_CIPHER *sk, EVP_ASYM_CIPHER *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline EVP_ASYM_CIPHER *sk_EVP_ASYM_CIPHER_set(struct stack_st_EVP_ASYM_CIPHER *sk, int idx, EVP_ASYM_CIPHER *ptr) { return (EVP_ASYM_CIPHER *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_ASYM_CIPHER_find(struct stack_st_EVP_ASYM_CIPHER *sk, EVP_ASYM_CIPHER *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_ASYM_CIPHER_find_ex(struct stack_st_EVP_ASYM_CIPHER *sk, EVP_ASYM_CIPHER *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_ASYM_CIPHER_find_all(struct stack_st_EVP_ASYM_CIPHER *sk, EVP_ASYM_CIPHER *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_EVP_ASYM_CIPHER_sort(struct stack_st_EVP_ASYM_CIPHER *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_EVP_ASYM_CIPHER_is_sorted(const struct stack_st_EVP_ASYM_CIPHER *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_ASYM_CIPHER * sk_EVP_ASYM_CIPHER_dup(const struct stack_st_EVP_ASYM_CIPHER *sk) { return (struct stack_st_EVP_ASYM_CIPHER *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_ASYM_CIPHER *sk_EVP_ASYM_CIPHER_deep_copy(const struct stack_st_EVP_ASYM_CIPHER *sk, sk_EVP_ASYM_CIPHER_copyfunc copyfunc, sk_EVP_ASYM_CIPHER_freefunc freefunc) { return (struct stack_st_EVP_ASYM_CIPHER *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_EVP_ASYM_CIPHER_compfunc sk_EVP_ASYM_CIPHER_set_cmp_func(struct stack_st_EVP_ASYM_CIPHER *sk, sk_EVP_ASYM_CIPHER_compfunc compare) { return (sk_EVP_ASYM_CIPHER_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
{
    struct stack_st_EVP_ASYM_CIPHER *asym_cipher_stack = stack;
...
{
    int i, count = 0;
    struct stack_st_EVP_ASYM_CIPHER *asymciph_stack =
...
struct stack_st_EVP_KEYEXCH; typedef int (*sk_EVP_KEYEXCH_compfunc)(const EVP_KEYEXCH * const *a, const EVP_KEYEXCH *const *b); typedef void (*sk_EVP_KEYEXCH_freefunc)(EVP_KEYEXCH *a); typedef EVP_KEYEXCH * (*sk_EVP_KEYEXCH_copyfunc)(const EVP_KEYEXCH *a); static __attribute__((unused)) inline int sk_EVP_KEYEXCH_num(const struct stack_st_EVP_KEYEXCH *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_KEYEXCH *sk_EVP_KEYEXCH_value(const struct stack_st_EVP_KEYEXCH *sk, int idx) { return (EVP_KEYEXCH *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_EVP_KEYEXCH *sk_EVP_KEYEXCH_new(sk_EVP_KEYEXCH_compfunc compare) { return (struct stack_st_EVP_KEYEXCH *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_EVP_KEYEXCH *sk_EVP_KEYEXCH_new_null(void) { return (struct stack_st_EVP_KEYEXCH *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_EVP_KEYEXCH *sk_EVP_KEYEXCH_new_reserve(sk_EVP_KEYEXCH_compfunc compare, int n) { return (struct stack_st_EVP_KEYEXCH *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_EVP_KEYEXCH_reserve(struct stack_st_EVP_KEYEXCH *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_EVP_KEYEXCH_free(struct stack_st_EVP_KEYEXCH *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_KEYEXCH_zero(struct stack_st_EVP_KEYEXCH *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_KEYEXCH *sk_EVP_KEYEXCH_delete(struct stack_st_EVP_KEYEXCH *sk, int i) { return (EVP_KEYEXCH *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline EVP_KEYEXCH *sk_EVP_KEYEXCH_delete_ptr(struct stack_st_EVP_KEYEXCH *sk, EVP_KEYEXCH *ptr) { return (EVP_KEYEXCH *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_KEYEXCH_push(struct stack_st_EVP_KEYEXCH *sk, EVP_KEYEXCH *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_KEYEXCH_unshift(struct stack_st_EVP_KEYEXCH *sk, EVP_KEYEXCH *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline EVP_KEYEXCH *sk_EVP_KEYEXCH_pop(struct stack_st_EVP_KEYEXCH *sk) { return (EVP_KEYEXCH *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_KEYEXCH *sk_EVP_KEYEXCH_shift(struct stack_st_EVP_KEYEXCH *sk) { return (EVP_KEYEXCH *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_KEYEXCH_pop_free(struct stack_st_EVP_KEYEXCH *sk, sk_EVP_KEYEXCH_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_EVP_KEYEXCH_insert(struct stack_st_EVP_KEYEXCH *sk, EVP_KEYEXCH *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline EVP_KEYEXCH *sk_EVP_KEYEXCH_set(struct stack_st_EVP_KEYEXCH *sk, int idx, EVP_KEYEXCH *ptr) { return (EVP_KEYEXCH *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_KEYEXCH_find(struct stack_st_EVP_KEYEXCH *sk, EVP_KEYEXCH *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_KEYEXCH_find_ex(struct stack_st_EVP_KEYEXCH *sk, EVP_KEYEXCH *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_KEYEXCH_find_all(struct stack_st_EVP_KEYEXCH *sk, EVP_KEYEXCH *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_EVP_KEYEXCH_sort(struct stack_st_EVP_KEYEXCH *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_EVP_KEYEXCH_is_sorted(const struct stack_st_EVP_KEYEXCH *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_KEYEXCH * sk_EVP_KEYEXCH_dup(const struct stack_st_EVP_KEYEXCH *sk) { return (struct stack_st_EVP_KEYEXCH *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_KEYEXCH *sk_EVP_KEYEXCH_deep_copy(const struct stack_st_EVP_KEYEXCH *sk, sk_EVP_KEYEXCH_copyfunc copyfunc, sk_EVP_KEYEXCH_freefunc freefunc) { return (struct stack_st_EVP_KEYEXCH *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_EVP_KEYEXCH_compfunc sk_EVP_KEYEXCH_set_cmp_func(struct stack_st_EVP_KEYEXCH *sk, sk_EVP_KEYEXCH_compfunc compare) { return (sk_EVP_KEYEXCH_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
{
    struct stack_st_EVP_KEYEXCH *kex_stack = stack;
...
{
    int i, count = 0;
    struct stack_st_EVP_KEYEXCH *kex_stack = sk_EVP_KEYEXCH_new(kex_cmp);
...
# 900 "../apps/list.c" 3 4
                          ((void *)0) 
# 900 "../apps/list.c"
                               && !EVP_KEYEXCH_is_a(k, select_name))
            continue;
...
# 954 "../apps/list.c"
        ...
        if (n > oid_size) {
            oid_buf = CRYPTO_realloc(oid_buf, n + 1, "../apps/list.c", 962);
            if (oid_buf == 
# 963 "../apps/list.c" 3 4
                          ((void *)0)
# 963 "../apps/list.c"
...
# 971 "../apps/list.c"
    ...
    CRYPTO_free(oid_buf, "../apps/list.c", 977);
}
...
struct stack_st_OSSL_STORE_LOADER; typedef int (*sk_OSSL_STORE_LOADER_compfunc)(const OSSL_STORE_LOADER * const *a, const OSSL_STORE_LOADER *const *b); typedef void (*sk_OSSL_STORE_LOADER_freefunc)(OSSL_STORE_LOADER *a); typedef OSSL_STORE_LOADER * (*sk_OSSL_STORE_LOADER_copyfunc)(const OSSL_STORE_LOADER *a); static __attribute__((unused)) inline int sk_OSSL_STORE_LOADER_num(const struct stack_st_OSSL_STORE_LOADER *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OSSL_STORE_LOADER *sk_OSSL_STORE_LOADER_value(const struct stack_st_OSSL_STORE_LOADER *sk, int idx) { return (OSSL_STORE_LOADER *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_OSSL_STORE_LOADER *sk_OSSL_STORE_LOADER_new(sk_OSSL_STORE_LOADER_compfunc compare) { return (struct stack_st_OSSL_STORE_LOADER *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_OSSL_STORE_LOADER *sk_OSSL_STORE_LOADER_new_null(void) { return (struct stack_st_OSSL_STORE_LOADER *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_OSSL_STORE_LOADER *sk_OSSL_STORE_LOADER_new_reserve(sk_OSSL_STORE_LOADER_compfunc compare, int n) { return (struct stack_st_OSSL_STORE_LOADER *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_OSSL_STORE_LOADER_reserve(struct stack_st_OSSL_STORE_LOADER *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_OSSL_STORE_LOADER_free(struct stack_st_OSSL_STORE_LOADER *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_OSSL_STORE_LOADER_zero(struct stack_st_OSSL_STORE_LOADER *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OSSL_STORE_LOADER *sk_OSSL_STORE_LOADER_delete(struct stack_st_OSSL_STORE_LOADER *sk, int i) { return (OSSL_STORE_LOADER *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline OSSL_STORE_LOADER *sk_OSSL_STORE_LOADER_delete_ptr(struct stack_st_OSSL_STORE_LOADER *sk, OSSL_STORE_LOADER *ptr) { return (OSSL_STORE_LOADER *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_STORE_LOADER_push(struct stack_st_OSSL_STORE_LOADER *sk, OSSL_STORE_LOADER *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_STORE_LOADER_unshift(struct stack_st_OSSL_STORE_LOADER *sk, OSSL_STORE_LOADER *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline OSSL_STORE_LOADER *sk_OSSL_STORE_LOADER_pop(struct stack_st_OSSL_STORE_LOADER *sk) { return (OSSL_STORE_LOADER *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OSSL_STORE_LOADER *sk_OSSL_STORE_LOADER_shift(struct stack_st_OSSL_STORE_LOADER *sk) { return (OSSL_STORE_LOADER *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_OSSL_STORE_LOADER_pop_free(struct stack_st_OSSL_STORE_LOADER *sk, sk_OSSL_STORE_LOADER_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_OSSL_STORE_LOADER_insert(struct stack_st_OSSL_STORE_LOADER *sk, OSSL_STORE_LOADER *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline OSSL_STORE_LOADER *sk_OSSL_STORE_LOADER_set(struct stack_st_OSSL_STORE_LOADER *sk, int idx, OSSL_STORE_LOADER *ptr) { return (OSSL_STORE_LOADER *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_STORE_LOADER_find(struct stack_st_OSSL_STORE_LOADER *sk, OSSL_STORE_LOADER *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_STORE_LOADER_find_ex(struct stack_st_OSSL_STORE_LOADER *sk, OSSL_STORE_LOADER *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_STORE_LOADER_find_all(struct stack_st_OSSL_STORE_LOADER *sk, OSSL_STORE_LOADER *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_OSSL_STORE_LOADER_sort(struct stack_st_OSSL_STORE_LOADER *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_OSSL_STORE_LOADER_is_sorted(const struct stack_st_OSSL_STORE_LOADER *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_OSSL_STORE_LOADER * sk_OSSL_STORE_LOADER_dup(const struct stack_st_OSSL_STORE_LOADER *sk) { return (struct stack_st_OSSL_STORE_LOADER *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_OSSL_STORE_LOADER *sk_OSSL_STORE_LOADER_deep_copy(const struct stack_st_OSSL_STORE_LOADER *sk, sk_OSSL_STORE_LOADER_copyfunc copyfunc, sk_OSSL_STORE_LOADER_freefunc freefunc) { return (struct stack_st_OSSL_STORE_LOADER *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_OSSL_STORE_LOADER_compfunc sk_OSSL_STORE_LOADER_set_cmp_func(struct stack_st_OSSL_STORE_LOADER *sk, sk_OSSL_STORE_LOADER_compfunc compare) { return (sk_OSSL_STORE_LOADER_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
{
    struct stack_st_OSSL_STORE_LOADER *store_stack = stack;
...
{
    struct stack_st_OSSL_STORE_LOADER *stores = sk_OSSL_STORE_LOADER_new(store_cmp);
    int i;

    if (stores == 
# 1173 "../apps/list.c" 3 4
                 ((void *)0)
# 1173 "../apps/list.c"
                     ) {
        BIO_printf(bio_err, "ERROR: Memory allocation\n");
    ...
    for (i = 0; i < sk_OSSL_STORE_LOADER_num(stores); i++) {
        ...
        struct stack_st_OPENSSL_CSTRING *names = 
# 1183 "../apps/list.c" 3 4
                                          ((void *)0)
# 1183 "../apps/list.c"
                                              ;

        if (select_name != 
# 1185 "../apps/list.c" 3 4
                          ((void *)0) 
# 1185 "../apps/list.c"
                               && !OSSL_STORE_LOADER_is_a(m, select_name))
            continue;

        names = ((struct stack_st_OPENSSL_CSTRING *)OPENSSL_sk_new(ossl_check_OPENSSL_CSTRING_compfunc_type(name_cmp)));
        if (names != 
# 1189 "../apps/list.c" 3 4
                    ((void *)0) 
# 1189 "../apps/list.c"
                         && OSSL_STORE_LOADER_names_do_all(m, collect_names,
                                                            names)) {
            BIO_printf(bio_out, "  ");
            print_names(bio_out, names);
...
struct stack_st_OSSL_PROVIDER; typedef int (*sk_OSSL_PROVIDER_compfunc)(const OSSL_PROVIDER * const *a, const OSSL_PROVIDER *const *b); typedef void (*sk_OSSL_PROVIDER_freefunc)(OSSL_PROVIDER *a); typedef OSSL_PROVIDER * (*sk_OSSL_PROVIDER_copyfunc)(const OSSL_PROVIDER *a); static __attribute__((unused)) inline int sk_OSSL_PROVIDER_num(const struct stack_st_OSSL_PROVIDER *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OSSL_PROVIDER *sk_OSSL_PROVIDER_value(const struct stack_st_OSSL_PROVIDER *sk, int idx) { return (OSSL_PROVIDER *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_OSSL_PROVIDER *sk_OSSL_PROVIDER_new(sk_OSSL_PROVIDER_compfunc compare) { return (struct stack_st_OSSL_PROVIDER *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_OSSL_PROVIDER *sk_OSSL_PROVIDER_new_null(void) { return (struct stack_st_OSSL_PROVIDER *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_OSSL_PROVIDER *sk_OSSL_PROVIDER_new_reserve(sk_OSSL_PROVIDER_compfunc compare, int n) { return (struct stack_st_OSSL_PROVIDER *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_OSSL_PROVIDER_reserve(struct stack_st_OSSL_PROVIDER *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_OSSL_PROVIDER_free(struct stack_st_OSSL_PROVIDER *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_OSSL_PROVIDER_zero(struct stack_st_OSSL_PROVIDER *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OSSL_PROVIDER *sk_OSSL_PROVIDER_delete(struct stack_st_OSSL_PROVIDER *sk, int i) { return (OSSL_PROVIDER *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline OSSL_PROVIDER *sk_OSSL_PROVIDER_delete_ptr(struct stack_st_OSSL_PROVIDER *sk, OSSL_PROVIDER *ptr) { return (OSSL_PROVIDER *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_PROVIDER_push(struct stack_st_OSSL_PROVIDER *sk, OSSL_PROVIDER *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_PROVIDER_unshift(struct stack_st_OSSL_PROVIDER *sk, OSSL_PROVIDER *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline OSSL_PROVIDER *sk_OSSL_PROVIDER_pop(struct stack_st_OSSL_PROVIDER *sk) { return (OSSL_PROVIDER *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OSSL_PROVIDER *sk_OSSL_PROVIDER_shift(struct stack_st_OSSL_PROVIDER *sk) { return (OSSL_PROVIDER *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_OSSL_PROVIDER_pop_free(struct stack_st_OSSL_PROVIDER *sk, sk_OSSL_PROVIDER_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_OSSL_PROVIDER_insert(struct stack_st_OSSL_PROVIDER *sk, OSSL_PROVIDER *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline OSSL_PROVIDER *sk_OSSL_PROVIDER_set(struct stack_st_OSSL_PROVIDER *sk, int idx, OSSL_PROVIDER *ptr) { return (OSSL_PROVIDER *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_PROVIDER_find(struct stack_st_OSSL_PROVIDER *sk, OSSL_PROVIDER *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_PROVIDER_find_ex(struct stack_st_OSSL_PROVIDER *sk, OSSL_PROVIDER *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_PROVIDER_find_all(struct stack_st_OSSL_PROVIDER *sk, OSSL_PROVIDER *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_OSSL_PROVIDER_sort(struct stack_st_OSSL_PROVIDER *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_OSSL_PROVIDER_is_sorted(const struct stack_st_OSSL_PROVIDER *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_OSSL_PROVIDER * sk_OSSL_PROVIDER_dup(const struct stack_st_OSSL_PROVIDER *sk) { return (struct stack_st_OSSL_PROVIDER *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_OSSL_PROVIDER *sk_OSSL_PROVIDER_deep_copy(const struct stack_st_OSSL_PROVIDER *sk, sk_OSSL_PROVIDER_copyfunc copyfunc, sk_OSSL_PROVIDER_freefunc freefunc) { return (struct stack_st_OSSL_PROVIDER *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_OSSL_PROVIDER_compfunc sk_OSSL_PROVIDER_set_cmp_func(struct stack_st_OSSL_PROVIDER *sk, sk_OSSL_PROVIDER_compfunc compare) { return (sk_OSSL_PROVIDER_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
# 1232 "../apps/list.c" 3 4
                            ((void *)0)
# 1232 "../apps/list.c"
                                , &collect_providers, providers) != 1) {
    ...
    for (i = 0; i < sk_OSSL_PROVIDER_num(providers); i++) {
        ...
        params[0] = OSSL_PARAM_construct_utf8_ptr("name",
                                                  &name, 0);
        params[1] = OSSL_PARAM_construct_utf8_ptr("version",
                                                  &version, 0);
        params[2] = OSSL_PARAM_construct_int("status", &status);
        params[3] = OSSL_PARAM_construct_utf8_ptr("buildinfo",
                                                  &buildinfo, 0);
...
typedef enum HELPLIST_CHOICE {
    ...
    OPT_PROV__FIRST=1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY, OPT_PROV__LAST
} HELPLIST_CHOICE;

const OPTIONS list_options[] = {

    { OPT_SECTION_STR, 1, '-', "General" " options:\n" },
    {"help", OPT_HELP, '-', "Display this summary"},

    { OPT_SECTION_STR, 1, '-', "Output" " options:\n" },
...
opthelp:
        ...
        case OPT_SELECT_NAME:
            select_name = opt_arg();
            break;
        case OPT_PROV__FIRST: case OPT_PROV__LAST: break; case OPT_PROV_PROVIDER: case OPT_PROV_PROVIDER_PATH: case OPT_PROV_PROPQUERY:
            if (!opt_provider(o))
                return 1;
            break;
        }
    ...
    if (!opt_check_rest_arg(
# 1680 "../apps/list.c" 3 4
                           ((void *)0)
# 1680 "../apps/list.c"
                               ))
        goto opthelp;
# 1691 "../apps/list.c"
    if (todo.commands)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_type(FT_general, one); } while(0);
    ...
    if (todo.random_instances)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_random_instances(); } while(0);
    if (todo.random_generators)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_random_generators(); } while(0);
    if (todo.digest_commands)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_type(FT_md, one); } while(0);
    if (todo.digest_algorithms)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_digests(""); } while(0);
    if (todo.kdf_algorithms)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_kdfs(); } while(0);
    if (todo.mac_algorithms)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_macs(); } while(0);
    if (todo.cipher_commands)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_type(FT_cipher, one); } while(0);
    if (todo.cipher_algorithms)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_ciphers(""); } while(0);
    if (todo.encoder_algorithms)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_encoders(); } while(0);
    if (todo.decoder_algorithms)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_decoders(); } while(0);
    if (todo.keymanager_algorithms)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_keymanagers(); } while(0);
    if (todo.signature_algorithms)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_signatures(); } while(0);
    if (todo.asym_cipher_algorithms)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_asymciphers(); } while(0);
    if (todo.keyexchange_algorithms)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_keyexchanges(); } while(0);
    if (todo.kem_algorithms)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_kems(); } while(0);
    if (todo.pk_algorithms)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_pkey(); } while(0);
    if (todo.pk_method)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_pkey_meth(); } while(0);
    if (todo.store_loaders)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_store_loaders(); } while(0);
    if (todo.provider_info)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_provider_info(); } while(0);

    if (todo.engines)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_engines(); } while(0);

    if (todo.disabled)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_disabled(); } while(0);
    if (todo.objects)
        do { if (print_newline++) { BIO_printf(bio_out, "\n"); } list_objects(); } while(0);
