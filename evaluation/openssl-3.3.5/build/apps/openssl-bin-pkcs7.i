...
typedef enum OPTION_choice {
    ...
    OPT_ENGINE, OPT_PROV__FIRST=1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY, OPT_PROV__LAST
} OPTION_CHOICE;
...
# 127 "../apps/pkcs7.c"
    ...
    if (informat == 4)
        ...
        p7i = PEM_read_bio_PKCS7(in, &p7, 
# 136 "../apps/pkcs7.c" 3 4
                                         ((void *)0)
# 136 "../apps/pkcs7.c"
                                             , 
# 136 "../apps/pkcs7.c" 3 4
...
# 144 "../apps/pkcs7.c"
    ...
    if (p7_print)
        PKCS7_print_ctx(out, p7, 0, 
# 148 "../apps/pkcs7.c" 3 4
                                   ((void *)0)
# 148 "../apps/pkcs7.c"
                                       );
    ...
    if (print_certs) {
        struct stack_st_X509 *certs = 
# 151 "../apps/pkcs7.c" 3 4
                               ((void *)0)
# 151 "../apps/pkcs7.c"
                                   ;
        struct stack_st_X509_CRL *crls = 
# 152 "../apps/pkcs7.c" 3 4
                                  ((void *)0)
# 152 "../apps/pkcs7.c"
                                      ;
