...
# 106 "../apps/dgst.c"
                             ;
    OPTION_CHOICE o;
    int separator = 0, debug = 0, keyform = 0, siglen = 0;
    int i, ret = 
# 109 "../apps/dgst.c" 3 4
                1
# 109 "../apps/dgst.c"
                            , out_bin = -1, want_pub = 0, do_verify = 0;
    int xoflen = 0;
    unsigned char *buf = 
# 111 "../apps/dgst.c" 3 4
                        ((void *)0)
...
# 140 "../apps/dgst.c"
        ...
        case OPT_MACOPT:
            if (!macopts)
                macopts = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null());
            if (!macopts || !OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(macopts), ossl_check_OPENSSL_STRING_type(opt_arg())))
                goto opthelp;
            break;
        case OPT_DIGEST:
...
# 280 "../apps/dgst.c"
        ...
        if (want_pub)
            sigkey = load_pubkey(keyfile, keyform, 0, 
# 284 "../apps/dgst.c" 3 4
                                                     ((void *)0)
# 284 "../apps/dgst.c"
                                                         , e, "public key");
...
# 309 "../apps/dgst.c"
            ...
            for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(macopts)); i++) {
                char *macopt = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(macopts), (i)));
...
# 463 "../apps/dgst.c"
    ...
    CRYPTO_clear_free(buf, 1024*8, "../apps/dgst.c", 465);
    BIO_free(in);
    CRYPTO_free(passin, "../apps/dgst.c", 467);
    BIO_free_all(out);
    EVP_MD_free(md);
    EVP_PKEY_free(sigkey);
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(sigopts));
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(macopts));
    CRYPTO_free(sigbuf, "../apps/dgst.c", 473);
    BIO_free(bmd);
    release_engine(e);
    return ret;
}
...
# 482 "../apps/dgst.c"
    ...
    if (strstr(name->name, "rsa") != 
# 485 "../apps/dgst.c" 3 4
                                    ((void *)0) 
# 485 "../apps/dgst.c"
                                         || strstr(name->name, "RSA") != 
# 485 "../apps/dgst.c" 3 4
                                                                         ((void *)0)
# 485 "../apps/dgst.c"
                                                                             )
...
# 493 "../apps/dgst.c"
        ...
        if (EVP_get_digestbyname(name->name) == 
# 494 "../apps/dgst.c" 3 4
                                               ((void *)0)
# 494 "../apps/dgst.c"
                                                   )
...
# 587 "../apps/dgst.c"
    ...
    if (binout) {
        ...
        BIO_printf(out, " *%s\n", file);
        CRYPTO_free((char *)file, "../apps/dgst.c", 633);
    } else {
        if (sig_name != 
# 635 "../apps/dgst.c" 3 4
                       ((void *)0)
...
# 655 "../apps/dgst.c"
        ...
        CRYPTO_clear_free(allocated_buf, len, "../apps/dgst.c", 656);
