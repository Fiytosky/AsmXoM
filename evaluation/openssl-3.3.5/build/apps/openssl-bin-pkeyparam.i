...
{
    ENGINE *e = 
# 48 "../apps/pkeyparam.c" 3 4
               ((void *)0)
# 48 "../apps/pkeyparam.c"
                   ;
    BIO *in = 
# 49 "../apps/pkeyparam.c" 3 4
             ((void *)0)
# 49 "../apps/pkeyparam.c"
                 , *out = 
# 49 "../apps/pkeyparam.c" 3 4
...
# 49 "../apps/pkeyparam.c"
                              ;
    EVP_PKEY *pkey = 
# 50 "../apps/pkeyparam.c" 3 4
                    ((void *)0)
# 50 "../apps/pkeyparam.c"
                        ;
    EVP_PKEY_CTX *ctx = 
# 51 "../apps/pkeyparam.c" 3 4
                       ((void *)0)
# 51 "../apps/pkeyparam.c"
                           ;
    int text = 0, noout = 0, ret = 
# 52 "../apps/pkeyparam.c" 3 4
                                  1
# 52 "../apps/pkeyparam.c"
                                              , check = 0, r;
    OPTION_CHOICE o;
    char *infile = 
# 54 "../apps/pkeyparam.c" 3 4
                  ((void *)0)
# 54 "../apps/pkeyparam.c"
                      , *outfile = 
# 54 "../apps/pkeyparam.c" 3 4
...
# 98 "../apps/pkeyparam.c"
    ...
    if (out == 
# 101 "../apps/pkeyparam.c" 3 4
              ((void *)0)
# 101 "../apps/pkeyparam.c"
                  )
        goto end;
    pkey = PEM_read_bio_Parameters_ex(in, 
# 103 "../apps/pkeyparam.c" 3 4
                                         ((void *)0)
# 103 "../apps/pkeyparam.c"
                                             , app_get0_libctx(),
                                      app_get0_propq());
    if (pkey == 
# 105 "../apps/pkeyparam.c" 3 4
               ((void *)0)
# 105 "../apps/pkeyparam.c"
                   ) {
    ...
    if (check) {
        if (e == 
# 112 "../apps/pkeyparam.c" 3 4
                ((void *)0)
# 112 "../apps/pkeyparam.c"
                    )
        ...
        if (ctx == 
# 117 "../apps/pkeyparam.c" 3 4
                  ((void *)0)
# 117 "../apps/pkeyparam.c"
                      ) {
            ERR_print_errors(bio_err);
            goto end;
        }
    ...
    if (text)
        EVP_PKEY_print_params(out, pkey, 0, 
# 141 "../apps/pkeyparam.c" 3 4
                                           ((void *)0)
# 141 "../apps/pkeyparam.c"
                                               );

    ret = 
# 143 "../apps/pkeyparam.c" 3 4
         0
# 143 "../apps/pkeyparam.c"
                     ;
