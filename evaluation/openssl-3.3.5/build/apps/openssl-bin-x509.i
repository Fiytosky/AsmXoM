...
typedef enum OPTION_choice {
    ...
    OPT_R__FIRST=1500, OPT_R_RAND, OPT_R_WRITERAND, OPT_R__LAST, OPT_PROV__FIRST=1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY, OPT_PROV__LAST, OPT_EXT
} OPTION_CHOICE;
...
const OPTIONS x509_options[] = {
    ...
    { OPT_SECTION_STR, 1, '-', "Certificate printing" " options:\n" },
    ...
    { OPT_SECTION_STR, 1, '-', "Certificate checking" " options:\n" },
    ...
    { OPT_SECTION_STR, 1, '-', "Certificate output" " options:\n" },
    ...
    { OPT_SECTION_STR, 1, '-', "Micro-CA" " options:\n" },
    {"CA", OPT_CA, '<',
    ...
    { OPT_SECTION_STR, 1, '-', "Certificate trust output" " options:\n" },
...
{
    const struct stack_st_X509_EXTENSION *cert_exts = X509_get0_extensions(cert);
    int i, n = OPENSSL_sk_num(ossl_check_const_X509_EXTENSION_sk_type(cert_exts));
    ASN1_OBJECT *skid = OBJ_nid2obj(82);
    ASN1_OBJECT *akid = OBJ_nid2obj(90);
    struct stack_st_X509_EXTENSION *exts;
    X509_REQ *req = X509_to_X509_REQ(cert, 
# 204 "../apps/x509.c" 3 4
                                          ((void *)0)
# 204 "../apps/x509.c"
                                              , 
...
# 207 "../apps/x509.c"
    ...
    if ((exts = ((struct stack_st_X509_EXTENSION *)OPENSSL_sk_new_reserve(ossl_check_X509_EXTENSION_compfunc_type(
# 215 "../apps/x509.c" 3 4
               ((void *)0)
# 215 "../apps/x509.c"
               ), (n)))) == 
...
# 215 "../apps/x509.c"
        ...
        goto err;
    for (i = 0; i < n; i++) {
        X509_EXTENSION *ex = ((X509_EXTENSION *)OPENSSL_sk_value(ossl_check_const_X509_EXTENSION_sk_type(cert_exts), (i)));
        ASN1_OBJECT *obj = X509_EXTENSION_get_object(ex);

        if (OBJ_cmp(obj, skid) != 0 && OBJ_cmp(obj, akid) != 0
                && !OPENSSL_sk_push(ossl_check_X509_EXTENSION_sk_type(exts), ossl_check_X509_EXTENSION_type(ex)))
            goto err;
    }

    if (OPENSSL_sk_num(ossl_check_const_X509_EXTENSION_sk_type(exts)) > 0) {
        if (ext_copy != -1 && ext_copy != 0
...
# 247 "../apps/x509.c" 3 4
              ((void *)0) 
# 247 "../apps/x509.c"
                   || !X509_STORE_CTX_init(xsc, ctx, cert, 
# 247 "../apps/x509.c" 3 4
                                                           ((void *)0)
# 247 "../apps/x509.c"
                                                               )) {
...
# 269 "../apps/x509.c"
                                         ;
    const unsigned long chtype = (0x1000|1);
...
# 281 "../apps/x509.c"
    ...
    int CAformat = 0, CAkeyformat = 0;
    unsigned long dateopt = 0x00UL;
    int fingerprint = 0, reqfile = 0, checkend = 0;
    int informat = 0, outformat = (5 | 0x8000), keyformat = 0;
...
# 305 "../apps/x509.c"
 ...
 opthelp:
        ...
        case OPT_HELP:
            ...
            goto end;
        case OPT_INFORM:
            if (!opt_format(opt_arg(), ((1L << 1) | (1L << 2)), &informat))
                goto opthelp;
            break;
        case OPT_IN:
            infile = opt_arg();
            break;
        case OPT_OUTFORM:
            if (!opt_format(opt_arg(), ( (1L << 1) | (1L << 2) | (1L << 3) | (1L << 4) | (1L << 5) | (1L << 6) | (1L << 7) | (1L << 8) | (1L << 9) | (1L << 10) | (1L << 11)), &outformat))
                goto opthelp;
            break;
        case OPT_KEYFORM:
            if (!opt_format(opt_arg(), ( (1L << 1) | (1L << 2) | (1L << 3) | (1L << 4) | (1L << 5) | (1L << 6) | (1L << 7) | (1L << 8) | (1L << 9) | (1L << 10) | (1L << 11)), &keyformat))
                goto opthelp;
            break;
        case OPT_CAFORM:
            if (!opt_format(opt_arg(), ( (1L << 1) | (1L << 2) | (1L << 3) | (1L << 4) | (1L << 5) | (1L << 6) | (1L << 7) | (1L << 8) | (1L << 9) | (1L << 10) | (1L << 11)), &CAformat))
                goto opthelp;
            break;
        case OPT_CAKEYFORM:
            if (!opt_format(opt_arg(), ( (1L << 1) | (1L << 2) | (1L << 3) | (1L << 4) | (1L << 5) | (1L << 6) | (1L << 7) | (1L << 8) | (1L << 9) | (1L << 10) | (1L << 11)), &CAkeyformat))
                goto opthelp;
            break;
        case OPT_OUT:
            outfile = opt_arg();
        ...
        case OPT_SIGOPT:
            if (!sigopts)
                sigopts = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null());
            if (!sigopts || !OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(sigopts), ossl_check_OPENSSL_STRING_type(opt_arg())))
                goto opthelp;
            break;
        case OPT_VFYOPT:
            if (!vfyopts)
                vfyopts = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null());
            if (!vfyopts || !OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(vfyopts), ossl_check_OPENSSL_STRING_type(opt_arg())))
                goto opthelp;
            break;
        case OPT_DAYS:
            days = atoi(opt_arg());
...
# 438 "../apps/x509.c" 3 4
                        ((void *)0) 
# 438 "../apps/x509.c"
                             && (trust = ((struct stack_st_ASN1_OBJECT *)OPENSSL_sk_new_null())) == 
# 438 "../apps/x509.c" 3 4
                                                                       ((void *)0)
# 438 "../apps/x509.c"
                                                                           )
                goto err;
            if ((objtmp = OBJ_txt2obj(opt_arg(), 0)) == 
# 440 "../apps/x509.c" 3 4
                                                       ((void *)0)
# 440 "../apps/x509.c"
                                                           ) {
            ...
            OPENSSL_sk_push(ossl_check_ASN1_OBJECT_sk_type(trust), ossl_check_ASN1_OBJECT_type(objtmp));
            trustout = 1;
            break;
        case OPT_ADDREJECT:
            if (reject == 
# 449 "../apps/x509.c" 3 4
                         ((void *)0) 
# 449 "../apps/x509.c"
                              && (reject = ((struct stack_st_ASN1_OBJECT *)OPENSSL_sk_new_null())) == 
# 449 "../apps/x509.c" 3 4
                                                                         ((void *)0)
# 449 "../apps/x509.c"
                                                                             )
...
# 451 "../apps/x509.c"
            ...
            OPENSSL_sk_push(ossl_check_ASN1_OBJECT_sk_type(reject), ossl_check_ASN1_OBJECT_type(objtmp));
            trustout = 1;
            break;
        case OPT_SETALIAS:
            alias = opt_arg();
...
# 642 "../apps/x509.c"
        ...
        if ((pubkey = load_pubkey(pubkeyfile, keyformat, 0, 
# 643 "../apps/x509.c" 3 4
                                                           ((void *)0)
# 643 "../apps/x509.c"
                                                               , e,
...
# 661 "../apps/x509.c"
           && (fissu = parse_name(issu, chtype, multirdn, "issuer")) == 
# 661 "../apps/x509.c" 3 4
                                                                        ((void *)0)
# 661 "../apps/x509.c"
                                                                            )
...
# 664 "../apps/x509.c"
           && (fsubj = parse_name(subj, chtype, multirdn, "subject")) == 
# 664 "../apps/x509.c" 3 4
                                                                         ((void *)0)
# 664 "../apps/x509.c"
                                                                             )
...
# 677 "../apps/x509.c"
            ...
            BIO_printf(bio_err, "Warning: ignoring " "-CAkey" " option since -CA option is not given\n");;
        if (CAkeyformat != 0)
            BIO_printf(bio_err, "Warning: ignoring " "-CAkeyform" " option since -CA option is not given\n");;
        if (CAformat != 0)
            BIO_printf(bio_err, "Warning: ignoring " "-CAform" " option since -CA option is not given\n");;
        if (CAserial != 
# 683 "../apps/x509.c" 3 4
                       ((void *)0)
# 683 "../apps/x509.c"
                           )
            BIO_printf(bio_err, "Warning: ignoring " "-CAserial" " option since -CA option is not given\n");;
        if (CA_createserial)
            BIO_printf(bio_err, "Warning: ignoring " "-CAcreateserial" " option since -CA option is not given\n");;
    }
...
# 690 "../apps/x509.c"
        ...
        if ((extconf = app_load_config_internal(extfile, 0)) == 
# 696 "../apps/x509.c" 3 4
                                                   ((void *)0)
# 696 "../apps/x509.c"
                                                       )
...
# 703 "../apps/x509.c"
       , 0x1);
        ...
        if (!X509V3_EXT_add_nconf(extconf, &ctx2, extsect, 
# 705 "../apps/x509.c" 3 4
                                                          ((void *)0)
# 705 "../apps/x509.c"
                                                              )) {
...
# 718 "../apps/x509.c"
        ...
        if ((pkey = X509_REQ_get0_pubkey(req)) == 
# 721 "../apps/x509.c" 3 4
                                                 ((void *)0)
# 721 "../apps/x509.c"
                                                     ) {
...
# 744 "../apps/x509.c"
        ...
        if ((x = X509_new_ex(app_get0_libctx(), app_get0_propq())) == 
# 749 "../apps/x509.c" 3 4
                                                                     ((void *)0)
# 749 "../apps/x509.c"
                                                                         )
...
# 801 "../apps/x509.c"
        ...
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ASN1_OBJECT_sk_type(trust)); i++)
            X509_add1_trust_object(x, ((ASN1_OBJECT *)OPENSSL_sk_value(ossl_check_const_ASN1_OBJECT_sk_type(trust), (i))));
    }
...
# 806 "../apps/x509.c"
        ...
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ASN1_OBJECT_sk_type(reject)); i++)
            X509_add1_reject_object(x, ((ASN1_OBJECT *)OPENSSL_sk_value(ossl_check_const_ASN1_OBJECT_sk_type(reject), (i))));
    }
...
# 842 "../apps/x509.c"
    ...
    X509V3_set_ctx(&ext_ctx, issuer_cert, x, 
# 851 "../apps/x509.c" 3 4
                                            ((void *)0)
# 851 "../apps/x509.c"
                                                , 
...
# 857 "../apps/x509.c"
    ...
    if ((print_pubkey != 0 || modulus != 0) && pkey == 
# 869 "../apps/x509.c" 3 4
                                                      ((void *)0)
# 869 "../apps/x509.c"
                                                          ) {
...
# 875 "../apps/x509.c"
        ...
        if ((rq = x509_to_req(x, ext_copy, ext_names)) == 
# 883 "../apps/x509.c" 3 4
                                                         ((void *)0)
# 883 "../apps/x509.c"
                                                             )
...
# 928 "../apps/x509.c"
    ...
    for (i = 1; i <= num; i++) {
        if (i == issuer) {
            ...
            ASN1_INTEGER *ser;
            BIGNUM *bnser = ASN1_INTEGER_to_BN(X509_get0_serialNumber(x), 
# 944 "../apps/x509.c" 3 4
                                                                         ((void *)0)
# 944 "../apps/x509.c"
                                                                             );
...
# 949 "../apps/x509.c"
            ...
            for (j = 0; j < OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(emlst)); j++)
                BIO_printf(out, "%s\n", ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(emlst), (j))));
            X509_email_free(emlst);
        } else if (i == aliasout) {
            unsigned char *alstr = X509_alias_get0(x, 
# 965 "../apps/x509.c" 3 4
                                                     ((void *)0)
# 965 "../apps/x509.c"
                                                         );
...
# 1052 "../apps/x509.c"
 ...
 err:
    ...
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(sigopts));
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(vfyopts));
    X509_REQ_free(rq);
    ASN1_INTEGER_free(sno);
    OPENSSL_sk_pop_free(ossl_check_ASN1_OBJECT_sk_type(trust),ossl_check_ASN1_OBJECT_freefunc_type(ASN1_OBJECT_free));
    OPENSSL_sk_pop_free(ossl_check_ASN1_OBJECT_sk_type(reject),ossl_check_ASN1_OBJECT_freefunc_type(ASN1_OBJECT_free));
    release_engine(e);
    clear_free(passin);
    return ret;
}
...
{
    char *buf = 
# 1118 "../apps/x509.c" 3 4
               ((void *)0)
# 1118 "../apps/x509.c"
                   ;
    ASN1_INTEGER *bs = 
# 1119 "../apps/x509.c" 3 4
                      ((void *)0)
# 1119 "../apps/x509.c"
                          ;
    BIGNUM *serial = 
# 1120 "../apps/x509.c" 3 4
                    ((void *)0)
# 1120 "../apps/x509.c"
                        ;
    ...
    if (serialfile == 
# 1123 "../apps/x509.c" 3 4
                     ((void *)0)
# 1123 "../apps/x509.c"
                         ) {
        const char *p = strrchr(CAfile, '.');
        size_t len = p != 
# 1125 "../apps/x509.c" 3 4
                         ((void *)0) 
# 1125 "../apps/x509.c"
                              ? (size_t)(p - CAfile) : strlen(CAfile);
    ...
    serial = load_serial(serialfile, &file_exists, create || defaultfile, 
# 1134 "../apps/x509.c" 3 4
                                                                         ((void *)0)
# 1134 "../apps/x509.c"
                                                                             );
    if (serial == 
# 1135 "../apps/x509.c" 3 4
                 ((void *)0)
# 1135 "../apps/x509.c"
                     )
        goto end;
...
# 1144 "../apps/x509.c" 3 4
                               ((void *)0)
# 1144 "../apps/x509.c"
                                   , serial, &bs);
    else
        bs = BN_to_ASN1_INTEGER(serial, 
# 1146 "../apps/x509.c" 3 4
                                       ((void *)0)
# 1146 "../apps/x509.c"
                                           );

 end:
    CRYPTO_free(buf, "../apps/x509.c", 1149);
    BN_free(serial);
    return bs;
}
...
{
    const struct stack_st_X509_EXTENSION *exts = 
# 1228 "../apps/x509.c" 3 4
                                          ((void *)0)
# 1228 "../apps/x509.c"
                                              ;
    struct stack_st_X509_EXTENSION *exts2 = 
# 1229 "../apps/x509.c" 3 4
                                     ((void *)0)
# 1229 "../apps/x509.c"
                                         ;
    X509_EXTENSION *ext = 
# 1230 "../apps/x509.c" 3 4
                         ((void *)0)
# 1230 "../apps/x509.c"
                             ;
    ASN1_OBJECT *obj;
    ...
    const char *sn, **names = 
# 1233 "../apps/x509.c" 3 4
                             ((void *)0)
# 1233 "../apps/x509.c"
                                 ;
    char *tmp_ext_names = 
# 1234 "../apps/x509.c" 3 4
                         ((void *)0)
# 1234 "../apps/x509.c"
                             ;

    exts = X509_get0_extensions(x);
    if ((num = OPENSSL_sk_num(ossl_check_const_X509_EXTENSION_sk_type(exts))) <= 0) {
    ...
    if ((tmp_ext_names = CRYPTO_strdup(ext_names, "../apps/x509.c", 1244)) == 
# 1244 "../apps/x509.c" 3 4
                                                      ((void *)0)
# 1244 "../apps/x509.c"
                                                          )
        goto end;
    if ((nn = parse_ext_names(tmp_ext_names, 
# 1246 "../apps/x509.c" 3 4
                                            ((void *)0)
# 1246 "../apps/x509.c"
                                                )) == 0) {
    ...
    if ((names = CRYPTO_malloc(sizeof(char *) * nn, "../apps/x509.c", 1250)) == 
# 1250 "../apps/x509.c" 3 4
                                                        ((void *)0)
# 1250 "../apps/x509.c"
                                                            )
        goto end;
    ...
    for (i = 0; i < num; i++) {
        ext = ((X509_EXTENSION *)OPENSSL_sk_value(ossl_check_const_X509_EXTENSION_sk_type(exts), (i)));


        obj = X509_EXTENSION_get_object(ext);
        sn = OBJ_nid2sn(OBJ_obj2nid(obj));
        if (sn == 
# 1260 "../apps/x509.c" 3 4
                 ((void *)0) 
# 1260 "../apps/x509.c"
                      || strcmp(sn, "UNDEF") == 0)
            continue;
        ...
        for (j = 0; j < nn; j++) {
            if (strcmp(sn, names[j]) == 0) {
                ...
                if (exts2 == 
# 1266 "../apps/x509.c" 3 4
                            ((void *)0)
                    
# 1267 "../apps/x509.c"
                   && (exts2 = ((struct stack_st_X509_EXTENSION *)OPENSSL_sk_new_null())) == 
# 1267 "../apps/x509.c" 3 4
                                                                ((void *)0)
# 1267 "../apps/x509.c"
                                                                    )
                    goto end;
                if (!OPENSSL_sk_push(ossl_check_X509_EXTENSION_sk_type(exts2), ossl_check_X509_EXTENSION_type(ext)))
                    goto end;
            }
        }
    }

    if (!OPENSSL_sk_num(ossl_check_const_X509_EXTENSION_sk_type(exts2))) {
        BIO_printf(bio, "No extensions matched with %s\n", ext_names);
        ret = 1;
        goto end;
    }

    ret = X509V3_extensions_print(bio, 
# 1281 "../apps/x509.c" 3 4
                                      ((void *)0)
# 1281 "../apps/x509.c"
                                          , exts2, 0, 0);
 end:
    OPENSSL_sk_free(ossl_check_X509_EXTENSION_sk_type(exts2));
    CRYPTO_free(names, "../apps/x509.c", 1284);
    CRYPTO_free(tmp_ext_names, "../apps/x509.c", 1285);
    return ret;
}
