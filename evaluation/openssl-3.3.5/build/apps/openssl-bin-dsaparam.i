...
{
    ENGINE *e = 
# 67 "../apps/dsaparam.c" 3 4
               ((void *)0)
# 67 "../apps/dsaparam.c"
                   ;
    BIO *out = 
# 68 "../apps/dsaparam.c" 3 4
              ((void *)0)
# 68 "../apps/dsaparam.c"
                  ;
    EVP_PKEY *params = 
# 69 "../apps/dsaparam.c" 3 4
                      ((void *)0)
# 69 "../apps/dsaparam.c"
                          , *pkey = 
# 69 "../apps/dsaparam.c" 3 4
...
# 69 "../apps/dsaparam.c"
                                        ;
    EVP_PKEY_CTX *ctx = 
# 70 "../apps/dsaparam.c" 3 4
                       ((void *)0)
# 70 "../apps/dsaparam.c"
                           ;
    int numbits = -1, numqbits = -1, num = 0, genkey = 0;
    int informat = 0, outformat = (5 | 0x8000), noout = 0;
    int ret = 1, i, text = 0, private = 0;
    char *infile = 
# 74 "../apps/dsaparam.c" 3 4
                  ((void *)0)
# 74 "../apps/dsaparam.c"
                      , *outfile = 
# 74 "../apps/dsaparam.c" 3 4
...
# 198 "../apps/dsaparam.c"
    ...
    if (text) {
        EVP_PKEY_print_params(out, params, 0, 
# 204 "../apps/dsaparam.c" 3 4
                                             ((void *)0)
# 204 "../apps/dsaparam.c"
                                                 );
    }
...
# 224 "../apps/dsaparam.c"
        ...
        if (pkey == 
# 235 "../apps/dsaparam.c" 3 4
                   ((void *)0)
# 235 "../apps/dsaparam.c"
                       )
            goto end;
        
# 237 "../apps/dsaparam.c" 3 4
       ((void) (0))
# 237 "../apps/dsaparam.c"
                      ;
        if (outformat == 4)
