# 0 "../apps/fipsinstall.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../apps/fipsinstall.c"
# 10 "../apps/fipsinstall.c"
...
# 17 "../apps/fipsinstall.c" 2
# 1 "include/openssl/fipskey.h" 1
# 15 "include/openssl/fipskey.h"
        
# 18 "../apps/fipsinstall.c" 2
...
# 20 "../apps/fipsinstall.c" 2
# 28 "../apps/fipsinstall.c"
static OSSL_CALLBACK self_test_events;
static char *self_test_corrupt_desc = 
# 29 "../apps/fipsinstall.c" 3 4
                                     ((void *)0)
# 29 "../apps/fipsinstall.c"
                                         ;
static char *self_test_corrupt_type = 
# 30 "../apps/fipsinstall.c" 3 4
                                     ((void *)0)
# 30 "../apps/fipsinstall.c"
                                         ;
...
const OPTIONS fipsinstall_options[] = {
    ...
    { OPT_SECTION_STR, 1, '-', "Input" " options:\n" },
    ...
    {
# 82 "../apps/fipsinstall.c" 3 4
    ((void *)0)
# 82 "../apps/fipsinstall.c"
        }
};
                  ...
                  unsigned char *out, size_t *out_len)
{
    ...
    if (!EVP_MAC_init(ctx, 
# 127 "../apps/fipsinstall.c" 3 4
                          ((void *)0)
# 127 "../apps/fipsinstall.c"
                              , 0, 
# 127 "../apps/fipsinstall.c" 3 4
                                   ((void *)0)
# 127 "../apps/fipsinstall.c"
    ...
    if (EVP_MAC_CTX_get_mac_size(ctx) > outsz)
        goto end;
    while ((i = BIO_read(in, (char *)tmp, 4096)) != 0) {
...
static int load_fips_prov_and_run_self_test(const char *prov_name)
{
    int ret = 0;
    OSSL_PROVIDER *prov = 
# 146 "../apps/fipsinstall.c" 3 4
                         ((void *)0)
# 146 "../apps/fipsinstall.c"
                             ;
    OSSL_PARAM params[4], *p = params;
    char *name = "", *vers = "", *build = "";

    prov = OSSL_PROVIDER_load(
# 150 "../apps/fipsinstall.c" 3 4
                             ((void *)0)
# 150 "../apps/fipsinstall.c"
                                 , prov_name);
    if (prov == 
# 151 "../apps/fipsinstall.c" 3 4
               ((void *)0)
# 151 "../apps/fipsinstall.c"
                   ) {
        BIO_printf(bio_err, "Failed to load FIPS module\n");
        goto end;
    }
    if (!quiet) {
        *p++ = OSSL_PARAM_construct_utf8_ptr("name",
                                             &name, sizeof(name));
        *p++ = OSSL_PARAM_construct_utf8_ptr("version",
                                             &vers, sizeof(vers));
        *p++ = OSSL_PARAM_construct_utf8_ptr("buildinfo",
                                             &build, sizeof(build));
                     ...
                     size_t len)
{
    int ret;
    char *hexstr = 
# 184 "../apps/fipsinstall.c" 3 4
                  ((void *)0)
# 184 "../apps/fipsinstall.c"
                      ;

    hexstr = OPENSSL_buf2hexstr(mac, (long)len);
    if (hexstr == 
# 187 "../apps/fipsinstall.c" 3 4
                 ((void *)0)
# 187 "../apps/fipsinstall.c"
                     )
        return 0;
    ret = BIO_printf(bio, "%s = %s\n", label, hexstr);
    CRYPTO_free(hexstr, "../apps/fipsinstall.c", 190);
    return ret;
}
                                     ...
                                     size_t install_mac_len)
{
    ...
    if (BIO_printf(out, "[%s]\n", section) <= 0
        ...
        || !print_mac(out, "module-mac", module_mac,
                      module_mac_len))
        goto end;

    if (install_mac != 
# 236 "../apps/fipsinstall.c" 3 4
                      ((void *)0) 
# 236 "../apps/fipsinstall.c"
                           && install_mac_len > 0) {
        if (!print_mac(out, "install-mac", install_mac,
                       install_mac_len)
            || BIO_printf(out, "%s = %s\n", "install-status",
                          "INSTALL_SELF_TEST_KATS_RUN") <= 0)
        goto end;
    }
    ret = 1;
end:
...
{
    BIO *mem_bio = 
# 254 "../apps/fipsinstall.c" 3 4
                  ((void *)0)
# 254 "../apps/fipsinstall.c"
                      ;
    CONF *conf = 
# 255 "../apps/fipsinstall.c" 3 4
                ((void *)0)
# 255 "../apps/fipsinstall.c"
                    ;

    mem_bio = BIO_new(BIO_s_mem());
    if (mem_bio == 
# 258 "../apps/fipsinstall.c" 3 4
                   ((void *)0)
# 258 "../apps/fipsinstall.c"
                       )
        return 0;
    if (!write_config_header(mem_bio, prov_name, section)
         || !write_config_fips_section(mem_bio, section,
                                       ...
                                       opts, 
# 263 "../apps/fipsinstall.c" 3 4
                                            ((void *)0)
# 263 "../apps/fipsinstall.c"
                                                , 0))
        goto end;

    conf = app_load_config_bio(mem_bio, 
# 266 "../apps/fipsinstall.c" 3 4
                                       ((void *)0)
# 266 "../apps/fipsinstall.c"
                                           );
    if (conf == 
# 267 "../apps/fipsinstall.c" 3 4
               ((void *)0)
# 267 "../apps/fipsinstall.c"
                   )
        goto end;

    if (CONF_modules_load(conf, 
# 270 "../apps/fipsinstall.c" 3 4
                               ((void *)0)
# 270 "../apps/fipsinstall.c"
                                   , 0) <= 0)
        goto end;
    BIO_free(mem_bio);
    return conf;
    ...
    BIO_free(mem_bio);
    return 
# 277 "../apps/fipsinstall.c" 3 4
          ((void *)0)
# 277 "../apps/fipsinstall.c"
              ;
}
...
{
    if (conf != 
# 282 "../apps/fipsinstall.c" 3 4
               ((void *)0)
# 282 "../apps/fipsinstall.c"
                   ) {
        NCONF_free(conf);
...
{
    return OSSL_LIB_CTX_load_config(
# 290 "../apps/fipsinstall.c" 3 4
                                   ((void *)0)
# 290 "../apps/fipsinstall.c"
                                       , parent_config_file);
}
                         ...
                         unsigned char *install_mac, size_t install_mac_len)
{
    int ret = 0;
    char *s = 
# 302 "../apps/fipsinstall.c" 3 4
             ((void *)0)
# 302 "../apps/fipsinstall.c"
                 ;
    unsigned char *buf1 = 
# 303 "../apps/fipsinstall.c" 3 4
                         ((void *)0)
# 303 "../apps/fipsinstall.c"
                             , *buf2 = 
# 303 "../apps/fipsinstall.c" 3 4
                                       ((void *)0)
# 303 "../apps/fipsinstall.c"
    ...
    long len;
    CONF *conf = 
# 305 "../apps/fipsinstall.c" 3 4
                ((void *)0)
# 305 "../apps/fipsinstall.c"
                    ;


    conf = app_load_config_internal(infile, 0);
    if (conf == 
# 309 "../apps/fipsinstall.c" 3 4
               ((void *)0)
# 309 "../apps/fipsinstall.c"
                   )
        goto end;

    s = NCONF_get_string(conf, section, "install-version");
    if (s == 
# 313 "../apps/fipsinstall.c" 3 4
            ((void *)0) 
# 313 "../apps/fipsinstall.c"
                 || strcmp(s, "1") != 0) {
        BIO_printf(bio_err, "version not found\n");
        goto end;
    }
    s = NCONF_get_string(conf, section, "module-mac");
    if (s == 
# 318 "../apps/fipsinstall.c" 3 4
            ((void *)0)
# 318 "../apps/fipsinstall.c"
                ) {
    ...
    if (buf1 == 
# 323 "../apps/fipsinstall.c" 3 4
               ((void *)0)
            
# 324 "../apps/fipsinstall.c"
    ...
    if (install_mac != 
# 329 "../apps/fipsinstall.c" 3 4
                      ((void *)0) 
# 329 "../apps/fipsinstall.c"
                           && install_mac_len > 0) {
        s = NCONF_get_string(conf, section, "install-status");
        if (s == 
# 331 "../apps/fipsinstall.c" 3 4
                ((void *)0) 
# 331 "../apps/fipsinstall.c"
                     || strcmp(s, "INSTALL_SELF_TEST_KATS_RUN") != 0) {
            BIO_printf(bio_err, "install status not found\n");
            goto end;
        }
        s = NCONF_get_string(conf, section, "install-mac");
        if (s == 
# 336 "../apps/fipsinstall.c" 3 4
                ((void *)0)
# 336 "../apps/fipsinstall.c"
                    ) {
        ...
        if (buf2 == 
# 341 "../apps/fipsinstall.c" 3 4
                   ((void *)0)
                
# 342 "../apps/fipsinstall.c"
    ...
    CRYPTO_free(buf1, "../apps/fipsinstall.c", 350);
    CRYPTO_free(buf2, "../apps/fipsinstall.c", 351);
    NCONF_free(conf);
    return ret;
}
...
int fipsinstall_main(int argc, char **argv)
{
    ...
    BIO *module_bio = 
# 362 "../apps/fipsinstall.c" 3 4
                     ((void *)0)
# 362 "../apps/fipsinstall.c"
                         , *mem_bio = 
# 362 "../apps/fipsinstall.c" 3 4
                                      ((void *)0)
# 362 "../apps/fipsinstall.c"
...
# 362 "../apps/fipsinstall.c"
                                                        ;
    char *in_fname = 
# 363 "../apps/fipsinstall.c" 3 4
                    ((void *)0)
# 363 "../apps/fipsinstall.c"
                        , *out_fname = 
# 363 "../apps/fipsinstall.c" 3 4
                                       ((void *)0)
# 363 "../apps/fipsinstall.c"
                                           , *prog;
    char *module_fname = 
# 364 "../apps/fipsinstall.c" 3 4
                        ((void *)0)
# 364 "../apps/fipsinstall.c"
                            , *parent_config = 
# 364 "../apps/fipsinstall.c" 3 4
                                               ((void *)0)
# 364 "../apps/fipsinstall.c"
...
# 364 "../apps/fipsinstall.c"
    ...
    const char *tail;
    EVP_MAC_CTX *ctx = 
# 366 "../apps/fipsinstall.c" 3 4
                      ((void *)0)
# 366 "../apps/fipsinstall.c"
                          , *ctx2 = 
# 366 "../apps/fipsinstall.c" 3 4
                                    ((void *)0)
# 366 "../apps/fipsinstall.c"
                                        ;
    struct stack_st_OPENSSL_STRING *opts = 
# 367 "../apps/fipsinstall.c" 3 4
                                    ((void *)0)
# 367 "../apps/fipsinstall.c"
                                        ;
    OPTION_CHOICE o;
    unsigned char *read_buffer = 
# 369 "../apps/fipsinstall.c" 3 4
                                ((void *)0)
# 369 "../apps/fipsinstall.c"
                                    ;
    unsigned char module_mac[64];
    size_t module_mac_len = 64;
    unsigned char install_mac[64];
    size_t install_mac_len = 64;
    EVP_MAC *mac = 
# 374 "../apps/fipsinstall.c" 3 4
                  ((void *)0)
# 374 "../apps/fipsinstall.c"
                      ;
    CONF *conf = 
# 375 "../apps/fipsinstall.c" 3 4
                ((void *)0)
# 375 "../apps/fipsinstall.c"
                    ;

    if ((opts = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null())) == 
# 377 "../apps/fipsinstall.c" 3 4
                                                ((void *)0)
# 377 "../apps/fipsinstall.c"
                                                    )
        goto end;
...
opthelp:
        ...
        case OPT_CONFIG:
            ...
            break;
        case OPT_MACOPT:
            if (!OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(opts), ossl_check_OPENSSL_STRING_type(opt_arg())))
                goto opthelp;
            if ((strncmp(opt_arg(), "hexkey:" "", sizeof("hexkey:") - 1) == 0))
                gotkey = 1;
            else if ((strncmp(opt_arg(), "digest:" "", sizeof("digest:") - 1) == 0))
                gotdigest = 1;
            break;
        case OPT_VERIFY:
            verify = 1;
...
# 468 "../apps/fipsinstall.c" 3 4
                           ((void *)0)
# 468 "../apps/fipsinstall.c"
                               ))
        goto opthelp;
    if (verify && in_fname == 
# 470 "../apps/fipsinstall.c" 3 4
                             ((void *)0)
# 470 "../apps/fipsinstall.c"
                                 ) {
    ...
    if (parent_config != 
# 475 "../apps/fipsinstall.c" 3 4
                        ((void *)0)
# 475 "../apps/fipsinstall.c"
                            ) {

        if (verify_module_load(parent_config)) {
            ret = OSSL_PROVIDER_available(
# 478 "../apps/fipsinstall.c" 3 4
                                         ((void *)0)
# 478 "../apps/fipsinstall.c"
                                             , prov_name) ? 0 : 1;
            if (!quiet) {
    ...
    if (module_fname == 
# 486 "../apps/fipsinstall.c" 3 4
                       ((void *)0)
# 486 "../apps/fipsinstall.c"
                           )
        goto opthelp;

    tail = opt_path_end(module_fname);
    if (tail != 
# 490 "../apps/fipsinstall.c" 3 4
               ((void *)0)
# 490 "../apps/fipsinstall.c"
                   ) {
        module_path = CRYPTO_strdup(module_fname, "../apps/fipsinstall.c", 491);
        if (module_path == 
# 492 "../apps/fipsinstall.c" 3 4
                          ((void *)0)
# 492 "../apps/fipsinstall.c"
                              )
            goto end;
        module_path[tail - module_fname] = '\0';
        if (!OSSL_PROVIDER_set_default_search_path(
# 495 "../apps/fipsinstall.c" 3 4
                                                  ((void *)0)
# 495 "../apps/fipsinstall.c"
                                                      , module_path))
            goto end;
    }
...
# 500 "../apps/fipsinstall.c" 3 4
                                        ((void *)0)
            
# 501 "../apps/fipsinstall.c"
           || self_test_corrupt_type != 
# 501 "../apps/fipsinstall.c" 3 4
                                        ((void *)0)
# 501 "../apps/fipsinstall.c"
                                            )
        OSSL_SELF_TEST_set_callback(
# 502 "../apps/fipsinstall.c" 3 4
                                   ((void *)0)
# 502 "../apps/fipsinstall.c"
                                       , self_test_events, 
# 502 "../apps/fipsinstall.c" 3 4
                                                           ((void *)0)
# 502 "../apps/fipsinstall.c"
    ...
    if (!gotdigest && !OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(opts), ossl_check_OPENSSL_STRING_type("digest:SHA256")))
        goto end;
    if (!gotkey && !OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(opts), ossl_check_OPENSSL_STRING_type("hexkey:" "f4556650ac31d35461610bac4ed81b1a181b2d8a43ea2854cbae22ca74560813")))
        goto end;

    module_bio = bio_open_default(module_fname, 'r', 2);
    if (module_bio == 
# 511 "../apps/fipsinstall.c" 3 4
                     ((void *)0)
# 511 "../apps/fipsinstall.c"
                         ) {
        BIO_printf(bio_err, "Failed to open module file\n");
        goto end;
    }

    read_buffer = app_malloc(4096, "I/O buffer");
    if (read_buffer == 
# 517 "../apps/fipsinstall.c" 3 4
                      ((void *)0)
# 517 "../apps/fipsinstall.c"
                          )
        goto end;

    mac = EVP_MAC_fetch(app_get0_libctx(), mac_name, app_get0_propq());
    if (mac == 
# 521 "../apps/fipsinstall.c" 3 4
              ((void *)0)
# 521 "../apps/fipsinstall.c"
                  ) {
    ...
    if (ctx == 
# 527 "../apps/fipsinstall.c" 3 4
              ((void *)0)
# 527 "../apps/fipsinstall.c"
                  ) {
    ...
    if (opts != 
# 532 "../apps/fipsinstall.c" 3 4
               ((void *)0)
# 532 "../apps/fipsinstall.c"
                   ) {
        int ok = 1;
        OSSL_PARAM *params =
        ...
        if (params == 
# 537 "../apps/fipsinstall.c" 3 4
                     ((void *)0)
# 537 "../apps/fipsinstall.c"
                         )
            goto end;
    ...
    if (ctx2 == 
# 551 "../apps/fipsinstall.c" 3 4
               ((void *)0)
# 551 "../apps/fipsinstall.c"
                   ) {
    ...
    if (fips_opts.self_test_onload == 0) {
        mem_bio = BIO_new_mem_buf((const void *)"INSTALL_SELF_TEST_KATS_RUN",
                                  strlen("INSTALL_SELF_TEST_KATS_RUN"));
        if (mem_bio == 
# 562 "../apps/fipsinstall.c" 3 4
                      ((void *)0)
# 562 "../apps/fipsinstall.c"
                          ) {
    ...
    if (verify) {
        ...
        if (conf == 
# 582 "../apps/fipsinstall.c" 3 4
                   ((void *)0)
# 582 "../apps/fipsinstall.c"
                       )
            goto end;
        ...
        fout =
            out_fname == 
# 588 "../apps/fipsinstall.c" 3 4
                        ((void *)0) 
# 588 "../apps/fipsinstall.c"
                             ? dup_bio_out((1 | 0x8000))
                              : bio_open_default(out_fname, 'w', (1 | 0x8000));
        if (fout == 
# 590 "../apps/fipsinstall.c" 3 4
                   ((void *)0)
# 590 "../apps/fipsinstall.c"
                       ) {
...
cleanup:
    CRYPTO_free(module_path, "../apps/fipsinstall.c", 611);
    BIO_free(fout);
    BIO_free(mem_bio);
    BIO_free(module_bio);
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(opts));
    EVP_MAC_free(mac);
    EVP_MAC_CTX_free(ctx2);
    EVP_MAC_CTX_free(ctx);
    CRYPTO_free(read_buffer, "../apps/fipsinstall.c", 619);
...
{
    const OSSL_PARAM *p = 
# 626 "../apps/fipsinstall.c" 3 4
                         ((void *)0)
# 626 "../apps/fipsinstall.c"
                             ;
    const char *phase = 
# 627 "../apps/fipsinstall.c" 3 4
                       ((void *)0)
# 627 "../apps/fipsinstall.c"
                           , *type = 
# 627 "../apps/fipsinstall.c" 3 4
                                     ((void *)0)
# 627 "../apps/fipsinstall.c"
...
# 627 "../apps/fipsinstall.c"
    ...
    p = OSSL_PARAM_locate_const(params, "st-phase");
    if (p == 
# 631 "../apps/fipsinstall.c" 3 4
            ((void *)0) 
# 631 "../apps/fipsinstall.c"
                 || p->data_type != 4)
        goto err;
    phase = (const char *)p->data;

    p = OSSL_PARAM_locate_const(params, "st-desc");
    if (p == 
# 636 "../apps/fipsinstall.c" 3 4
            ((void *)0) 
# 636 "../apps/fipsinstall.c"
                 || p->data_type != 4)
        goto err;
    desc = (const char *)p->data;

    p = OSSL_PARAM_locate_const(params, "st-type");
    if (p == 
# 641 "../apps/fipsinstall.c" 3 4
            ((void *)0) 
# 641 "../apps/fipsinstall.c"
                 || p->data_type != 4)
        goto err;
    ...
    if (strcmp(phase, "Corrupt") == 0
            && (self_test_corrupt_desc != 
# 657 "../apps/fipsinstall.c" 3 4
                                         ((void *)0)
                
# 658 "../apps/fipsinstall.c"
               || self_test_corrupt_type != 
# 658 "../apps/fipsinstall.c" 3 4
                                            ((void *)0)
# 658 "../apps/fipsinstall.c"
                                                )) {
        if (self_test_corrupt_desc != 
# 659 "../apps/fipsinstall.c" 3 4
                                     ((void *)0)
                
# 660 "../apps/fipsinstall.c"
               && strcmp(self_test_corrupt_desc, desc) != 0)
            goto end;
        if (self_test_corrupt_type != 
# 662 "../apps/fipsinstall.c" 3 4
                                     ((void *)0)
                
# 663 "../apps/fipsinstall.c"
