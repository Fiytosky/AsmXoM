...
# 76 "../apps/pkey.c"
                                                                 , *prog;
    OPTION_CHOICE o;
    int informat = 0, outformat = (5 | 0x8000);
...
# 175 "../apps/pkey.c"
    ...
    if (traditional && (noout || outformat != (5 | 0x8000)))
        BIO_printf(bio_err,
...
# 297 "../apps/pkey.c"
    ...
    if (text_pub) {
        if (EVP_PKEY_print_public(out, pkey, 0, 
# 308 "../apps/pkey.c" 3 4
                                               ((void *)0)
# 308 "../apps/pkey.c"
                                                   ) <= 0)
...
# 311 "../apps/pkey.c"
                      ;
        if (EVP_PKEY_print_private(out, pkey, 0, 
# 312 "../apps/pkey.c" 3 4
                                                ((void *)0)
# 312 "../apps/pkey.c"
                                                    ) <= 0)
    ...
    release_engine(e);
    BIO_free_all(out);
    CRYPTO_free(passin, "../apps/pkey.c", 326);
    CRYPTO_free(passout, "../apps/pkey.c", 327);
