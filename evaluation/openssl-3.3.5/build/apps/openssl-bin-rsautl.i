...
# 74 "../apps/rsautl.c"
                              ;
    ENGINE *e = 
# 75 "../apps/rsautl.c" 3 4
               ((void *)0)
# 75 "../apps/rsautl.c"
                   ;
    EVP_PKEY *pkey = 
# 76 "../apps/rsautl.c" 3 4
                    ((void *)0)
# 76 "../apps/rsautl.c"
                        ;
    EVP_PKEY_CTX *ctx = 
# 77 "../apps/rsautl.c" 3 4
                       ((void *)0)
# 77 "../apps/rsautl.c"
                           ;
    X509 *x;
    char *infile = 
# 79 "../apps/rsautl.c" 3 4
                  ((void *)0)
# 79 "../apps/rsautl.c"
                      , *outfile = 
# 79 "../apps/rsautl.c" 3 4
...
# 82 "../apps/rsautl.c"
    ...
    int keyformat = 0, keysize, ret = 1, rv;
...
# 183 "../apps/rsautl.c"
    ...
    case 2:
        pkey = load_pubkey(keyfile, keyformat, 0, 
# 194 "../apps/rsautl.c" 3 4
                                                 ((void *)0)
# 194 "../apps/rsautl.c"
                                                     , e, "public key");
        break;
    ...
    case 3:
        x = load_cert_pass(keyfile, 0, 1, 
# 198 "../apps/rsautl.c" 3 4
           ((void *)0)
# 198 "../apps/rsautl.c"
           , "Certificate");
        if (x) {
...
# 213 "../apps/rsautl.c"
    ...
    if ((ctx = EVP_PKEY_CTX_new_from_pkey(
# 240 "../apps/rsautl.c" 3 4
                                         ((void *)0)
# 240 "../apps/rsautl.c"
                                             , pkey, 
# 240 "../apps/rsautl.c" 3 4
...
# 240 "../apps/rsautl.c"
    ...
    BIO_free(in);
    BIO_free_all(out);
    CRYPTO_free(rsa_in, "../apps/rsautl.c", 288);
    CRYPTO_free(rsa_out, "../apps/rsautl.c", 289);
    CRYPTO_free(passin, "../apps/rsautl.c", 290);
    return ret;
}
