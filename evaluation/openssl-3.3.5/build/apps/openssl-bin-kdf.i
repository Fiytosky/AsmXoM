...
static char *alloc_kdf_algorithm_name(struct stack_st_OPENSSL_STRING **optp,
...
# 57 "../apps/kdf.c"
        ...
        *optp = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null());
    if (*optp == 
# 59 "../apps/kdf.c" 3 4
                ((void *)0)
# 59 "../apps/kdf.c"
...
# 60 "../apps/kdf.c"
    ...
    if (OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(*optp), ossl_check_OPENSSL_STRING_type(res)))
        return res;
    CRYPTO_free(res, "../apps/kdf.c", 66);
    return 
# 67 "../apps/kdf.c" 3 4
          ((void *)0)
# 67 "../apps/kdf.c"
...
# 105 "../apps/kdf.c"
                ...
                opts = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null());
            if (opts == 
# 107 "../apps/kdf.c" 3 4
                       ((void *)0) 
# 107 "../apps/kdf.c"
                            || !OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(opts), ossl_check_OPENSSL_STRING_type(opt_arg())))
                goto opthelp;
            break;
        case OPT_CIPHER:
            CRYPTO_free(cipher, "../apps/kdf.c", 111);
...
# 113 "../apps/kdf.c"
            ...
            break;
        case OPT_DIGEST:
            CRYPTO_free(digest, "../apps/kdf.c", 117);
...
# 119 "../apps/kdf.c"
            ...
            break;
        case OPT_MAC:
            CRYPTO_free(mac, "../apps/kdf.c", 123);
...
err:
    if (ret != 0)
        ERR_print_errors(bio_err);
    CRYPTO_clear_free(dkm_bytes, dkm_len, "../apps/kdf.c", 201);
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(opts));
    EVP_KDF_free(kdf);
    EVP_KDF_CTX_free(ctx);
    BIO_free(out);
    CRYPTO_free(hexout, "../apps/kdf.c", 206);
    CRYPTO_free(cipher, "../apps/kdf.c", 207);
    CRYPTO_free(digest, "../apps/kdf.c", 208);
    CRYPTO_free(mac, "../apps/kdf.c", 209);
    return ret;
}
