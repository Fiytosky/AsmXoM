...
# 85 "../apps/dhparam.c"
                                         ;
    EVP_PKEY_CTX *ctx = 
# 86 "../apps/dhparam.c" 3 4
                       ((void *)0)
# 86 "../apps/dhparam.c"
                           ;
    char *infile = 
# 87 "../apps/dhparam.c" 3 4
                  ((void *)0)
# 87 "../apps/dhparam.c"
                      , *outfile = 
# 87 "../apps/dhparam.c" 3 4
...
# 242 "../apps/dhparam.c"
        ...
        tmppkey = 
# 248 "../apps/dhparam.c" 3 4
                 ((void *)0)
# 248 "../apps/dhparam.c"
                     ;
    } else {
        OSSL_DECODER_CTX *decoderctx = 
# 250 "../apps/dhparam.c" 3 4
                                      ((void *)0)
# 250 "../apps/dhparam.c"
                                          ;
...
# 273 "../apps/dhparam.c" 3 4
                                               ((void *)0)
# 273 "../apps/dhparam.c"
                                                   ,
                                                (informat == 4)
                                                    ? keytype : 
# 275 "../apps/dhparam.c" 3 4
                                                               ((void *)0)
# 275 "../apps/dhparam.c"
                                                                   ,
                                                0x04,
                                                
# 277 "../apps/dhparam.c" 3 4
                                               ((void *)0)
# 277 "../apps/dhparam.c"
                                                   , 
# 277 "../apps/dhparam.c" 3 4
...
# 291 "../apps/dhparam.c"
                ...
                if ((int)BIO_ctrl(in,1,0,
# 296 "../apps/dhparam.c" 3 4
                   ((void *)0)
# 296 "../apps/dhparam.c"
                   ) == 0)
                    done = 0;
...
# 321 "../apps/dhparam.c"
    ...
    if (text)
        EVP_PKEY_print_params(out, pkey, 4, 
# 326 "../apps/dhparam.c" 3 4
                                           ((void *)0)
# 326 "../apps/dhparam.c"
                                               );
...
{
    OSSL_PARAM_BLD *tmpl = 
# 376 "../apps/dhparam.c" 3 4
                          ((void *)0)
# 376 "../apps/dhparam.c"
                              ;
    OSSL_PARAM *params = 
# 377 "../apps/dhparam.c" 3 4
                        ((void *)0)
# 377 "../apps/dhparam.c"
                            ;
    BIGNUM *bn_p = 
# 378 "../apps/dhparam.c" 3 4
                  ((void *)0)
# 378 "../apps/dhparam.c"
                      , *bn_q = 
# 378 "../apps/dhparam.c" 3 4
...
# 378 "../apps/dhparam.c"
                                                  ;
    EVP_PKEY_CTX *ctx = 
# 379 "../apps/dhparam.c" 3 4
                       ((void *)0)
# 379 "../apps/dhparam.c"
                           ;
    EVP_PKEY *pkey = 
# 380 "../apps/dhparam.c" 3 4
                    ((void *)0)
# 380 "../apps/dhparam.c"
                        ;

    if (!EVP_PKEY_get_bn_param(dh, "p", &bn_p)
            || !EVP_PKEY_get_bn_param(dh, "q", &bn_q)
            || !EVP_PKEY_get_bn_param(dh, "g", &bn_g)) {
        BIO_printf(bio_err, "Error, failed to set DH parameters\n");
        goto err;
    }

    if ((tmpl = OSSL_PARAM_BLD_new()) == 
# 389 "../apps/dhparam.c" 3 4
                                        ((void *)0)
            
# 390 "../apps/dhparam.c"
           || !OSSL_PARAM_BLD_push_BN(tmpl, "p",
                                        bn_p)
            || !OSSL_PARAM_BLD_push_BN(tmpl, "q",
                                        bn_q)
            || !OSSL_PARAM_BLD_push_BN(tmpl, "g",
                                        bn_g)
            || (params = OSSL_PARAM_BLD_to_param(tmpl)) == 
# 396 "../apps/dhparam.c" 3 4
                                                          ((void *)0)
# 396 "../apps/dhparam.c"
                                                              ) {
        BIO_printf(bio_err, "Error, failed to set DH parameters\n");
    ...
    if (ctx == 
# 402 "../apps/dhparam.c" 3 4
              ((void *)0)
            
# 403 "../apps/dhparam.c"
           || EVP_PKEY_fromdata_init(ctx) <= 0
            || EVP_PKEY_fromdata(ctx, &pkey, ( ( 0x04 | 0x80) ), params) <= 0) {
        BIO_printf(bio_err, "Error, failed to set DH parameters\n");
        goto err;
    }
