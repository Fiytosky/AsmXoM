...
const OPTIONS pkcs8_options[] = {
    ...
    { OPT_SECTION_STR, 1, '-', "Scrypt" " options:\n" },
...
# 88 "../apps/pkcs8.c"
    ...
    int informat = 0, outformat = (5 | 0x8000), topk8 = 0, pbe_nid = -1;
 ...
 opthelp:
        ...
        case OPT_IN:
            ...
            break;
        case OPT_OUTFORM:
            if (!opt_format(opt_arg(), ((1L << 1) | (1L << 2)), &outformat))
                goto opthelp;
            break;
        case OPT_OUT:
            outfile = opt_arg();
        ...
        case OPT_V2PRF:
            pbe_nid = OBJ_txt2nid(opt_arg());
            if (!EVP_PBE_find(0x1, pbe_nid, 
# 157 "../apps/pkcs8.c" 3 4
                                                        ((void *)0)
# 157 "../apps/pkcs8.c"
                                                            , 
# 157 "../apps/pkcs8.c" 3 4
...
# 223 "../apps/pkcs8.c"
    ...
    in = bio_open_default(infile, 'r',
                          informat == 0 ? (5 | 0x8000) : informat);
    if (in == 
# 228 "../apps/pkcs8.c" 3 4
             ((void *)0)
# 228 "../apps/pkcs8.c"
                 )
        goto end;
...
# 231 "../apps/pkcs8.c"
    ...
    if (topk8) {
        ...
        if (pkey == 
# 236 "../apps/pkcs8.c" 3 4
                   ((void *)0)
# 236 "../apps/pkcs8.c"
                       )
            goto end;
        if ((p8inf = EVP_PKEY2PKCS8(pkey)) == 
# 238 "../apps/pkcs8.c" 3 4
                                             ((void *)0)
# 238 "../apps/pkcs8.c"
                                                 ) {
...
# 244 "../apps/pkcs8.c"
            ...
            if (cipher) {
                ...
                if (scrypt_N && scrypt_r && scrypt_p)
                    pbe = PKCS5_pbe2_set_scrypt(cipher, 
# 258 "../apps/pkcs8.c" 3 4
                                                       ((void *)0)
# 258 "../apps/pkcs8.c"
                                                           , saltlen, 
# 258 "../apps/pkcs8.c" 3 4
...
# 262 "../apps/pkcs8.c"
                ...
                pbe = PKCS5_pbe_set(pbe_nid, iter, 
# 265 "../apps/pkcs8.c" 3 4
                                                  ((void *)0)
# 265 "../apps/pkcs8.c"
                                                      , saltlen);
            }
            if (pbe == 
# 267 "../apps/pkcs8.c" 3 4
                      ((void *)0)
# 267 "../apps/pkcs8.c"
                          ) {
...
# 295 "../apps/pkcs8.c"
    ...
    if (nocrypt) {
        if (informat == (5 | 0x8000) || informat == 0) {
            p8inf = PEM_read_bio_PKCS8_PRIV_KEY_INFO(in, 
# 312 "../apps/pkcs8.c" 3 4
                                                        ((void *)0)
# 312 "../apps/pkcs8.c"
                                                            , 
# 312 "../apps/pkcs8.c" 3 4
...
# 312 "../apps/pkcs8.c"
            ...
            p8inf = d2i_PKCS8_PRIV_KEY_INFO_bio(in, 
# 314 "../apps/pkcs8.c" 3 4
                                                   ((void *)0)
# 314 "../apps/pkcs8.c"
                                                       );
        } else {
        ...
        if (informat == (5 | 0x8000) || informat == 0) {
            p8 = PEM_read_bio_PKCS8(in, 
# 321 "../apps/pkcs8.c" 3 4
                                       ((void *)0)
# 321 "../apps/pkcs8.c"
                                           , 
# 321 "../apps/pkcs8.c" 3 4
...
# 363 "../apps/pkcs8.c" 3 4
   ((void) (0))
# 363 "../apps/pkcs8.c"
                  ;
    if (outformat == (5 | 0x8000)) {
        if (traditional)
            PEM_write_bio_PrivateKey_traditional(out, pkey, 
# 366 "../apps/pkcs8.c" 3 4
                                                           ((void *)0)
# 366 "../apps/pkcs8.c"
                                                               , 
# 366 "../apps/pkcs8.c" 3 4
...
# 367 "../apps/pkcs8.c" 3 4
                                                ((void *)0)
# 367 "../apps/pkcs8.c"
                                                    , passout);
        else
            PEM_write_bio_PrivateKey(out, pkey, 
# 369 "../apps/pkcs8.c" 3 4
                                               ((void *)0)
# 369 "../apps/pkcs8.c"
                                                   , 
# 369 "../apps/pkcs8.c" 3 4
...
# 369 "../apps/pkcs8.c"
    ...
    BIO_free_all(out);
    BIO_free(in);
    CRYPTO_free(passin, "../apps/pkcs8.c", 386);
    CRYPTO_free(passout, "../apps/pkcs8.c", 387);
