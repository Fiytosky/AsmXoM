...
# 40 "../apps/openssl.c" 3 4
                           ((void *)0)
# 40 "../apps/openssl.c"
                               ;

BIO *bio_in = 
# 42 "../apps/openssl.c" 3 4
             ((void *)0)
# 42 "../apps/openssl.c"
                 ;
BIO *bio_out = 
# 43 "../apps/openssl.c" 3 4
              ((void *)0)
# 43 "../apps/openssl.c"
                  ;
BIO *bio_err = 
# 44 "../apps/openssl.c" 3 4
              ((void *)0)
# 44 "../apps/openssl.c"
                  ;
...
{
    if (fp->deprecated_version != 
# 48 "../apps/openssl.c" 3 4
                                 ((void *)0)
# 48 "../apps/openssl.c"
                                     )
    ...
    if (strcmp(fp->deprecated_alternative, "unknown") != 0)
...
{
    const char *use_libctx = 
# 60 "../apps/openssl.c" 3 4
                            ((void *)0)
# 60 "../apps/openssl.c"
                                ;

    signal(
# 62 "../apps/openssl.c" 3 4
          13
# 62 "../apps/openssl.c"
                 , 
# 62 "../apps/openssl.c" 3 4
...
# 67 "../apps/openssl.c"
    ...
    if (use_libctx != 
# 78 "../apps/openssl.c" 3 4
                     ((void *)0)
# 78 "../apps/openssl.c"
                         ) {

        if (strcmp(use_libctx, "1") == 0) {
            if (app_create_libctx() == 
# 81 "../apps/openssl.c" 3 4
                                      ((void *)0)
# 81 "../apps/openssl.c"
                                          )
                return 0;
...
# 232 "../apps/openssl.c" 3 4
                                    ((void *)0) 
# 232 "../apps/openssl.c"
                                         };
static char *version_argv[] = { "version", 
# 233 "../apps/openssl.c" 3 4
                                          ((void *)0) 
# 233 "../apps/openssl.c"
                                               };
...
{
    FUNCTION f, *fp;
    struct lhash_st_FUNCTION *prog = 
# 238 "../apps/openssl.c" 3 4
                              ((void *)0)
# 238 "../apps/openssl.c"
                                  ;
    char *pname;
...
# 265 "../apps/openssl.c"
    if ((fname = "apps_startup", !apps_startup())
            || (fname = "prog_init", (prog = prog_init()) == 
# 266 "../apps/openssl.c" 3 4
                                                            ((void *)0)
# 266 "../apps/openssl.c"
                                                                )) {
        BIO_printf(bio_err,
...
# 283 "../apps/openssl.c"
    ...
    CRYPTO_free(default_config_file, "../apps/openssl.c", 310);
    lh_FUNCTION_free(prog);
    CRYPTO_free(arg.argv, "../apps/openssl.c", 312);
    if (!app_RAND_write())
        ret = 
# 314 "../apps/openssl.c" 3 4
             1
# 314 "../apps/openssl.c"
                         ;
...
# 412 "../apps/openssl.c"
    ...
    if (fp != 
# 423 "../apps/openssl.c" 3 4
             ((void *)0)
# 423 "../apps/openssl.c"
                 ) {
        if (fp->deprecated_alternative != 
# 424 "../apps/openssl.c" 3 4
                                         ((void *)0)
# 424 "../apps/openssl.c"
                                             )
            warn_deprecated(fp);
    ...
    f.name = argv[0];
    if (((strncmp(f.name, "no-" "", sizeof("no-") - 1) == 0) ? ((f.name) += sizeof("no-") - 1, 1) : 0)) {




        if (lh_FUNCTION_retrieve(prog, &f) == 
# 434 "../apps/openssl.c" 3 4
                                             ((void *)0)
# 434 "../apps/openssl.c"
                                                 ) {
...
static struct lhash_st_FUNCTION *prog_init(void)
{
    static struct lhash_st_FUNCTION *ret = 
# 469 "../apps/openssl.c" 3 4
                                    ((void *)0)
# 469 "../apps/openssl.c"
                                        ;
    ...
    for (i = 0, f = functions; f->name != 
# 480 "../apps/openssl.c" 3 4
                                         ((void *)0)
# 480 "../apps/openssl.c"
                                             ; ++f, ++i)
        ;
    ...
    if ((ret = lh_FUNCTION_new(function_hash, function_cmp)) == 
# 484 "../apps/openssl.c" 3 4
                                                               ((void *)0)
# 484 "../apps/openssl.c"
                                                                   )
        return 
# 485 "../apps/openssl.c" 3 4
              ((void *)0)
# 485 "../apps/openssl.c"
                  ;

    for (f = functions; f->name != 
# 487 "../apps/openssl.c" 3 4
                                  ((void *)0)
# 487 "../apps/openssl.c"
                                      ; f++)
