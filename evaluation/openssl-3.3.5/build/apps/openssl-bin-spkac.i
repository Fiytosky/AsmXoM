...
# 144 "../apps/spkac.c"
        ...
        pkey = load_key(strcmp(keyfile, "-") ? keyfile : 
# 148 "../apps/spkac.c" 3 4
                                                        ((void *)0)
# 148 "../apps/spkac.c"
                                                            ,
                        keyformat, 1, passin, e, "private key");
        if (pkey == 
# 150 "../apps/spkac.c" 3 4
                   ((void *)0)
# 150 "../apps/spkac.c"
                       )
            goto end;
        ...
        if (spki == 
# 153 "../apps/spkac.c" 3 4
                   ((void *)0)
# 153 "../apps/spkac.c"
                       )
            goto end;
        if (challenge != 
# 155 "../apps/spkac.c" 3 4
                        ((void *)0)
...
# 169 "../apps/spkac.c"
        ...
        if (out == 
# 173 "../apps/spkac.c" 3 4
                  ((void *)0)
# 173 "../apps/spkac.c"
                      ) {
            CRYPTO_free(spkstr, "../apps/spkac.c", 174);
            goto end;
        }
        BIO_printf(out, "SPKAC=%s\n", spkstr);
        CRYPTO_free(spkstr, "../apps/spkac.c", 178);
        ret = 0;
        goto end;
    }

    if ((conf = app_load_config_internal(infile, 0)) == 
# 183 "../apps/spkac.c" 3 4
                                           ((void *)0)
# 183 "../apps/spkac.c"
                                               )
        goto end;
...
# 203 "../apps/spkac.c"
    ...
    EVP_PKEY_free(pkey);
    release_engine(e);
    CRYPTO_free(passin, "../apps/spkac.c", 231);
    return ret;
}
