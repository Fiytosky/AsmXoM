...
typedef enum OPTION_choice {
    ...
    OPT_MD,
    OPT_MULTI, OPT_PROV__FIRST=1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY, OPT_PROV__LAST
} OPTION_CHOICE;
...
const OPTIONS ocsp_options[] = {
    ...
    { OPT_SECTION_STR, 1, '-', "Responder" " options:\n" },
    ...
    { OPT_SECTION_STR, 1, '-', "Client" " options:\n" },
...
# 213 "../apps/ocsp.c"
                                              ;
    struct stack_st_OPENSSL_STRING *rsign_sigopts = 
# 214 "../apps/ocsp.c" 3 4
                                             ((void *)0)
# 214 "../apps/ocsp.c"
                                                 ;
...
# 222 "../apps/ocsp.c"
                                    ;
    struct stack_st_OPENSSL_STRING *reqnames = 
# 223 "../apps/ocsp.c" 3 4
                                        ((void *)0)
# 223 "../apps/ocsp.c"
                                            ;
    struct stack_st_X509 *sign_other = 
# 224 "../apps/ocsp.c" 3 4
                                ((void *)0)
# 224 "../apps/ocsp.c"
                                    , *verify_other = 
...
# 226 "../apps/ocsp.c"
                                    ;
    struct stack_st_X509 *rca_certs = 
# 227 "../apps/ocsp.c" 3 4
                               ((void *)0)
# 227 "../apps/ocsp.c"
                                   ;
    EVP_MD *resp_certid_md = 
# 228 "../apps/ocsp.c" 3 4
                            ((void *)0)
# 228 "../apps/ocsp.c"
                                ;
...
# 245 "../apps/ocsp.c"
    ...
    if ((reqnames = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null())) == 
# 255 "../apps/ocsp.c" 3 4
                                                    ((void *)0)
            
# 256 "../apps/ocsp.c"
           || (ids = ((struct stack_st_OCSP_CERTID *)OPENSSL_sk_new_null())) == 
# 256 "../apps/ocsp.c" 3 4
                                                   ((void *)0)
...
# 257 "../apps/ocsp.c"
 ...
 opthelp:
        ...
        case OPT_TIMEOUT:
            ...
            break;
        case OPT_URL:
            CRYPTO_free(thost, "../apps/ocsp.c", 282);
            CRYPTO_free(tport, "../apps/ocsp.c", 283);
            CRYPTO_free(tpath, "../apps/ocsp.c", 284);
            thost = tport = tpath = 
# 285 "../apps/ocsp.c" 3 4
                                   ((void *)0)
# 285 "../apps/ocsp.c"
...
# 288 "../apps/ocsp.c"
        ...
        case OPT_RESPOUT:
            ...
            break;
        case OPT_ISSUER:
            issuer = load_cert_pass(opt_arg(), 0, 1, 
# 425 "../apps/ocsp.c" 3 4
                    ((void *)0)
# 425 "../apps/ocsp.c"
                    , "issuer certificate");
...
# 428 "../apps/ocsp.c"
                ...
                if ((issuers = ((struct stack_st_X509 *)OPENSSL_sk_new_null())) == 
# 429 "../apps/ocsp.c" 3 4
                                                     ((void *)0)
# 429 "../apps/ocsp.c"
                                                         )
            ...
            if (!OPENSSL_sk_push(ossl_check_X509_sk_type(issuers), ossl_check_X509_type(issuer)))
                goto end;
            break;
        case OPT_CERT:
            reset_unknown();
...
# 441 "../apps/ocsp.c"
            ...
            if (!add_ocsp_cert(&req, cert, cert_id_md, issuer, ids))
                goto end;
            if (!OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(reqnames), ossl_check_OPENSSL_STRING_type(opt_arg())))
                goto end;
            trailing_md = 0;
            break;
        case OPT_SERIAL:
...
# 492 "../apps/ocsp.c"
                ...
                rsign_sigopts = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null());
            if (rsign_sigopts == 
# 494 "../apps/ocsp.c" 3 4
                                ((void *)0)
                
# 495 "../apps/ocsp.c"
               || !OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(rsign_sigopts), ossl_check_OPENSSL_STRING_type(opt_arg())))
                goto end;
            break;
        case OPT_HEADER:
            header = opt_arg();
...
# 565 "../apps/ocsp.c"
            ...
            goto end;
        req = ((OCSP_REQUEST*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? OCSP_REQUEST_new : ((OCSP_REQUEST *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_OCSP_REQUEST : ((OCSP_REQUEST *(*)(OCSP_REQUEST **,const unsigned char **,long))0))), derbio, ((void**) (1 ? 
# 567 "../apps/ocsp.c" 3 4
             ((void *)0) 
# 567 "../apps/ocsp.c"
             : (OCSP_REQUEST**)0))));
...
# 587 "../apps/ocsp.c"
            ...
            rkeyfile = rsignfile;
        rsigner = load_cert_pass(rsignfile, 0, 1, 
# 589 "../apps/ocsp.c" 3 4
                 ((void *)0)
# 589 "../apps/ocsp.c"
...
# 590 "../apps/ocsp.c"
        ...
        if (!load_certs(rca_filename, 0, &rca_certs, 
# 594 "../apps/ocsp.c" 3 4
                                                    ((void *)0)
# 594 "../apps/ocsp.c"
                                                        , "CA certificates"))
...
# 596 "../apps/ocsp.c"
            ...
            if (!load_certs(rcertfile, 0, &rother, 
# 597 "../apps/ocsp.c" 3 4
                                                  ((void *)0)
# 597 "../apps/ocsp.c"
                                                      ,
...
# 601 "../apps/ocsp.c"
        ...
        rkey = load_key(rkeyfile, 0, 0, passin, 
# 605 "../apps/ocsp.c" 3 4
                                                          ((void *)0)
# 605 "../apps/ocsp.c"
                                                              ,
...
# 642 "../apps/ocsp.c"
        ...
        if (index_changed(rdb)) {
            CA_DB *newrdb = load_index(ridx_filename, 
# 645 "../apps/ocsp.c" 3 4
                                                     ((void *)0)
# 645 "../apps/ocsp.c"
                                                         );
...
# 683 "../apps/ocsp.c"
                   && add_nonce) {
        if (!OCSP_request_add1_nonce(req, 
# 684 "../apps/ocsp.c" 3 4
                                         ((void *)0)
# 684 "../apps/ocsp.c"
                                             , -1))
...
# 689 "../apps/ocsp.c"
            ...
            keyfile = signfile;
        signer = load_cert_pass(signfile, 0, 1, 
# 691 "../apps/ocsp.c" 3 4
                ((void *)0)
# 691 "../apps/ocsp.c"
                , "signer certificate");
...
# 696 "../apps/ocsp.c"
            ...
            if (!load_certs(sign_certfile, 0, &sign_other, 
# 697 "../apps/ocsp.c" 3 4
                                                          ((void *)0)
# 697 "../apps/ocsp.c"
                                                              ,
...
# 703 "../apps/ocsp.c"
        ...
        if (!OCSP_request_sign(req, signer, key, 
# 706 "../apps/ocsp.c" 3 4
                                                ((void *)0)
# 706 "../apps/ocsp.c"
                                                    ,
...
# 718 "../apps/ocsp.c"
            ...
            goto end;
        (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_OCSP_REQUEST : ((int (*)(const OCSP_REQUEST *,unsigned char **))0))), derbio, ((void*) (1 ? req : (const OCSP_REQUEST*)0))));
        BIO_free(derbio);
    }
...
# 745 "../apps/ocsp.c"
            ...
            goto end;
        resp = ((OCSP_RESPONSE*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? OCSP_RESPONSE_new : ((OCSP_RESPONSE *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_OCSP_RESPONSE : ((OCSP_RESPONSE *(*)(OCSP_RESPONSE **,const unsigned char **,long))0))), derbio, ((void**) (1 ? 
# 747 "../apps/ocsp.c" 3 4
              ((void *)0) 
# 747 "../apps/ocsp.c"
              : (OCSP_RESPONSE**)0))));
...
# 762 "../apps/ocsp.c"
            ...
            goto end;
        (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_OCSP_RESPONSE : ((int (*)(const OCSP_RESPONSE *,unsigned char **))0))), derbio, ((void*) (1 ? resp : (const OCSP_RESPONSE*)0))));
        BIO_free(derbio);
    }
...
# 809 "../apps/ocsp.c"
        ...
        if (!load_certs(verify_certfile, 0, &verify_other, 
# 810 "../apps/ocsp.c" 3 4
                                                          ((void *)0)
# 810 "../apps/ocsp.c"
                                                              ,
...
# 824 "../apps/ocsp.c"
    ...
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(rsign_sigopts));
    EVP_PKEY_free(key);
    EVP_PKEY_free(rkey);
    ...
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(reqnames));
    OPENSSL_sk_free(ossl_check_OCSP_CERTID_sk_type(ids));
    ...
    CRYPTO_free(thost, "../apps/ocsp.c", 879);
    CRYPTO_free(tport, "../apps/ocsp.c", 880);
    CRYPTO_free(tpath, "../apps/ocsp.c", 881);
...
# 921 "../apps/ocsp.c" 3 4
             ((void *)0) 
# 921 "../apps/ocsp.c"
                  || !OPENSSL_sk_push(ossl_check_OCSP_CERTID_sk_type(ids), ossl_check_OCSP_CERTID_type(id)))
        goto err;
...
# 980 "../apps/ocsp.c" 3 4
              ((void *)0) 
# 980 "../apps/ocsp.c"
                   || !OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(names)))
        return 1;
...
# 983 "../apps/ocsp.c" 3 4
             ((void *)0) 
# 983 "../apps/ocsp.c"
                  || !OPENSSL_sk_num(ossl_check_const_OCSP_CERTID_sk_type(ids)))
        return 0;

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OCSP_CERTID_sk_type(ids)); i++) {
        id = ((OCSP_CERTID *)OPENSSL_sk_value(ossl_check_const_OCSP_CERTID_sk_type(ids), (i)));
        name = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(names), (i)));
...
# 1039 "../apps/ocsp.c"
    ...
    OCSP_CERTID *cid;
    OCSP_BASICRESP *bs = 
# 1041 "../apps/ocsp.c" 3 4
                        ((void *)0)
# 1041 "../apps/ocsp.c"
                            ;
    int i, id_count;
    EVP_MD_CTX *mctx = 
# 1043 "../apps/ocsp.c" 3 4
                      ((void *)0)
# 1043 "../apps/ocsp.c"
                          ;
    EVP_PKEY_CTX *pkctx = 
# 1044 "../apps/ocsp.c" 3 4
                         ((void *)0)
# 1044 "../apps/ocsp.c"
                             ;
...
# 1050 "../apps/ocsp.c"
    ...
    if (bs == 
# 1055 "../apps/ocsp.c" 3 4
             ((void *)0)
# 1055 "../apps/ocsp.c"
                 ) {
        *resp = OCSP_response_create(2, bs);
        goto end;
    }
    thisupd = X509_gmtime_adj(
# 1059 "../apps/ocsp.c" 3 4
                             ((void *)0)
# 1059 "../apps/ocsp.c"
                                 , 0);
    if (ndays != -1)
        nextupd = X509_time_adj_ex(
# 1061 "../apps/ocsp.c" 3 4
                                  ((void *)0)
# 1061 "../apps/ocsp.c"
                                      , ndays, nmin * 60, 
# 1061 "../apps/ocsp.c" 3 4
...
# 1061 "../apps/ocsp.c"
    ...
    for (i = 0; i < id_count; i++) {
        ...
        OCSP_CERTID *cid_resp_md = 
# 1072 "../apps/ocsp.c" 3 4
                                  ((void *)0)
# 1072 "../apps/ocsp.c"
                                      ;
...
# 1077 "../apps/ocsp.c"
        ...
        if (cert_id_md == 
# 1080 "../apps/ocsp.c" 3 4
                         ((void *)0)
# 1080 "../apps/ocsp.c"
                             ) {
            *resp = OCSP_response_create(2,
                                         
# 1082 "../apps/ocsp.c" 3 4
                                        ((void *)0)
# 1082 "../apps/ocsp.c"
                                            );
            goto end;
        }
        for (jj = 0; jj < OPENSSL_sk_num(ossl_check_const_X509_sk_type(ca)) && !found; jj++) {
            X509 *ca_cert = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ca), (jj)));
            OCSP_CERTID *ca_id = OCSP_cert_to_id(cert_id_md, 
# 1087 "../apps/ocsp.c" 3 4
                                                            ((void *)0)
# 1087 "../apps/ocsp.c"
                                                                , ca_cert);
            ...
            if (OCSP_id_issuer_cmp(ca_id, cid) == 0) {
                found = 1;
                if (resp_md != 
# 1091 "../apps/ocsp.c" 3 4
                              ((void *)0)
# 1091 "../apps/ocsp.c"
                                  )
                    cid_resp_md = OCSP_cert_to_id(resp_md, 
# 1092 "../apps/ocsp.c" 3 4
                                                          ((void *)0)
# 1092 "../apps/ocsp.c"
                                                              , ca_cert);
            }
...
# 1111 "../apps/ocsp.c"
            ...
            OCSP_basic_add1_status(bs, cid,
                                   0,
                                   0, 
# 1115 "../apps/ocsp.c" 3 4
                                     ((void *)0)
# 1115 "../apps/ocsp.c"
                                         , thisupd, nextupd);
        } else if (inf[0][0] == 'R') {
            ASN1_OBJECT *inst = 
# 1117 "../apps/ocsp.c" 3 4
                               ((void *)0)
# 1117 "../apps/ocsp.c"
                                   ;
            ASN1_TIME *revtm = 
# 1118 "../apps/ocsp.c" 3 4
                              ((void *)0)
# 1118 "../apps/ocsp.c"
                                  ;
            ASN1_GENERALIZEDTIME *invtm = 
# 1119 "../apps/ocsp.c" 3 4
                                         ((void *)0)
# 1119 "../apps/ocsp.c"
                                             ;
            ...
            if (single == 
# 1127 "../apps/ocsp.c" 3 4
                         ((void *)0)
# 1127 "../apps/ocsp.c"
                             ) {
                *resp = OCSP_response_create(2,
                                             
# 1129 "../apps/ocsp.c" 3 4
                                            ((void *)0)
# 1129 "../apps/ocsp.c"
                                                );
                goto end;
...
# 1135 "../apps/ocsp.c"
    ...
    mctx = EVP_MD_CTX_new();
    if (mctx == 
# 1149 "../apps/ocsp.c" 3 4
               ((void *)0) 
# 1149 "../apps/ocsp.c"
                    || !EVP_DigestSignInit(mctx, &pkctx, rmd, 
# 1149 "../apps/ocsp.c" 3 4
                                                              ((void *)0)
# 1149 "../apps/ocsp.c"
                                                                  , rkey)) {
        *resp = OCSP_response_create(2, 
# 1150 "../apps/ocsp.c" 3 4
                                                                        ((void *)0)
# 1150 "../apps/ocsp.c"
                                                                            );
        goto end;
    }
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(sigopts)); i++) {
        char *sigopt = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(sigopts), (i)));
...
# 1186 "../apps/ocsp.c"
    ...
    for (i = 0; i < 6; i++)
        row[i] = 
# 1189 "../apps/ocsp.c" 3 4
                ((void *)0)
# 1189 "../apps/ocsp.c"
                    ;
    bn = ASN1_INTEGER_to_BN(ser, 
# 1190 "../apps/ocsp.c" 3 4
                                ((void *)0)
# 1190 "../apps/ocsp.c"
                                    );
    (void)((bn) ? 0 : (OPENSSL_die("assertion failed: " "bn", "../apps/ocsp.c", 1191), 1));

    if (BN_is_zero(bn)) {
        itmp = CRYPTO_strdup("00", "../apps/ocsp.c", 1194);
        (void)((itmp) ? 0 : (OPENSSL_die("assertion failed: " "itmp", "../apps/ocsp.c", 1195), 1));
    } else {
        itmp = BN_bn2hex(bn);
    }
    row[3] = itmp;
    ...
    CRYPTO_free(itmp, "../apps/ocsp.c", 1202);
    return rrow;
}
                        ...
                        int timeout)
{
    ...
    return http_server_get_asn1_req((OCSP_REQUEST_it()),
                                    (ASN1_VALUE **)preq, 
# 1211 "../apps/ocsp.c" 3 4
                                                        ((void *)0)
# 1211 "../apps/ocsp.c"
                                                            , pcbio, acbio,
                                    
# 1212 "../apps/ocsp.c" 3 4
                                   ((void *)0) 
# 1212 "../apps/ocsp.c"
                                                              ,
                                    prog, 1 , timeout);
...
{
    SSL_CTX *ctx = 
# 1244 "../apps/ocsp.c" 3 4
                  ((void *)0)
# 1244 "../apps/ocsp.c"
                      ;
    OCSP_RESPONSE *resp = 
# 1245 "../apps/ocsp.c" 3 4
                         ((void *)0)
# 1245 "../apps/ocsp.c"
                             ;
...
# 1249 "../apps/ocsp.c"
    ...
    resp = (OCSP_RESPONSE *)
        app_http_post_asn1(host, port, path, proxy, no_proxy,
                           ...
                           (ASN1_VALUE *)req, (OCSP_REQUEST_it()),
                           "application/ocsp-response",
                           req_timeout, (OCSP_RESPONSE_it()));

    if (resp == 
# 1262 "../apps/ocsp.c" 3 4
               ((void *)0)
# 1262 "../apps/ocsp.c"
                   )
