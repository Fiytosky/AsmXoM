...
static char *alloc_mac_algorithm_name(struct stack_st_OPENSSL_STRING **optp,
...
# 117 "../apps/mac.c"
            ...
            break;
        case OPT_CIPHER:
            CRYPTO_free(cipher, "../apps/mac.c", 121);
...
# 123 "../apps/mac.c"
            ...
            break;
        case OPT_DIGEST:
            CRYPTO_free(digest, "../apps/mac.c", 127);
...
# 200 "../apps/mac.c"
    ...
    if (!EVP_MAC_final(ctx, buf, &len, 1024*8)) {
        BIO_printf(bio_err, "EVP_MAC_final failed\n");
        goto err;
    }
...
err:
    if (ret != 0)
        ERR_print_errors(bio_err);
    CRYPTO_clear_free(buf, 1024*8, "../apps/mac.c", 227);
    CRYPTO_free(cipher, "../apps/mac.c", 228);
    CRYPTO_free(digest, "../apps/mac.c", 229);
