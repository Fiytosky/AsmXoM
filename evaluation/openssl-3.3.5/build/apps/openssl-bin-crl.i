...
typedef enum OPTION_choice {
    ...
    OPT_HASH_OLD, OPT_NOOUT, OPT_NAMEOPT, OPT_MD, OPT_PROV__FIRST=1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY, OPT_PROV__LAST
} OPTION_CHOICE;
...
# 258 "../apps/crl.c"
        ...
        if (!newcrl)
            goto end;
        pkey = load_key(keyfile, keyformat, 0, 
# 267 "../apps/crl.c" 3 4
                                              ((void *)0)
# 267 "../apps/crl.c"
                                                  , 
    ...
    if (num) {
        for (i = 1; i <= num; i++) {
            ...
            if (crlnumber == i) {
                ...
                crlnum = X509_CRL_get_ext_d2i(x, 88, 
# 299 "../apps/crl.c" 3 4
                                                                ((void *)0)
# 299 "../apps/crl.c"
                                                                    , 
