...
const OPTIONS req_options[] = {
    ...
    { OPT_SECTION_STR, 1, '-', "Keys and Signing" " options:\n" },
...
{
    CRYPTO_free((char *)x, "../apps/req.c", 188);
}
...
static int duplicated(struct lhash_st_OPENSSL_STRING *addexts, char *kv)
{
    char *p;
    size_t off;
...
# 204 "../apps/req.c"
    ...
    off = p - kv;
    if ((kv = CRYPTO_strdup(kv, "../apps/req.c", 209)) == 
# 209 "../apps/req.c" 3 4
                                    ((void *)0)
# 209 "../apps/req.c"
                                        )
...
# 214 "../apps/req.c"
    ...
    if (p == kv) {
        ...
        CRYPTO_free(kv, "../apps/req.c", 218);
        return -2;
    }
    *p = '\0';


    p = (char *)((OPENSSL_STRING *)OPENSSL_LH_insert(ossl_check_OPENSSL_STRING_lh_type(addexts), ossl_check_OPENSSL_STRING_lh_plain_type((OPENSSL_STRING *)kv)));
    if (p != 
# 225 "../apps/req.c" 3 4
            ((void *)0)
# 225 "../apps/req.c"
        ...
        CRYPTO_free(p, "../apps/req.c", 227);
        return 1;
    } else if (OPENSSL_LH_error(ossl_check_OPENSSL_STRING_lh_type(addexts))) {
        CRYPTO_free(kv, "../apps/req.c", 230);
        return -1;
    }
...
# 243 "../apps/req.c"
                              ;
    struct stack_st_OPENSSL_STRING *pkeyopts = 
# 244 "../apps/req.c" 3 4
                                        ((void *)0)
# 244 "../apps/req.c"
                                            , *sigopts = 
...
# 244 "../apps/req.c"
                                                                              ;
    struct lhash_st_OPENSSL_STRING *addexts = 
# 245 "../apps/req.c" 3 4
                                       ((void *)0)
# 245 "../apps/req.c"
                                           ;
...
# 258 "../apps/req.c"
                          ;
    char *template = default_config_file, *keyout = 
# 259 "../apps/req.c" 3 4
                                                   ((void *)0)
# 259 "../apps/req.c"
                                                       ;
...
# 260 "../apps/req.c"
    ...
    int informat = 0, outformat = (5 | 0x8000), keyform = 0;
 ...
 opthelp:
        ...
        case OPT_KEYGEN_ENGINE:
            ...
            gen_eng = setup_engine_methods(opt_arg(), (unsigned int)-1, 0);
            if (gen_eng == 
# 301 "../apps/req.c" 3 4
                          ((void *)0)
# 301 "../apps/req.c"
...
# 354 "../apps/req.c"
                ...
                pkeyopts = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null());
            if (pkeyopts == 
# 356 "../apps/req.c" 3 4
                           ((void *)0)
                    
# 357 "../apps/req.c"
                   || !OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(pkeyopts), ossl_check_OPENSSL_STRING_type(opt_arg())))
                goto opthelp;
            break;
        case OPT_SIGOPT:
            if (!sigopts)
...
# 465 "../apps/req.c"
                ...
                addexts = ((struct lhash_st_OPENSSL_STRING *)OPENSSL_LH_set_thunks(OPENSSL_LH_new(ossl_check_OPENSSL_STRING_lh_hashfunc_type(ext_name_hash), ossl_check_OPENSSL_STRING_lh_compfunc_type(ext_name_cmp)), lh_OPENSSL_STRING_hash_thunk, lh_OPENSSL_STRING_comp_thunk, lh_OPENSSL_STRING_doall_thunk, lh_OPENSSL_STRING_doall_arg_thunk));
...
# 501 "../apps/req.c"
    ...
    if ((req_conf = app_load_config_verbose(template, verbose)) == 
# 514 "../apps/req.c" 3 4
                                                                  ((void *)0)
# 514 "../apps/req.c"
                                                                      )
...
# 516 "../apps/req.c"
        ...
        if ((addext_conf = app_load_config_bio(addext_bio, 
# 520 "../apps/req.c" 3 4
                                                          ((void *)0)
# 520 "../apps/req.c"
                                                              )) == 
...
# 526 "../apps/req.c"
        ...
        p = app_conf_try_string(req_conf, 
# 527 "../apps/req.c" 3 4
                                         ((void *)0)
# 527 "../apps/req.c"
                                             , "oid_file");
...
# 555 "../apps/req.c"
        ...
        extsect = app_conf_try_string(req_conf, section,
                                   gen_x509 ? "x509_extensions" : "req_extensions");
    if (extsect != 
# 558 "../apps/req.c" 3 4
                  ((void *)0)
# 558 "../apps/req.c"
...
# 562 "../apps/req.c"
       , 0x1);
        ...
        if (!X509V3_EXT_add_nconf(req_conf, &ctx, extsect, 
# 564 "../apps/req.c" 3 4
                                                          ((void *)0)
# 564 "../apps/req.c"
                                                              )) {
...
# 575 "../apps/req.c"
       , 0x1);
        X509V3_set_nconf(&ctx, req_conf);
        if (!X509V3_EXT_add_nconf(addext_conf, &ctx, "default", 
# 577 "../apps/req.c" 3 4
                                                               ((void *)0)
# 577 "../apps/req.c"
                                                                   )) {
...
# 592 "../apps/req.c"
    ...
    if (chtype != (0x1000)) {
        p = app_conf_try_string(req_conf, section, "utf8");
        if (p != 
# 599 "../apps/req.c" 3 4
                ((void *)0) 
# 599 "../apps/req.c"
...
# 614 "../apps/req.c"
        ...
        if (!app_conf_try_number(req_conf, section, "default_bits", &newkey_len))
            newkey_len = 2048;
...
# 650 "../apps/req.c"
            ...
            char *genopt;
            for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(pkeyopts)); i++) {
                genopt = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(pkeyopts), (i)));
...
# 672 "../apps/req.c"
        ...
        keyout = app_conf_try_string(req_conf, section, "default_keyfile");
...
# 749 "../apps/req.c"
        ...
        if ((CAcert = load_cert_pass(CAfile, 0, 1, passin,
...
# 768 "../apps/req.c"
        ...
        if (gen_x509) {
            ...
            EVP_PKEY *issuer_key = CAcert != 
# 780 "../apps/req.c" 3 4
                                            ((void *)0) 
# 780 "../apps/req.c"
                                                 ? CAkey : pkey;
            X509V3_CTX ext_ctx;
            X509_NAME *issuer = CAcert != 
# 782 "../apps/req.c" 3 4
                                         ((void *)0) 
# 782 "../apps/req.c"
                                              ? X509_get_subject_name(CAcert) :
                X509_REQ_get_subject_name(req);
            X509_NAME *n_subj = fsubj != 
# 784 "../apps/req.c" 3 4
                                        ((void *)0) 
# 784 "../apps/req.c"
                                             ? fsubj :
...
# 799 "../apps/req.c" 3 4
                                ((void *)0)
# 799 "../apps/req.c"
                                    , X509_get_serialNumber(new_x509)))
                    goto end;
            }
...
# 843 "../apps/req.c"
            ...
            if (precert) {
                if (X509_add1_ext_i2d(new_x509, 952,
...
# 1008 "../apps/req.c"
    ...
    EVP_PKEY_free(pkey);
    EVP_PKEY_CTX_free(genctx);
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(pkeyopts));
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(sigopts));
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(vfyopts));
    OPENSSL_LH_doall(ossl_check_OPENSSL_STRING_lh_type(addexts), ossl_check_OPENSSL_STRING_lh_doallfunc_type(exts_cleanup));
    OPENSSL_LH_free(ossl_check_OPENSSL_STRING_lh_type(addexts));

    release_engine(gen_eng);

    CRYPTO_free(keyalgstr, "../apps/req.c", 1037);
    X509_REQ_free(req);
    ...
    if (passin != nofree_passin)
        CRYPTO_free(passin, "../apps/req.c", 1046);
    if (passout != nofree_passout)
        CRYPTO_free(passout, "../apps/req.c", 1048);
    return ret;
}
                       ...
                       int attribs, unsigned long chtype)
{
    ...
    if (OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(dn_sk))) {
        i = -1;
 start:
        for (;;) {
            i++;
            if (OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(dn_sk)) <= i)
                break;

            v = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(dn_sk), (i)));
            p = q = 
# 1143 "../apps/req.c" 3 4
                   ((void *)0)
# 1143 "../apps/req.c"
            ...
            if (!join(buf, sizeof(buf), v->name, "_default", "Name"))
                return 0;
            if ((def = app_conf_try_string(req_conf, dn_sect, buf)) == 
# 1170 "../apps/req.c" 3 4
                                                                      ((void *)0)
# 1170 "../apps/req.c"
                                                                          )
            ...
            if (!join(buf, sizeof(buf), v->name, "_value", "Name"))
                return 0;
            if ((value = app_conf_try_string(req_conf, dn_sect, buf)) == 
# 1175 "../apps/req.c" 3 4
                                                                        ((void *)0)
# 1175 "../apps/req.c"
                                                                            )
...
# 1198 "../apps/req.c" 3 4
                           ((void *)0)
# 1198 "../apps/req.c"
                               ) && (OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(attr_sk)) > 0)
                && (!batch)) {
                BIO_printf(bio_err,
...
# 1210 "../apps/req.c" 3 4
                               ((void *)0)
# 1210 "../apps/req.c"
                                   ) || (OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(attr_sk)) <= i))
                    break;

                v = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(attr_sk), (i)));
                type = v->name;
                if ((nid = OBJ_txt2nid(type)) == 0)
                    goto start2;
                     ...
                     unsigned long chtype)
{
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(dn_sk)); i++) {
        int mval;
        v = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(dn_sk), (i)));
        p = q = 
# 1268 "../apps/req.c" 3 4
...
# 1268 "../apps/req.c"
    ...
    if (attribs) {
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(attr_sk)); i++) {
            v = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(attr_sk), (i)));
...
# 1527 "../apps/req.c"
        ...
        param = PEM_read_bio_Parameters(pbio, 
# 1529 "../apps/req.c" 3 4
                                             ((void *)0)
# 1529 "../apps/req.c"
                                                 );
...
# 1531 "../apps/req.c"
            ...
            (void)(int)BIO_ctrl(pbio,1,0,
# 1534 "../apps/req.c" 3 4
                 ((void *)0)
# 1534 "../apps/req.c"
                 );
            x = PEM_read_bio_X509(pbio, 
# 1535 "../apps/req.c" 3 4
                                       ((void *)0)
# 1535 "../apps/req.c"
                                           , 
...
# 1553 "../apps/req.c"
    ...
    if (keytypelen > 0)
        *pkeytype = CRYPTO_strndup(keytype, keytypelen, "../apps/req.c", 1559);
    else
        *pkeytype = CRYPTO_strdup(keytype, "../apps/req.c", 1561);
