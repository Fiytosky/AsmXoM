# 0 "../apps/lib/app_rand.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../apps/lib/app_rand.c"
# 10 "../apps/lib/app_rand.c"
...
static struct stack_st_OPENSSL_STRING *randfiles;
...
void app_RAND_load_conf(CONF *c, const char *section)
{
    ...
    if (randfile == 
# 23 "../apps/lib/app_rand.c" 3 4
                   ((void *)0)
# 23 "../apps/lib/app_rand.c"
                       )
        return;
    ...
    if (save_rand_file == 
# 29 "../apps/lib/app_rand.c" 3 4
                         ((void *)0)
# 29 "../apps/lib/app_rand.c"
                             ) {
        save_rand_file = CRYPTO_strdup(randfile, "../apps/lib/app_rand.c", 30);

        if (save_rand_file == 
# 32 "../apps/lib/app_rand.c" 3 4
                             ((void *)0)
# 32 "../apps/lib/app_rand.c"
                                 ) {
...
int app_RAND_load(void)
{
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(randfiles)); i++) {
        p = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(randfiles), (i)));
        if (!loadfiles(p))
            ret = 0;
    }
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(randfiles));
    return ret;
}
...
int app_RAND_write(void)
{
    ...
    if (save_rand_file == 
# 83 "../apps/lib/app_rand.c" 3 4
                         ((void *)0)
# 83 "../apps/lib/app_rand.c"
                             )
        return 1;
    ...
    CRYPTO_free(save_rand_file, "../apps/lib/app_rand.c", 90);
    save_rand_file = 
# 91 "../apps/lib/app_rand.c" 3 4
                     ((void *)0)
# 91 "../apps/lib/app_rand.c"
                         ;
    return ret;
}
...
enum r_range { OPT_R__FIRST=1500, OPT_R_RAND, OPT_R_WRITERAND, OPT_R__LAST };
...
int opt_rand(int opt)
{
    ...
    case OPT_R_RAND:
        if (randfiles == 
# 108 "../apps/lib/app_rand.c" 3 4
                        ((void *)0)
                
# 109 "../apps/lib/app_rand.c"
               && (randfiles = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null())) == 
# 109 "../apps/lib/app_rand.c" 3 4
                                                                ((void *)0)
# 109 "../apps/lib/app_rand.c"
                                                                    )
            return 0;
        if (!OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(randfiles), ossl_check_OPENSSL_STRING_type(opt_arg())))
            return 0;
        break;
    case OPT_R_WRITERAND:
        CRYPTO_free(save_rand_file, "../apps/lib/app_rand.c", 115);
        save_rand_file = CRYPTO_strdup(opt_arg(), "../apps/lib/app_rand.c", 116);
        if (save_rand_file == 
# 117 "../apps/lib/app_rand.c" 3 4
                             ((void *)0)
# 117 "../apps/lib/app_rand.c"
                                 )
            return 0;
        break;
    }
