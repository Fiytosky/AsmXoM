# 0 "../apps/lib/app_x509.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../apps/lib/app_x509.c"
# 10 "../apps/lib/app_x509.c"
    ...
    case 15:
        {
            ...
            if (v == 
# 45 "../apps/lib/app_x509.c" 3 4
                    ((void *)0)
# 45 "../apps/lib/app_x509.c"
                        ) {
                BIO_printf(bio_err,
    ...
    case 15:
        {
            ...
            if (v == 
# 69 "../apps/lib/app_x509.c" 3 4
                    ((void *)0)
# 69 "../apps/lib/app_x509.c"
                        ) {
                BIO_printf(bio_err,
                               ...
                               void *object, const char *value)
{
    int rv = 0;
    char *stmp, *vtmp = 
# 90 "../apps/lib/app_x509.c" 3 4
                       ((void *)0)
# 90 "../apps/lib/app_x509.c"
                           ;
    size_t vtmp_len = 0;
    int cmd = 0;

    stmp = CRYPTO_strdup(value, "../apps/lib/app_x509.c", 94);
    if (stmp == 
# 95 "../apps/lib/app_x509.c" 3 4
               ((void *)0)
# 95 "../apps/lib/app_x509.c"
                   )
        return -1;
    vtmp = strchr(stmp, ':');
    if (vtmp != 
# 98 "../apps/lib/app_x509.c" 3 4
               ((void *)0)
# 98 "../apps/lib/app_x509.c"
                   ) {
        *vtmp = 0;
        vtmp++;
    ...
    if (strcmp(stmp, "distid") == 0) {
        ...
        if (vtmp != 
# 109 "../apps/lib/app_x509.c" 3 4
                   ((void *)0)
# 109 "../apps/lib/app_x509.c"
                       ) {
            void *hexid;
            long hexid_len = 0;

            hexid = OPENSSL_hexstr2buf((const char *)vtmp, &hexid_len);
            CRYPTO_free(stmp, "../apps/lib/app_x509.c", 114);
            stmp = vtmp = hexid;
    ...
    CRYPTO_free(stmp, "../apps/lib/app_x509.c", 125);
    return rv;
}
