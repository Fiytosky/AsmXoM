# 0 "../apps/lib/http_server.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../apps/lib/http_server.c"
# 20 "../apps/lib/http_server.c"
...
# 21 "../apps/lib/http_server.c" 2
# 1 "../apps/include/http_server.h" 1
# 13 "../apps/include/http_server.h"
...
# 14 "../apps/include/http_server.h" 2
# 1 "../apps/include/log.h" 1
# 16 "../apps/include/log.h"
...
# 25 "../apps/lib/http_server.c" 2

# 1 "../apps/include/s_apps.h" 1
# 12 "../apps/include/s_apps.h"
...
struct stack_st_SRP_gN_cache; typedef int (*sk_SRP_gN_cache_compfunc)(const SRP_gN_cache * const *a, const SRP_gN_cache *const *b); typedef void (*sk_SRP_gN_cache_freefunc)(SRP_gN_cache *a); typedef SRP_gN_cache * (*sk_SRP_gN_cache_copyfunc)(const SRP_gN_cache *a); static __attribute__((unused)) inline SRP_gN_cache *ossl_check_SRP_gN_cache_type(SRP_gN_cache *ptr) { return ptr; } static __attribute__((unused)) inline const OPENSSL_STACK *ossl_check_const_SRP_gN_cache_sk_type(const struct stack_st_SRP_gN_cache *sk) { return (const OPENSSL_STACK *)sk; } static __attribute__((unused)) inline OPENSSL_STACK *ossl_check_SRP_gN_cache_sk_type(struct stack_st_SRP_gN_cache *sk) { return (OPENSSL_STACK *)sk; } static __attribute__((unused)) inline OPENSSL_sk_compfunc ossl_check_SRP_gN_cache_compfunc_type(sk_SRP_gN_cache_compfunc cmp) { return (OPENSSL_sk_compfunc)cmp; } static __attribute__((unused)) inline OPENSSL_sk_copyfunc ossl_check_SRP_gN_cache_copyfunc_type(sk_SRP_gN_cache_copyfunc cpy) { return (OPENSSL_sk_copyfunc)cpy; } static __attribute__((unused)) inline OPENSSL_sk_freefunc ossl_check_SRP_gN_cache_freefunc_type(sk_SRP_gN_cache_freefunc fr) { return (OPENSSL_sk_freefunc)fr; }
# 76 "include/openssl/srp.h"
...
struct stack_st_SRP_user_pwd; typedef int (*sk_SRP_user_pwd_compfunc)(const SRP_user_pwd * const *a, const SRP_user_pwd *const *b); typedef void (*sk_SRP_user_pwd_freefunc)(SRP_user_pwd *a); typedef SRP_user_pwd * (*sk_SRP_user_pwd_copyfunc)(const SRP_user_pwd *a); static __attribute__((unused)) inline SRP_user_pwd *ossl_check_SRP_user_pwd_type(SRP_user_pwd *ptr) { return ptr; } static __attribute__((unused)) inline const OPENSSL_STACK *ossl_check_const_SRP_user_pwd_sk_type(const struct stack_st_SRP_user_pwd *sk) { return (const OPENSSL_STACK *)sk; } static __attribute__((unused)) inline OPENSSL_STACK *ossl_check_SRP_user_pwd_sk_type(struct stack_st_SRP_user_pwd *sk) { return (OPENSSL_STACK *)sk; } static __attribute__((unused)) inline OPENSSL_sk_compfunc ossl_check_SRP_user_pwd_compfunc_type(sk_SRP_user_pwd_compfunc cmp) { return (OPENSSL_sk_compfunc)cmp; } static __attribute__((unused)) inline OPENSSL_sk_copyfunc ossl_check_SRP_user_pwd_copyfunc_type(sk_SRP_user_pwd_copyfunc cpy) { return (OPENSSL_sk_copyfunc)cpy; } static __attribute__((unused)) inline OPENSSL_sk_freefunc ossl_check_SRP_user_pwd_freefunc_type(sk_SRP_user_pwd_freefunc fr) { return (OPENSSL_sk_freefunc)fr; }
# 115 "include/openssl/srp.h"
__attribute__((deprecated("Since OpenSSL " "3.0")))
...
struct stack_st_SRP_gN; typedef int (*sk_SRP_gN_compfunc)(const SRP_gN * const *a, const SRP_gN *const *b); typedef void (*sk_SRP_gN_freefunc)(SRP_gN *a); typedef SRP_gN * (*sk_SRP_gN_copyfunc)(const SRP_gN *a); static __attribute__((unused)) inline SRP_gN *ossl_check_SRP_gN_type(SRP_gN *ptr) { return ptr; } static __attribute__((unused)) inline const OPENSSL_STACK *ossl_check_const_SRP_gN_sk_type(const struct stack_st_SRP_gN *sk) { return (const OPENSSL_STACK *)sk; } static __attribute__((unused)) inline OPENSSL_STACK *ossl_check_SRP_gN_sk_type(struct stack_st_SRP_gN *sk) { return (OPENSSL_STACK *)sk; } static __attribute__((unused)) inline OPENSSL_sk_compfunc ossl_check_SRP_gN_compfunc_type(sk_SRP_gN_compfunc cmp) { return (OPENSSL_sk_compfunc)cmp; } static __attribute__((unused)) inline OPENSSL_sk_copyfunc ossl_check_SRP_gN_copyfunc_type(sk_SRP_gN_copyfunc cpy) { return (OPENSSL_sk_copyfunc)cpy; } static __attribute__((unused)) inline OPENSSL_sk_freefunc ossl_check_SRP_gN_freefunc_type(sk_SRP_gN_freefunc fr) { return (OPENSSL_sk_freefunc)fr; }
...
__attribute__((deprecated("Since OpenSSL " "1.1.0")))
SRP_user_pwd *SRP_VBASE_get_by_user(SRP_VBASE *vb, char *username);
# 14 "../apps/include/s_apps.h" 2
...
int ssl_load_stores(SSL_CTX *ctx, const char *vfyCApath,
                    ...
                    const char *chCAstore, struct stack_st_X509_CRL *crls,
                    int crl_download);
...
# 27 "../apps/lib/http_server.c" 2
# 1 "../apps/include/log.h" 1
# 28 "../apps/lib/http_server.c" 2
# 45 "../apps/lib/http_server.c"
int n_responders = 0;
int acfd = (int)(-1);
...
void socket_timeout(int signum)
{
    if (acfd != (int)(-1))
        (void)shutdown(acfd, 
# 51 "../apps/lib/http_server.c" 3 4
                            SHUT_RD
# 51 "../apps/lib/http_server.c"
                                   );
}
...
static void killall(int ret, pid_t *kidpids)
{
    ...
    for (i = 0; i < n_responders; ++i)
        if (kidpids[i] != 0)
            (void)kill(kidpids[i], 
# 60 "../apps/lib/http_server.c" 3 4
                                  15
# 60 "../apps/lib/http_server.c"
                                         );
    CRYPTO_free(kidpids, "../apps/lib/http_server.c", 61);
    OSSL_sleep(1000);
    exit(ret);
}
...
{
    pid_t *kidpids = 
# 80 "../apps/lib/http_server.c" 3 4
                    ((void *)0)
# 80 "../apps/lib/http_server.c"
                        ;
    int status;
    int procs = 0;
    int i;
    ...
    openlog(prog, 
# 85 "../apps/lib/http_server.c" 3 4
                 0x01
# 85 "../apps/lib/http_server.c"
                        , 
# 85 "../apps/lib/http_server.c" 3 4
                          (3<<3)
# 85 "../apps/lib/http_server.c"
    ...
    if (setpgid(0, 0)) {
        trace_log_message(18, prog, 
# 88 "../apps/lib/http_server.c" 3 4
       2
# 88 "../apps/lib/http_server.c"
       , "error detaching from parent process group: %s", strerror(
# 88 "../apps/lib/http_server.c" 3 4
       (*__errno_location ())
# 88 "../apps/lib/http_server.c"
       ))
    ...
    signal(
# 97 "../apps/lib/http_server.c" 3 4
          2
# 97 "../apps/lib/http_server.c"
                , noteterm);
    signal(
# 98 "../apps/lib/http_server.c" 3 4
          15
# 98 "../apps/lib/http_server.c"
                 , noteterm);
    ...
    while (termsig == 0) {
        ...
        while (termsig == 0 && procs >= n_responders) {
            if ((fpid = waitpid(-1, &status, 0)) > 0) {
                ...
                if (i >= n_responders) {
                    trace_log_message(18, prog, 
# 117 "../apps/lib/http_server.c" 3 4
                   2
# 117 "../apps/lib/http_server.c"
                   , "internal error: no matching child slot for pid: %ld", (long)fpid)
                ...
                if (status != 0) {
                    if (
# 123 "../apps/lib/http_server.c" 3 4
                       (((
# 123 "../apps/lib/http_server.c"
                       status
# 123 "../apps/lib/http_server.c" 3 4
                       ) & 0x7f) == 0)
# 123 "../apps/lib/http_server.c"
                        ...
                        trace_log_message(18, prog, 
# 124 "../apps/lib/http_server.c" 3 4
                       4
# 124 "../apps/lib/http_server.c"
                       , "child process: %ld, exit status: %d", (long)fpid, 
# 124 "../apps/lib/http_server.c" 3 4
                       (((
# 124 "../apps/lib/http_server.c"
                       status
...
# 127 "../apps/lib/http_server.c" 3 4
                              (((signed char) (((
# 127 "../apps/lib/http_server.c"
                              status
# 127 "../apps/lib/http_server.c" 3 4
                              ) & 0x7f) + 1) >> 1) > 0)
# 127 "../apps/lib/http_server.c"
                        ...
                        if (
# 131 "../apps/lib/http_server.c" 3 4
                           ((
# 131 "../apps/lib/http_server.c"
                           status
# 131 "../apps/lib/http_server.c" 3 4
                           ) & 0x80)
# 131 "../apps/lib/http_server.c"
                        ...
                        trace_log_message(18, prog, 
# 134 "../apps/lib/http_server.c" 3 4
                       4
# 134 "../apps/lib/http_server.c"
                       , "child process: %ld, term signal %d%s", (long)fpid, 
# 134 "../apps/lib/http_server.c" 3 4
                       ((
# 134 "../apps/lib/http_server.c"
                       status
...
# 141 "../apps/lib/http_server.c" 3 4
                      (*__errno_location ()) 
# 141 "../apps/lib/http_server.c"
                            != 
# 141 "../apps/lib/http_server.c" 3 4
                               4
# 141 "../apps/lib/http_server.c"
                ...
                trace_log_message(18, prog, 
# 142 "../apps/lib/http_server.c" 3 4
               2
# 142 "../apps/lib/http_server.c"
               , "waitpid() failed: %s", strerror(
# 142 "../apps/lib/http_server.c" 3 4
               (*__errno_location ())
# 142 "../apps/lib/http_server.c"
               ))
        ...
        case -1:
            ...
            break;
        case 0:
            CRYPTO_free(kidpids, "../apps/lib/http_server.c", 156);
            signal(
# 157 "../apps/lib/http_server.c" 3 4
                  2
# 157 "../apps/lib/http_server.c"
                        , 
# 157 "../apps/lib/http_server.c" 3 4
                          ((__sighandler_t) 0)
# 157 "../apps/lib/http_server.c"
            ...
            signal(
# 158 "../apps/lib/http_server.c" 3 4
                  15
# 158 "../apps/lib/http_server.c"
                         , 
# 158 "../apps/lib/http_server.c" 3 4
                           ((__sighandler_t) 0)
# 158 "../apps/lib/http_server.c"
            ...
            if (RAND_poll() <= 0) {
                trace_log_message(18, prog, 
# 162 "../apps/lib/http_server.c" 3 4
               2
# 162 "../apps/lib/http_server.c"
               , "%s", "RAND_poll() failed");
                _exit(1);
            }
            return;
        default:
            ...
            if (i >= n_responders) {
                trace_log_message(18, prog, 
# 175 "../apps/lib/http_server.c" 3 4
               2
# 175 "../apps/lib/http_server.c"
               , "%s", "internal error: no free child slots")
                                                               ;
                killall(1, kidpids);
            }
            break;
    ...
    trace_log_message(18, prog, 
# 184 "../apps/lib/http_server.c" 3 4
   6
# 184 "../apps/lib/http_server.c"
...
{
    BIO *acbio = 
# 192 "../apps/lib/http_server.c" 3 4
                ((void *)0)
# 192 "../apps/lib/http_server.c"
                    , *bufbio;
    int asock;
    int port_num;
    char name[40];

    BIO_snprintf(name, sizeof(name), "*:%s", port);
    if (verb >= 0 && !log_set_verbosity(prog, verb))
        return 
# 199 "../apps/lib/http_server.c" 3 4
              ((void *)0)
# 199 "../apps/lib/http_server.c"
                  ;
    bufbio = BIO_new(BIO_f_buffer());
    if (bufbio == 
# 201 "../apps/lib/http_server.c" 3 4
                 ((void *)0)
# 201 "../apps/lib/http_server.c"
                     )
        goto err;
    acbio = BIO_new(BIO_s_accept());
    if (acbio == 
# 204 "../apps/lib/http_server.c" 3 4
                ((void *)0)
        
# 205 "../apps/lib/http_server.c"
       || BIO_int_ctrl(acbio,118,4,256) <= 0
        || BIO_ctrl(acbio,131,0x01,
# 206 "../apps/lib/http_server.c" 3 4
          ((void *)0)
# 206 "../apps/lib/http_server.c"
          ) <= 0
        || BIO_ctrl(acbio,118,0, (char *)(name)) <= 0) {
        trace_log_message(18, prog, 
# 208 "../apps/lib/http_server.c" 3 4
       3
# 208 "../apps/lib/http_server.c"
       , "%s", "error setting up accept BIO");
        goto err;
    }

    BIO_ctrl(acbio,118,3, (char *)(bufbio));
    bufbio = 
# 213 "../apps/lib/http_server.c" 3 4
            ((void *)0)
# 213 "../apps/lib/http_server.c"
                ;
    if (BIO_ctrl(acbio,101,0,
# 214 "../apps/lib/http_server.c" 3 4
       ((void *)0)
# 214 "../apps/lib/http_server.c"
       ) <= 0) {
        trace_log_message(18, prog, 
# 215 "../apps/lib/http_server.c" 3 4
       3
# 215 "../apps/lib/http_server.c"
       , "error setting accept on port %s", port);
        goto err;
    }


    BIO_ctrl(acbio,105,0,(char *)(&asock));
    port_num = report_server_accept(bio_out, asock, 1, 1);
    if (port_num == 0) {
        trace_log_message(18, prog, 
# 223 "../apps/lib/http_server.c" 3 4
       3
# 223 "../apps/lib/http_server.c"
       , "%s", "error printing ACCEPT string");
        goto err;
    }
 ...
 err:
    ...
    BIO_free(bufbio);
    return 
# 233 "../apps/lib/http_server.c" 3 4
          ((void *)0)
# 233 "../apps/lib/http_server.c"
              ;
}
...
# 247 "../apps/lib/http_server.c" 3 4
                  ((*__ctype_b_loc ())[(int) ((
# 247 "../apps/lib/http_server.c"
                  ((unsigned char)(p[1]))
# 247 "../apps/lib/http_server.c" 3 4
...
int http_server_get_asn1_req(const ASN1_ITEM *it, ASN1_VALUE **preq,
                             ...
                             const char *prog, int accept_get, int timeout)
{
    BIO *cbio = *pcbio, *getbio = 
# 267 "../apps/lib/http_server.c" 3 4
                                 ((void *)0)
# 267 "../apps/lib/http_server.c"
                                     , *b64 = 
# 267 "../apps/lib/http_server.c" 3 4
                                              ((void *)0)
# 267 "../apps/lib/http_server.c"
    ...
    *preq = 
# 274 "../apps/lib/http_server.c" 3 4
           ((void *)0)
# 274 "../apps/lib/http_server.c"
               ;
    if (ppath != 
# 275 "../apps/lib/http_server.c" 3 4
                ((void *)0)
# 275 "../apps/lib/http_server.c"
                    )
        *ppath = 
# 276 "../apps/lib/http_server.c" 3 4
                ((void *)0)
# 276 "../apps/lib/http_server.c"
                    ;

    if (cbio == 
# 278 "../apps/lib/http_server.c" 3 4
               ((void *)0)
# 278 "../apps/lib/http_server.c"
                   ) {
        char *port;

        get_sock_info_address(BIO_ctrl(acbio,105,0,(char *)(
# 281 "../apps/lib/http_server.c" 3 4
                             ((void *)0)
# 281 "../apps/lib/http_server.c"
                             )), 
# 281 "../apps/lib/http_server.c" 3 4
                                                      ((void *)0)
# 281 "../apps/lib/http_server.c"
                                                          , &port);
        if (port == 
# 282 "../apps/lib/http_server.c" 3 4
                   ((void *)0)
# 282 "../apps/lib/http_server.c"
                       ) {
            trace_log_message(18, prog, 
# 283 "../apps/lib/http_server.c" 3 4
           3
# 283 "../apps/lib/http_server.c"
           , "%s", "cannot get port listening on");
            goto fatal;
        }
        trace_log_message(18, prog, 
# 286 "../apps/lib/http_server.c" 3 4
       7
# 286 "../apps/lib/http_server.c"
       , "awaiting new connection on port %s ...", port)
                                                                 ;
        CRYPTO_free(port, "../apps/lib/http_server.c", 288);

        if (BIO_ctrl(acbio,101,0,
# 290 "../apps/lib/http_server.c" 3 4
           ((void *)0)
# 290 "../apps/lib/http_server.c"
           ) <= 0)
        ...
        *pcbio = cbio = BIO_pop(acbio);
        ...
        trace_log_message(18, prog, 
# 296 "../apps/lib/http_server.c" 3 4
       7
# 296 "../apps/lib/http_server.c"
       , "%s", "awaiting next request ...");
    }
    if (cbio == 
# 298 "../apps/lib/http_server.c" 3 4
               ((void *)0)
# 298 "../apps/lib/http_server.c"
                   ) {
    ...
    if (len < 0) {
        trace_log_message(18, prog, 
# 317 "../apps/lib/http_server.c" 3 4
       4
# 317 "../apps/lib/http_server.c"
       , "%s", "request line read error");
        (void)http_server_send_status(prog, cbio, 400, "Bad Request");
        goto out;
    }

    if (((end = strchr(reqbuf, '\r')) != 
# 322 "../apps/lib/http_server.c" 3 4
                                        ((void *)0) 
# 322 "../apps/lib/http_server.c"
                                             && end[1] == '\n')
            || (end = strchr(reqbuf, '\n')) != 
# 323 "../apps/lib/http_server.c" 3 4
                                              ((void *)0)
# 323 "../apps/lib/http_server.c"
                                                  )
        *end = '\0';
    if (log_get_verbosity() < (
# 325 "../apps/lib/http_server.c" 3 4
                             7 
# 325 "../apps/lib/http_server.c"
                             + 1))
        trace_log_message(-1, prog, 
# 326 "../apps/lib/http_server.c" 3 4
                                   6
# 326 "../apps/lib/http_server.c"
                                           ,
                          "received request, 1st line: %s", reqbuf);
    trace_log_message(18, prog, (
# 328 "../apps/lib/http_server.c" 3 4
   7 
# 328 "../apps/lib/http_server.c"
   + 1), "%s", "received request header:");
    trace_log_message(18, prog, (
# 329 "../apps/lib/http_server.c" 3 4
   7 
# 329 "../apps/lib/http_server.c"
   + 1), "%s", reqbuf);
    if (end == 
# 330 "../apps/lib/http_server.c" 3 4
              ((void *)0)
# 330 "../apps/lib/http_server.c"
                  ) {
        trace_log_message(18, prog, 
# 331 "../apps/lib/http_server.c" 3 4
       4
# 331 "../apps/lib/http_server.c"
       , "%s", "cannot parse HTTP header: missing end of line")
                                                                 ;
        (void)http_server_send_status(prog, cbio, 400, "Bad Request");
        goto out;
    }
    ...
    url = meth = reqbuf;
    if ((accept_get && ((strncmp(url, "GET " "", sizeof("GET ") - 1) == 0) ? ((url) += sizeof("GET ") - 1, 1) : 0))
            || ((strncmp(url, "POST " "", sizeof("POST ") - 1) == 0) ? ((url) += sizeof("POST ") - 1, 1) : 0)) {
        ...
        if (*url != '/') {
            trace_log_message(18, prog, 
# 346 "../apps/lib/http_server.c" 3 4
           4
# 346 "../apps/lib/http_server.c"
        ...
        for (end = url; *end != '\0'; end++)
            if (*end == ' ')
                break;
        if (!(strncmp(end, " ""HTTP/""""1." "", sizeof(" ""HTTP/""""1.") - 1) == 0)) {
            trace_log_message(18, prog, 
# 359 "../apps/lib/http_server.c" 3 4
           4
# 359 "../apps/lib/http_server.c"
           , "invalid %s -- bad HTTP/version string: %s", meth, end + 1)
        ...
        *end = '\0';
        ...
        if (found_keep_alive != 
# 367 "../apps/lib/http_server.c" 3 4
                               ((void *)0)
# 367 "../apps/lib/http_server.c"
                                   )
            *found_keep_alive = end[sizeof(" ""HTTP/""""1.") - 1] > '0';
        ...
        if (len < 0) {
            trace_log_message(18, prog, 
# 382 "../apps/lib/http_server.c" 3 4
           4
# 382 "../apps/lib/http_server.c"
        ...
        if (strlen(meth) == 3) {
            if ((getbio = BIO_new_mem_buf(url, len)) == 
# 388 "../apps/lib/http_server.c" 3 4
                                                       ((void *)0)
                
# 389 "../apps/lib/http_server.c"
               || (b64 = BIO_new(BIO_f_base64())) == 
# 389 "../apps/lib/http_server.c" 3 4
                                                     ((void *)0)
# 389 "../apps/lib/http_server.c"
                                                         ) {
                trace_log_message(18, prog, 
# 390 "../apps/lib/http_server.c" 3 4
               3
# 390 "../apps/lib/http_server.c"
        ...
        trace_log_message(18, prog, 
# 398 "../apps/lib/http_server.c" 3 4
       4
# 398 "../apps/lib/http_server.c"
       , "HTTP request does not begin with %sPOST: %s", accept_get ? "GET or " : "", reqbuf)
    ...
    *end = '\0';
    ...
    for (;;) {
        ...
        if (len <= 0) {
            trace_log_message(18, prog, 
# 418 "../apps/lib/http_server.c" 3 4
           4
# 418 "../apps/lib/http_server.c"
           , "%s", "error reading HTTP header");
            (void)http_server_send_status(prog, cbio, 400, "Bad Request");
            goto out;
        }

        if (((end = strchr(inbuf, '\r')) != 
# 423 "../apps/lib/http_server.c" 3 4
                                           ((void *)0) 
# 423 "../apps/lib/http_server.c"
                                                && end[1] == '\n')
            || (end = strchr(inbuf, '\n')) != 
# 424 "../apps/lib/http_server.c" 3 4
                                             ((void *)0)
# 424 "../apps/lib/http_server.c"
                                                 )
            *end = '\0';
        trace_log_message(18, prog, (
# 426 "../apps/lib/http_server.c" 3 4
       7 
# 426 "../apps/lib/http_server.c"
       + 1), "%s", *inbuf == '\0' ? " " : inbuf)
                                                                      ;
        if (end == 
# 428 "../apps/lib/http_server.c" 3 4
                  ((void *)0)
# 428 "../apps/lib/http_server.c"
                      ) {
            trace_log_message(18, prog, 
# 429 "../apps/lib/http_server.c" 3 4
           4
# 429 "../apps/lib/http_server.c"
           , "%s", "error parsing HTTP header: missing end of line")
                                                                      ;
            (void)http_server_send_status(prog, cbio, 400, "Bad Request");
            goto out;
        }
        ...
        value = strchr(key, ':');
        if (value == 
# 440 "../apps/lib/http_server.c" 3 4
                    ((void *)0)
# 440 "../apps/lib/http_server.c"
                        ) {
            trace_log_message(18, prog, 
# 441 "../apps/lib/http_server.c" 3 4
           4
# 441 "../apps/lib/http_server.c"
           , "%s", "error parsing HTTP header: missing ':'")
                                                              ;
            (void)http_server_send_status(prog, cbio, 400, "Bad Request");
            goto out;
        }
        *(value++) = '\0';
        ...
        if (found_keep_alive != 
# 450 "../apps/lib/http_server.c" 3 4
                               ((void *)0)
            
# 451 "../apps/lib/http_server.c"
    ...
    req = ASN1_item_d2i_bio(it, getbio != 
# 466 "../apps/lib/http_server.c" 3 4
                                         ((void *)0) 
# 466 "../apps/lib/http_server.c"
                                              ? getbio : cbio, 
# 466 "../apps/lib/http_server.c" 3 4
                                                               ((void *)0)
# 466 "../apps/lib/http_server.c"
    ...
    if (req == 
# 467 "../apps/lib/http_server.c" 3 4
              ((void *)0)
# 467 "../apps/lib/http_server.c"
                  ) {
        trace_log_message(18, prog, 
# 468 "../apps/lib/http_server.c" 3 4
       4
# 468 "../apps/lib/http_server.c"
       , "%s", "error parsing DER-encoded request content")
                                                             ;
        (void)http_server_send_status(prog, cbio, 400, "Bad Request");
    } else if (ppath != 
# 471 "../apps/lib/http_server.c" 3 4
                       ((void *)0) 
# 471 "../apps/lib/http_server.c"
                            && (*ppath = CRYPTO_strdup(url, "../apps/lib/http_server.c", 471)) == 
# 471 "../apps/lib/http_server.c" 3 4
                                                                 ((void *)0)
# 471 "../apps/lib/http_server.c"
                                                                     ) {
        trace_log_message(18, prog, 
# 472 "../apps/lib/http_server.c" 3 4
       3
# 472 "../apps/lib/http_server.c"
 ...
 fatal:
    ...
    if (ppath != 
# 491 "../apps/lib/http_server.c" 3 4
                ((void *)0)
# 491 "../apps/lib/http_server.c"
                    ) {
        CRYPTO_free(*ppath, "../apps/lib/http_server.c", 492);
        *ppath = 
# 493 "../apps/lib/http_server.c" 3 4
                ((void *)0)
# 493 "../apps/lib/http_server.c"
                    ;
    }
    BIO_free_all(cbio);
    *pcbio = 
# 496 "../apps/lib/http_server.c" 3 4
            ((void *)0)
# 496 "../apps/lib/http_server.c"
                ;
    ret = -1;
    goto out;
}
...
{
    char buf[200], *p;
    int ret = BIO_snprintf(buf, sizeof(buf), "HTTP/""""1.""0"" 200 OK\r\n%s"
                           "Content-type: %s\r\n"
                           "Content-Length: %d\r\n",
                           keep_alive ? "Connection: keep-alive\r\n" : "",
                           content_type,
                           ASN1_item_i2d(resp, 
# 512 "../apps/lib/http_server.c" 3 4
                                              ((void *)0)
# 512 "../apps/lib/http_server.c"
                                                  , it));

    if (ret < 0 || (size_t)ret >= sizeof(buf))
        return 0;
    if (log_get_verbosity() < (
# 516 "../apps/lib/http_server.c" 3 4
                             7 
# 516 "../apps/lib/http_server.c"
                             + 1) && (p = strchr(buf, '\r')) != 
# 516 "../apps/lib/http_server.c" 3 4
                                                                     ((void *)0)
# 516 "../apps/lib/http_server.c"
        ...
        trace_log_message(-1, prog, 
# 517 "../apps/lib/http_server.c" 3 4
                                   6
# 517 "../apps/lib/http_server.c"
                                           ,
                          "sending response, 1st line: %.*s", (int)(p - buf),
                          buf);
    trace_log_message(18, prog, (
# 520 "../apps/lib/http_server.c" 3 4
   7 
# 520 "../apps/lib/http_server.c"
   + 1), "sending response header:\n%s", buf);

    ret = BIO_printf(cbio, "%s\r\n", buf) > 0
        && ASN1_item_i2d_bio(it, cbio, resp) > 0;

    (void)(int)BIO_ctrl(cbio,11,0,
# 525 "../apps/lib/http_server.c" 3 4
         ((void *)0)
# 525 "../apps/lib/http_server.c"
         );
    return ret;
}
...
{
    char buf[200];
    int ret = BIO_snprintf(buf, sizeof(buf), "HTTP/""""1.""0"" %d %s\r\n\r\n",
    ...
    if (ret < 0 || (size_t)ret >= sizeof(buf))
        return 0;
    trace_log_message(18, prog, (
# 539 "../apps/lib/http_server.c" 3 4
   7 
# 539 "../apps/lib/http_server.c"
   + 1), "sending response header:\n%s", buf);

    ret = BIO_printf(cbio, "%s\r\n", buf) > 0;
    (void)(int)BIO_ctrl(cbio,11,0,
# 542 "../apps/lib/http_server.c" 3 4
         ((void *)0)
# 542 "../apps/lib/http_server.c"
         );
    return ret;
}
