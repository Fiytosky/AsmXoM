# 0 "../apps/lib/s_socket.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../apps/lib/s_socket.c"
# 11 "../apps/lib/s_socket.c"
...
# 17 "../apps/lib/s_socket.c" 2
# 40 "../apps/lib/s_socket.c"
...
BIO_ADDR *ourpeer = 
# 48 "../apps/lib/s_socket.c" 3 4
                   ((void *)0)
# 48 "../apps/lib/s_socket.c"
                       ;
# 74 "../apps/lib/s_socket.c"
int init_client(int *sock, const char *host, const char *port,
                const char *bindhost, const char *bindport,
                int family, int type, int protocol, int tfo, int doconn,
                BIO_ADDR **ba_ret)
{
    BIO_ADDRINFO *res = 
# 79 "../apps/lib/s_socket.c" 3 4
                       ((void *)0)
# 79 "../apps/lib/s_socket.c"
                           ;
    BIO_ADDRINFO *bindaddr = 
# 80 "../apps/lib/s_socket.c" 3 4
                            ((void *)0)
# 80 "../apps/lib/s_socket.c"
                                ;
    const BIO_ADDRINFO *ai = 
# 81 "../apps/lib/s_socket.c" 3 4
                            ((void *)0)
# 81 "../apps/lib/s_socket.c"
                                ;
    const BIO_ADDRINFO *bi = 
# 82 "../apps/lib/s_socket.c" 3 4
                            ((void *)0)
# 82 "../apps/lib/s_socket.c"
                                ;
    int found = 0;
    int ret;
    int options = 0;
    ...
    if (bindhost != 
# 97 "../apps/lib/s_socket.c" 3 4
                   ((void *)0) 
# 97 "../apps/lib/s_socket.c"
                        || bindport != 
# 97 "../apps/lib/s_socket.c" 3 4
                                       ((void *)0)
# 97 "../apps/lib/s_socket.c"
    ...
    ret = 0;
    for (ai = res; ai != 
# 107 "../apps/lib/s_socket.c" 3 4
                        ((void *)0)
# 107 "../apps/lib/s_socket.c"
                            ; ai = BIO_ADDRINFO_next(ai)) {



        (void)(((family == 
# 111 "../apps/lib/s_socket.c" 3 4
       0 
# 111 "../apps/lib/s_socket.c"
       || family == BIO_ADDRINFO_family(ai)) && (type == 0 || type == BIO_ADDRINFO_socktype(ai)) && (protocol == 0 || protocol == BIO_ADDRINFO_protocol(ai))) ? 0 : (OPENSSL_die("assertion failed: " "(family == AF_UNSPEC || family == BIO_ADDRINFO_family(ai)) && (type == 0 || type == BIO_ADDRINFO_socktype(ai)) && (protocol == 0 || protocol == BIO_ADDRINFO_protocol(ai))", "../apps/lib/s_socket.c", 111), 1))
        ...
        if (bindaddr != 
# 117 "../apps/lib/s_socket.c" 3 4
                       ((void *)0)
# 117 "../apps/lib/s_socket.c"
                           ) {
            for (bi = bindaddr; bi != 
# 118 "../apps/lib/s_socket.c" 3 4
                                     ((void *)0)
# 118 "../apps/lib/s_socket.c"
                                         ; bi = BIO_ADDRINFO_next(bi)) {
                if (BIO_ADDRINFO_family(bi) == BIO_ADDRINFO_family(ai))
                    break;
            }
            if (bi == 
# 122 "../apps/lib/s_socket.c" 3 4
                     ((void *)0)
# 122 "../apps/lib/s_socket.c"
                         )
                continue;
            ++found;
        }
        ...
        *sock = BIO_socket(BIO_ADDRINFO_family(ai), BIO_ADDRINFO_socktype(ai),
        ...
        if (bi != 
# 136 "../apps/lib/s_socket.c" 3 4
                 ((void *)0)
# 136 "../apps/lib/s_socket.c"
                     ) {
...
# 162 "../apps/lib/s_socket.c"
        if (BIO_ADDRINFO_protocol(ai) == 
# 162 "../apps/lib/s_socket.c" 3 4
                                        IPPROTO_TCP
# 162 "../apps/lib/s_socket.c"
                                                   ) {
            options |= 0x10;
        ...
        if (tfo || !doconn) {
            if (ba_ret == 
# 176 "../apps/lib/s_socket.c" 3 4
                         ((void *)0)
# 176 "../apps/lib/s_socket.c"
                             ) {
    ...
    if (*sock == (-1)) {
        if (bindaddr != 
# 191 "../apps/lib/s_socket.c" 3 4
                       ((void *)0) 
# 191 "../apps/lib/s_socket.c"
                            && !found) {
            BIO_printf(bio_err, "Can't bind %saddress for %s%s%s\n",

                       BIO_ADDRINFO_family(res) == 
# 194 "../apps/lib/s_socket.c" 3 4
                                                  10 
# 194 "../apps/lib/s_socket.c"
                                                           ? "IPv6 " :

                       BIO_ADDRINFO_family(res) == 
# 196 "../apps/lib/s_socket.c" 3 4
                                                  2 
# 196 "../apps/lib/s_socket.c"
                                                          ? "IPv4 " :
                       BIO_ADDRINFO_family(res) == 
# 197 "../apps/lib/s_socket.c" 3 4
                                                  1 
# 197 "../apps/lib/s_socket.c"
                                                          ? "unix " : "",
                       bindhost != 
# 198 "../apps/lib/s_socket.c" 3 4
                                  ((void *)0) 
# 198 "../apps/lib/s_socket.c"
                                       ? bindhost : "",
                       bindport != 
# 199 "../apps/lib/s_socket.c" 3 4
                                  ((void *)0) 
# 199 "../apps/lib/s_socket.c"
                                       ? ":" : "",
                       bindport != 
# 200 "../apps/lib/s_socket.c" 3 4
                                  ((void *)0) 
# 200 "../apps/lib/s_socket.c"
                                       ? bindport : "");
            ERR_clear_error();
            ret = 0;
        }
        ...
        char *hostname = 
# 206 "../apps/lib/s_socket.c" 3 4
                        ((void *)0)
# 206 "../apps/lib/s_socket.c"
                            ;

        hostname = BIO_ADDR_hostname_string(BIO_ADDRINFO_address(ai), 1);
        if (hostname != 
# 209 "../apps/lib/s_socket.c" 3 4
                       ((void *)0)
# 209 "../apps/lib/s_socket.c"
                           ) {
            BIO_printf(bio_err, "Connecting to %s\n", hostname);
            CRYPTO_free(hostname, "../apps/lib/s_socket.c", 211);
        }
...
out:
    if (bindaddr != 
# 218 "../apps/lib/s_socket.c" 3 4
                   ((void *)0)
# 218 "../apps/lib/s_socket.c"
                       ) {
...
void get_sock_info_address(int asock, char **hostname, char **service)
{
    ...
    if (hostname != 
# 229 "../apps/lib/s_socket.c" 3 4
                   ((void *)0)
# 229 "../apps/lib/s_socket.c"
                       )
        *hostname = 
# 230 "../apps/lib/s_socket.c" 3 4
                   ((void *)0)
# 230 "../apps/lib/s_socket.c"
                       ;
    if (service != 
# 231 "../apps/lib/s_socket.c" 3 4
                  ((void *)0)
# 231 "../apps/lib/s_socket.c"
                      )
        *service = 
# 232 "../apps/lib/s_socket.c" 3 4
                  ((void *)0)
# 232 "../apps/lib/s_socket.c"
                      ;

    if ((info.addr = BIO_ADDR_new()) != 
# 234 "../apps/lib/s_socket.c" 3 4
                                       ((void *)0)
            
# 235 "../apps/lib/s_socket.c"
           && BIO_sock_info(asock, BIO_SOCK_INFO_ADDRESS, &info)) {
        if (hostname != 
# 236 "../apps/lib/s_socket.c" 3 4
                       ((void *)0)
# 236 "../apps/lib/s_socket.c"
                           )
            *hostname = BIO_ADDR_hostname_string(info.addr, 1);
        if (service != 
# 238 "../apps/lib/s_socket.c" 3 4
                      ((void *)0)
# 238 "../apps/lib/s_socket.c"
                          )
...
int report_server_accept(BIO *out, int asock, int with_address, int with_pid)
{
    ...
    if (with_address) {
        ...
        success = hostname != 
# 254 "../apps/lib/s_socket.c" 3 4
                             ((void *)0) 
# 254 "../apps/lib/s_socket.c"
                                  && service != 
# 254 "../apps/lib/s_socket.c" 3 4
                                                ((void *)0)
# 254 "../apps/lib/s_socket.c"
        ...
        if (success)
            success = BIO_printf(out,
                                 strchr(hostname, ':') == 
# 257 "../apps/lib/s_socket.c" 3 4
                                                         ((void *)0)
                                 
# 258 "../apps/lib/s_socket.c"
                                ? " %s:%s"
                                 : " [%s]:%s",
                                 hostname, service) > 0;
        else
            (void)BIO_printf(out, "unknown:error\n");
        CRYPTO_free(hostname, "../apps/lib/s_socket.c", 263);
        CRYPTO_free(service, "../apps/lib/s_socket.c", 264);
    }
    if (with_pid)
        success *= BIO_printf(out, " PID=%d", getpid()) > 0;
    success *= BIO_printf(out, "\n") > 0;
    (void)(int)BIO_ctrl(out,11,0,
# 269 "../apps/lib/s_socket.c" 3 4
         ((void *)0)
# 269 "../apps/lib/s_socket.c"
         );

    return success;
}
# 294 "../apps/lib/s_socket.c"
int do_server(int *accept_sock, const char *host, const char *port,
              int family, int type, int protocol, do_server_cb cb,
              unsigned char *context, int naccept, BIO *bio_s_out,
              int tfo)
{
    ...
    int i;
    BIO_ADDRINFO *res = 
# 302 "../apps/lib/s_socket.c" 3 4
                       ((void *)0)
# 302 "../apps/lib/s_socket.c"
                           ;
    const BIO_ADDRINFO *next;
    int sock_family, sock_type, sock_protocol, sock_port;
    const BIO_ADDR *sock_address;
    int sock_family_fallback = 
# 306 "../apps/lib/s_socket.c" 3 4
                              0
# 306 "../apps/lib/s_socket.c"
                                       ;
    const BIO_ADDR *sock_address_fallback = 
# 307 "../apps/lib/s_socket.c" 3 4
                                           ((void *)0)
# 307 "../apps/lib/s_socket.c"
                                               ;
    ...
    (void)(((family == 
# 322 "../apps/lib/s_socket.c" 3 4
   0 
# 322 "../apps/lib/s_socket.c"
   || family == BIO_ADDRINFO_family(res)) && (type == 0 || type == BIO_ADDRINFO_socktype(res)) && (protocol == 0 || protocol == BIO_ADDRINFO_protocol(res))) ? 0 : (OPENSSL_die("assertion failed: " "(family == AF_UNSPEC || family == BIO_ADDRINFO_family(res)) && (type == 0 || type == BIO_ADDRINFO_socktype(res)) && (protocol == 0 || protocol == BIO_ADDRINFO_protocol(res))", "../apps/lib/s_socket.c", 322), 1))
    ...
    if (tfo && sock_type == 
# 331 "../apps/lib/s_socket.c" 3 4
                           SOCK_STREAM
# 331 "../apps/lib/s_socket.c"
                                      )
        sock_options |= 0x20;

    if (sock_family == 
# 334 "../apps/lib/s_socket.c" 3 4
                      10
# 334 "../apps/lib/s_socket.c"
                              )
        sock_options |= 0x02;
    if (next != 
# 336 "../apps/lib/s_socket.c" 3 4
               ((void *)0)
            
# 337 "../apps/lib/s_socket.c"
           && BIO_ADDRINFO_socktype(next) == sock_type
            && BIO_ADDRINFO_protocol(next) == sock_protocol) {
        if (sock_family == 
# 339 "../apps/lib/s_socket.c" 3 4
                          2
                
# 340 "../apps/lib/s_socket.c"
               && BIO_ADDRINFO_family(next) == 
# 340 "../apps/lib/s_socket.c" 3 4
                                               10
# 340 "../apps/lib/s_socket.c"
                                                       ) {
            ...
            sock_family = 
# 345 "../apps/lib/s_socket.c" 3 4
                         10
# 345 "../apps/lib/s_socket.c"
                                 ;
            sock_address = BIO_ADDRINFO_address(next);
        } else if (sock_family == 
# 347 "../apps/lib/s_socket.c" 3 4
                                 10
                   
# 348 "../apps/lib/s_socket.c"
                  && BIO_ADDRINFO_family(next) == 
# 348 "../apps/lib/s_socket.c" 3 4
                                                  2
# 348 "../apps/lib/s_socket.c"
                                                         ) {
            sock_options &= ~0x02;
    ...
    if (asock == (-1) && sock_family_fallback != 
# 355 "../apps/lib/s_socket.c" 3 4
                                                          0
# 355 "../apps/lib/s_socket.c"
                                                                   ) {
...
# 387 "../apps/lib/s_socket.c"
    sock_port = BIO_ADDR_rawport(sock_address);

    BIO_ADDRINFO_free(res);
    res = 
# 390 "../apps/lib/s_socket.c" 3 4
         ((void *)0)
# 390 "../apps/lib/s_socket.c"
             ;
    ...
    if (accept_sock != 
# 398 "../apps/lib/s_socket.c" 3 4
                      ((void *)0)
# 398 "../apps/lib/s_socket.c"
                          )
        *accept_sock = asock;
    for (;;) {
        char sink[64];
        ...
        if (type == 
# 405 "../apps/lib/s_socket.c" 3 4
                   SOCK_STREAM
# 405 "../apps/lib/s_socket.c"
                              ) {
            BIO_ADDR_free(ourpeer);
            ourpeer = BIO_ADDR_new();
            if (ourpeer == 
# 408 "../apps/lib/s_socket.c" 3 4
                          ((void *)0)
# 408 "../apps/lib/s_socket.c"
                              ) {
                BIO_closesocket(asock);
                ERR_print_errors(bio_err);
                goto end;
...
# 451 "../apps/lib/s_socket.c" 3 4
               ((void) (((
# 451 "../apps/lib/s_socket.c"
               &readfds
# 451 "../apps/lib/s_socket.c" 3 4
               )->__fds_bits)[((
# 451 "../apps/lib/s_socket.c"
...
# 451 "../apps/lib/s_socket.c"
                                            ;
            } while (select(sock + 1, &readfds, 
# 452 "../apps/lib/s_socket.c" 3 4
                                               ((void *)0)
# 452 "../apps/lib/s_socket.c"
                                                   , 
# 452 "../apps/lib/s_socket.c" 3 4
                                                     ((void *)0)
# 452 "../apps/lib/s_socket.c"
    ...
    if (family == 
# 471 "../apps/lib/s_socket.c" 3 4
                 1
# 471 "../apps/lib/s_socket.c"
                        )
        unlink(host);

    BIO_ADDR_free(ourpeer);
    ourpeer = 
# 475 "../apps/lib/s_socket.c" 3 4
             ((void *)0)
# 475 "../apps/lib/s_socket.c"
                 ;
    return ret;
}
