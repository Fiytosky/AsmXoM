# 0 "../apps/lib/tlssrp_depr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../apps/lib/tlssrp_depr.c"
# 19 "../apps/lib/tlssrp_depr.c"
...
# 25 "../apps/lib/tlssrp_depr.c" 2
# 1 "../apps/include/s_apps.h" 1
# 21 "../apps/include/s_apps.h"
...
static int srp_Verify_N_and_g(const BIGNUM *N, const BIGNUM *g)
{
    ...
    int ret =
        g != 
# 33 "../apps/lib/tlssrp_depr.c" 3 4
            ((void *)0) 
# 33 "../apps/lib/tlssrp_depr.c"
                 && N != 
# 33 "../apps/lib/tlssrp_depr.c" 3 4
                         ((void *)0) 
# 33 "../apps/lib/tlssrp_depr.c"
...
# 33 "../apps/lib/tlssrp_depr.c"
                                                && BN_is_odd(N) &&
        BN_check_prime(N, bn_ctx, 
# 34 "../apps/lib/tlssrp_depr.c" 3 4
                                 ((void *)0)
# 34 "../apps/lib/tlssrp_depr.c"
                                     ) == 1 &&
        p != 
# 35 "../apps/lib/tlssrp_depr.c" 3 4
            ((void *)0) 
# 35 "../apps/lib/tlssrp_depr.c"
                 && BN_rshift1(p, N) &&

        BN_check_prime(p, bn_ctx, 
# 37 "../apps/lib/tlssrp_depr.c" 3 4
                                 ((void *)0)
# 37 "../apps/lib/tlssrp_depr.c"
                                     ) == 1 &&
        r != 
# 38 "../apps/lib/tlssrp_depr.c" 3 4
            ((void *)0) 
# 38 "../apps/lib/tlssrp_depr.c"
                 &&
...
# 65 "../apps/lib/tlssrp_depr.c"
static int ssl_srp_verify_param_cb(SSL *s, void *arg)
{
    SRP_ARG *srp_arg = (SRP_ARG *)arg;
    BIGNUM *N = 
# 68 "../apps/lib/tlssrp_depr.c" 3 4
               ((void *)0)
# 68 "../apps/lib/tlssrp_depr.c"
                   , *g = 
# 68 "../apps/lib/tlssrp_depr.c" 3 4
                          ((void *)0)
# 68 "../apps/lib/tlssrp_depr.c"
    ...
    if (((N = SSL_get_srp_N(s)) == 
# 70 "../apps/lib/tlssrp_depr.c" 3 4
                                  ((void *)0)
# 70 "../apps/lib/tlssrp_depr.c"
                                      ) || ((g = SSL_get_srp_g(s)) == 
# 70 "../apps/lib/tlssrp_depr.c" 3 4
                                                                      ((void *)0)
# 70 "../apps/lib/tlssrp_depr.c"
...
static char *ssl_give_srp_client_pwd_cb(SSL *s, void *arg)
{
    ...
    if ((l = password_callback(pass, 1024, 0, &cb_tmp)) < 0) {
        ...
        CRYPTO_free(pass, "../apps/lib/tlssrp_depr.c", 114);
        return 
# 115 "../apps/lib/tlssrp_depr.c" 3 4
              ((void *)0)
# 115 "../apps/lib/tlssrp_depr.c"
                  ;
    }
    *(pass + l) = '\0';
...
static int ssl_srp_server_param_cb(SSL *s, int *ad, void *arg)
{
    ...
    if (p->login == 
# 163 "../apps/lib/tlssrp_depr.c" 3 4
                   ((void *)0) 
# 163 "../apps/lib/tlssrp_depr.c"
                        && p->user == 
# 163 "../apps/lib/tlssrp_depr.c" 3 4
                                      ((void *)0)
# 163 "../apps/lib/tlssrp_depr.c"
    ...
    if (p->user == 
# 169 "../apps/lib/tlssrp_depr.c" 3 4
                  ((void *)0)
# 169 "../apps/lib/tlssrp_depr.c"
                      ) {
 ...
 err:
    ...
    p->user = 
# 187 "../apps/lib/tlssrp_depr.c" 3 4
             ((void *)0)
# 187 "../apps/lib/tlssrp_depr.c"
                 ;
    p->login = 
# 188 "../apps/lib/tlssrp_depr.c" 3 4
              ((void *)0)
# 188 "../apps/lib/tlssrp_depr.c"
                  ;
    return ret;
}
...
# 198 "../apps/lib/tlssrp_depr.c" 3 4
                             ((void *)0)
# 198 "../apps/lib/tlssrp_depr.c"
                                 ;
    srp_callback_parm->login = 
# 199 "../apps/lib/tlssrp_depr.c" 3 4
                              ((void *)0)
# 199 "../apps/lib/tlssrp_depr.c"
                                  ;

    if (srp_callback_parm->vb == 
# 201 "../apps/lib/tlssrp_depr.c" 3 4
                                ((void *)0)
# 201 "../apps/lib/tlssrp_depr.c"
                                    ) {
...
# 226 "../apps/lib/tlssrp_depr.c" 3 4
                                  ((void *)0)
# 226 "../apps/lib/tlssrp_depr.c"
                                      )
