...
# 169 "../apps/lib/opt.c"
    ...
    for (; o->name != 
# 174 "../apps/lib/opt.c" 3 4
                     ((void *)0) 
# 174 "../apps/lib/opt.c"
                          && o->name != OPT_PARAM_STR; ++o) {
...
# 217 "../apps/lib/opt.c"
        if (o->name[0] == '\0') {
            (void)((unknown_name != 
# 218 "../apps/lib/opt.c" 3 4
           ((void *)0)
# 218 "../apps/lib/opt.c"
           ) ? 0 : (OPENSSL_die("assertion failed: " "unknown_name != NULL", "../apps/lib/opt.c", 218), 1));
            (void)((unknown == 
# 219 "../apps/lib/opt.c" 3 4
           ((void *)0)
# 219 "../apps/lib/opt.c"
           ) ? 0 : (OPENSSL_die("assertion failed: " "unknown == NULL", "../apps/lib/opt.c", 219), 1));
            unknown = o;
            (void)((unknown->valtype == 0 || unknown->valtype == '-') ? 0 : (OPENSSL_die("assertion failed: " "unknown->valtype == 0 || unknown->valtype == '-'", "../apps/lib/opt.c", 221), 1));
        }
    }
    return prog;
}
...
int opt_cipher_silent(const char *name, EVP_CIPHER **cipherp)
{
    ...
    if ((c = EVP_CIPHER_fetch(app_get0_libctx(), name,
                              app_get0_propq())) != 
# 398 "../apps/lib/opt.c" 3 4
                                                   ((void *)0)
        
# 399 "../apps/lib/opt.c"
       || (opt_legacy_okay()
            && (c = (EVP_CIPHER *)EVP_get_cipherbyname(name)) != 
# 400 "../apps/lib/opt.c" 3 4
                                                                ((void *)0)
# 400 "../apps/lib/opt.c"
                                                                    )) {
        ERR_pop_to_mark();
        if (cipherp != 
# 402 "../apps/lib/opt.c" 3 4
                      ((void *)0)
# 402 "../apps/lib/opt.c"
                          ) {
...
int opt_cipher(const char *name, EVP_CIPHER **cipherp)
{
     ...
     EVP_CIPHER *c = 
# 429 "../apps/lib/opt.c" 3 4
                    ((void *)0)
# 429 "../apps/lib/opt.c"
                        ;

    if (name == 
# 431 "../apps/lib/opt.c" 3 4
               ((void *)0)
# 431 "../apps/lib/opt.c"
                   )
         return 1;
...
# 457 "../apps/lib/opt.c" 3 4
                                                                         ((void *)0)
        
# 458 "../apps/lib/opt.c"
       || (opt_legacy_okay()
            && (md = (EVP_MD *)EVP_get_digestbyname(name)) != 
# 459 "../apps/lib/opt.c" 3 4
                                                             ((void *)0)
# 459 "../apps/lib/opt.c"
                                                                 )) {
        ERR_pop_to_mark();
        if (mdp != 
# 461 "../apps/lib/opt.c" 3 4
                  ((void *)0)
# 461 "../apps/lib/opt.c"
                      ) {
            EVP_MD_free(*mdp);
...
# 582 "../apps/lib/opt.c"
            ...
            || (l == 0 && 
# 583 "../apps/lib/opt.c" 3 4
                         (*__errno_location ()) 
# 583 "../apps/lib/opt.c"
                               != 0)) {
        opt_number_error(value);
        
# 585 "../apps/lib/opt.c" 3 4
       (*__errno_location ()) 
# 585 "../apps/lib/opt.c"
             = oerrno;
        return 0;
...
# 609 "../apps/lib/opt.c"
            ...
            || (m == 0 && 
# 610 "../apps/lib/opt.c" 3 4
                         (*__errno_location ()) 
# 610 "../apps/lib/opt.c"
                               != 0)) {
        opt_number_error(value);
        
# 612 "../apps/lib/opt.c" 3 4
       (*__errno_location ()) 
# 612 "../apps/lib/opt.c"
             = oerrno;
        return 0;
    ...
    if (sizeof(m) > sizeof(*result)
        && (m < (-((ossl_intmax_t) ((((ossl_intmax_t) 1) << ((sizeof(ossl_intmax_t) * 8
# 617 "../apps/lib/opt.c"
               ) - 1)) ^ ((ossl_intmax_t) -1))) - 1) || m > ((ossl_intmax_t) ((((ossl_intmax_t) 1) << ((sizeof(ossl_intmax_t) * 8
# 617 "../apps/lib/opt.c"
                                      ) - 1)) ^ ((ossl_intmax_t) -1))))) {
        opt_number_error(value);
        return 0;
...
# 637 "../apps/lib/opt.c"
            ...
            || (m == 0 && 
# 638 "../apps/lib/opt.c" 3 4
                         (*__errno_location ()) 
# 638 "../apps/lib/opt.c"
                               != 0)) {
        opt_number_error(value);
        
# 640 "../apps/lib/opt.c" 3 4
       (*__errno_location ()) 
# 640 "../apps/lib/opt.c"
             = oerrno;
        return 0;
...
# 689 "../apps/lib/opt.c"
            ...
            || (l == 0 && 
# 690 "../apps/lib/opt.c" 3 4
                         (*__errno_location ()) 
# 690 "../apps/lib/opt.c"
                               != 0)) {
        opt_number_error(value);
        
# 692 "../apps/lib/opt.c" 3 4
       (*__errno_location ()) 
# 692 "../apps/lib/opt.c"
             = oerrno;
        return 0;
...
int opt_verify(int opt, X509_VERIFY_PARAM *vpm)
{
    ...
    (void)((vpm != 
# 715 "../apps/lib/opt.c" 3 4
   ((void *)0)
# 715 "../apps/lib/opt.c"
   ) ? 0 : (OPENSSL_die("assertion failed: " "vpm != NULL", "../apps/lib/opt.c", 715), 1));
    (void)((opt > OPT_V__FIRST) ? 0 : (OPENSSL_die("assertion failed: " "opt > OPT_V__FIRST", "../apps/lib/opt.c", 716), 1));
    (void)((opt < OPT_V__LAST) ? 0 : (OPENSSL_die("assertion failed: " "opt < OPT_V__LAST", "../apps/lib/opt.c", 717), 1));
...
void opt_begin(void)
{
    opt_index = 1;
    arg = 
# 870 "../apps/lib/opt.c" 3 4
         ((void *)0)
# 870 "../apps/lib/opt.c"
             ;
    flag = 
# 871 "../apps/lib/opt.c" 3 4
          ((void *)0)
# 871 "../apps/lib/opt.c"
              ;
}
...
int opt_next(void)
{
    ...
    arg = 
# 889 "../apps/lib/opt.c" 3 4
         ((void *)0)
# 889 "../apps/lib/opt.c"
             ;
    p = argv[opt_index];
    if (p == 
# 891 "../apps/lib/opt.c" 3 4
            ((void *)0)
# 891 "../apps/lib/opt.c"
                )
        return 0;
...
# 909 "../apps/lib/opt.c"
    ...
    for (o = opts; o->name; ++o) {
        ...
        if (arg == 
# 928 "../apps/lib/opt.c" 3 4
                  ((void *)0)
# 928 "../apps/lib/opt.c"
                      ) {
            if (argv[opt_index] == 
# 929 "../apps/lib/opt.c" 3 4
                                  ((void *)0)
# 929 "../apps/lib/opt.c"
                                      ) {
        ...
        case 'a':
            if (opt_format(arg,
                           o->valtype == 'c' ? (((1L << 1) | (1L << 2)) | (1L << 5)) :
                           o->valtype == 'E' ? (((1L << 1) | (1L << 2)) | (1L << 6)) :
                           o->valtype == 'F' ? ((1L << 1) | (1L << 2)) :
                           o->valtype == 'A' ? ((1L << 1) | (1L << 2) | (1L << 3)) :
                           ( (1L << 1) | (1L << 2) | (1L << 3) | (1L << 4) | (1L << 5) | (1L << 6) | (1L << 7) | (1L << 8) | (1L << 9) | (1L << 10) | (1L << 11)), &ival))
                break;
    ...
    if (unknown != 
# 1011 "../apps/lib/opt.c" 3 4
                  ((void *)0)
# 1011 "../apps/lib/opt.c"
                      ) {
        if (dunno != 
# 1012 "../apps/lib/opt.c" 3 4
                    ((void *)0)
# 1012 "../apps/lib/opt.c"
                        ) {
...
int opt_check_rest_arg(const char *expected)
{
    ...
    if (opt == 
# 1069 "../apps/lib/opt.c" 3 4
              ((void *)0) 
# 1069 "../apps/lib/opt.c"
                   || *opt == '\0') {
        if (expected == 
# 1070 "../apps/lib/opt.c" 3 4
                       ((void *)0)
# 1070 "../apps/lib/opt.c"
                           )
            return 1;
    ...
    if (expected != 
# 1075 "../apps/lib/opt.c" 3 4
                   ((void *)0)
# 1075 "../apps/lib/opt.c"
                       ) {
        opt = argv[opt_index + 1];
        if (opt == 
# 1077 "../apps/lib/opt.c" 3 4
                  ((void *)0) 
# 1077 "../apps/lib/opt.c"
                       || *opt == '\0')
            return 1;
...
static void opt_print(const OPTIONS *o, int doingparams, int width)
{
    ...
    linelen += (printlen > 0) ? printlen : 30;
