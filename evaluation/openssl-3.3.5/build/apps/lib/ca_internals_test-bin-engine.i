...
{
    ENGINE *e = 
# 30 "../apps/lib/engine.c" 3 4
               ((void *)0)
# 30 "../apps/lib/engine.c"
                   ;

    if ((e = ENGINE_by_id("dynamic")) != 
# 32 "../apps/lib/engine.c" 3 4
                                        ((void *)0)
# 32 "../apps/lib/engine.c"
                                            ) {
        if (!ENGINE_ctrl_cmd_string(e, "SO_PATH", engine, 0)
            || !ENGINE_ctrl_cmd_string(e, "LOAD", 
# 34 "../apps/lib/engine.c" 3 4
                                                 ((void *)0)
# 34 "../apps/lib/engine.c"
                                                     , 0)) {
            ENGINE_free(e);
            e = 
# 36 "../apps/lib/engine.c" 3 4
               ((void *)0)
# 36 "../apps/lib/engine.c"
                   ;
        }
    }
    return e;
...
{
    ENGINE *e = 
# 45 "../apps/lib/engine.c" 3 4
               ((void *)0)
# 45 "../apps/lib/engine.c"
                   ;


    if (id != 
# 48 "../apps/lib/engine.c" 3 4
             ((void *)0)
# 48 "../apps/lib/engine.c"
                 ) {
        if (strcmp(id, "auto") == 0) {
            BIO_printf(bio_err, "Enabling auto ENGINE support\n");
            ENGINE_register_all_complete();
            return 
# 52 "../apps/lib/engine.c" 3 4
                  ((void *)0)
# 52 "../apps/lib/engine.c"
                      ;
        }
        if ((e = ENGINE_by_id(id)) == 
# 54 "../apps/lib/engine.c" 3 4
                                     ((void *)0)
            
# 55 "../apps/lib/engine.c"
           && (e = try_load_engine(id)) == 
# 55 "../apps/lib/engine.c" 3 4
                                           ((void *)0)
# 55 "../apps/lib/engine.c"
                                               ) {
            ...
            return 
# 58 "../apps/lib/engine.c" 3 4
                  ((void *)0)
# 58 "../apps/lib/engine.c"
                      ;
        }
        if (debug)
            (void)ENGINE_ctrl(e, 1, 0, bio_err, 0);
        if (!ENGINE_ctrl_cmd(e, "SET_USER_INTERFACE", 0,
            ...
            ENGINE_free(e);
            return 
# 68 "../apps/lib/engine.c" 3 4
                  ((void *)0)
# 68 "../apps/lib/engine.c"
                      ;
        }
...
{
    char *new_uri = 
# 107 "../apps/lib/engine.c" 3 4
                   ((void *)0)
# 107 "../apps/lib/engine.c"
                       ;


    if (e == 
# 110 "../apps/lib/engine.c" 3 4
            ((void *)0)
# 110 "../apps/lib/engine.c"
                ) {
        BIO_printf(bio_err, "No engine specified for loading %s\n", desc);
    } else if (key_id == 
# 112 "../apps/lib/engine.c" 3 4
                        ((void *)0)
# 112 "../apps/lib/engine.c"
                            ) {
        BIO_printf(bio_err, "No engine key id specified for loading %s\n", desc);
    } else {
        const char *engineid = ENGINE_get_id(e);
        size_t uri_sz =
            sizeof("org.openssl.engine" ":") - 1
            + strlen(engineid)
            + 1
            + strlen(key_id)
            + 1
        ...
        new_uri = CRYPTO_malloc(uri_sz, "../apps/lib/engine.c", 124);
        if (new_uri != 
# 125 "../apps/lib/engine.c" 3 4
                      ((void *)0)
# 125 "../apps/lib/engine.c"
                          ) {
            OPENSSL_strlcpy(new_uri, "org.openssl.engine" ":", uri_sz);
...
int get_legacy_pkey_id(OSSL_LIB_CTX *libctx, const char *algname, ENGINE *e)
{
    const EVP_PKEY_ASN1_METHOD *ameth;
    ENGINE *tmpeng = 
# 141 "../apps/lib/engine.c" 3 4
                    ((void *)0)
# 141 "../apps/lib/engine.c"
                        ;
    int pkey_id = 0;
    ...
    if (ameth == 
# 150 "../apps/lib/engine.c" 3 4
                ((void *)0) 
# 150 "../apps/lib/engine.c"
                     && e != 
# 150 "../apps/lib/engine.c" 3 4
                             ((void *)0)
# 150 "../apps/lib/engine.c"
    ...
    if (tmpeng == 
# 155 "../apps/lib/engine.c" 3 4
                 ((void *)0)
# 155 "../apps/lib/engine.c"
                     )
        ameth = 
# 156 "../apps/lib/engine.c" 3 4
               ((void *)0)
# 156 "../apps/lib/engine.c"
                   ;

    ERR_pop_to_mark();
    if (ameth == 
# 159 "../apps/lib/engine.c" 3 4
                ((void *)0)
# 159 "../apps/lib/engine.c"
                    )
        return 0;

    EVP_PKEY_asn1_get0_info(&pkey_id, 
# 162 "../apps/lib/engine.c" 3 4
                                     ((void *)0)
# 162 "../apps/lib/engine.c"
                                         , 
# 162 "../apps/lib/engine.c" 3 4
                                           ((void *)0)
# 162 "../apps/lib/engine.c"
...
const EVP_MD *get_digest_from_engine(const char *name)
{
    ...
    if (eng != 
# 173 "../apps/lib/engine.c" 3 4
              ((void *)0)
# 173 "../apps/lib/engine.c"
                  ) {
        ENGINE_finish(eng);
    ...
    return 
# 178 "../apps/lib/engine.c" 3 4
          ((void *)0)
# 178 "../apps/lib/engine.c"
              ;
}
...
const EVP_CIPHER *get_cipher_from_engine(const char *name)
{
    ...
    if (eng != 
# 187 "../apps/lib/engine.c" 3 4
              ((void *)0)
# 187 "../apps/lib/engine.c"
                  ) {
        ENGINE_finish(eng);
    ...
    return 
# 192 "../apps/lib/engine.c" 3 4
          ((void *)0)
# 192 "../apps/lib/engine.c"
              ;
}
