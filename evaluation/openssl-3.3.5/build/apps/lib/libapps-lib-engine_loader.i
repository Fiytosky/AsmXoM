# 0 "../apps/lib/engine_loader.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../apps/lib/engine_loader.c"
# 17 "../apps/lib/engine_loader.c"
...
# 18 "../apps/lib/engine_loader.c" 2
# 37 "../apps/lib/engine_loader.c"
...
{
    OSSL_STORE_LOADER_CTX *ctx = CRYPTO_zalloc(sizeof(*ctx), "../apps/lib/engine_loader.c", 46);

    if (ctx != 
# 48 "../apps/lib/engine_loader.c" 3 4
              ((void *)0)
# 48 "../apps/lib/engine_loader.c"
                  ) {
        ctx->e = e;
        ctx->keyid = keyid;
    }
...
{
    if (ctx != 
# 57 "../apps/lib/engine_loader.c" 3 4
              ((void *)0)
# 57 "../apps/lib/engine_loader.c"
                  ) {
        ENGINE_free(ctx->e);
        CRYPTO_free(ctx->keyid, "../apps/lib/engine_loader.c", 59);
        CRYPTO_free(ctx, "../apps/lib/engine_loader.c", 60);
    }
}
                                          ...
                                          void *ui_data)
{
    const char *p = uri, *q;
    ENGINE *e = 
# 70 "../apps/lib/engine_loader.c" 3 4
               ((void *)0)
# 70 "../apps/lib/engine_loader.c"
                   ;
    char *keyid = 
# 71 "../apps/lib/engine_loader.c" 3 4
                 ((void *)0)
# 71 "../apps/lib/engine_loader.c"
                     ;
    OSSL_STORE_LOADER_CTX *ctx = 
# 72 "../apps/lib/engine_loader.c" 3 4
                                ((void *)0)
# 72 "../apps/lib/engine_loader.c"
                                    ;

    if (!((OPENSSL_strncasecmp(p, "org.openssl.engine" ":" "", sizeof("org.openssl.engine" ":") - 1) == 0) ? ((p) += sizeof("org.openssl.engine" ":") - 1, 1) : 0))
        return 
# 75 "../apps/lib/engine_loader.c" 3 4
              ((void *)0)
# 75 "../apps/lib/engine_loader.c"
                  ;


    q = strchr(p, ':');
    if (q != 
# 79 "../apps/lib/engine_loader.c" 3 4
            ((void *)0)
        
# 80 "../apps/lib/engine_loader.c"
       && p[0] != ':'
        && q[1] != '\0') {
        char engineid[256];
        ...
        keyid = CRYPTO_strdup(q + 1, "../apps/lib/engine_loader.c", 89);
    }

    if (e != 
# 92 "../apps/lib/engine_loader.c" 3 4
            ((void *)0) 
# 92 "../apps/lib/engine_loader.c"
                 && keyid != 
# 92 "../apps/lib/engine_loader.c" 3 4
                             ((void *)0)
# 92 "../apps/lib/engine_loader.c"
    ...
    if (ctx == 
# 95 "../apps/lib/engine_loader.c" 3 4
              ((void *)0)
# 95 "../apps/lib/engine_loader.c"
                  ) {
        CRYPTO_free(keyid, "../apps/lib/engine_loader.c", 96);
        ENGINE_free(e);
    }
...
{
    EVP_PKEY *pkey = 
# 117 "../apps/lib/engine_loader.c" 3 4
                    ((void *)0)
# 117 "../apps/lib/engine_loader.c"
                        , *pubkey = 
# 117 "../apps/lib/engine_loader.c" 3 4
                                    ((void *)0)
# 117 "../apps/lib/engine_loader.c"
...
# 118 "../apps/lib/engine_loader.c" 3 4
                           ((void *)0)
# 118 "../apps/lib/engine_loader.c"
                               ;
    ...
    if (ctx->loaded == 0) {
        if (ENGINE_init(ctx->e)) {
            ...
            if ((pkey == 
# 127 "../apps/lib/engine_loader.c" 3 4
                        ((void *)0) 
# 127 "../apps/lib/engine_loader.c"
                             && ctx->expected == 0)
                || ctx->expected == 3)
                pubkey =
    ...
    if (pubkey != 
# 138 "../apps/lib/engine_loader.c" 3 4
                 ((void *)0)
# 138 "../apps/lib/engine_loader.c"
                     )
        info = OSSL_STORE_INFO_new_PUBKEY(pubkey);
    else if (pkey != 
# 140 "../apps/lib/engine_loader.c" 3 4
                    ((void *)0)
# 140 "../apps/lib/engine_loader.c"
                        )
        info = OSSL_STORE_INFO_new_PKEY(pkey);
    if (info == 
# 142 "../apps/lib/engine_loader.c" 3 4
               ((void *)0)
# 142 "../apps/lib/engine_loader.c"
                   ) {
        EVP_PKEY_free(pkey);
...
# 167 "../apps/lib/engine_loader.c" 3 4
                               ((void *)0)
# 167 "../apps/lib/engine_loader.c"
                                   ;

    if ((loader = OSSL_STORE_LOADER_new(
# 169 "../apps/lib/engine_loader.c" 3 4
                                       ((void *)0)
# 169 "../apps/lib/engine_loader.c"
                                           , "org.openssl.engine")) == 
# 169 "../apps/lib/engine_loader.c" 3 4
                                                                ((void *)0)
        
# 170 "../apps/lib/engine_loader.c"
       || !OSSL_STORE_LOADER_set_open(loader, engine_open)
        ...
        loader = 
# 178 "../apps/lib/engine_loader.c" 3 4
                ((void *)0)
# 178 "../apps/lib/engine_loader.c"
                    ;
    }

    return loader != 
# 181 "../apps/lib/engine_loader.c" 3 4
                    ((void *)0)
# 181 "../apps/lib/engine_loader.c"
                        ;
}

void destroy_engine_loader(void)
{
    OSSL_STORE_LOADER *loader = OSSL_STORE_unregister_loader("org.openssl.engine");
    OSSL_STORE_LOADER_free(loader);
}
