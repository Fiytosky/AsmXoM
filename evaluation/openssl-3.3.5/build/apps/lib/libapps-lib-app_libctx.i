# 0 "../apps/lib/app_libctx.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../apps/lib/app_libctx.c"
# 9 "../apps/lib/app_libctx.c"
...
# 11 "../apps/lib/app_libctx.c" 2

static OSSL_LIB_CTX *app_libctx = 
# 12 "../apps/lib/app_libctx.c" 3 4
                                 ((void *)0)
# 12 "../apps/lib/app_libctx.c"
                                     ;
static const char *app_propq = 
# 13 "../apps/lib/app_libctx.c" 3 4
                              ((void *)0)
# 13 "../apps/lib/app_libctx.c"
                                  ;
...
OSSL_LIB_CTX *app_create_libctx(void)
{
    ...
    if (app_libctx == 
# 37 "../apps/lib/app_libctx.c" 3 4
                     ((void *)0)
# 37 "../apps/lib/app_libctx.c"
                         ) {
        if (!app_provider_load(
# 38 "../apps/lib/app_libctx.c" 3 4
                              ((void *)0)
# 38 "../apps/lib/app_libctx.c"
                                  , "null")) {
            opt_printf_stderr("Failed to create null provider\n");
            return 
# 40 "../apps/lib/app_libctx.c" 3 4
                  ((void *)0)
# 40 "../apps/lib/app_libctx.c"
                      ;
        }
        app_libctx = OSSL_LIB_CTX_new();
    }
    if (app_libctx == 
# 44 "../apps/lib/app_libctx.c" 3 4
                     ((void *)0)
# 44 "../apps/lib/app_libctx.c"
                         )
