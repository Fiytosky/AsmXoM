# 0 "../apps/lib/cmp_mock_srv.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../apps/lib/cmp_mock_srv.c"
# 11 "../apps/lib/cmp_mock_srv.c"
...
# 124 "../include/internal/sockets.h" 2
...
# 12 "../apps/include/engine_loader.h"
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) int OSSL_STORE_ctrl(OSSL_STORE_CTX *ctx, int cmd,
                                          ... );
__attribute__((deprecated("Since OpenSSL " "3.0"))) int OSSL_STORE_vctrl(OSSL_STORE_CTX *ctx, int cmd,
                                           va_list args);
...
int OSSL_STORE_do_all_loaders(void (*do_function)(const OSSL_STORE_LOADER *loader,
                                                  void *do_arg),
                              void *do_arg);
# 13 "../apps/include/engine_loader.h" 2
...
# 12 "../apps/lib/cmp_mock_srv.c" 2
# 1 "../apps/include/cmp_mock_srv.h" 1
# 17 "../apps/include/cmp_mock_srv.h"
...
# 18 "../apps/include/cmp_mock_srv.h" 2
...
typedef struct
{
    ...
    struct stack_st_X509 *caPubsOut;
    X509 *newWithNew;
    X509 *newWithOld;
    X509 *oldWithNew;
...
{
    if (ctx == 
# 38 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0)
# 38 "../apps/lib/cmp_mock_srv.c"
                  )
        return;
    ...
    CRYPTO_free(ctx, "../apps/lib/cmp_mock_srv.c", 47);
}

static mock_srv_ctx *mock_srv_ctx_new(void)
{
    mock_srv_ctx *ctx = CRYPTO_zalloc(sizeof(mock_srv_ctx), "../apps/lib/cmp_mock_srv.c", 52);

    if (ctx == 
# 54 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0)
# 54 "../apps/lib/cmp_mock_srv.c"
                  )
        goto err;

    if ((ctx->statusOut = OSSL_CMP_PKISI_new()) == 
# 57 "../apps/lib/cmp_mock_srv.c" 3 4
                                                  ((void *)0)
# 57 "../apps/lib/cmp_mock_srv.c"
                                                      )
        goto err;
 ...
 err:
    ...
    return 
# 66 "../apps/lib/cmp_mock_srv.c" 3 4
          ((void *)0)
# 66 "../apps/lib/cmp_mock_srv.c"
              ;
}
# 87 "../apps/lib/cmp_mock_srv.c"
int ossl_cmp_mock_srv_set1_refCert(OSSL_CMP_SRV_CTX *srv_ctx, X509 *cert) { mock_srv_ctx *ctx = OSSL_CMP_SRV_CTX_get0_custom_ctx(srv_ctx); if (ctx == 
# 87 "../apps/lib/cmp_mock_srv.c" 3 4
((void *)0)
# 87 "../apps/lib/cmp_mock_srv.c"
) { (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",87,__func__), ERR_set_error)((58),(103),
# 87 "../apps/lib/cmp_mock_srv.c" 3 4
((void *)0)
# 87 "../apps/lib/cmp_mock_srv.c"
); return 0; } if (cert == 
...
((void *)0) 
# 87 "../apps/lib/cmp_mock_srv.c"
|| X509_up_ref(cert)) { X509_free(ctx->refCert); ctx->refCert = cert; return 1; } return 0; }
int ossl_cmp_mock_srv_set1_certOut(OSSL_CMP_SRV_CTX *srv_ctx, X509 *cert) { mock_srv_ctx *ctx = OSSL_CMP_SRV_CTX_get0_custom_ctx(srv_ctx); if (ctx == 
# 88 "../apps/lib/cmp_mock_srv.c" 3 4
((void *)0)
# 88 "../apps/lib/cmp_mock_srv.c"
) { (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",88,__func__), ERR_set_error)((58),(103),
# 88 "../apps/lib/cmp_mock_srv.c" 3 4
((void *)0)
# 88 "../apps/lib/cmp_mock_srv.c"
); return 0; } if (cert == 
...
((void *)0) 
# 88 "../apps/lib/cmp_mock_srv.c"
|| X509_up_ref(cert)) { X509_free(ctx->certOut); ctx->certOut = cert; return 1; } return 0; }

int ossl_cmp_mock_srv_set1_chainOut(OSSL_CMP_SRV_CTX *srv_ctx,
                                    struct stack_st_X509 *chain)
{
    mock_srv_ctx *ctx = OSSL_CMP_SRV_CTX_get0_custom_ctx(srv_ctx);
    struct stack_st_X509 *chain_copy = 
# 94 "../apps/lib/cmp_mock_srv.c" 3 4
                                ((void *)0)
# 94 "../apps/lib/cmp_mock_srv.c"
                                    ;

    if (ctx == 
# 96 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0)
# 96 "../apps/lib/cmp_mock_srv.c"
                  ) {
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",97,__func__), ERR_set_error)((58),(103),
# 97 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 97 "../apps/lib/cmp_mock_srv.c"
       );
        return 0;
    }
    if (chain != 
# 100 "../apps/lib/cmp_mock_srv.c" 3 4
                ((void *)0) 
# 100 "../apps/lib/cmp_mock_srv.c"
                     && (chain_copy = X509_chain_up_ref(chain)) == 
# 100 "../apps/lib/cmp_mock_srv.c" 3 4
                                                                   ((void *)0)
# 100 "../apps/lib/cmp_mock_srv.c"
                                                                       )
...
{
    mock_srv_ctx *ctx = OSSL_CMP_SRV_CTX_get0_custom_ctx(srv_ctx);
    struct stack_st_X509 *caPubs_copy = 
# 111 "../apps/lib/cmp_mock_srv.c" 3 4
                                 ((void *)0)
# 111 "../apps/lib/cmp_mock_srv.c"
                                     ;

    if (ctx == 
# 113 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0)
# 113 "../apps/lib/cmp_mock_srv.c"
                  ) {
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",114,__func__), ERR_set_error)((58),(103),
# 114 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 114 "../apps/lib/cmp_mock_srv.c"
       );
        return 0;
    }
    if (caPubs != 
# 117 "../apps/lib/cmp_mock_srv.c" 3 4
                 ((void *)0) 
# 117 "../apps/lib/cmp_mock_srv.c"
                      && (caPubs_copy = X509_chain_up_ref(caPubs)) == 
# 117 "../apps/lib/cmp_mock_srv.c" 3 4
                                                                      ((void *)0)
# 117 "../apps/lib/cmp_mock_srv.c"
                                                                          )
...
int ossl_cmp_mock_srv_set1_newWithNew(OSSL_CMP_SRV_CTX *srv_ctx, X509 *cert) { mock_srv_ctx *ctx = OSSL_CMP_SRV_CTX_get0_custom_ctx(srv_ctx); if (ctx == 
# 124 "../apps/lib/cmp_mock_srv.c" 3 4
((void *)0)
# 124 "../apps/lib/cmp_mock_srv.c"
) { (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",124,__func__), ERR_set_error)((58),(103),
# 124 "../apps/lib/cmp_mock_srv.c" 3 4
((void *)0)
# 124 "../apps/lib/cmp_mock_srv.c"
); return 0; } if (cert == 
...
((void *)0) 
# 124 "../apps/lib/cmp_mock_srv.c"
|| X509_up_ref(cert)) { X509_free(ctx->newWithNew); ctx->newWithNew = cert; return 1; } return 0; }
int ossl_cmp_mock_srv_set1_newWithOld(OSSL_CMP_SRV_CTX *srv_ctx, X509 *cert) { mock_srv_ctx *ctx = OSSL_CMP_SRV_CTX_get0_custom_ctx(srv_ctx); if (ctx == 
# 125 "../apps/lib/cmp_mock_srv.c" 3 4
((void *)0)
# 125 "../apps/lib/cmp_mock_srv.c"
) { (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",125,__func__), ERR_set_error)((58),(103),
# 125 "../apps/lib/cmp_mock_srv.c" 3 4
((void *)0)
# 125 "../apps/lib/cmp_mock_srv.c"
); return 0; } if (cert == 
...
((void *)0) 
# 125 "../apps/lib/cmp_mock_srv.c"
|| X509_up_ref(cert)) { X509_free(ctx->newWithOld); ctx->newWithOld = cert; return 1; } return 0; }
int ossl_cmp_mock_srv_set1_oldWithNew(OSSL_CMP_SRV_CTX *srv_ctx, X509 *cert) { mock_srv_ctx *ctx = OSSL_CMP_SRV_CTX_get0_custom_ctx(srv_ctx); if (ctx == 
# 126 "../apps/lib/cmp_mock_srv.c" 3 4
((void *)0)
# 126 "../apps/lib/cmp_mock_srv.c"
) { (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",126,__func__), ERR_set_error)((58),(103),
# 126 "../apps/lib/cmp_mock_srv.c" 3 4
((void *)0)
# 126 "../apps/lib/cmp_mock_srv.c"
); return 0; } if (cert == 
...
((void *)0) 
# 126 "../apps/lib/cmp_mock_srv.c"
|| X509_up_ref(cert)) { X509_free(ctx->oldWithNew); ctx->oldWithNew = cert; return 1; } return 0; }
                                     ...
                                     int fail_info, const char *text)
{
    ...
    if (ctx == 
# 134 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0)
# 134 "../apps/lib/cmp_mock_srv.c"
                  ) {
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",135,__func__), ERR_set_error)((58),(103),
# 135 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 135 "../apps/lib/cmp_mock_srv.c"
       );
        return 0;
    }
    if ((si = OSSL_CMP_STATUSINFO_new(status, fail_info, text)) == 
# 138 "../apps/lib/cmp_mock_srv.c" 3 4
                                                                  ((void *)0)
# 138 "../apps/lib/cmp_mock_srv.c"
                                                                      )
        return 0;
    OSSL_CMP_PKISI_free(ctx->statusOut);
    ctx->statusOut = si;
...
int ossl_cmp_mock_srv_set_sendError(OSSL_CMP_SRV_CTX *srv_ctx, int bodytype)
{
    ...
    if (ctx == 
# 149 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0)
# 149 "../apps/lib/cmp_mock_srv.c"
                  ) {
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",150,__func__), ERR_set_error)((58),(103),
# 150 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 150 "../apps/lib/cmp_mock_srv.c"
       );
        return 0;
    }
...
int ossl_cmp_mock_srv_set_pollCount(OSSL_CMP_SRV_CTX *srv_ctx, int count)
{
    ...
    if (ctx == 
# 162 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0)
# 162 "../apps/lib/cmp_mock_srv.c"
                  ) {
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",163,__func__), ERR_set_error)((58),(103),
# 163 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 163 "../apps/lib/cmp_mock_srv.c"
       );
        return 0;
    }
    if (count < 0) {
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",167,__func__), ERR_set_error)((58),(100),
# 167 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 167 "../apps/lib/cmp_mock_srv.c"
       );
        return 0;
    }
    ctx->pollCount = count;
...
int ossl_cmp_mock_srv_set_checkAfterTime(OSSL_CMP_SRV_CTX *srv_ctx, int sec)
{
    ...
    if (ctx == 
# 178 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0)
# 178 "../apps/lib/cmp_mock_srv.c"
                  ) {
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",179,__func__), ERR_set_error)((58),(103),
# 179 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 179 "../apps/lib/cmp_mock_srv.c"
       );
        return 0;
    }
...
static int delayed_delivery(OSSL_CMP_SRV_CTX *srv_ctx, const OSSL_CMP_MSG *req)
{
    ...
    if (ctx == 
# 192 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0) 
# 192 "../apps/lib/cmp_mock_srv.c"
                   || req == 
# 192 "../apps/lib/cmp_mock_srv.c" 3 4
                             ((void *)0)
# 192 "../apps/lib/cmp_mock_srv.c"
                                 ) {
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",193,__func__), ERR_set_error)((58),(103),
# 193 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 193 "../apps/lib/cmp_mock_srv.c"
       );
        return -1;
    }
    ...
    if (ctx->pollCount > 0 && ctx->curr_pollCount == 0) {
        ...
        if ((ctx->req = OSSL_CMP_MSG_dup(req)) == 
# 211 "../apps/lib/cmp_mock_srv.c" 3 4
                                                 ((void *)0)
# 211 "../apps/lib/cmp_mock_srv.c"
                                                     )
            return -1;
        return 1;
    }
                       ...
                       const X509_NAME *issuer, const ASN1_INTEGER *serial)
{
    ...
    if (refcert == 
# 225 "../apps/lib/cmp_mock_srv.c" 3 4
                  ((void *)0)
# 225 "../apps/lib/cmp_mock_srv.c"
                      )
        return 1;
    ref_issuer = X509_get_issuer_name(refcert);
    ref_serial = X509_get0_serialNumber(refcert);
    return (ref_issuer == 
# 229 "../apps/lib/cmp_mock_srv.c" 3 4
                         ((void *)0) 
# 229 "../apps/lib/cmp_mock_srv.c"
                              || X509_NAME_cmp(issuer, ref_issuer) == 0)
        && (ref_serial == 
# 230 "../apps/lib/cmp_mock_srv.c" 3 4
                         ((void *)0) 
# 230 "../apps/lib/cmp_mock_srv.c"
                              || ASN1_INTEGER_cmp(serial, ref_serial) == 0);
}


static int clean_transaction(OSSL_CMP_SRV_CTX *srv_ctx,
                             __attribute__((unused)) const ASN1_OCTET_STRING *id)
{
    mock_srv_ctx *ctx = OSSL_CMP_SRV_CTX_get0_custom_ctx(srv_ctx);

    if (ctx == 
# 239 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0)
# 239 "../apps/lib/cmp_mock_srv.c"
                  ) {
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",240,__func__), ERR_set_error)((58),(103),
# 240 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 240 "../apps/lib/cmp_mock_srv.c"
       );
        return 0;
    }
    ...
    OSSL_CMP_MSG_free(ctx->req);
    ctx->req = 
# 246 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0)
# 246 "../apps/lib/cmp_mock_srv.c"
                  ;
    return 1;
}
...
static OSSL_CMP_PKISI *process_cert_request(OSSL_CMP_SRV_CTX *srv_ctx,
                                            ...
                                            __attribute__((unused)) int certReqId,
                                            const OSSL_CRMF_MSG *crm,
                                            ...
                                            struct stack_st_X509 **caPubs)
{
    ...
    int bodytype;
    OSSL_CMP_PKISI *si = 
# 261 "../apps/lib/cmp_mock_srv.c" 3 4
                        ((void *)0)
# 261 "../apps/lib/cmp_mock_srv.c"
                            ;

    if (ctx == 
# 263 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0) 
# 263 "../apps/lib/cmp_mock_srv.c"
                   || cert_req == 
# 263 "../apps/lib/cmp_mock_srv.c" 3 4
                                  ((void *)0)
            
# 264 "../apps/lib/cmp_mock_srv.c"
           || certOut == 
# 264 "../apps/lib/cmp_mock_srv.c" 3 4
                         ((void *)0) 
# 264 "../apps/lib/cmp_mock_srv.c"
                              || chainOut == 
# 264 "../apps/lib/cmp_mock_srv.c" 3 4
...
# 264 "../apps/lib/cmp_mock_srv.c"
        ...
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",265,__func__), ERR_set_error)((58),(103),
# 265 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 265 "../apps/lib/cmp_mock_srv.c"
       );
        return 
# 266 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0)
# 266 "../apps/lib/cmp_mock_srv.c"
                  ;
    }
    bodytype = OSSL_CMP_MSG_get_bodytype(cert_req);
    if (ctx->sendError == 1 || ctx->sendError == bodytype) {
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",270,__func__), ERR_set_error)((58),(158),
# 270 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 270 "../apps/lib/cmp_mock_srv.c"
       );
        return 
# 271 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0)
# 271 "../apps/lib/cmp_mock_srv.c"
                  ;
    }

    *certOut = 
# 274 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0)
# 274 "../apps/lib/cmp_mock_srv.c"
                  ;
    *chainOut = 
# 275 "../apps/lib/cmp_mock_srv.c" 3 4
               ((void *)0)
# 275 "../apps/lib/cmp_mock_srv.c"
                   ;
    *caPubs = 
# 276 "../apps/lib/cmp_mock_srv.c" 3 4
             ((void *)0)
# 276 "../apps/lib/cmp_mock_srv.c"
                 ;

    if (ctx->pollCount > 0 && ctx->curr_pollCount == 0) {

        if ((ctx->req = OSSL_CMP_MSG_dup(cert_req)) == 
# 280 "../apps/lib/cmp_mock_srv.c" 3 4
                                                      ((void *)0)
# 280 "../apps/lib/cmp_mock_srv.c"
                                                          )
            return 
# 281 "../apps/lib/cmp_mock_srv.c" 3 4
                  ((void *)0)
# 281 "../apps/lib/cmp_mock_srv.c"
                      ;
        return OSSL_CMP_STATUSINFO_new(3, 0, 
# 282 "../apps/lib/cmp_mock_srv.c" 3 4
                                                                     ((void *)0)
# 282 "../apps/lib/cmp_mock_srv.c"
                                                                         );
    }
    ...
    if (OSSL_CMP_MSG_get_bodytype(cert_req) == 2) {
        ...
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OSSL_CMP_ITAV_sk_type(itavs)); i++) {
            OSSL_CMP_ITAV *itav = ((OSSL_CMP_ITAV *)OPENSSL_sk_value(ossl_check_const_OSSL_CMP_ITAV_sk_type(itavs), (i)));
            ASN1_OBJECT *obj = OSSL_CMP_ITAV_get0_type(itav);
            struct stack_st_ASN1_UTF8STRING *strs;
            ASN1_UTF8STRING *str;
            const char *data;

            if (OBJ_obj2nid(obj) == 1255) {
                if (!OSSL_CMP_ITAV_get0_certProfile(itav, &strs))
                    return 
# 303 "../apps/lib/cmp_mock_srv.c" 3 4
                          ((void *)0)
# 303 "../apps/lib/cmp_mock_srv.c"
                              ;
                if (OPENSSL_sk_num(ossl_check_const_ASN1_UTF8STRING_sk_type(strs)) < 1) {
                    (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",305,__func__), ERR_set_error)((58),(196),
# 305 "../apps/lib/cmp_mock_srv.c" 3 4
                   ((void *)0)
# 305 "../apps/lib/cmp_mock_srv.c"
                   );
                    return 
# 306 "../apps/lib/cmp_mock_srv.c" 3 4
                          ((void *)0)
# 306 "../apps/lib/cmp_mock_srv.c"
                              ;
                }
                str = ((ASN1_UTF8STRING *)OPENSSL_sk_value(ossl_check_const_ASN1_UTF8STRING_sk_type(strs), (0)));
                if (str == 
# 309 "../apps/lib/cmp_mock_srv.c" 3 4
                          ((void *)0)
                    
# 310 "../apps/lib/cmp_mock_srv.c"
                   || (data =
                        (const char *)ASN1_STRING_get0_data(str)) == 
# 311 "../apps/lib/cmp_mock_srv.c" 3 4
                                                                    ((void *)0)
# 311 "../apps/lib/cmp_mock_srv.c"
                                                                        ) {
                    (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",312,__func__), ERR_set_error)((58),((262|(0x2 << 18L))),
# 312 "../apps/lib/cmp_mock_srv.c" 3 4
                   ((void *)0)
# 312 "../apps/lib/cmp_mock_srv.c"
                   );
                    return 
# 313 "../apps/lib/cmp_mock_srv.c" 3 4
                          ((void *)0)
# 313 "../apps/lib/cmp_mock_srv.c"
                              ;
                }
                if (strcmp(data, "profile1") != 0) {
                    (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",316,__func__), ERR_set_error)((58),(196),
# 316 "../apps/lib/cmp_mock_srv.c" 3 4
                   ((void *)0)
# 316 "../apps/lib/cmp_mock_srv.c"
                   );
                    return 
# 317 "../apps/lib/cmp_mock_srv.c" 3 4
                          ((void *)0)
# 317 "../apps/lib/cmp_mock_srv.c"
                              ;
                }
                break;
            }
    ...
    if (bodytype == 7
            && crm != 
# 326 "../apps/lib/cmp_mock_srv.c" 3 4
                     ((void *)0) 
# 326 "../apps/lib/cmp_mock_srv.c"
                                               && ctx->refCert != 
# 326 "../apps/lib/cmp_mock_srv.c" 3 4
                                                                  ((void *)0)
# 326 "../apps/lib/cmp_mock_srv.c"
        ...
        if (cid == 
# 329 "../apps/lib/cmp_mock_srv.c" 3 4
                  ((void *)0)
# 329 "../apps/lib/cmp_mock_srv.c"
                      ) {
            (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",330,__func__), ERR_set_error)((58),(165),
# 330 "../apps/lib/cmp_mock_srv.c" 3 4
           ((void *)0)
# 330 "../apps/lib/cmp_mock_srv.c"
           );
            return 
# 331 "../apps/lib/cmp_mock_srv.c" 3 4
                  ((void *)0)
# 331 "../apps/lib/cmp_mock_srv.c"
                      ;
        }
        if (!refcert_cmp(ctx->refCert,
                         OSSL_CRMF_CERTID_get0_issuer(cid),
                         OSSL_CRMF_CERTID_get0_serialNumber(cid))) {
            (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",336,__func__), ERR_set_error)((58),(189),
# 336 "../apps/lib/cmp_mock_srv.c" 3 4
           ((void *)0)
# 336 "../apps/lib/cmp_mock_srv.c"
           );
            return 
# 337 "../apps/lib/cmp_mock_srv.c" 3 4
                  ((void *)0)
# 337 "../apps/lib/cmp_mock_srv.c"
                      ;
        }
    }

    if (ctx->certOut != 
# 341 "../apps/lib/cmp_mock_srv.c" 3 4
                       ((void *)0)
            
# 342 "../apps/lib/cmp_mock_srv.c"
           && (*certOut = X509_dup(ctx->certOut)) == 
# 342 "../apps/lib/cmp_mock_srv.c" 3 4
                                                     ((void *)0)
# 342 "../apps/lib/cmp_mock_srv.c"
                                                         )
        ...
        goto err;
    if (ctx->chainOut != 
# 345 "../apps/lib/cmp_mock_srv.c" 3 4
                        ((void *)0)
            
# 346 "../apps/lib/cmp_mock_srv.c"
           && (*chainOut = X509_chain_up_ref(ctx->chainOut)) == 
# 346 "../apps/lib/cmp_mock_srv.c" 3 4
                                                                ((void *)0)
# 346 "../apps/lib/cmp_mock_srv.c"
                                                                    )
        goto err;
    if (ctx->caPubsOut != 
# 348 "../apps/lib/cmp_mock_srv.c" 3 4
                         ((void *)0)
            
# 349 "../apps/lib/cmp_mock_srv.c"
           && (*caPubs = X509_chain_up_ref(ctx->caPubsOut)) == 
# 349 "../apps/lib/cmp_mock_srv.c" 3 4
                                                               ((void *)0)
# 349 "../apps/lib/cmp_mock_srv.c"
                                                                   )
        goto err;
    if (ctx->statusOut != 
# 351 "../apps/lib/cmp_mock_srv.c" 3 4
                         ((void *)0)
            
# 352 "../apps/lib/cmp_mock_srv.c"
           && (si = OSSL_CMP_PKISI_dup(ctx->statusOut)) == 
# 352 "../apps/lib/cmp_mock_srv.c" 3 4
                                                           ((void *)0)
# 352 "../apps/lib/cmp_mock_srv.c"
                                                               )
        goto err;
 ...
 err:
    X509_free(*certOut);
    *certOut = 
# 358 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0)
# 358 "../apps/lib/cmp_mock_srv.c"
                  ;
    OSSL_STACK_OF_X509_free(*chainOut);
    *chainOut = 
# 360 "../apps/lib/cmp_mock_srv.c" 3 4
               ((void *)0)
# 360 "../apps/lib/cmp_mock_srv.c"
                   ;
    OSSL_STACK_OF_X509_free(*caPubs);
    *caPubs = 
# 362 "../apps/lib/cmp_mock_srv.c" 3 4
             ((void *)0)
# 362 "../apps/lib/cmp_mock_srv.c"
                 ;
    return 
# 363 "../apps/lib/cmp_mock_srv.c" 3 4
          ((void *)0)
# 363 "../apps/lib/cmp_mock_srv.c"
              ;
}
                                  ...
                                  const ASN1_INTEGER *serial)
{
    ...
    if (ctx == 
# 373 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0) 
# 373 "../apps/lib/cmp_mock_srv.c"
                   || rr == 
# 373 "../apps/lib/cmp_mock_srv.c" 3 4
                            ((void *)0)
# 373 "../apps/lib/cmp_mock_srv.c"
                                ) {
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",374,__func__), ERR_set_error)((58),(103),
# 374 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 374 "../apps/lib/cmp_mock_srv.c"
       );
        return 
# 375 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0)
# 375 "../apps/lib/cmp_mock_srv.c"
                  ;
    }
    if (ctx->sendError == 1
            || ctx->sendError == OSSL_CMP_MSG_get_bodytype(rr)) {
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",379,__func__), ERR_set_error)((58),(158),
# 379 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 379 "../apps/lib/cmp_mock_srv.c"
       );
        return 
# 380 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0)
# 380 "../apps/lib/cmp_mock_srv.c"
                  ;
    }


    if ((issuer != 
# 384 "../apps/lib/cmp_mock_srv.c" 3 4
                  ((void *)0) 
# 384 "../apps/lib/cmp_mock_srv.c"
                       || serial != 
# 384 "../apps/lib/cmp_mock_srv.c" 3 4
                                    ((void *)0)
# 384 "../apps/lib/cmp_mock_srv.c"
        ...
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",387,__func__), ERR_set_error)(58, 149,
                       "wrong certificate to revoke");
        return 
# 389 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0)
# 389 "../apps/lib/cmp_mock_srv.c"
                  ;
    }
                                        ...
                                        const OSSL_CMP_ITAV *req)
{
    ...
    case 1254:
        {
            X509 *rootcacert = 
# 405 "../apps/lib/cmp_mock_srv.c" 3 4
                              ((void *)0)
# 405 "../apps/lib/cmp_mock_srv.c"
                                  ;

            if (!OSSL_CMP_ITAV_get0_rootCaCert(req, &rootcacert))
                return 
# 408 "../apps/lib/cmp_mock_srv.c" 3 4
                      ((void *)0)
# 408 "../apps/lib/cmp_mock_srv.c"
                          ;

            if (rootcacert != 
# 410 "../apps/lib/cmp_mock_srv.c" 3 4
                             ((void *)0)
                
# 411 "../apps/lib/cmp_mock_srv.c"
...
# 414 "../apps/lib/cmp_mock_srv.c" 3 4
                                                       ((void *)0)
# 414 "../apps/lib/cmp_mock_srv.c"
                                                           , 
# 414 "../apps/lib/cmp_mock_srv.c" 3 4
                                                             ((void *)0)
# 414 "../apps/lib/cmp_mock_srv.c"
                        ...
                        struct stack_st_OSSL_CMP_ITAV **out)
{
    ...
    if (ctx == 
# 434 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0) 
# 434 "../apps/lib/cmp_mock_srv.c"
                   || genm == 
# 434 "../apps/lib/cmp_mock_srv.c" 3 4
                              ((void *)0) 
# 434 "../apps/lib/cmp_mock_srv.c"
...
# 434 "../apps/lib/cmp_mock_srv.c"
        ...
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",435,__func__), ERR_set_error)((58),(103),
# 435 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 435 "../apps/lib/cmp_mock_srv.c"
       );
        return 0;
    }
    if (ctx->sendError == 1
            || ctx->sendError == OSSL_CMP_MSG_get_bodytype(genm)
            || OPENSSL_sk_num(ossl_check_const_OSSL_CMP_ITAV_sk_type(in)) > 1) {
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",441,__func__), ERR_set_error)((58),(158),
# 441 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 441 "../apps/lib/cmp_mock_srv.c"
       );
        return 0;
    }
    if (OPENSSL_sk_num(ossl_check_const_OSSL_CMP_ITAV_sk_type(in)) == 1) {
        OSSL_CMP_ITAV *req = ((OSSL_CMP_ITAV *)OPENSSL_sk_value(ossl_check_const_OSSL_CMP_ITAV_sk_type(in), (0))), *rsp;
        ASN1_OBJECT *obj = OSSL_CMP_ITAV_get0_type(req);

        if ((*out = ((struct stack_st_OSSL_CMP_ITAV *)OPENSSL_sk_new_reserve(ossl_check_OSSL_CMP_ITAV_compfunc_type(
# 448 "../apps/lib/cmp_mock_srv.c" 3 4
                   ((void *)0)
# 448 "../apps/lib/cmp_mock_srv.c"
                   ), (1)))) == 
# 448 "../apps/lib/cmp_mock_srv.c" 3 4
                                                             ((void *)0)
# 448 "../apps/lib/cmp_mock_srv.c"
        ...
        if (rsp != 
# 451 "../apps/lib/cmp_mock_srv.c" 3 4
                  ((void *)0) 
# 451 "../apps/lib/cmp_mock_srv.c"
                       && OPENSSL_sk_push(ossl_check_OSSL_CMP_ITAV_sk_type(*out), ossl_check_OSSL_CMP_ITAV_type(rsp)))
            return 1;
        OPENSSL_sk_free(ossl_check_OSSL_CMP_ITAV_sk_type(*out));
        return 0;
    }

    *out = ((struct stack_st_OSSL_CMP_ITAV *)OPENSSL_sk_deep_copy(ossl_check_const_OSSL_CMP_ITAV_sk_type(in), ossl_check_OSSL_CMP_ITAV_copyfunc_type(OSSL_CMP_ITAV_dup), ossl_check_OSSL_CMP_ITAV_freefunc_type(OSSL_CMP_ITAV_free)))
                                                         ;
    return *out != 
# 459 "../apps/lib/cmp_mock_srv.c" 3 4
                  ((void *)0)
# 459 "../apps/lib/cmp_mock_srv.c"
                      ;
}
                          ...
                          const OSSL_CMP_PKIFREETEXT *errorDetails)
{
    ...
    if (ctx == 
# 472 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0) 
# 472 "../apps/lib/cmp_mock_srv.c"
                   || error == 
# 472 "../apps/lib/cmp_mock_srv.c" 3 4
                               ((void *)0)
# 472 "../apps/lib/cmp_mock_srv.c"
                                   ) {
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",473,__func__), ERR_set_error)((58),(103),
# 473 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 473 "../apps/lib/cmp_mock_srv.c"
       );
        return;
    }
    ...
    if (statusInfo == 
# 479 "../apps/lib/cmp_mock_srv.c" 3 4
                     ((void *)0)
# 479 "../apps/lib/cmp_mock_srv.c"
                         ) {
        ...
        BIO_printf(bio_err, "pkiStatusInfo: %s\n",
                   sibuf != 
# 484 "../apps/lib/cmp_mock_srv.c" 3 4
                           ((void *)0) 
# 484 "../apps/lib/cmp_mock_srv.c"
                                ? sibuf: "<invalid>");
    }

    if (errorCode == 
# 487 "../apps/lib/cmp_mock_srv.c" 3 4
                    ((void *)0)
# 487 "../apps/lib/cmp_mock_srv.c"
                        )
        BIO_printf(bio_err, "errorCode absent\n");
    else
        BIO_printf(bio_err, "errorCode: %ld\n", ASN1_INTEGER_get(errorCode));

    if (OPENSSL_sk_num(ossl_check_const_ASN1_UTF8STRING_sk_type(errorDetails)) <= 0) {
        BIO_printf(bio_err, "errorDetails absent\n");
    } else {
        BIO_printf(bio_err, "errorDetails: ");
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ASN1_UTF8STRING_sk_type(errorDetails)); i++) {
            if (i > 0)
                BIO_printf(bio_err, ", ");
            ASN1_STRING_print_ex(bio_err,
                                 ((ASN1_UTF8STRING *)OPENSSL_sk_value(ossl_check_const_ASN1_UTF8STRING_sk_type(errorDetails), (i))),
                                 8);
        }
        BIO_printf(bio_err, "\n");
    }
                            ...
                            const OSSL_CMP_PKISI *si)
{
    ...
    if (ctx == 
# 516 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0) 
# 516 "../apps/lib/cmp_mock_srv.c"
                   || certConf == 
# 516 "../apps/lib/cmp_mock_srv.c" 3 4
                                  ((void *)0) 
# 516 "../apps/lib/cmp_mock_srv.c"
...
# 516 "../apps/lib/cmp_mock_srv.c"
        ...
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",517,__func__), ERR_set_error)((58),(103),
# 517 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 517 "../apps/lib/cmp_mock_srv.c"
       );
        return 0;
    }
    if (ctx->sendError == 1
            ...
            || ctx->certOut == 
# 522 "../apps/lib/cmp_mock_srv.c" 3 4
                              ((void *)0)
# 522 "../apps/lib/cmp_mock_srv.c"
                                  ) {
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",523,__func__), ERR_set_error)((58),(158),
# 523 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 523 "../apps/lib/cmp_mock_srv.c"
       );
        return 0;
    }

    if ((digest = X509_digest_sig(ctx->certOut, 
# 527 "../apps/lib/cmp_mock_srv.c" 3 4
                                               ((void *)0)
# 527 "../apps/lib/cmp_mock_srv.c"
                                                   , 
# 527 "../apps/lib/cmp_mock_srv.c" 3 4
                                                     ((void *)0)
# 527 "../apps/lib/cmp_mock_srv.c"
...
# 527 "../apps/lib/cmp_mock_srv.c"
    ...
    if (ASN1_OCTET_STRING_cmp(certHash, digest) != 0) {
        ...
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",531,__func__), ERR_set_error)((58),(156),
# 531 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 531 "../apps/lib/cmp_mock_srv.c"
       );
        return 0;
    }
    ASN1_OCTET_STRING_free(digest);
                           ...
                           OSSL_CMP_MSG **req, int64_t *check_after)
{
    ...
    if (req != 
# 546 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0)
# 546 "../apps/lib/cmp_mock_srv.c"
                  )
        *req = 
# 547 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0)
# 547 "../apps/lib/cmp_mock_srv.c"
                  ;
    if (ctx == 
# 548 "../apps/lib/cmp_mock_srv.c" 3 4
              ((void *)0) 
# 548 "../apps/lib/cmp_mock_srv.c"
                   || pollReq == 
# 548 "../apps/lib/cmp_mock_srv.c" 3 4
                                 ((void *)0)
            
# 549 "../apps/lib/cmp_mock_srv.c"
           || req == 
# 549 "../apps/lib/cmp_mock_srv.c" 3 4
                     ((void *)0) 
# 549 "../apps/lib/cmp_mock_srv.c"
                          || check_after == 
# 549 "../apps/lib/cmp_mock_srv.c" 3 4
...
# 549 "../apps/lib/cmp_mock_srv.c"
        ...
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",550,__func__), ERR_set_error)((58),(103),
# 550 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 550 "../apps/lib/cmp_mock_srv.c"
       );
        return 0;
    }
    ...
    if (ctx->sendError == 1
        ...
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",556,__func__), ERR_set_error)((58),(158),
# 556 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 556 "../apps/lib/cmp_mock_srv.c"
       );
        return 0;
    }
    if (ctx->req == 
# 559 "../apps/lib/cmp_mock_srv.c" 3 4
                   ((void *)0)
# 559 "../apps/lib/cmp_mock_srv.c"
                       ) {
        (ERR_new(), ERR_set_debug("../apps/lib/cmp_mock_srv.c",560,__func__), ERR_set_error)((58),(105),
# 560 "../apps/lib/cmp_mock_srv.c" 3 4
       ((void *)0)
# 560 "../apps/lib/cmp_mock_srv.c"
       );
        return 0;
    }
    ...
    if (++ctx->curr_pollCount >= ctx->pollCount) {
        ...
        *req = ctx->req;
        ctx->req = 
# 567 "../apps/lib/cmp_mock_srv.c" 3 4
                  ((void *)0)
# 567 "../apps/lib/cmp_mock_srv.c"
                      ;
        *check_after = 0;
    } else {
...
OSSL_CMP_SRV_CTX *ossl_cmp_mock_srv_new(OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if (srv_ctx != 
# 580 "../apps/lib/cmp_mock_srv.c" 3 4
                  ((void *)0) 
# 580 "../apps/lib/cmp_mock_srv.c"
                       && ctx != 
# 580 "../apps/lib/cmp_mock_srv.c" 3 4
                                 ((void *)0)
            
# 581 "../apps/lib/cmp_mock_srv.c"
    ...
    return 
# 590 "../apps/lib/cmp_mock_srv.c" 3 4
          ((void *)0)
# 590 "../apps/lib/cmp_mock_srv.c"
              ;
}
...
{
    if (srv_ctx != 
# 595 "../apps/lib/cmp_mock_srv.c" 3 4
                  ((void *)0)
# 595 "../apps/lib/cmp_mock_srv.c"
                      )
