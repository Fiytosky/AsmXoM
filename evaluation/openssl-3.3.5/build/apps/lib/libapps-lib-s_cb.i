...
# 18 "../apps/lib/s_cb.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 19 "../apps/lib/s_cb.c" 2
...
# 24 "../apps/lib/s_cb.c" 2




# 1 "../apps/include/s_apps.h" 1
# 13 "../apps/include/s_apps.h"
...
# 29 "../apps/lib/s_cb.c" 2



VERIFY_CB_ARGS verify_args = { -1, 0, 0, 0 };
...
# 159 "../apps/lib/s_cb.c"
    ...
    if (build_chain && !SSL_CTX_ctrl(ctx,105, chflags, 
# 186 "../apps/lib/s_cb.c" 3 4
                       ((void *)0)
# 186 "../apps/lib/s_cb.c"
                       )) {
...
static void ssl_print_client_cert_types(BIO *bio, SSL *s)
{
    ...
    for (i = 0; i < cert_type_num; i++) {
        ...
        const char *cname = lookup((int)cert_type, cert_type_list, 
# 218 "../apps/lib/s_cb.c" 3 4
                                                                  ((void *)0)
# 218 "../apps/lib/s_cb.c"
                                                                      );
...
static int do_print_sigalgs(BIO *out, SSL *s, int shared)
{
    ...
    if (shared)
        nsig = SSL_get_shared_sigalgs(s, 0, 
# 272 "../apps/lib/s_cb.c" 3 4
                                           ((void *)0)
# 272 "../apps/lib/s_cb.c"
                                               , 
# 272 "../apps/lib/s_cb.c" 3 4
...
# 272 "../apps/lib/s_cb.c"
        ...
        nsig = SSL_get_sigalgs(s, -1, 
# 274 "../apps/lib/s_cb.c" 3 4
                                     ((void *)0)
# 274 "../apps/lib/s_cb.c"
                                         , 
# 274 "../apps/lib/s_cb.c" 3 4
...
# 274 "../apps/lib/s_cb.c"
    ...
    for (i = 0; i < nsig; i++) {
        ...
        const char *sstr = 
# 287 "../apps/lib/s_cb.c" 3 4
                          ((void *)0)
# 287 "../apps/lib/s_cb.c"
                              ;
        if (shared)
            SSL_get_shared_sigalgs(s, i, &sign_nid, &hash_nid, 
# 289 "../apps/lib/s_cb.c" 3 4
                                                              ((void *)0)
# 289 "../apps/lib/s_cb.c"
                                                                  ,
                                   &rsign, &rhash);
        else
            SSL_get_sigalgs(s, i, &sign_nid, &hash_nid, 
# 292 "../apps/lib/s_cb.c" 3 4
                                                       ((void *)0)
# 292 "../apps/lib/s_cb.c"
                                                           , &rsign, &rhash);
        if (i)
...
int ssl_print_groups(BIO *out, SSL *s, int noshared)
{
    ...
    ngroups = SSL_ctrl(s,90,0,(int*)(
# 384 "../apps/lib/s_cb.c" 3 4
             ((void *)0)
# 384 "../apps/lib/s_cb.c"
             ));
    if (ngroups <= 0)
    ...
    CRYPTO_free(groups, "../apps/lib/s_cb.c", 397);
    if (noshared) {
        BIO_puts(out, "\n");
        return 1;
    }
    BIO_puts(out, "\nShared groups: ");
    ngroups = SSL_ctrl(s,93,-1,
# 403 "../apps/lib/s_cb.c" 3 4
             ((void *)0)
# 403 "../apps/lib/s_cb.c"
             );
    for (i = 0; i < ngroups; i++) {
    ...
    case 408:
        {
            ...
            if (!EVP_PKEY_get_utf8_string_param(key, "group",
...
# 865 "../apps/lib/s_cb.c"
    ...
    (void)((length != 0) ? 0 : (OPENSSL_die("assertion failed: " "length != 0", "../apps/lib/s_cb.c", 870), 1));
    port = BIO_ADDR_rawport(peer);
    length += sizeof(port);
    buffer = app_malloc(length, "cookie generate buffer");

    memcpy(buffer, &port, sizeof(port));
    BIO_ADDR_rawaddress(peer, buffer + sizeof(port), 
# 876 "../apps/lib/s_cb.c" 3 4
                                                    ((void *)0)
# 876 "../apps/lib/s_cb.c"
                                                        );

    if (EVP_Q_mac(
# 878 "../apps/lib/s_cb.c" 3 4
                 ((void *)0)
# 878 "../apps/lib/s_cb.c"
                     , "HMAC", 
# 878 "../apps/lib/s_cb.c" 3 4
...
# 878 "../apps/lib/s_cb.c"
                                                 ,
                  cookie_secret, 16, buffer, length,
                  cookie, 255, cookie_len) == 
# 880 "../apps/lib/s_cb.c" 3 4
                                                             ((void *)0)
# 880 "../apps/lib/s_cb.c"
                                                                 ) {
        BIO_printf(bio_err,
    ...
    CRYPTO_free(buffer, "../apps/lib/s_cb.c", 887);
    BIO_ADDR_free(lpeer);
...
# 999 "../apps/lib/s_cb.c"
    ...
    while (exc->next != 
# 1006 "../apps/lib/s_cb.c" 3 4
                       ((void *)0)
# 1006 "../apps/lib/s_cb.c"
                           )
        exc = exc->next;
    ...
    while (exc != 
# 1011 "../apps/lib/s_cb.c" 3 4
                 ((void *)0)
# 1011 "../apps/lib/s_cb.c"
                     ) {
        i++;
        ...
        if (rv & 0x1) {
            ...
            if (exc->build_chain) {
                if (!SSL_ctrl(ssl,105, 0, 
# 1030 "../apps/lib/s_cb.c" 3 4
                    ((void *)0)
# 1030 "../apps/lib/s_cb.c"
                    ))
                    return 0;
            } else if (exc->chain != 
# 1032 "../apps/lib/s_cb.c" 3 4
                                    ((void *)0)
# 1032 "../apps/lib/s_cb.c"
                                        ) {
                if (!SSL_ctrl(ssl,88,1,(char *)(exc->chain)))
                    return 0;
            }
        }
        exc = exc->prev;
...
void ssl_excert_free(SSL_EXCERT *exc)
{
    ...
    if (exc == 
# 1072 "../apps/lib/s_cb.c" 3 4
              ((void *)0)
# 1072 "../apps/lib/s_cb.c"
                  )
        return;
    while (exc) {
        X509_free(exc->cert);
        ...
        curr = exc;
        exc = exc->next;
        CRYPTO_free(curr, "../apps/lib/s_cb.c", 1080);
    }
}
...
int load_excert(SSL_EXCERT **pexc)
{
    ...
    if (exc == 
# 1088 "../apps/lib/s_cb.c" 3 4
              ((void *)0)
# 1088 "../apps/lib/s_cb.c"
                  )
        return 1;

    if (exc->certfile == 
# 1091 "../apps/lib/s_cb.c" 3 4
                        ((void *)0) 
# 1091 "../apps/lib/s_cb.c"
                             && exc->next == 
# 1091 "../apps/lib/s_cb.c" 3 4
                                             ((void *)0)
# 1091 "../apps/lib/s_cb.c"
        ...
        ssl_excert_free(exc);
        *pexc = 
# 1093 "../apps/lib/s_cb.c" 3 4
               ((void *)0)
# 1093 "../apps/lib/s_cb.c"
                   ;
        return 1;
    }
    for (; exc; exc = exc->next) {
        if (exc->certfile == 
# 1097 "../apps/lib/s_cb.c" 3 4
                            ((void *)0)
# 1097 "../apps/lib/s_cb.c"
                                ) {
            BIO_printf(bio_err, "Missing filename\n");
            return 0;
        }
        exc->cert = load_cert_pass(exc->certfile, exc->certform, 1, 
# 1101 "../apps/lib/s_cb.c" 3 4
                   ((void *)0)
# 1101 "../apps/lib/s_cb.c"
                   , "Server Certificate")
                                                   ;
        if (exc->cert == 
# 1103 "../apps/lib/s_cb.c" 3 4
                        ((void *)0)
# 1103 "../apps/lib/s_cb.c"
                            )
            return 0;
        if (exc->keyfile != 
# 1105 "../apps/lib/s_cb.c" 3 4
                           ((void *)0)
# 1105 "../apps/lib/s_cb.c"
                               ) {
            exc->key = load_key(exc->keyfile, exc->keyform,
                                0, 
# 1107 "../apps/lib/s_cb.c" 3 4
                                  ((void *)0)
# 1107 "../apps/lib/s_cb.c"
                                      , 
# 1107 "../apps/lib/s_cb.c" 3 4
                                        ((void *)0)
# 1107 "../apps/lib/s_cb.c"
            ...
            exc->key = load_key(exc->certfile, exc->certform,
                                0, 
# 1110 "../apps/lib/s_cb.c" 3 4
                                  ((void *)0)
# 1110 "../apps/lib/s_cb.c"
                                      , 
# 1110 "../apps/lib/s_cb.c" 3 4
                                        ((void *)0)
# 1110 "../apps/lib/s_cb.c"
        ...
        if (exc->key == 
# 1112 "../apps/lib/s_cb.c" 3 4
                       ((void *)0)
# 1112 "../apps/lib/s_cb.c"
                           )
            return 0;
        if (exc->chainfile != 
# 1114 "../apps/lib/s_cb.c" 3 4
                             ((void *)0)
# 1114 "../apps/lib/s_cb.c"
                                 ) {
            if (!load_certs(exc->chainfile, 0, &exc->chain, 
# 1115 "../apps/lib/s_cb.c" 3 4
                                                           ((void *)0)
# 1115 "../apps/lib/s_cb.c"
                                                               , "server chain"))
                return 0;
        }
    }
...
# 1128 "../apps/lib/s_cb.c" 3 4
   ((void) (0))
# 1128 "../apps/lib/s_cb.c"
                             ;
    
# 1129 "../apps/lib/s_cb.c" 3 4
   ((void) (0))
# 1129 "../apps/lib/s_cb.c"
                            ;

    if (exc == 
# 1131 "../apps/lib/s_cb.c" 3 4
              ((void *)0)
# 1131 "../apps/lib/s_cb.c"
                  ) {
    ...
    case OPT_X_CERT:
        if (exc->certfile != 
# 1145 "../apps/lib/s_cb.c" 3 4
                            ((void *)0) 
# 1145 "../apps/lib/s_cb.c"
    ...
    case OPT_X_KEY:
        if (exc->keyfile != 
# 1153 "../apps/lib/s_cb.c" 3 4
                           ((void *)0)
# 1153 "../apps/lib/s_cb.c"
                               ) {
    ...
    case OPT_X_CHAIN:
        if (exc->chainfile != 
# 1160 "../apps/lib/s_cb.c" 3 4
                             ((void *)0)
# 1160 "../apps/lib/s_cb.c"
                                 ) {
    ...
    case OPT_X_CHAIN_BUILD:
        ...
        break;
    case OPT_X_CERTFORM:
        if (!opt_format(opt_arg(), ( (1L << 1) | (1L << 2) | (1L << 3) | (1L << 4) | (1L << 5) | (1L << 6) | (1L << 7) | (1L << 8) | (1L << 9) | (1L << 10) | (1L << 11)), &exc->certform))
            return 0;
        break;
    case OPT_X_KEYFORM:
        if (!opt_format(opt_arg(), ( (1L << 1) | (1L << 2) | (1L << 3) | (1L << 4) | (1L << 5) | (1L << 6) | (1L << 7) | (1L << 8) | (1L << 9) | (1L << 10) | (1L << 11)), &exc->keyform))
            return 0;
        break;
    }
    return 1;
 ...
 err:
    ...
    ssl_excert_free(exc);
    *pexc = 
# 1184 "../apps/lib/s_cb.c" 3 4
           ((void *)0)
# 1184 "../apps/lib/s_cb.c"
               ;
    return 0;
}
...
static void print_raw_cipherlist(SSL *s)
{
    ...
    if (!SSL_is_server(s))
        return;
    num = SSL_ctrl(s,110,0,
# 1196 "../apps/lib/s_cb.c" 3 4
         ((void *)0)
# 1196 "../apps/lib/s_cb.c"
         );
    (void)((num == 2) ? 0 : (OPENSSL_die("assertion failed: " "num == 2", "../apps/lib/s_cb.c", 1197), 1));
    ...
    for (i = 0; i < rlistlen; i += num, rlist += num) {
        ...
        if (i)
            BIO_puts(bio_err, ":");
        if (c != 
# 1204 "../apps/lib/s_cb.c" 3 4
                ((void *)0)
# 1204 "../apps/lib/s_cb.c"
                    ) {
...
void print_verify_detail(SSL *s, BIO *bio)
{
    int mdpth;
    EVP_PKEY *mspki = 
# 1247 "../apps/lib/s_cb.c" 3 4
                     ((void *)0)
# 1247 "../apps/lib/s_cb.c"
                         ;
    ...
    if (verify_err == 0) {
        ...
        if (peername != 
# 1254 "../apps/lib/s_cb.c" 3 4
                       ((void *)0)
# 1254 "../apps/lib/s_cb.c"
                           )
    ...
    if ((mdpth = SSL_get0_dane_authority(s, 
# 1262 "../apps/lib/s_cb.c" 3 4
                                           ((void *)0)
# 1262 "../apps/lib/s_cb.c"
                                               , &mspki)) >= 0) {
        uint8_t usage, selector, mtype;
        const unsigned char *data = 
# 1264 "../apps/lib/s_cb.c" 3 4
                                   ((void *)0)
# 1264 "../apps/lib/s_cb.c"
                                       ;
        size_t dlen = 0;
        char *hexdata;

        mdpth = SSL_get0_dane_tlsa(s, &usage, &selector, &mtype, &data, &dlen);
# 1278 "../apps/lib/s_cb.c"
        if (dlen > 12)
        ...
        BIO_printf(bio, "DANE TLSA %d %d %d %s%s ",
                   ...
                   (dlen > 12) ? "..." : "", hexdata);
        if (SSL_get0_peer_rpk(s) == 
# 1285 "../apps/lib/s_cb.c" 3 4
                                   ((void *)0)
# 1285 "../apps/lib/s_cb.c"
                                       )
            BIO_printf(bio, "%s certificate at depth %d\n",
                       (mspki != 
# 1287 "../apps/lib/s_cb.c" 3 4
                                ((void *)0)
# 1287 "../apps/lib/s_cb.c"
                                    ) ? "signed the peer" :
                       mdpth ? "matched the TA" : "matched the EE", mdpth);
        else
            BIO_printf(bio, "matched the peer raw public key\n");
        CRYPTO_free(hexdata, "../apps/lib/s_cb.c", 1291);
    }
}
...
void print_ssl_summary(SSL *s)
{
    ...
    if (peer != 
# 1307 "../apps/lib/s_cb.c" 3 4
               ((void *)0)
# 1307 "../apps/lib/s_cb.c"
                   ) {
...
# 1317 "../apps/lib/s_cb.c" 3 4
                          ((void *)0)
# 1317 "../apps/lib/s_cb.c"
                              ) {
               ...
               SSL_CTX *ctx)
{
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(str)); i += 2) {
        const char *flag = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(str), (i)));
        const char *arg = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(str), (i + 1)));

        if (SSL_CONF_cmd(cctx, flag, arg) <= 0) {
            BIO_printf(bio_err, "Call to SSL_CONF_cmd(%s, %s) failed\n",
                       flag, arg == 
# 1349 "../apps/lib/s_cb.c" 3 4
                                   ((void *)0) 
# 1349 "../apps/lib/s_cb.c"
                                        ? "<NULL>" : arg);
            ERR_print_errors(bio_err);
            return 0;
        }
...
{
    X509_STORE *vfy = 
# 1393 "../apps/lib/s_cb.c" 3 4
                     ((void *)0)
# 1393 "../apps/lib/s_cb.c"
                         , *ch = 
# 1393 "../apps/lib/s_cb.c" 3 4
                                 ((void *)0)
# 1393 "../apps/lib/s_cb.c"
    ...
    if (vfyCApath != 
# 1396 "../apps/lib/s_cb.c" 3 4
                    ((void *)0) 
# 1396 "../apps/lib/s_cb.c"
                         || vfyCAfile != 
# 1396 "../apps/lib/s_cb.c" 3 4
                                         ((void *)0) 
# 1396 "../apps/lib/s_cb.c"
...
# 1396 "../apps/lib/s_cb.c"
        ...
        vfy = X509_STORE_new();
        if (vfy == 
# 1398 "../apps/lib/s_cb.c" 3 4
                  ((void *)0)
# 1398 "../apps/lib/s_cb.c"
                      )
            goto err;
        if (vfyCAfile != 
# 1400 "../apps/lib/s_cb.c" 3 4
                        ((void *)0) 
# 1400 "../apps/lib/s_cb.c"
                             && !X509_STORE_load_file(vfy, vfyCAfile))
            goto err;
        if (vfyCApath != 
# 1402 "../apps/lib/s_cb.c" 3 4
                        ((void *)0) 
# 1402 "../apps/lib/s_cb.c"
                             && !X509_STORE_load_path(vfy, vfyCApath))
            goto err;
        if (vfyCAstore != 
# 1404 "../apps/lib/s_cb.c" 3 4
                         ((void *)0) 
# 1404 "../apps/lib/s_cb.c"
                              && !X509_STORE_load_store(vfy, vfyCAstore))
            goto err;
        add_crls_store(vfy, crls);
        if (SSL_CTX_ctrl(ctx,106,1,(char *)(vfy)) == 0)
            goto err;
        if (crl_download)
            store_setup_crl_download(vfy);
    }
    if (chCApath != 
# 1412 "../apps/lib/s_cb.c" 3 4
                   ((void *)0) 
# 1412 "../apps/lib/s_cb.c"
                        || chCAfile != 
# 1412 "../apps/lib/s_cb.c" 3 4
                                       ((void *)0) 
# 1412 "../apps/lib/s_cb.c"
...
# 1412 "../apps/lib/s_cb.c"
        ...
        ch = X509_STORE_new();
        if (ch == 
# 1414 "../apps/lib/s_cb.c" 3 4
                 ((void *)0)
# 1414 "../apps/lib/s_cb.c"
                     )
            goto err;
        if (chCAfile != 
# 1416 "../apps/lib/s_cb.c" 3 4
                       ((void *)0) 
# 1416 "../apps/lib/s_cb.c"
                            && !X509_STORE_load_file(ch, chCAfile))
            goto err;
        if (chCApath != 
# 1418 "../apps/lib/s_cb.c" 3 4
                       ((void *)0) 
# 1418 "../apps/lib/s_cb.c"
                            && !X509_STORE_load_path(ch, chCApath))
            goto err;
        if (chCAstore != 
# 1420 "../apps/lib/s_cb.c" 3 4
                        ((void *)0) 
# 1420 "../apps/lib/s_cb.c"
                             && !X509_STORE_load_store(ch, chCAstore))
            goto err;
        if (SSL_CTX_ctrl(ctx,107,1,(char *)(ch)) == 0)
            goto err;
    }
    rv = 1;
 err:
...
static STRINT_PAIR callback_types[] = {
    ...
    {"Shared Curve", (5 | (2 << 16))},
    {"Check Curve", (6 | (2 << 16))},
    {"Supported Signature Algorithm", (11 | (5 << 16))},
    {"Shared Signature Algorithm", (12 | (5 << 16))},
    {"Check Signature Algorithm", (13 | (5 << 16))},
    ...
    {"Session ticket", (10 | 0)},
    {
# 1463 "../apps/lib/s_cb.c" 3 4
    ((void *)0)
# 1463 "../apps/lib/s_cb.c"
        }
};
                                   ...
                                   void *other, void *ex)
{
    ...
    nm = lookup(op, callback_types, 
# 1480 "../apps/lib/s_cb.c" 3 4
                                   ((void *)0)
# 1480 "../apps/lib/s_cb.c"
                                       );
    show_nm = nm != 
# 1481 "../apps/lib/s_cb.c" 3 4
                   ((void *)0)
# 1481 "../apps/lib/s_cb.c"
                       ;
    switch (op) {
    case (10 | 0):
    case (15 | 0):
    ...
    case (2 << 16):
        {
            ...
            if (cname == 
# 1518 "../apps/lib/s_cb.c" 3 4
                        ((void *)0)
# 1518 "../apps/lib/s_cb.c"
                            )
    ...
    case (6 << 16):
        {
            if (cert_md) {
                ...
                if (pkey == 
# 1533 "../apps/lib/s_cb.c" 3 4
                           ((void *)0)
# 1533 "../apps/lib/s_cb.c"
                               ) {
...
# 1538 "../apps/lib/s_cb.c" 3 4
                                           ((void *)0)
# 1538 "../apps/lib/s_cb.c"
                                               , 
# 1538 "../apps/lib/s_cb.c" 3 4
                                                 ((void *)0)
# 1538 "../apps/lib/s_cb.c"
    ...
    case (5 << 16):
        {
            ...
            const char *sname = 
# 1549 "../apps/lib/s_cb.c" 3 4
                               ((void *)0)
# 1549 "../apps/lib/s_cb.c"
                                   ;
            int raw_sig_code = (salg[0] << 8) + salg[1];


            if (nm != 
# 1553 "../apps/lib/s_cb.c" 3 4
                     ((void *)0)
# 1553 "../apps/lib/s_cb.c"
                         )
                BIO_printf(sdb->out, "%s", nm);
            else
                BIO_printf(sdb->out, "s_cb.c:security_callback_debug op=0x%x", op);

            sname = lookup(raw_sig_code, signature_tls13_scheme_list, 
# 1558 "../apps/lib/s_cb.c" 3 4
                                                                     ((void *)0)
# 1558 "../apps/lib/s_cb.c"
                                                                         );
            if (sname != 
# 1559 "../apps/lib/s_cb.c" 3 4
                        ((void *)0)
# 1559 "../apps/lib/s_cb.c"
                            ) {
...
# 1564 "../apps/lib/s_cb.c" 3 4
                                                                                ((void *)0)
# 1564 "../apps/lib/s_cb.c"
                                                                                    );
                const char *hash_str = lookup(hash_code, signature_tls12_hash_list, 
# 1565 "../apps/lib/s_cb.c" 3 4
                                                                                   ((void *)0)
# 1565 "../apps/lib/s_cb.c"
                                                                                       );

                if (alg_str != 
# 1567 "../apps/lib/s_cb.c" 3 4
                              ((void *)0) 
# 1567 "../apps/lib/s_cb.c"
                                   && hash_str != 
# 1567 "../apps/lib/s_cb.c" 3 4
                                                  ((void *)0)
# 1567 "../apps/lib/s_cb.c"
...
{
    if (bio_keylog == 
# 1595 "../apps/lib/s_cb.c" 3 4
                     ((void *)0)
# 1595 "../apps/lib/s_cb.c"
                         ) {
    ...
    (void)(int)BIO_ctrl(bio_keylog,11,0,
# 1605 "../apps/lib/s_cb.c" 3 4
         ((void *)0)
# 1605 "../apps/lib/s_cb.c"
         );
}
...
int set_keylog_file(SSL_CTX *ctx, const char *keylog_file)
{
    ...
    bio_keylog = 
# 1612 "../apps/lib/s_cb.c" 3 4
                ((void *)0)
# 1612 "../apps/lib/s_cb.c"
                    ;

    if (ctx == 
# 1614 "../apps/lib/s_cb.c" 3 4
              ((void *)0) 
# 1614 "../apps/lib/s_cb.c"
                   || keylog_file == 
# 1614 "../apps/lib/s_cb.c" 3 4
                                     ((void *)0)
# 1614 "../apps/lib/s_cb.c"
    ...
    if (bio_keylog == 
# 1625 "../apps/lib/s_cb.c" 3 4
                     ((void *)0)
# 1625 "../apps/lib/s_cb.c"
                         ) {
    ...
    if ((int)BIO_ctrl(bio_keylog,133,0,
# 1631 "../apps/lib/s_cb.c" 3 4
       ((void *)0)
# 1631 "../apps/lib/s_cb.c"
       ) == 0) {
        BIO_puts(bio_keylog,
                 "# SSL/TLS secrets log file, generated by OpenSSL\n");
        (void)(int)BIO_ctrl(bio_keylog,11,0,
# 1634 "../apps/lib/s_cb.c" 3 4
             ((void *)0)
# 1634 "../apps/lib/s_cb.c"
             );
    }
...
void print_ca_names(BIO *bio, SSL *s)
{
    ...
    if (sk == 
# 1646 "../apps/lib/s_cb.c" 3 4
             ((void *)0) 
# 1646 "../apps/lib/s_cb.c"
                  || OPENSSL_sk_num(ossl_check_const_X509_NAME_sk_type(sk)) == 0) {
        if (!SSL_is_server(s))
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_NAME_sk_type(sk)); i++) {
        X509_NAME_print_ex(bio, ((X509_NAME *)OPENSSL_sk_value(ossl_check_const_X509_NAME_sk_type(sk), (i))), 0, get_nameopt());
        BIO_write(bio, "\n", 1);
    }
}
...
void ssl_print_secure_renegotiation_notes(BIO *bio, SSL *s)
{
    if ((SSL_is_dtls(s) || (SSL_version(s) < 0x0304))) {
        BIO_printf(bio, "Secure Renegotiation IS%s supported\n",
                   SSL_ctrl((s), 76, 0, 
# 1663 "../apps/lib/s_cb.c" 3 4
                  ((void *)0)
# 1663 "../apps/lib/s_cb.c"
                  ) ? "" : " NOT");
    } else {
...
int progress_cb(EVP_PKEY_CTX *ctx)
{
    ...
    BIO_write(b, &c, 1);
    (void)(int)BIO_ctrl(b,11,0,
# 1677 "../apps/lib/s_cb.c" 3 4
         ((void *)0)
# 1677 "../apps/lib/s_cb.c"
         );
    return 1;
}
