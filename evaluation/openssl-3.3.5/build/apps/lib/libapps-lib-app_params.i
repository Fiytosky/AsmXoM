# 0 "../apps/lib/app_params.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../apps/lib/app_params.c"
# 10 "../apps/lib/app_params.c"
...
# 12 "../apps/lib/app_params.c" 2

static int describe_param_type(char *buf, size_t bufsz, const OSSL_PARAM *param)
{
    const char *type_mod = "";
    const char *type = 
# 16 "../apps/lib/app_params.c" 3 4
                      ((void *)0)
# 16 "../apps/lib/app_params.c"
                          ;
...
{
    if (pdefs == 
# 77 "../apps/lib/app_params.c" 3 4
                ((void *)0)
# 77 "../apps/lib/app_params.c"
                    ) {
        return 1;
    } else if (pdefs->key == 
# 79 "../apps/lib/app_params.c" 3 4
                            ((void *)0)
# 79 "../apps/lib/app_params.c"
                                ) {
        ...
        for (; pdefs->key != 
# 87 "../apps/lib/app_params.c" 3 4
                            ((void *)0)
# 87 "../apps/lib/app_params.c"
                                ; pdefs++) {
            char buf[200];
