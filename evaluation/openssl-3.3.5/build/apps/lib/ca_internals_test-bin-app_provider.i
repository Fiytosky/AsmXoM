# 0 "../apps/lib/app_provider.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../apps/lib/app_provider.c"
# 10 "../apps/lib/app_provider.c"
...
enum prov_range { OPT_PROV__FIRST=1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY, OPT_PROV__LAST };

static struct stack_st_OSSL_PROVIDER *app_providers = 
# 26 "../apps/lib/app_provider.c" 3 4
                                               ((void *)0)
# 26 "../apps/lib/app_provider.c"
                                                   ;
...
int app_provider_load(OSSL_LIB_CTX *libctx, const char *provider_name)
{
    ...
    if (prov == 
# 38 "../apps/lib/app_provider.c" 3 4
               ((void *)0)
# 38 "../apps/lib/app_provider.c"
                   ) {
    ...
    if (app_providers == 
# 45 "../apps/lib/app_provider.c" 3 4
                        ((void *)0)
# 45 "../apps/lib/app_provider.c"
                            )
        app_providers = sk_OSSL_PROVIDER_new_null();
    if (app_providers == 
# 47 "../apps/lib/app_provider.c" 3 4
                        ((void *)0)
        
# 48 "../apps/lib/app_provider.c"
...
void app_providers_cleanup(void)
{
    ...
    app_providers = 
# 58 "../apps/lib/app_provider.c" 3 4
                   ((void *)0)
# 58 "../apps/lib/app_provider.c"
                       ;
}
...
{
    if (path != 
# 63 "../apps/lib/app_provider.c" 3 4
               ((void *)0) 
# 63 "../apps/lib/app_provider.c"
                    && *path == '\0')
        path = 
# 64 "../apps/lib/app_provider.c" 3 4
              ((void *)0)
# 64 "../apps/lib/app_provider.c"
                  ;
