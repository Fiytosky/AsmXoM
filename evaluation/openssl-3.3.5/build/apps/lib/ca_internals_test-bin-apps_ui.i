# 0 "../apps/lib/apps_ui.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../apps/lib/apps_ui.c"
# 10 "../apps/lib/apps_ui.c"
...
extern BIO *bio_err;
# 14 "../apps/lib/apps_ui.c" 2

static UI_METHOD *ui_method = 
# 15 "../apps/lib/apps_ui.c" 3 4
                             ((void *)0)
# 15 "../apps/lib/apps_ui.c"
                                 ;
static const UI_METHOD *ui_base_method = 
# 16 "../apps/lib/apps_ui.c" 3 4
                                        ((void *)0)
# 16 "../apps/lib/apps_ui.c"
                                            ;
...
static int ui_open(UI *ui)
{
    ...
    if (opener != 
# 22 "../apps/lib/apps_ui.c" 3 4
                 ((void *)0)
# 22 "../apps/lib/apps_ui.c"
                     )
        return opener(ui);
    return 1;
}
...
{
    int (*reader)(UI *ui, UI_STRING *uis) = 
# 29 "../apps/lib/apps_ui.c" 3 4
                                           ((void *)0)
# 29 "../apps/lib/apps_ui.c"
                                               ;
        ...
        case UIT_VERIFY:
            {
                ...
                if (password != 
# 40 "../apps/lib/apps_ui.c" 3 4
                               ((void *)0)
# 40 "../apps/lib/apps_ui.c"
                                   ) {
    ...
    if (reader != 
# 55 "../apps/lib/apps_ui.c" 3 4
                 ((void *)0)
# 55 "../apps/lib/apps_ui.c"
                     )
...
{
    int (*writer)(UI *ui, UI_STRING *uis) = 
# 64 "../apps/lib/apps_ui.c" 3 4
                                           ((void *)0)
# 64 "../apps/lib/apps_ui.c"
                                               ;
        ...
        case UIT_VERIFY:
            {
                ...
                if (password != 
# 75 "../apps/lib/apps_ui.c" 3 4
                               ((void *)0)
# 75 "../apps/lib/apps_ui.c"
                                   )
                    return 1;
            }
            break;
    ...
    if (writer != 
# 88 "../apps/lib/apps_ui.c" 3 4
                 ((void *)0)
# 88 "../apps/lib/apps_ui.c"
                     )
...
static int ui_close(UI *ui)
{
    ...
    if (closer != 
# 97 "../apps/lib/apps_ui.c" 3 4
                 ((void *)0)
# 97 "../apps/lib/apps_ui.c"
                     )
        return closer(ui);
    return 1;
}
                                 ...
                                 const char *object_name)
{
    ...
    if (phrase_desc == 
# 108 "../apps/lib/apps_ui.c" 3 4
                      ((void *)0)
# 108 "../apps/lib/apps_ui.c"
                          )
        phrase_desc = "pass phrase";
    if (object_name == 
# 110 "../apps/lib/apps_ui.c" 3 4
                      ((void *)0) 
# 110 "../apps/lib/apps_ui.c"
                           && cb_data != 
# 110 "../apps/lib/apps_ui.c" 3 4
                                         ((void *)0)
# 110 "../apps/lib/apps_ui.c"
    ...
    return UI_construct_prompt(
# 112 "../apps/lib/apps_ui.c" 3 4
                              ((void *)0)
# 112 "../apps/lib/apps_ui.c"
...
{
    if (ui_meth == 
# 117 "../apps/lib/apps_ui.c" 3 4
                  ((void *)0)
# 117 "../apps/lib/apps_ui.c"
                      )
        ui_meth = UI_null();
...
int setup_ui_method(void)
{
    ...
    return ui_method != 
# 130 "../apps/lib/apps_ui.c" 3 4
                       ((void *)0)
        
# 131 "../apps/lib/apps_ui.c"
...
{
    if (ui_method != 
# 141 "../apps/lib/apps_ui.c" 3 4
                    ((void *)0)
# 141 "../apps/lib/apps_ui.c"
                        ) {
        UI_destroy_method(ui_method);
        ui_method = 
# 143 "../apps/lib/apps_ui.c" 3 4
                   ((void *)0)
# 143 "../apps/lib/apps_ui.c"
                       ;
    }
}
...
{
    void *vp = CRYPTO_malloc(sz, "../apps/lib/apps_ui.c", 154);

    if (vp == 
# 156 "../apps/lib/apps_ui.c" 3 4
             ((void *)0)
# 156 "../apps/lib/apps_ui.c"
                 ) {
...
int password_callback(char *buf, int bufsiz, int verify, PW_CB_DATA *cb_data)
{
    ...
    int ok = 0;
    char *buff = 
# 169 "../apps/lib/apps_ui.c" 3 4
                ((void *)0)
# 169 "../apps/lib/apps_ui.c"
                    ;
    int ui_flags = 0;
    const char *prompt_info = 
# 171 "../apps/lib/apps_ui.c" 3 4
                             ((void *)0)
# 171 "../apps/lib/apps_ui.c"
                                 ;
    char *prompt;

    if ((ui = UI_new_method(ui_method)) == 
# 174 "../apps/lib/apps_ui.c" 3 4
                                          ((void *)0)
# 174 "../apps/lib/apps_ui.c"
                                              )
        return 0;

    if (cb_data != 
# 177 "../apps/lib/apps_ui.c" 3 4
                  ((void *)0) 
# 177 "../apps/lib/apps_ui.c"
                       && cb_data->prompt_info != 
# 177 "../apps/lib/apps_ui.c" 3 4
                                                  ((void *)0)
# 177 "../apps/lib/apps_ui.c"
    ...
    if (prompt == 
# 180 "../apps/lib/apps_ui.c" 3 4
                 ((void *)0)
# 180 "../apps/lib/apps_ui.c"
                     ) {
    ...
    CRYPTO_clear_free(buff, (unsigned int)bufsiz, "../apps/lib/apps_ui.c", 205);
    ...
    UI_free(ui);
    CRYPTO_free(prompt, "../apps/lib/apps_ui.c", 221);
    return res;
}
