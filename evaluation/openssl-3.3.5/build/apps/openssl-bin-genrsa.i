...
typedef enum OPTION_choice {
    ...
    OPT_R__FIRST=1500, OPT_R_RAND, OPT_R_WRITERAND, OPT_R__LAST, OPT_PROV__FIRST=1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY, OPT_PROV__LAST, OPT_TRADITIONAL
} OPTION_CHOICE;
...
int genrsa_main(int argc, char **argv)
{
    ...
    ENGINE *eng = 
# 79 "../apps/genrsa.c" 3 4
                 ((void *)0)
# 79 "../apps/genrsa.c"
                     ;
    BIGNUM *bn = BN_new();
    BIO *out = 
# 81 "../apps/genrsa.c" 3 4
              ((void *)0)
# 81 "../apps/genrsa.c"
                  ;
    EVP_PKEY *pkey = 
# 82 "../apps/genrsa.c" 3 4
                    ((void *)0)
# 82 "../apps/genrsa.c"
                        ;
    EVP_PKEY_CTX *ctx = 
# 83 "../apps/genrsa.c" 3 4
                       ((void *)0)
# 83 "../apps/genrsa.c"
                           ;
    EVP_CIPHER *enc = 
# 84 "../apps/genrsa.c" 3 4
                     ((void *)0)
# 84 "../apps/genrsa.c"
                         ;
...
# 87 "../apps/genrsa.c"
                                                            ;
    char *prog, *hexe, *dece, *ciphername = 
# 88 "../apps/genrsa.c" 3 4
                                           ((void *)0)
# 88 "../apps/genrsa.c"
                                               ;
    OPTION_CHOICE o;
...
opthelp:
        ...
        case OPT_OUT:
            ...
            break;
        case OPT_ENGINE:
            eng = setup_engine_methods(opt_arg(), (unsigned int)-1, 0);
            break;
...
# 215 "../apps/genrsa.c"
        ...
        CRYPTO_free(hexe, "../apps/genrsa.c", 224);
        CRYPTO_free(dece, "../apps/genrsa.c", 225);
        BN_free(e);
    }
    if (traditional) {
        if (!PEM_write_bio_PrivateKey_traditional(out, pkey, enc, 
# 229 "../apps/genrsa.c" 3 4
                                                                 ((void *)0)
# 229 "../apps/genrsa.c"
                                                                     , 0,
                                                  
# 230 "../apps/genrsa.c" 3 4
                                                 ((void *)0)
# 230 "../apps/genrsa.c"
                                                     , passout))
            goto end;
    } else {
        if (!PEM_write_bio_PrivateKey(out, pkey, enc, 
# 233 "../apps/genrsa.c" 3 4
                                                     ((void *)0)
# 233 "../apps/genrsa.c"
                                                         , 0, 
# 233 "../apps/genrsa.c" 3 4
...
# 233 "../apps/genrsa.c"
    ...
    BIO_free_all(out);
    release_engine(eng);
    CRYPTO_free(passout, "../apps/genrsa.c", 246);
    if (ret != 0)
