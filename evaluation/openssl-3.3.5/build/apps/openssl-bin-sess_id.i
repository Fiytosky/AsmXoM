...
{
    SSL_SESSION *x = 
# 50 "../apps/sess_id.c" 3 4
                    ((void *)0)
# 50 "../apps/sess_id.c"
                        ;
    X509 *peer = 
# 51 "../apps/sess_id.c" 3 4
                ((void *)0)
# 51 "../apps/sess_id.c"
                    ;
    BIO *out = 
# 52 "../apps/sess_id.c" 3 4
              ((void *)0)
# 52 "../apps/sess_id.c"
                  ;
    char *infile = 
# 53 "../apps/sess_id.c" 3 4
                  ((void *)0)
# 53 "../apps/sess_id.c"
                      , *outfile = 
# 53 "../apps/sess_id.c" 3 4
...
# 53 "../apps/sess_id.c"
 ...
 opthelp:
        ...
        case OPT_INFORM:
            ...
            break;
        case OPT_OUTFORM:
            if (!opt_format(opt_arg(), ((1L << 1) | (1L << 2)) | (1L << 8),
                            &outformat))
                goto opthelp;
            break;
        case OPT_IN:
...
# 133 "../apps/sess_id.c"
    ...
    if (!noout && !cert) {
        if (outformat == 4) {
            i = (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_SSL_SESSION : ((int (*)(const SSL_SESSION *,unsigned char **))0))), out, ((void*) (1 ? x : (const SSL_SESSION*)0))));
...
{
    SSL_SESSION *x = 
# 178 "../apps/sess_id.c" 3 4
                    ((void *)0)
# 178 "../apps/sess_id.c"
                        ;
    BIO *in = 
# 179 "../apps/sess_id.c" 3 4
             ((void *)0)
# 179 "../apps/sess_id.c"
                 ;
    ...
    if (in == 
# 182 "../apps/sess_id.c" 3 4
             ((void *)0)
# 182 "../apps/sess_id.c"
                 )
        goto end;
    if (format == 4)
        x = ((SSL_SESSION*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? SSL_SESSION_new : ((SSL_SESSION *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_SSL_SESSION : ((SSL_SESSION *(*)(SSL_SESSION **,const unsigned char **,long))0))), in, ((void**) (1 ? 
# 185 "../apps/sess_id.c" 3 4
           ((void *)0) 
# 185 "../apps/sess_id.c"
           : (SSL_SESSION**)0))));
    else
        x = PEM_read_bio_SSL_SESSION(in, 
# 187 "../apps/sess_id.c" 3 4
                                        ((void *)0)
# 187 "../apps/sess_id.c"
                                            , 
# 187 "../apps/sess_id.c" 3 4
