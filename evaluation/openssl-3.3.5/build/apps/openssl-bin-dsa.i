...
# 198 "../apps/dsa.c"
                               ;
        if ((pubin && EVP_PKEY_print_public(out, pkey, 0, 
# 199 "../apps/dsa.c" 3 4
                                                         ((void *)0)
# 199 "../apps/dsa.c"
                                                             ) <= 0)
            || (!pubin && EVP_PKEY_print_private(out, pkey, 0, 
# 200 "../apps/dsa.c" 3 4
                                                              ((void *)0)
# 200 "../apps/dsa.c"
                                                                  ) <= 0)) {
...
# 208 "../apps/dsa.c"
    ...
    if (outformat == 4) {
        ...
        output_type = "PEM";
    } else if (outformat == 11) {
        output_type = "MSBLOB";
    } else if (outformat == 12) {
        if (pubin) {
    ...
    if (outformat == 4 || outformat == (5 | 0x8000)) {
        if (pubout || pubin)
...
# 282 "../apps/dsa.c"
    ...
    EVP_CIPHER_free(enc);
    release_engine(e);
    CRYPTO_free(passin, "../apps/dsa.c", 304);
    CRYPTO_free(passout, "../apps/dsa.c", 305);
    return ret;
}
