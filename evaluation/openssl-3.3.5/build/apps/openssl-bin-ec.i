...
typedef enum OPTION_choice {
    ...
    OPT_NO_PUBLIC, OPT_CHECK, OPT_PROV__FIRST=1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY, OPT_PROV__LAST
} OPTION_CHOICE;
...
# 74 "../apps/ec.c"
                                                                              ;
    OPTION_CHOICE o;
    int informat = 0, outformat = (5 | 0x8000), text = 0, noout = 0;
...
# 80 "../apps/ec.c"
 ...
 opthelp:
        ...
        case OPT_HELP:
            ...
            goto end;
        case OPT_INFORM:
            if (!opt_format(opt_arg(), ( (1L << 1) | (1L << 2) | (1L << 3) | (1L << 4) | (1L << 5) | (1L << 6) | (1L << 7) | (1L << 8) | (1L << 9) | (1L << 10) | (1L << 11)), &informat))
                goto opthelp;
            break;
        case OPT_IN:
            infile = opt_arg();
...
# 198 "../apps/ec.c"
       && !EVP_PKEY_set_utf8_string_param(
                eckey, "encoding", asn1_encoding)) {
        BIO_printf(bio_err, "unable to set asn1 encoding format\n");
        goto end;
    }

    if (no_public) {
        if (!EVP_PKEY_set_int_param(eckey, "include-public", 0)) {
            BIO_printf(bio_err, "unable to disable public key encoding\n");
            goto end;
        }
    } else {
        if (!EVP_PKEY_set_int_param(eckey, "include-public", 1)) {
...
# 217 "../apps/ec.c"
                               ;
        if ((pubin && EVP_PKEY_print_public(out, eckey, 0, 
# 218 "../apps/ec.c" 3 4
                                                          ((void *)0)
# 218 "../apps/ec.c"
                                                              ) <= 0)
            || (!pubin && EVP_PKEY_print_private(out, eckey, 0, 
# 219 "../apps/ec.c" 3 4
                                                               ((void *)0)
# 219 "../apps/ec.c"
                                                                   ) <= 0)) {
...
# 227 "../apps/ec.c"
    ...
    if (!noout) {
        int selection;
        const char *output_type = outformat == 4 ? "DER" : "PEM";
...
# 258 "../apps/ec.c"
            ...
            OSSL_ENCODER_CTX_set_cipher(ectx, EVP_CIPHER_get0_name(enc), 
# 259 "../apps/ec.c" 3 4
                                                                        ((void *)0)
# 259 "../apps/ec.c"
                                                                            );
...
# 285 "../apps/ec.c"
        ...
        CRYPTO_clear_free(passin, strlen(passin), "../apps/ec.c", 286);
    if (passout != 
# 287 "../apps/ec.c" 3 4
                  ((void *)0)
# 287 "../apps/ec.c"
                      )
        CRYPTO_clear_free(passout, strlen(passout), "../apps/ec.c", 288);
    return ret;
}
