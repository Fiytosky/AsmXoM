...
__attribute__((deprecated("Since OpenSSL " "1.1.0"))) ASN1_TYPE *PKCS12_get_attr(const PKCS12_SAFEBAG *bag,
                                                   int attr_nid);
...
static int get_cert_chain(X509 *cert, X509_STORE *store,
                          struct stack_st_X509 *untrusted_certs,
...
typedef enum OPTION_choice {
    ...
    OPT_R__FIRST=1500, OPT_R_RAND, OPT_R_WRITERAND, OPT_R__LAST, OPT_PROV__FIRST=1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY, OPT_PROV__LAST, OPT_JDKTRUST,
...
const OPTIONS pkcs12_options[] = {
    ...
    { OPT_SECTION_STR, 1, '-', "PKCS#12 import (parsing PKCS#12)" " options:\n" },
    ...
    { OPT_SECTION_STR, 1, '-', "PKCS#12 output (export)" " options:\n" },
...
# 182 "../apps/pkcs12.c"
    ...
    ENGINE *e = 
# 184 "../apps/pkcs12.c" 3 4
               ((void *)0)
# 184 "../apps/pkcs12.c"
                   ;
    BIO *in = 
# 185 "../apps/pkcs12.c" 3 4
             ((void *)0)
# 185 "../apps/pkcs12.c"
                 , *out = 
# 185 "../apps/pkcs12.c" 3 4
...
# 185 "../apps/pkcs12.c"
                              ;
    PKCS12 *p12 = 
# 186 "../apps/pkcs12.c" 3 4
                 ((void *)0)
# 186 "../apps/pkcs12.c"
                     ;
    struct stack_st_OPENSSL_STRING *canames = 
# 187 "../apps/pkcs12.c" 3 4
                                       ((void *)0)
# 187 "../apps/pkcs12.c"
                                           ;
 ...
 opthelp:
        ...
        case OPT_NOENC:
            ...
            enc_name = opt_flag() + 1;
            enc = 
# 258 "../apps/pkcs12.c" 3 4
                 ((void *)0)
# 258 "../apps/pkcs12.c"
                     ;
            ciphername = 
# 259 "../apps/pkcs12.c" 3 4
                        ((void *)0)
# 259 "../apps/pkcs12.c"
                            ;
            break;
        ...
        case OPT_CANAME:
            if (canames == 
# 320 "../apps/pkcs12.c" 3 4
                          ((void *)0)
                
# 321 "../apps/pkcs12.c"
               && (canames = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null())) == 
# 321 "../apps/pkcs12.c" 3 4
                                                              ((void *)0)
# 321 "../apps/pkcs12.c"
                                                                  )
                goto end;
            if (OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(canames), ossl_check_OPENSSL_STRING_type(opt_arg())) <= 0)
                goto end;
            break;
        case OPT_IN:
            infile = opt_arg();
...
# 375 "../apps/pkcs12.c"
    ...
    if (export_pkcs12) {
        ...
        if (keyname != 
# 396 "../apps/pkcs12.c" 3 4
                      ((void *)0)
# 396 "../apps/pkcs12.c"
                          )
            BIO_printf(bio_err, "Warning: -%s option ignored without -export\n", "inkey");;
        if (certfile != 
# 398 "../apps/pkcs12.c" 3 4
                       ((void *)0)
# 398 "../apps/pkcs12.c"
                           )
            BIO_printf(bio_err, "Warning: -%s option ignored without -export\n", "certfile");;
        if (passcertsarg != 
# 400 "../apps/pkcs12.c" 3 4
                           ((void *)0)
# 400 "../apps/pkcs12.c"
                               )
            BIO_printf(bio_err, "Warning: -%s option ignored without -export\n", "passcerts");;
        if (chain)
            BIO_printf(bio_err, "Warning: -%s option ignored without -export\n", "chain");;
        if (untrusted != 
# 404 "../apps/pkcs12.c" 3 4
                        ((void *)0)
# 404 "../apps/pkcs12.c"
                            )
            BIO_printf(bio_err, "Warning: -%s option ignored without -export\n", "untrusted");;
        if (CAfile != 
# 406 "../apps/pkcs12.c" 3 4
                     ((void *)0)
# 406 "../apps/pkcs12.c"
                         )
            BIO_printf(bio_err, "Warning: -%s option ignored without -export\n", "CAfile");;
        if (CApath != 
# 408 "../apps/pkcs12.c" 3 4
                     ((void *)0)
# 408 "../apps/pkcs12.c"
                         )
            BIO_printf(bio_err, "Warning: -%s option ignored without -export\n", "CApath");;
        if (CAstore != 
# 410 "../apps/pkcs12.c" 3 4
                      ((void *)0)
# 410 "../apps/pkcs12.c"
                          )
            BIO_printf(bio_err, "Warning: -%s option ignored without -export\n", "CAstore");;
        ...
        if (noCAstore)
            BIO_printf(bio_err, "Warning: -%s option ignored without -export\n", "no-CAstore");;
        if (name != 
# 418 "../apps/pkcs12.c" 3 4
                   ((void *)0)
# 418 "../apps/pkcs12.c"
                       )
            BIO_printf(bio_err, "Warning: -%s option ignored without -export\n", "name");;
        if (canames != 
# 420 "../apps/pkcs12.c" 3 4
                      ((void *)0)
# 420 "../apps/pkcs12.c"
                          )
            BIO_printf(bio_err, "Warning: -%s option ignored without -export\n", "caname");;
        if (csp_name != 
# 422 "../apps/pkcs12.c" 3 4
                       ((void *)0)
# 422 "../apps/pkcs12.c"
                           )
            BIO_printf(bio_err, "Warning: -%s option ignored without -export\n", "CSP");;
        ...
        if (key_pbe != 0)
            BIO_printf(bio_err, "Warning: -%s option ignored without -export\n", "keypbe");;
        if (cert_pbe != 0 && cert_pbe != -1)
            BIO_printf(bio_err, "Warning: -%s option ignored without -export\n", "certpbe and -descert");;
        if (macalg != 
# 434 "../apps/pkcs12.c" 3 4
                     ((void *)0)
# 434 "../apps/pkcs12.c"
                         )
            BIO_printf(bio_err, "Warning: -%s option ignored without -export\n", "macalg");;
...
# 468 "../apps/pkcs12.c"
    ...
    if (!app_passwd(passcertsarg, 
# 475 "../apps/pkcs12.c" 3 4
                                 ((void *)0)
# 475 "../apps/pkcs12.c"
                                     , &passcerts, 
# 475 "../apps/pkcs12.c" 3 4
...
# 499 "../apps/pkcs12.c"
    ...
    if (export_pkcs12) {
        EVP_PKEY *key = 
# 531 "../apps/pkcs12.c" 3 4
                       ((void *)0)
# 531 "../apps/pkcs12.c"
                           ;
        X509 *ee_cert = 
# 532 "../apps/pkcs12.c" 3 4
                       ((void *)0)
# 532 "../apps/pkcs12.c"
                           , *x = 
# 532 "../apps/pkcs12.c" 3 4
...
# 532 "../apps/pkcs12.c"
                                      ;
        struct stack_st_X509 *certs = 
# 533 "../apps/pkcs12.c" 3 4
                               ((void *)0)
# 533 "../apps/pkcs12.c"
                                   ;
        struct stack_st_X509 *untrusted_certs = 
# 534 "../apps/pkcs12.c" 3 4
                                         ((void *)0)
# 534 "../apps/pkcs12.c"
                                             ;
        EVP_MD *macmd = 
# 535 "../apps/pkcs12.c" 3 4
                       ((void *)0)
# 535 "../apps/pkcs12.c"
                           ;
        unsigned char *catmp = 
# 536 "../apps/pkcs12.c" 3 4
                              ((void *)0)
# 536 "../apps/pkcs12.c"
                                  ;
        int i;
        ASN1_OBJECT *obj = 
# 538 "../apps/pkcs12.c" 3 4
                          ((void *)0)
# 538 "../apps/pkcs12.c"
                              ;
...
# 556 "../apps/pkcs12.c"
        ...
        if (!(options & 0x2)) {
            if (!load_certs(infile, 1, &certs, passin,
                ...
                goto export_end;
            if (OPENSSL_sk_num(ossl_check_const_X509_sk_type(certs)) < 1) {
                BIO_printf(bio_err, "No certificate in -in file %s\n", infile);
                goto export_end;
            }

            if (key != 
# 570 "../apps/pkcs12.c" 3 4
                      ((void *)0)
# 570 "../apps/pkcs12.c"
                          ) {

                for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(certs)); i++) {
                    x = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(certs), (i)));
                    if (cert_matches_key(x, key)) {
                        ee_cert = x;

                        X509_keyid_set1(ee_cert, 
# 577 "../apps/pkcs12.c" 3 4
                                                ((void *)0)
# 577 "../apps/pkcs12.c"
                                                    , 0);
                        X509_alias_set1(ee_cert, 
# 578 "../apps/pkcs12.c" 3 4
                                                ((void *)0)
# 578 "../apps/pkcs12.c"
                                                    , 0);

                        (void)((X509 *)OPENSSL_sk_delete(ossl_check_X509_sk_type(certs), (i)));
                        break;
                    }
                }
                if (ee_cert == 
# 584 "../apps/pkcs12.c" 3 4
                              ((void *)0)
# 584 "../apps/pkcs12.c"
                                  ) {
                    BIO_printf(bio_err,
...
# 608 "../apps/pkcs12.c"
                ...
                ee_cert_tmp = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(certs), (0)));

            if (ee_cert_tmp == 
# 611 "../apps/pkcs12.c" 3 4
                              ((void *)0)
# 611 "../apps/pkcs12.c"
                                  ) {
                BIO_printf(bio_err,
...
# 619 "../apps/pkcs12.c"
            ...
            if (vret == 0) {
                ...
                X509_free(((X509 *)OPENSSL_sk_shift(ossl_check_X509_sk_type(chain2))));

                add_certs = X509_add_certs(certs, chain2, 0x1
                                           | 0x4);
...
# 644 "../apps/pkcs12.c"
        ...
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(canames)); i++) {
            catmp = (unsigned char *)((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(canames), (i)));
            X509_alias_set1(((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(certs), (i))), catmp, -1);
        }

        if (csp_name != 
# 656 "../apps/pkcs12.c" 3 4
                       ((void *)0) 
# 656 "../apps/pkcs12.c"
                            && key != 
# 656 "../apps/pkcs12.c" 3 4
...
# 656 "../apps/pkcs12.c"
        ...
        if (add_lmk && key != 
# 661 "../apps/pkcs12.c" 3 4
                             ((void *)0)
# 661 "../apps/pkcs12.c"
                                 )
            EVP_PKEY_add1_attr_by_NID(key, 856, 0, 
# 662 "../apps/pkcs12.c" 3 4
                                                              ((void *)0)
# 662 "../apps/pkcs12.c"
                                                                  , -1);

        if (!noprompt && !(enc == 
# 664 "../apps/pkcs12.c" 3 4
                                 ((void *)0) 
# 664 "../apps/pkcs12.c"
                                      && maciter == -1)) {
...
# 698 "../apps/pkcs12.c"
        ...
        if (maciter != -1) {
            if (!PKCS12_set_mac(p12, mpass, -1, 
# 704 "../apps/pkcs12.c" 3 4
                                               ((void *)0)
# 704 "../apps/pkcs12.c"
                                                   , macsaltlen, maciter, macmd)) {
...
# 713 "../apps/pkcs12.c"
 ...
 export_end:
    ...
    if (in == 
# 734 "../apps/pkcs12.c" 3 4
             ((void *)0)
# 734 "../apps/pkcs12.c"
                 )
        goto end;

    p12 = PKCS12_init_ex(21, app_get0_libctx(), app_get0_propq());
    if (p12 == 
# 738 "../apps/pkcs12.c" 3 4
              ((void *)0)
# 738 "../apps/pkcs12.c"
                  ) {
        ERR_print_errors(bio_err);
    ...
    if ((p12 = d2i_PKCS12_bio(in, &p12)) == 
# 742 "../apps/pkcs12.c" 3 4
                                           ((void *)0)
# 742 "../apps/pkcs12.c"
                                               ) {
        ERR_print_errors(bio_err);
    ...
    if ((options & 0x4) && PKCS12_mac_present(p12)) {
        ...
        X509_ALGOR_get0(&macobj, 
# 775 "../apps/pkcs12.c" 3 4
                                ((void *)0)
# 775 "../apps/pkcs12.c"
                                    , 
# 775 "../apps/pkcs12.c" 3 4
...
# 775 "../apps/pkcs12.c"
        ...
        BIO_printf(bio_err, ", Iteration %ld\n",
                   tmaciter != 
# 779 "../apps/pkcs12.c" 3 4
                              ((void *)0) 
# 779 "../apps/pkcs12.c"
                                   ? ASN1_INTEGER_get(tmaciter) : 1L);
        BIO_printf(bio_err, "MAC length: %ld, salt length: %ld\n",
                   tmac != 
# 781 "../apps/pkcs12.c" 3 4
                          ((void *)0) 
# 781 "../apps/pkcs12.c"
                               ? ASN1_STRING_length(tmac) : 0L,
                   tsalt != 
# 782 "../apps/pkcs12.c" 3 4
                           ((void *)0) 
# 782 "../apps/pkcs12.c"
                                ? ASN1_STRING_length(tsalt) : 0L);
    }
    if (macver) {
        EVP_KDF *pkcs12kdf;
...
# 789 "../apps/pkcs12.c"
        ...
        if (!mpass[0] && PKCS12_verify_mac(p12, 
# 796 "../apps/pkcs12.c" 3 4
                                               ((void *)0)
# 796 "../apps/pkcs12.c"
                                                   , 0)) {
...
# 799 "../apps/pkcs12.c"
            ...
            if (ERR_GET_LIB(err) == 35
                && ERR_GET_REASON(err) == 108) {
                BIO_printf(bio_err, "Warning: MAC is absent!\n");
                goto dump;
            }

            utmp = OPENSSL_asc2uni(mpass, -1, 
# 816 "../apps/pkcs12.c" 3 4
                                             ((void *)0)
# 816 "../apps/pkcs12.c"
                                                 , &utmplen);
            if (utmp == 
# 817 "../apps/pkcs12.c" 3 4
                       ((void *)0)
# 817 "../apps/pkcs12.c"
                           )
                goto end;
            badpass = OPENSSL_uni2utf8(utmp, utmplen);
            CRYPTO_free(utmp, "../apps/pkcs12.c", 820);
...
# 837 "../apps/pkcs12.c"
    ...
    BIO_free(in);
    BIO_free_all(out);
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(canames));
    CRYPTO_free(badpass, "../apps/pkcs12.c", 852);
    CRYPTO_free(passcerts, "../apps/pkcs12.c", 853);
    CRYPTO_free(passin, "../apps/pkcs12.c", 854);
    CRYPTO_free(passout, "../apps/pkcs12.c", 855);
    return ret;
}
...
# 861 "../apps/pkcs12.c" 3 4
                                     ((void *)0)
# 861 "../apps/pkcs12.c"
                                         ;
    X509_ATTRIBUTE *attr = 
# 862 "../apps/pkcs12.c" 3 4
                          ((void *)0)
# 862 "../apps/pkcs12.c"
                              ;
...
# 865 "../apps/pkcs12.c"
    ...
    attrs = (struct stack_st_X509_ATTRIBUTE*)PKCS12_SAFEBAG_get0_attrs(bag);


    attr = X509_ATTRIBUTE_create(1283, 6, (ASN1_OBJECT*)cbarg);
...
# 893 "../apps/pkcs12.c" 3 4
                                                  ((void *)0)
# 893 "../apps/pkcs12.c"
                                                      )
        return 0;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_PKCS7_sk_type(asafes)); i++) {
        struct stack_st_PKCS12_SAFEBAG *bags;

        p7 = ((PKCS7 *)OPENSSL_sk_value(ossl_check_const_PKCS7_sk_type(asafes), (i)));
...
# 917 "../apps/pkcs12.c"
        ...
        if (!dump_certs_pkeys_bags(out, bags, pass, passlen,
                                   options, pempass, enc)) {
            OPENSSL_sk_pop_free(ossl_check_PKCS12_SAFEBAG_sk_type(bags),ossl_check_PKCS12_SAFEBAG_freefunc_type(PKCS12_SAFEBAG_free));
            goto err;
        }
        OPENSSL_sk_pop_free(ossl_check_PKCS12_SAFEBAG_sk_type(bags),ossl_check_PKCS12_SAFEBAG_freefunc_type(PKCS12_SAFEBAG_free));
    }
 ...
 err:
    OPENSSL_sk_pop_free(ossl_check_PKCS7_sk_type(asafes),ossl_check_PKCS7_freefunc_type(PKCS7_free));
    return ret;
}
...
{
    int i;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_PKCS12_SAFEBAG_sk_type(bags)); i++) {
        if (!dump_certs_pkeys_bag(out,
                                  ((PKCS12_SAFEBAG *)OPENSSL_sk_value(ossl_check_const_PKCS12_SAFEBAG_sk_type(bags), (i))),
...
# 968 "../apps/pkcs12.c" 3 4
                                           ((void *)0)
# 968 "../apps/pkcs12.c"
                                               )
            return 0;
        print_attribs(out, PKCS8_pkey_get0_attrs(p8c), "Key Attributes");
        ret = PEM_write_bio_PrivateKey(out, pkey, enc, 
# 971 "../apps/pkcs12.c" 3 4
                                                      ((void *)0)
# 971 "../apps/pkcs12.c"
                                                          , 0, 
# 971 "../apps/pkcs12.c" 3 4
...
# 971 "../apps/pkcs12.c"
    ...
    case 151:
        if (options & 0x4) {
            ...
            X509_SIG_get0(tp8, &tp8alg, 
# 982 "../apps/pkcs12.c" 3 4
                                       ((void *)0)
# 982 "../apps/pkcs12.c"
                                           );
            alg_print(tp8alg);
...
# 988 "../apps/pkcs12.c" 3 4
                                                             ((void *)0)
# 988 "../apps/pkcs12.c"
                                                                 )
            return 0;
        if ((pkey = EVP_PKCS82PKEY(p8)) == 
# 990 "../apps/pkcs12.c" 3 4
                                          ((void *)0)
# 990 "../apps/pkcs12.c"
                                              ) {
...
# 996 "../apps/pkcs12.c"
    ...
    case 152:
        ...
        if (PKCS12_SAFEBAG_get_bag_nid(bag) != 158)
            return 1;
        if ((x509 = PKCS12_SAFEBAG_get1_cert(bag)) == 
# 1013 "../apps/pkcs12.c" 3 4
                                                     ((void *)0)
# 1013 "../apps/pkcs12.c"
                                                         )
            return 0;
...
# 1052 "../apps/pkcs12.c" 3 4
                               ((void *)0)
# 1052 "../apps/pkcs12.c"
                                   ;
    struct stack_st_X509 *chn = 
# 1053 "../apps/pkcs12.c" 3 4
                         ((void *)0)
# 1053 "../apps/pkcs12.c"
                             ;
    int i = 0;
...
int cert_load(BIO *in, struct stack_st_X509 *sk)
{
    ...
    while ((cert = PEM_read_bio_X509(in, 
# 1172 "../apps/pkcs12.c" 3 4
                                        ((void *)0)
# 1172 "../apps/pkcs12.c"
                                            , 
# 1172 "../apps/pkcs12.c" 3 4
...
# 1172 "../apps/pkcs12.c"
        ...
        ret = 1;
        if (!OPENSSL_sk_push(ossl_check_X509_sk_type(sk), ossl_check_X509_type(cert)))
            return 0;
    }
    if (ret)
        ERR_clear_error();
...
void print_attribute(BIO *out, const ASN1_TYPE *av)
{
    ...
    case 30:
        ...
        BIO_printf(out, "%s\n", value);
        CRYPTO_free(value, "../apps/pkcs12.c", 1195);
        break;
                  ...
                  const char *name)
{
    ...
    if (!OPENSSL_sk_num(ossl_check_const_X509_ATTRIBUTE_sk_type(attrlst))) {
        BIO_printf(out, "%s: <Empty Attributes>\n", name);
        return 1;
    }
    BIO_printf(out, "%s\n", name);
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_ATTRIBUTE_sk_type(attrlst)); i++) {
        ASN1_OBJECT *attr_obj;
        attr = ((X509_ATTRIBUTE *)OPENSSL_sk_value(ossl_check_const_X509_ATTRIBUTE_sk_type(attrlst), (i)));
