...
typedef enum OPTION_choice {
    ...
    OPT_V__FIRST=2000, OPT_V_POLICY, OPT_V_PURPOSE, OPT_V_VERIFY_NAME, OPT_V_VERIFY_DEPTH, OPT_V_ATTIME, OPT_V_VERIFY_HOSTNAME, OPT_V_VERIFY_EMAIL, OPT_V_VERIFY_IP, OPT_V_IGNORE_CRITICAL, OPT_V_ISSUER_CHECKS, OPT_V_CRL_CHECK, OPT_V_CRL_CHECK_ALL, OPT_V_POLICY_CHECK, OPT_V_EXPLICIT_POLICY, OPT_V_INHIBIT_ANY, OPT_V_INHIBIT_MAP, OPT_V_X509_STRICT, OPT_V_EXTENDED_CRL, OPT_V_USE_DELTAS, OPT_V_POLICY_PRINT, OPT_V_CHECK_SS_SIG, OPT_V_TRUSTED_FIRST, OPT_V_SUITEB_128_ONLY, OPT_V_SUITEB_128, OPT_V_SUITEB_192, OPT_V_PARTIAL_CHAIN, OPT_V_NO_ALT_CHAINS, OPT_V_NO_CHECK_TIME, OPT_V_VERIFY_AUTH_LEVEL, OPT_V_ALLOW_PROXY_CERTS, OPT_V__LAST, OPT_NAMEOPT, OPT_VFYOPT,
    OPT_VERBOSE,
...
{
    ENGINE *e = 
# 81 "../apps/verify.c" 3 4
               ((void *)0)
# 81 "../apps/verify.c"
                   ;
    struct stack_st_X509 *untrusted = 
# 82 "../apps/verify.c" 3 4
                               ((void *)0)
# 82 "../apps/verify.c"
                                   , *trusted = 
# 82 "../apps/verify.c" 3 4
...
# 83 "../apps/verify.c" 3 4
                              ((void *)0)
# 83 "../apps/verify.c"
                                  ;
    struct stack_st_OPENSSL_STRING *vfyopts = 
# 84 "../apps/verify.c" 3 4
                                       ((void *)0)
# 84 "../apps/verify.c"
                                           ;
    X509_STORE *store = 
# 85 "../apps/verify.c" 3 4
                       ((void *)0)
# 85 "../apps/verify.c"
                           ;
    X509_VERIFY_PARAM *vpm = 
# 86 "../apps/verify.c" 3 4
                            ((void *)0)
# 86 "../apps/verify.c"
                                ;
    const char *prog, *CApath = 
# 87 "../apps/verify.c" 3 4
                               ((void *)0)
# 87 "../apps/verify.c"
                                   , *CAfile = 
# 87 "../apps/verify.c" 3 4
...
# 92 "../apps/verify.c"
 ...
 opthelp:
        ...
        case OPT_UNTRUSTED:
            ...
            if (!load_certs(opt_arg(), 0, &untrusted, 
# 148 "../apps/verify.c" 3 4
                                                     ((void *)0)
# 148 "../apps/verify.c"
                                                         ,
        ...
        case OPT_TRUSTED:
            ...
            noCApath = 1;
            noCAstore = 1;
            if (!load_certs(opt_arg(), 0, &trusted, 
# 157 "../apps/verify.c" 3 4
                                                   ((void *)0)
# 157 "../apps/verify.c"
        ...
        case OPT_CRLFILE:
            ...
            if (!load_crls(opt_arg(), &crls, 
# 162 "../apps/verify.c" 3 4
                                            ((void *)0)
# 162 "../apps/verify.c"
                                                , "other CRLs"))
                goto end;
        ...
        case OPT_CRL_DOWNLOAD:
            ...
            break;
        case OPT_ENGINE:
            if ((e = setup_engine_methods(opt_arg(), (unsigned int)-1, 0)) == 
# 169 "../apps/verify.c" 3 4
                                                   ((void *)0)
# 169 "../apps/verify.c"
                                                       ) {
    ...
    if (trusted != 
# 201 "../apps/verify.c" 3 4
                  ((void *)0)
        
# 202 "../apps/verify.c"
       && (CAfile != 
# 202 "../apps/verify.c" 3 4
                     ((void *)0) 
# 202 "../apps/verify.c"
                          || CApath != 
# 202 "../apps/verify.c" 3 4
...
# 210 "../apps/verify.c"
    ...
    if (argc < 1) {
        if (check(store, 
# 224 "../apps/verify.c" 3 4
                        ((void *)0)
# 224 "../apps/verify.c"
                            , untrusted, trusted, crls, show_chain,
                  vfyopts) != 1)
            ret = -1;
    } else {
        for (i = 0; i < argc; i++)
...
# 253 "../apps/verify.c" 3 4
                           ((void *)0)
# 253 "../apps/verify.c"
                               ;
    int num_untrusted;

    x = load_cert_pass(file, 0, 1, 
# 256 "../apps/verify.c" 3 4
       ((void *)0)
# 256 "../apps/verify.c"
       , "certificate file");
    if (x == 
# 257 "../apps/verify.c" 3 4
            ((void *)0)
# 257 "../apps/verify.c"
                )
        goto end;
    ...
    if (opts != 
# 260 "../apps/verify.c" 3 4
               ((void *)0)
# 260 "../apps/verify.c"
                   ) {
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(opts)); i++) {
            char *opt = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(opts), (i)));
...
# 284 "../apps/verify.c"
    ...
    if (tchain != 
# 287 "../apps/verify.c" 3 4
                 ((void *)0)
# 287 "../apps/verify.c"
                     )
        X509_STORE_CTX_set0_trusted_stack(csc, tchain);
    if (crls != 
# 289 "../apps/verify.c" 3 4
               ((void *)0)
# 289 "../apps/verify.c"
                   )
...
# 293 "../apps/verify.c"
        ...
        if (show_chain) {
            ...
            for (j = 0; j < OPENSSL_sk_num(ossl_check_const_X509_sk_type(chain)); j++) {
                X509 *cert = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(chain), (j)));
                BIO_printf(bio_out, "depth=%d: ", j);
                X509_NAME_print_ex_fp(
# 304 "../apps/verify.c" 3 4
                                     stdout
# 304 "../apps/verify.c"
                                           ,
