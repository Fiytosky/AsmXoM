...
typedef enum OPTION_choice {
    ...
    OPT_PROV__FIRST=1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY, OPT_PROV__LAST, OPT_R__FIRST=1500, OPT_R_RAND, OPT_R_WRITERAND, OPT_R__LAST
} OPTION_CHOICE;
...
static const char *param_datatype_2name(unsigned int type, int *ishex)
{
    *ishex = 0;
    ...
    case 2: return "uint";
    case 3: return "float";
    case 5: *ishex = 1; return "string";
    case 4: return "string";
    default:
        return 
# 73 "../apps/genpkey.c" 3 4
              ((void *)0)
# 73 "../apps/genpkey.c"
                  ;
    }
...
{
    CONF *conf = 
# 108 "../apps/genpkey.c" 3 4
                ((void *)0)
# 108 "../apps/genpkey.c"
                    ;
    BIO *in = 
# 109 "../apps/genpkey.c" 3 4
             ((void *)0)
# 109 "../apps/genpkey.c"
                 , *out = 
# 109 "../apps/genpkey.c" 3 4
...
# 109 "../apps/genpkey.c"
                                                 ;
    ENGINE *e = 
# 110 "../apps/genpkey.c" 3 4
               ((void *)0)
# 110 "../apps/genpkey.c"
                   ;
    EVP_PKEY *pkey = 
# 111 "../apps/genpkey.c" 3 4
                    ((void *)0)
# 111 "../apps/genpkey.c"
                        ;
    EVP_PKEY_CTX *ctx = 
# 112 "../apps/genpkey.c" 3 4
                       ((void *)0)
# 112 "../apps/genpkey.c"
                           ;
    char *outfile = 
# 113 "../apps/genpkey.c" 3 4
                   ((void *)0)
# 113 "../apps/genpkey.c"
                       , *passarg = 
# 113 "../apps/genpkey.c" 3 4
...
# 113 "../apps/genpkey.c"
                                                      , *prog, *p;
    char *outpubkeyfile = 
# 114 "../apps/genpkey.c" 3 4
                         ((void *)0)
# 114 "../apps/genpkey.c"
                             ;
    const char *ciphername = 
# 115 "../apps/genpkey.c" 3 4
                            ((void *)0)
# 115 "../apps/genpkey.c"
                                , *paramfile = 
# 115 "../apps/genpkey.c" 3 4
...
# 116 "../apps/genpkey.c"
    ...
    struct stack_st_OPENSSL_STRING *keyopt = 
# 121 "../apps/genpkey.c" 3 4
                                      ((void *)0)
# 121 "../apps/genpkey.c"
                                          ;
    ...
    keyopt = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null());
    if (keyopt == 
# 126 "../apps/genpkey.c" 3 4
                 ((void *)0)
# 126 "../apps/genpkey.c"
                     )
        goto end;
 ...
 opthelp:
        ...
        case OPT_ALGORITHM:
            ...
            break;
        case OPT_PKEYOPT:
            if (!OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(keyopt), ossl_check_OPENSSL_STRING_type(opt_arg())))
                goto end;
            break;
        case OPT_QUIET:
            verbose = 0;
...
# 211 "../apps/genpkey.c"
    ...
    if (ctx == 
# 215 "../apps/genpkey.c" 3 4
              ((void *)0)
# 215 "../apps/genpkey.c"
                  )
        goto opthelp;

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(keyopt)); i++) {
        p = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(keyopt), (i)));
...
# 228 "../apps/genpkey.c"
    ...
    if (!app_passwd(passarg, 
# 235 "../apps/genpkey.c" 3 4
                            ((void *)0)
# 235 "../apps/genpkey.c"
                                , &pass, 
# 235 "../apps/genpkey.c" 3 4
...
# 262 "../apps/genpkey.c" 3 4
       ((void) (0))
# 262 "../apps/genpkey.c"
                      ;
        rv = PEM_write_bio_PrivateKey(out, pkey, cipher, 
# 263 "../apps/genpkey.c" 3 4
                                                        ((void *)0)
# 263 "../apps/genpkey.c"
                                                            , 0, 
# 263 "../apps/genpkey.c" 3 4
...
# 267 "../apps/genpkey.c" 3 4
       ((void) (0))
# 267 "../apps/genpkey.c"
                      ;
        rv = i2d_PrivateKey_bio(out, pkey);
        if (rv > 0 && outpubkey != 
# 269 "../apps/genpkey.c" 3 4
                                  ((void *)0)
# 269 "../apps/genpkey.c"
                                      )
    ...
    if (text) {
        if (do_param)
            rv = EVP_PKEY_print_params(out, pkey, 0, 
# 285 "../apps/genpkey.c" 3 4
                                                    ((void *)0)
# 285 "../apps/genpkey.c"
                                                        );
        else
            rv = EVP_PKEY_print_private(out, pkey, 0, 
# 287 "../apps/genpkey.c" 3 4
                                                     ((void *)0)
# 287 "../apps/genpkey.c"
                                                         );
    ...
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(keyopt));
    if (ret != 0)
        ERR_print_errors(bio_err);
    EVP_PKEY_free(pkey);
    EVP_PKEY_CTX_free(ctx);
    ...
    BIO_free(in);
    release_engine(e);
    CRYPTO_free(pass, "../apps/genpkey.c", 306);
    NCONF_free(conf);
    return ret;
}
                            ...
                            OSSL_LIB_CTX *libctx, const char *propq)
{
    BIO *pbio;
    EVP_PKEY *pkey = 
# 315 "../apps/genpkey.c" 3 4
                    ((void *)0)
# 315 "../apps/genpkey.c"
                        ;
    EVP_PKEY_CTX *ctx = 
# 316 "../apps/genpkey.c" 3 4
                       ((void *)0)
# 316 "../apps/genpkey.c"
                           ;
    if (*pctx) {
...
# 323 "../apps/genpkey.c"
    ...
    pkey = PEM_read_bio_Parameters_ex(pbio, 
# 328 "../apps/genpkey.c" 3 4
                                           ((void *)0)
# 328 "../apps/genpkey.c"
                                               , libctx, propq);
    BIO_free(pbio);
