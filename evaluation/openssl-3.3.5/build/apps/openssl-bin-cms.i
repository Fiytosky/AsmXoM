...
*make_receipt_request(struct stack_st_OPENSSL_STRING *rr_to, int rr_allorfirst,
                      struct stack_st_OPENSSL_STRING *rr_from);
...
typedef enum OPTION_choice {
    ...
    OPT_PROV__FIRST=1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY, OPT_PROV__LAST, OPT_CONFIG,
...
const OPTIONS cms_options[] = {
    ...
    { OPT_SECTION_STR, 1, '-', "Operation" " options:\n" },
    ...
    { OPT_SECTION_STR, 1, '-', "File format" " options:\n" },
    ...
    { OPT_SECTION_STR, 1, '-', "Keys and passwords" " options:\n" },
    ...
    { OPT_SECTION_STR, 1, '-', "Signing" " options:\n" },
    ...
    { OPT_SECTION_STR, 1, '-', "Verification" " options:\n" },
    {"signer", -2, 's', "Signer certificate(s) output file"},
    {"content", OPT_CONTENT, '<',
    ...
    {"cades", -2, '-', "Check signingCertificate (CAdES-BES)"},
    ...
    { OPT_SECTION_STR, 1, '-', "Printing" " options:\n" },
    {"noout", OPT_NOOUT, '-',
...
# 286 "../apps/cms.c"
                         ;
    struct stack_st_OPENSSL_STRING *rr_to = 
# 287 "../apps/cms.c" 3 4
                                     ((void *)0)
# 287 "../apps/cms.c"
                                         , *rr_from = 
...
# 287 "../apps/cms.c"
                                                          ;
    struct stack_st_OPENSSL_STRING *sksigners = 
# 288 "../apps/cms.c" 3 4
                                         ((void *)0)
# 288 "../apps/cms.c"
                                             , *skkeys = 
...
# 288 "../apps/cms.c"
                                                             ;
    struct stack_st_X509 *encerts = ((struct stack_st_X509 *)OPENSSL_sk_new_null()), *other = 
# 289 "../apps/cms.c" 3 4
                                                          ((void *)0)
# 289 "../apps/cms.c"
                                                              ;
...
# 304 "../apps/cms.c"
    ...
    int verify_retcode = 0, rctformat = (7 | 0x8000), keyform = 0;
...
# 318 "../apps/cms.c"
 ...
 opthelp:
        ...
        case OPT_HELP:
            ...
            goto end;
        case OPT_INFORM:
            if (!opt_format(opt_arg(), (((1L << 1) | (1L << 2)) | (1L << 5)), &informat))
                goto opthelp;
            break;
        case OPT_OUTFORM:
            if (!opt_format(opt_arg(), (((1L << 1) | (1L << 2)) | (1L << 5)), &outformat))
                goto opthelp;
            break;
        case OPT_OUT:
            outfile = opt_arg();
        ...
        case OPT_DECRYPT:
            ...
            break;
        case OPT_SIGN:
            operation = (3 | 0x100 | 0x400);
            break;
        case OPT_VERIFY:
            operation = (4 | 0x200);
            break;
        case OPT_RESIGN:
            operation = (5 | 0x200 | 0x100 | 0x400);
            break;
        case OPT_SIGN_RECEIPT:
            operation = (6 | 0x200 | 0x100);
            break;
...
# 503 "../apps/cms.c"
               && (rr_from = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null())) == 
# 503 "../apps/cms.c" 3 4
                                                              ((void *)0)
# 503 "../apps/cms.c"
                                                                  )
                goto end;
            if (OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(rr_from), ossl_check_OPENSSL_STRING_type(opt_arg())) <= 0)
                goto end;
            break;
        case OPT_RR_TO:
            if (rr_to == 
...
# 510 "../apps/cms.c"
               && (rr_to = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null())) == 
# 510 "../apps/cms.c" 3 4
                                                            ((void *)0)
# 510 "../apps/cms.c"
                                                                )
                goto end;
            if (OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(rr_to), ossl_check_OPENSSL_STRING_type(opt_arg())) <= 0)
                goto end;
            break;
        case OPT_PRINT:
            noout = print = 1;
...
# 558 "../apps/cms.c"
            ...
            break;
        case OPT_ENGINE:
            e = setup_engine_methods(opt_arg(), (unsigned int)-1, 0);
            break;
        case OPT_PASSIN:
            passinarg = opt_arg();
            break;
...
# 588 "../apps/cms.c"
                   && (sksigners = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null())) == 
# 588 "../apps/cms.c" 3 4
                                                                    ((void *)0)
# 588 "../apps/cms.c"
                                                                        )
                    goto end;
                if (OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(sksigners), ossl_check_OPENSSL_STRING_type(signerfile)) <= 0)
                    goto end;
                if (keyfile == 
# 592 "../apps/cms.c" 3 4
                              ((void *)0)
...
# 595 "../apps/cms.c"
                   && (skkeys = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null())) == 
# 595 "../apps/cms.c" 3 4
                                                                 ((void *)0)
# 595 "../apps/cms.c"
                                                                     )
                    goto end;
                if (OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(skkeys), ossl_check_OPENSSL_STRING_type(keyfile)) <= 0)
                    goto end;
                keyfile = 
# 599 "../apps/cms.c" 3 4
                         ((void *)0)
...
# 620 "../apps/cms.c"
            ...
            break;
        case OPT_KEYFORM:
            if (!opt_format(opt_arg(), ( (1L << 1) | (1L << 2) | (1L << 3) | (1L << 4) | (1L << 5) | (1L << 6) | (1L << 7) | (1L << 8) | (1L << 9) | (1L << 10) | (1L << 11)), &keyform))
                goto opthelp;
            break;
        case OPT_RECIP:
            if (operation == (1 | 0x100)) {
                cert = load_cert_pass(opt_arg(), 0, 1, 
# 633 "../apps/cms.c" 3 4
                      ((void *)0)
# 633 "../apps/cms.c"
...
# 635 "../apps/cms.c"
                    ...
                    goto end;
                if (!OPENSSL_sk_push(ossl_check_X509_sk_type(encerts), ossl_check_X509_type(cert)))
                    goto end;
                cert = 
# 639 "../apps/cms.c" 3 4
                      ((void *)0)
# 639 "../apps/cms.c"
        ...
        case OPT_KEYOPT:
            keyidx = -1;
            if (operation == (1 | 0x100)) {
                if (OPENSSL_sk_num(ossl_check_const_X509_sk_type(encerts)) > 0)
                    keyidx += OPENSSL_sk_num(ossl_check_const_X509_sk_type(encerts));
            } else {
                if (keyfile != 
# 653 "../apps/cms.c" 3 4
                              ((void *)0) 
...
# 655 "../apps/cms.c"
                    ...
                    keyidx += OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(skkeys));
            }
            if (keyidx < 0) {
...
# 662 "../apps/cms.c" 3 4
                            ((void *)0) 
# 662 "../apps/cms.c"
                                 || key_param->idx != keyidx) {
                cms_key_param *nparam;
                nparam = app_malloc(sizeof(*nparam), "key param buffer");
                if ((nparam->param = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null())) == 
# 665 "../apps/cms.c" 3 4
                                                                     ((void *)0)
# 665 "../apps/cms.c"
                                                                         ) {
                    CRYPTO_free(nparam, "../apps/cms.c", 666);
                    goto end;
                }
                nparam->idx = keyidx;
                nparam->next = 
...
# 671 "../apps/cms.c"
            ...
            if (OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(key_param->param), ossl_check_OPENSSL_STRING_type(opt_arg())) <= 0)
                goto end;
            break;
...
# 789 "../apps/cms.c" 3 4
                           ((void *)0) 
# 789 "../apps/cms.c"
                                && OPENSSL_sk_num(ossl_check_const_X509_sk_type(encerts)) <= 0) {
...
# 815 "../apps/cms.c"
    ...
    if ((flags & 0x80) != 0) {
        ...
        if (!(operation & 0x200))
            informat = 2;
        if ((operation & 0x400) != 0 && (flags & 0x40) != 0)
            binary_files = 1;
        if ((operation & 0x200) != 0 && contfile == 
# 826 "../apps/cms.c" 3 4
                                                      ((void *)0)
...
# 856 "../apps/cms.c"
        ...
        if (!load_certs(certfile, 0, &other, 
# 857 "../apps/cms.c" 3 4
                                            ((void *)0)
# 857 "../apps/cms.c"
                                                , "certificate file")) {
...
# 863 "../apps/cms.c"
                         && (operation == (2 | 0x200))) {
        if ((recip = load_cert_pass(recipfile, 0, 1, 
# 864 "../apps/cms.c" 3 4
                    ((void *)0)
# 864 "../apps/cms.c"
                    , "recipient certificate file")
...
# 871 "../apps/cms.c"
        ...
        if ((originator = load_cert_pass(originatorfile, 0, 1, 
# 872 "../apps/cms.c" 3 4
                         ((void *)0)
# 872 "../apps/cms.c"
...
# 873 "../apps/cms.c"
    ...
    if (operation == (6 | 0x200 | 0x100)) {
        if ((signer = load_cert_pass(signerfile, 0, 1, 
# 880 "../apps/cms.c" 3 4
                     ((void *)0)
# 880 "../apps/cms.c"
...
# 881 "../apps/cms.c"
    ...
    if ((operation == (2 | 0x200)) || (operation == (1 | 0x100))) {
        if (keyfile == 
# 888 "../apps/cms.c" 3 4
                      ((void *)0)
# 888 "../apps/cms.c"
            ...
            keyfile = recipfile;
    } else if ((operation == (3 | 0x100 | 0x400)) || (operation == (6 | 0x200 | 0x100))) {
        if (keyfile == 
# 891 "../apps/cms.c" 3 4
                      ((void *)0)
# 891 "../apps/cms.c"
...
# 956 "../apps/cms.c"
        ...
        rcms = load_content_info(rctformat, rctin, 0, 
# 961 "../apps/cms.c" 3 4
                                                     ((void *)0)
# 961 "../apps/cms.c"
                                                         , "receipt");
...
# 968 "../apps/cms.c"
    ...
    if ((operation == (4 | 0x200)) || (operation == (7 | 0x200))) {
...
# 991 "../apps/cms.c" 3 4
                            ((void *)0)
# 991 "../apps/cms.c"
                                , in, cipher, flags, libctx, app_get0_propq());
        if (cms == 
# 992 "../apps/cms.c" 3 4
                  ((void *)0)
# 992 "../apps/cms.c"
            ...
            goto end;
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(encerts)); i++) {
            CMS_RecipientInfo *ri;
            cms_key_param *kparam;
            int tflags = flags | 0x40000;

            EVP_PKEY_CTX *pctx;
            X509 *x = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(encerts), (i)));
            int res;
...
# 1025 "../apps/cms.c"
                ...
                if (EVP_EncryptInit_ex(wctx, wrap_cipher, 
# 1028 "../apps/cms.c" 3 4
                                                         ((void *)0)
# 1028 "../apps/cms.c"
                                                             , 
...
# 1043 "../apps/cms.c"
            ...
            pwri_tmp = (unsigned char *)CRYPTO_strdup((char *)pwri_pass, "../apps/cms.c", 1044);
            if (pwri_tmp == 
# 1045 "../apps/cms.c" 3 4
                           ((void *)0)
# 1045 "../apps/cms.c"
...
# 1073 "../apps/cms.c"
            ...
            goto end;
        si = ((CMS_SignerInfo *)OPENSSL_sk_value(ossl_check_const_CMS_SignerInfo_sk_type(sis), (0)));
...
# 1094 "../apps/cms.c" 3 4
                                   ((void *)0)
# 1094 "../apps/cms.c"
                                       , other, in, flags, libctx, app_get0_propq());
            if (cms == 
# 1095 "../apps/cms.c" 3 4
                      ((void *)0)
# 1095 "../apps/cms.c"
...
# 1102 "../apps/cms.c"
        ...
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(sksigners)); i++) {
            CMS_SignerInfo *si;
            cms_key_param *kparam;
            int tflags = flags;
            signerfile = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(sksigners), (i)));
            keyfile = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(skkeys), (i)));

            signer = load_cert_pass(signerfile, 0, 1, 
# 1116 "../apps/cms.c" 3 4
                    ((void *)0)
# 1116 "../apps/cms.c"
                    , "signer certificate");
...
# 1147 "../apps/cms.c"
        ...
        if (operation == (3 | 0x100 | 0x400) && digestbin != 
# 1150 "../apps/cms.c" 3 4
                                                   ((void *)0)
...
# 1151 "../apps/cms.c"
           && (flags & 0x1000) == 0) {
            ...
            if (!CMS_final_digest(cms, digestbin, digestlen, 
# 1153 "../apps/cms.c" 3 4
                                                            ((void *)0)
# 1153 "../apps/cms.c"
                                                                , flags))
                goto end;
        } else if (operation == (3 | 0x100 | 0x400) && (flags & 0x1000) == 0) {
            if (!CMS_final(cms, in, 
# 1156 "../apps/cms.c" 3 4
                                   ((void *)0)
# 1156 "../apps/cms.c"
...
# 1194 "../apps/cms.c"
    ...
    } else if (operation == (15 | 0x200)) {
        if (!CMS_data(cms, out, flags))
            goto end;
    } else if (operation == (11 | 0x200)) {
        if (!CMS_uncompress(cms, indata, out, flags))
            goto end;
    } else if (operation == (9 | 0x200)) {
    ...
    } else if (operation == (13 | 0x200)) {
        if (!CMS_EncryptedData_decrypt(cms, secret_key, secret_keylen,
                                       indata, out, flags))
            goto end;
    } else if (operation == (4 | 0x200)) {
        if (CMS_verify(cms, other, store, indata, out, flags) > 0) {
            BIO_printf(bio_err, "%s Verification successful\n",
                       (flags & 0x100000) != 0 ? "CAdES" : "CMS");
        } else {
...
# 1226 "../apps/cms.c"
            ...
            struct stack_st_X509 *signers = CMS_get0_signers(cms);
...
# 1250 "../apps/cms.c"
                                     ;
                if (get_nameopt() != ((1 | 2 | 4 | 0x10 | 0x100 | 0x200) | 8 | (2 << 16) | (1 << 23) | 0)) {
                    pctx = ASN1_PCTX_new();
                    if (pctx != 
# 1253 "../apps/cms.c" 3 4
                               ((void *)0)
# 1253 "../apps/cms.c"
            ...
            if (operation == (5 | 0x200 | 0x100 | 0x400))
    ...
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(sksigners));
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(skkeys));
    CRYPTO_free(secret_key, "../apps/cms.c", 1296);
    CRYPTO_free(secret_keyid, "../apps/cms.c", 1297);
    CRYPTO_free(pwri_tmp, "../apps/cms.c", 1298);
    ASN1_OBJECT_free(econtent_type);
    CMS_ReceiptRequest_free(rr);
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(rr_to));
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(rr_from));
    for (key_param = key_first; key_param;) {
        cms_key_param *tparam;
        OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(key_param->param));
        tparam = key_param->next;
        CRYPTO_free(key_param, "../apps/cms.c", 1307);
        key_param = tparam;
    }
    ...
    BIO_free(indata);
    BIO_free_all(out);
    CRYPTO_free(digestbin, "../apps/cms.c", 1326);
    CRYPTO_free(passin, "../apps/cms.c", 1327);
    NCONF_free(conf);
    return ret;
}
...
# 1339 "../apps/cms.c"
        ...
        return 0;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(signers)); i++)
        PEM_write_bio_X509(tmp, ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(signers), (i))));
    BIO_free(tmp);
    return 1;
}
...
static void gnames_stack_print(struct stack_st_GENERAL_NAMES *gns)
{
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_GENERAL_NAMES_sk_type(gns)); i++) {
        gens = ((GENERAL_NAMES *)OPENSSL_sk_value(ossl_check_const_GENERAL_NAMES_sk_type(gns), (i)));
        for (j = 0; j < OPENSSL_sk_num(ossl_check_const_GENERAL_NAME_sk_type(gens)); j++) {
            gen = ((GENERAL_NAME *)OPENSSL_sk_value(ossl_check_const_GENERAL_NAME_sk_type(gens), (j)));
            BIO_puts(bio_err, "    ");
...
static void receipt_request_print(CMS_ContentInfo *cms)
{
    ...
    int i, rv;
    sis = CMS_get0_SignerInfos(cms);
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CMS_SignerInfo_sk_type(sis)); i++) {
        si = ((CMS_SignerInfo *)OPENSSL_sk_value(ossl_check_const_CMS_SignerInfo_sk_type(sis), (i)));
...
# 1436 "../apps/cms.c"
                           ;
    ret = ((struct stack_st_GENERAL_NAMES *)OPENSSL_sk_new_null());
    if (ret == 
# 1438 "../apps/cms.c" 3 4
              ((void *)0)
# 1438 "../apps/cms.c"
        ...
        goto err;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(ns)); i++) {
        char *str = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(ns), (i)));
        gen = a2i_GENERAL_NAME(
# 1442 "../apps/cms.c" 3 4
                              ((void *)0)
# 1442 "../apps/cms.c"
                                  , 
...
# 1446 "../apps/cms.c"
            ...
            goto err;
        if (!OPENSSL_sk_push(ossl_check_GENERAL_NAME_sk_type(gens), ossl_check_GENERAL_NAME_type(gen)))
            goto err;
        gen = 
# 1450 "../apps/cms.c" 3 4
             ((void *)0)
# 1450 "../apps/cms.c"
                 ;
        if (!OPENSSL_sk_push(ossl_check_GENERAL_NAMES_sk_type(ret), ossl_check_GENERAL_NAMES_type(gens)))
            goto err;
        gens = 
# 1453 "../apps/cms.c" 3 4
              ((void *)0)
# 1453 "../apps/cms.c"
 ...
 err:
    OPENSSL_sk_pop_free(ossl_check_GENERAL_NAMES_sk_type(ret),ossl_check_GENERAL_NAMES_freefunc_type(GENERAL_NAMES_free));
...
*make_receipt_request(struct stack_st_OPENSSL_STRING *rr_to, int rr_allorfirst,
                      struct stack_st_OPENSSL_STRING *rr_from)
{
    struct stack_st_GENERAL_NAMES *rct_to = 
# 1469 "../apps/cms.c" 3 4
                                     ((void *)0)
# 1469 "../apps/cms.c"
                                         , *rct_from = 
...
# 1480 "../apps/cms.c"
    ...
    rr = CMS_ReceiptRequest_create0_ex(
# 1482 "../apps/cms.c" 3 4
                                      ((void *)0)
# 1482 "../apps/cms.c"
                                          , -1, rr_allorfirst, rct_from,
...
# 1484 "../apps/cms.c"
    ...
    return rr;
 err:
    OPENSSL_sk_pop_free(ossl_check_GENERAL_NAMES_sk_type(rct_to),ossl_check_GENERAL_NAMES_freefunc_type(GENERAL_NAMES_free));
    OPENSSL_sk_pop_free(ossl_check_GENERAL_NAMES_sk_type(rct_from),ossl_check_GENERAL_NAMES_freefunc_type(GENERAL_NAMES_free));
    return 
# 1490 "../apps/cms.c" 3 4
          ((void *)0)
# 1490 "../apps/cms.c"
                              ...
                              struct stack_st_OPENSSL_STRING *param)
{
    char *keyopt;
    int i;
    if (OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(param)) <= 0)
        return 1;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(param)); i++) {
        keyopt = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(param), (i)));
