...
typedef enum OPTION_choice {
    ...
    OPT_KDFLEN, OPT_R__FIRST=1500, OPT_R_RAND, OPT_R_WRITERAND, OPT_R__LAST, OPT_PROV__FIRST=1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY, OPT_PROV__LAST,
    OPT_CONFIG,
...
const OPTIONS pkeyutl_options[] = {
    ...
    { OPT_SECTION_STR, 1, '-', "Signing/Derivation" " options:\n" },
    {"digest", OPT_DIGEST, 's',
...
{
    CONF *conf = 
# 106 "../apps/pkeyutl.c" 3 4
                ((void *)0)
# 106 "../apps/pkeyutl.c"
                    ;
    BIO *in = 
# 107 "../apps/pkeyutl.c" 3 4
             ((void *)0)
# 107 "../apps/pkeyutl.c"
                 , *out = 
# 107 "../apps/pkeyutl.c" 3 4
...
# 107 "../apps/pkeyutl.c"
                              ;
    ENGINE *e = 
# 108 "../apps/pkeyutl.c" 3 4
               ((void *)0)
# 108 "../apps/pkeyutl.c"
                   ;
    EVP_PKEY_CTX *ctx = 
# 109 "../apps/pkeyutl.c" 3 4
                       ((void *)0)
# 109 "../apps/pkeyutl.c"
                           ;
    EVP_PKEY *pkey = 
# 110 "../apps/pkeyutl.c" 3 4
                    ((void *)0)
# 110 "../apps/pkeyutl.c"
                        ;
    char *infile = 
# 111 "../apps/pkeyutl.c" 3 4
                  ((void *)0)
# 111 "../apps/pkeyutl.c"
                      , *outfile = 
# 111 "../apps/pkeyutl.c" 3 4
...
# 113 "../apps/pkeyutl.c"
    ...
    int keyform = 0, peerform = 0;
    int keysize = -1, pkey_op = (1<<4), key_type = 1;
    int engine_impl = 0;
    int ret = 1, rv = -1;
    size_t buf_outlen;
    const char *inkey = 
# 121 "../apps/pkeyutl.c" 3 4
                       ((void *)0)
# 121 "../apps/pkeyutl.c"
                           ;
    const char *peerkey = 
# 122 "../apps/pkeyutl.c" 3 4
                         ((void *)0)
# 122 "../apps/pkeyutl.c"
                             ;
    const char *kdfalg = 
# 123 "../apps/pkeyutl.c" 3 4
                        ((void *)0)
# 123 "../apps/pkeyutl.c"
                            , *digestname = 
# 123 "../apps/pkeyutl.c" 3 4
...
# 125 "../apps/pkeyutl.c" 3 4
                                        ((void *)0)
# 125 "../apps/pkeyutl.c"
                                            ;
    struct stack_st_OPENSSL_STRING *pkeyopts_passin = 
# 126 "../apps/pkeyutl.c" 3 4
                                               ((void *)0)
# 126 "../apps/pkeyutl.c"
                                                   ;
    int rawin = 0;
    EVP_MD_CTX *mctx = 
# 128 "../apps/pkeyutl.c" 3 4
                      ((void *)0)
# 128 "../apps/pkeyutl.c"
                          ;
    EVP_MD *md = 
# 129 "../apps/pkeyutl.c" 3 4
                ((void *)0)
# 129 "../apps/pkeyutl.c"
                    ;
    int filesize = -1;
 ...
 opthelp:
        ...
        case OPT_PASSIN:
            ...
            break;
        case OPT_PEERFORM:
            if (!opt_format(opt_arg(), ( (1L << 1) | (1L << 2) | (1L << 3) | (1L << 4) | (1L << 5) | (1L << 6) | (1L << 7) | (1L << 8) | (1L << 9) | (1L << 10) | (1L << 11)), &peerform))
                goto opthelp;
            break;
        case OPT_KEYFORM:
...
# 180 "../apps/pkeyutl.c"
        ...
        case OPT_PKEYOPT:
            if ((pkeyopts == 
# 232 "../apps/pkeyutl.c" 3 4
                            ((void *)0) 
# 232 "../apps/pkeyutl.c"
                                 &&
                 (pkeyopts = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null())) == 
# 233 "../apps/pkeyutl.c" 3 4
                                                             ((void *)0)
# 233 "../apps/pkeyutl.c"
                                                                 ) ||
                OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(pkeyopts), ossl_check_OPENSSL_STRING_type(opt_arg())) == 0) {
        ...
        case OPT_PKEYOPT_PASSIN:
            if ((pkeyopts_passin == 
# 240 "../apps/pkeyutl.c" 3 4
                                   ((void *)0) 
# 240 "../apps/pkeyutl.c"
                                        &&
                 (pkeyopts_passin = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null())) == 
# 241 "../apps/pkeyutl.c" 3 4
                                                                    ((void *)0)
# 241 "../apps/pkeyutl.c"
                                                                        ) ||
                OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(pkeyopts_passin), ossl_check_OPENSSL_STRING_type(opt_arg())) == 0) {
                BIO_puts(bio_err, "out of memory\n");
                goto end;
            }
            break;
...
# 257 "../apps/pkeyutl.c"
    ...
    if (rawin && pkey_op != (1<<4) && pkey_op != (1<<5)) {
        BIO_printf(bio_err,
...
# 308 "../apps/pkeyutl.c"
    ...
    if (peerkey != 
# 312 "../apps/pkeyutl.c" 3 4
                  ((void *)0) 
# 312 "../apps/pkeyutl.c"
                       && !setup_peer(ctx, peerform, peerkey, e)) {
        BIO_printf(bio_err, "%s: Error setting up peer key\n", prog);
        goto end;
    }
    if (pkeyopts != 
# 316 "../apps/pkeyutl.c" 3 4
                   ((void *)0)
# 316 "../apps/pkeyutl.c"
                       ) {
        int num = OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(pkeyopts));
        int i;

        for (i = 0; i < num; ++i) {
            const char *opt = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(pkeyopts), (i)));
    ...
    if (pkeyopts_passin != 
# 330 "../apps/pkeyutl.c" 3 4
                          ((void *)0)
# 330 "../apps/pkeyutl.c"
                              ) {
        int num = OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(pkeyopts_passin));
        int i;

        for (i = 0; i < num; i++) {
            char *opt = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(pkeyopts_passin), (i)));
            char *passin = strchr(opt, ':');
            char *passwd;

            if (passin == 
# 339 "../apps/pkeyutl.c" 3 4
                         ((void *)0)
# 339 "../apps/pkeyutl.c"
                             ) {
                ...
                passwd = CRYPTO_strdup(passwd_buf, "../apps/pkeyutl.c", 354);
                if (passwd == 
# 355 "../apps/pkeyutl.c" 3 4
                             ((void *)0)
# 355 "../apps/pkeyutl.c"
                                 ) {
                    BIO_puts(bio_err, "out of memory\n");
                ...
                *passin = 0;
                passin++;
                if (app_passwd(passin, 
# 364 "../apps/pkeyutl.c" 3 4
                                      ((void *)0)
# 364 "../apps/pkeyutl.c"
                                          , &passwd, 
# 364 "../apps/pkeyutl.c" 3 4
...
# 364 "../apps/pkeyutl.c"
            ...
            if (EVP_PKEY_CTX_ctrl_str(ctx, opt, passwd) <= 0) {
                BIO_printf(bio_err, "%s: Can't set parameter \"%s\":\n",
                           prog, opt);
                CRYPTO_free(passwd, "../apps/pkeyutl.c", 373);
                goto end;
            }
            CRYPTO_free(passwd, "../apps/pkeyutl.c", 376);
        }
    }

    if (sigfile != 
# 380 "../apps/pkeyutl.c" 3 4
                  ((void *)0) 
# 380 "../apps/pkeyutl.c"
                       && (pkey_op != (1<<5))) {
        BIO_printf(bio_err,
...
# 386 "../apps/pkeyutl.c"
    ...
    if (pkey_op != (1<<11)) {
        ...
        if (infile != 
# 394 "../apps/pkeyutl.c" 3 4
                     ((void *)0)
# 394 "../apps/pkeyutl.c"
                         ) {
            struct stat st;

            if (stat(infile, &st) == 0 && st.st_size <= 0x7fffffff
# 397 "../apps/pkeyutl.c"
                                                              )
                filesize = (int)st.st_size;
        }
        if (in == 
# 400 "../apps/pkeyutl.c" 3 4
                 ((void *)0)
# 400 "../apps/pkeyutl.c"
                     )
            goto end;
...
# 477 "../apps/pkeyutl.c"
    ...
    BIO_free(in);
    BIO_free_all(out);
    CRYPTO_free(buf_in, "../apps/pkeyutl.c", 515);
    CRYPTO_free(buf_out, "../apps/pkeyutl.c", 516);
    CRYPTO_free(sig, "../apps/pkeyutl.c", 517);
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(pkeyopts));
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(pkeyopts_passin));
    NCONF_free(conf);
    return ret;
}
...
{
    EVP_PKEY *pkey = 
# 531 "../apps/pkeyutl.c" 3 4
                    ((void *)0)
# 531 "../apps/pkeyutl.c"
                        ;
    EVP_PKEY_CTX *ctx = 
# 532 "../apps/pkeyutl.c" 3 4
                       ((void *)0)
# 532 "../apps/pkeyutl.c"
                           ;
    ENGINE *impl = 
# 533 "../apps/pkeyutl.c" 3 4
                  ((void *)0)
# 533 "../apps/pkeyutl.c"
                      ;
    char *passin = 
# 534 "../apps/pkeyutl.c" 3 4
                  ((void *)0)
# 534 "../apps/pkeyutl.c"
                      ;
    int rv = -1;
    ...
    if (((pkey_op == (1<<4)) || (pkey_op == (1<<10))
         || (pkey_op == (1<<11)))
        && (key_type != 1 && kdfalg == 
# 540 "../apps/pkeyutl.c" 3 4
                                                ((void *)0)
# 540 "../apps/pkeyutl.c"
                                                    )) {
...
# 544 "../apps/pkeyutl.c"
    ...
    case 2:
        pkey = load_pubkey(keyfile, keyform, 0, 
# 554 "../apps/pkeyutl.c" 3 4
                                               ((void *)0)
# 554 "../apps/pkeyutl.c"
                                                   , e, "public key");
        break;
    ...
    case 3:
        x = load_cert_pass(keyfile, keyform, 1, 
# 558 "../apps/pkeyutl.c" 3 4
           ((void *)0)
# 558 "../apps/pkeyutl.c"
           , "Certificate");
        if (x) {
...
# 604 "../apps/pkeyutl.c"
    ...
    if (rawin) {
        ...
        switch (pkey_op) {
        case (1<<4):
            rv = EVP_DigestSignInit_ex(mctx, 
# 612 "../apps/pkeyutl.c" 3 4
                                            ((void *)0)
# 612 "../apps/pkeyutl.c"
                                                , digestname, libctx, propq,
                                       pkey, 
# 613 "../apps/pkeyutl.c" 3 4
                                            ((void *)0)
# 613 "../apps/pkeyutl.c"
                                                );
            break;
        ...
        case (1<<5):
            rv = EVP_DigestVerifyInit_ex(mctx, 
# 617 "../apps/pkeyutl.c" 3 4
                                              ((void *)0)
# 617 "../apps/pkeyutl.c"
                                                  , digestname, libctx, propq,
                                         pkey, 
# 618 "../apps/pkeyutl.c" 3 4
                                              ((void *)0)
# 618 "../apps/pkeyutl.c"
                                                  );
            break;
...
# 652 "../apps/pkeyutl.c"
    ...
    CRYPTO_free(passin, "../apps/pkeyutl.c", 656);
    return ctx;
...
{
    EVP_PKEY *peer = 
# 664 "../apps/pkeyutl.c" 3 4
                    ((void *)0)
# 664 "../apps/pkeyutl.c"
                        ;
    ENGINE *engine = 
# 665 "../apps/pkeyutl.c" 3 4
                    ((void *)0)
# 665 "../apps/pkeyutl.c"
                        ;
    int ret;
    ...
    if (peerform == 8)
        engine = e;
    peer = load_pubkey(file, peerform, 0, 
# 670 "../apps/pkeyutl.c" 3 4
                                         ((void *)0)
# 670 "../apps/pkeyutl.c"
                                             , engine, "peer key");
    if (peer == 
# 671 "../apps/pkeyutl.c" 3 4
               ((void *)0)
# 671 "../apps/pkeyutl.c"
                   ) {
...
# 721 "../apps/pkeyutl.c"
    ...
    if (EVP_PKEY_get_id(pkey) == 1087
            || EVP_PKEY_get_id(pkey) == 1088) {
        if (filesize < 0) {
            BIO_printf(bio_err,
        ...
        case (1<<4):
            ...
            rv = EVP_DigestSign(mctx, 
# 748 "../apps/pkeyutl.c" 3 4
                                     ((void *)0)
# 748 "../apps/pkeyutl.c"
                                         , poutlen, mbuf, buf_len);
            if (rv == 1 && out != 
# 749 "../apps/pkeyutl.c" 3 4
                                 ((void *)0)
# 749 "../apps/pkeyutl.c"
                                     ) {
    ...
    case (1<<4):
        ...
        rv = EVP_DigestSignFinal(mctx, 
# 791 "../apps/pkeyutl.c" 3 4
                                      ((void *)0)
# 791 "../apps/pkeyutl.c"
                                          , poutlen);
        if (rv == 1 && out != 
# 792 "../apps/pkeyutl.c" 3 4
                             ((void *)0)
# 792 "../apps/pkeyutl.c"
                                 ) {
            *out = app_malloc(*poutlen, "buffer output");
    ...
    CRYPTO_free(mbuf, "../apps/pkeyutl.c", 800);
    return rv;
}
