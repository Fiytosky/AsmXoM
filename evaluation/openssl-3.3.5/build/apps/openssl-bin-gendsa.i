...
{
    ENGINE *e = 
# 56 "../apps/gendsa.c" 3 4
               ((void *)0)
# 56 "../apps/gendsa.c"
                   ;
    BIO *out = 
# 57 "../apps/gendsa.c" 3 4
              ((void *)0)
# 57 "../apps/gendsa.c"
                  , *in = 
# 57 "../apps/gendsa.c" 3 4
...
# 57 "../apps/gendsa.c"
                              ;
    EVP_PKEY *pkey = 
# 58 "../apps/gendsa.c" 3 4
                    ((void *)0)
# 58 "../apps/gendsa.c"
                        ;
    EVP_PKEY_CTX *ctx = 
# 59 "../apps/gendsa.c" 3 4
                       ((void *)0)
# 59 "../apps/gendsa.c"
                           ;
    EVP_CIPHER *enc = 
# 60 "../apps/gendsa.c" 3 4
                     ((void *)0)
# 60 "../apps/gendsa.c"
                         ;
    char *dsaparams = 
# 61 "../apps/gendsa.c" 3 4
                     ((void *)0)
# 61 "../apps/gendsa.c"
                         , *ciphername = 
# 61 "../apps/gendsa.c" 3 4
...
# 121 "../apps/gendsa.c"
    ...
    pkey = load_keyparams(dsaparams, 0, 1, "DSA", "DSA parameters");

    out = bio_open_owner(outfile, (5 | 0x8000), private);
    if (out == 
# 129 "../apps/gendsa.c" 3 4
              ((void *)0)
# 129 "../apps/gendsa.c"
                  )
        goto end2;
...
# 154 "../apps/gendsa.c" 3 4
   ((void) (0))
# 154 "../apps/gendsa.c"
                  ;
    if (!PEM_write_bio_PrivateKey(out, pkey, enc, 
# 155 "../apps/gendsa.c" 3 4
                                                 ((void *)0)
# 155 "../apps/gendsa.c"
                                                     , 0, 
# 155 "../apps/gendsa.c" 3 4
...
# 155 "../apps/gendsa.c"
 ...
 end2:
    ...
    EVP_CIPHER_free(enc);
    release_engine(e);
    CRYPTO_free(passout, "../apps/gendsa.c", 170);
    return ret;
}
