...
const OPTIONS asn1parse_options[] = {
    ...
    { OPT_SECTION_STR, 1, '-', "Formatting" " options:\n" },
    {"i", OPT_INDENT, 0, "indents the output"},
    {"dump", OPT_DUMP, 0, "unknown data in hex form"},
    {"dlimit", OPT_DLIMIT, 'p',
     "dump the first arg bytes of unknown data in hex form"},
    {
# 56 "../apps/asn1parse.c" 3 4
    ((void *)0)
# 56 "../apps/asn1parse.c"
        }
};
...
{
    ASN1_TYPE *at = 
# 63 "../apps/asn1parse.c" 3 4
                   ((void *)0)
# 63 "../apps/asn1parse.c"
                       ;
    BIO *in = 
# 64 "../apps/asn1parse.c" 3 4
             ((void *)0)
# 64 "../apps/asn1parse.c"
                 , *b64 = 
# 64 "../apps/asn1parse.c" 3 4
...
# 64 "../apps/asn1parse.c"
                                              ;
    BUF_MEM *buf = 
# 65 "../apps/asn1parse.c" 3 4
                  ((void *)0)
# 65 "../apps/asn1parse.c"
                      ;
    struct stack_st_OPENSSL_STRING *osk = 
# 66 "../apps/asn1parse.c" 3 4
                                   ((void *)0)
# 66 "../apps/asn1parse.c"
                                       ;
    char *genstr = 
# 67 "../apps/asn1parse.c" 3 4
                  ((void *)0)
# 67 "../apps/asn1parse.c"
                      , *genconf = 
# 67 "../apps/asn1parse.c" 3 4
...
# 68 "../apps/asn1parse.c"
                                                        ;
    unsigned char *str = 
# 69 "../apps/asn1parse.c" 3 4
                        ((void *)0)
# 69 "../apps/asn1parse.c"
                            ;
    char *name = 
# 70 "../apps/asn1parse.c" 3 4
                ((void *)0)
# 70 "../apps/asn1parse.c"
                    , *header = 
# 70 "../apps/asn1parse.c" 3 4
...
# 70 "../apps/asn1parse.c"
    ...
    int indent = 0, noout = 0, dump = 0, informat = (5 | 0x8000);
...
# 78 "../apps/asn1parse.c"
    ...
    if ((osk = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null())) == 
# 82 "../apps/asn1parse.c" 3 4
                                               ((void *)0)
# 82 "../apps/asn1parse.c"
                                                   ) {
 ...
 opthelp:
        ...
        case OPT_HELP:
            ...
            goto end;
        case OPT_INFORM:
            if (!opt_format(opt_arg(), ((1L << 1) | (1L << 2) | (1L << 3)), &informat))
                goto opthelp;
            break;
        case OPT_IN:
            infile = opt_arg();
        ...
        case OPT_OID:
            ...
            break;
        case OPT_OFFSET:
            offset = strtol(opt_arg(), 
# 118 "../apps/asn1parse.c" 3 4
                                      ((void *)0)
# 118 "../apps/asn1parse.c"
                                          , 0);
            break;
        case OPT_LENGTH:
            length = strtol(opt_arg(), 
# 121 "../apps/asn1parse.c" 3 4
                                      ((void *)0)
# 121 "../apps/asn1parse.c"
                                          , 0);
            break;
        case OPT_DUMP:
            dump = -1;
        ...
        case OPT_DLIMIT:
            dump = strtol(opt_arg(), 
# 127 "../apps/asn1parse.c" 3 4
                                    ((void *)0)
# 127 "../apps/asn1parse.c"
                                        , 0);
            break;
        case OPT_STRPARSE:
            if (OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(osk), ossl_check_OPENSSL_STRING_type(opt_arg())) <= 0)
                goto end;
            break;
        case OPT_GENSTR:
            genstr = opt_arg();
        ...
        case OPT_ITEM:
            ...
            if (it == 
# 145 "../apps/asn1parse.c" 3 4
                     ((void *)0)
# 145 "../apps/asn1parse.c"
                         ) {
                size_t tmp;
                ...
                for (tmp = 0;; tmp++) {
                    ...
                    if (it == 
# 152 "../apps/asn1parse.c" 3 4
                             ((void *)0)
# 152 "../apps/asn1parse.c"
                                 )
                        break;
...
# 163 "../apps/asn1parse.c" 3 4
                           ((void *)0)
# 163 "../apps/asn1parse.c"
                               ))
        goto opthelp;

    if (oidfile != 
# 166 "../apps/asn1parse.c" 3 4
                  ((void *)0)
# 166 "../apps/asn1parse.c"
                      ) {
        in = bio_open_default(oidfile, 'r', (1 | 0x8000));
        if (in == 
# 168 "../apps/asn1parse.c" 3 4
                 ((void *)0)
# 168 "../apps/asn1parse.c"
                     )
            goto end;
...
# 174 "../apps/asn1parse.c" 3 4
                                                         ((void *)0)
# 174 "../apps/asn1parse.c"
                                                             )
        goto end;

    if (derfile && (derout = bio_open_default(derfile, 'w', 4)) == 
# 177 "../apps/asn1parse.c" 3 4
                                                                            ((void *)0)
# 177 "../apps/asn1parse.c"
                                                                                )
        goto end;

    if ((buf = BUF_MEM_new()) == 
# 180 "../apps/asn1parse.c" 3 4
                                ((void *)0)
# 180 "../apps/asn1parse.c"
                                    )
        goto end;
    if (genconf == 
# 182 "../apps/asn1parse.c" 3 4
                  ((void *)0) 
# 182 "../apps/asn1parse.c"
                       && genstr == 
# 182 "../apps/asn1parse.c" 3 4
                                    ((void *)0) 
# 182 "../apps/asn1parse.c"
        ...
        if (!BUF_MEM_grow(buf, 
# 191 "../apps/asn1parse.c" 3 4
                              8192 
# 191 "../apps/asn1parse.c"
                                     * 8))
            goto end;
        ...
        if (genstr || genconf) {
            ...
            if (informat == (3 | 0x8000)) {
                BIO *tmp;

                if ((b64 = BIO_new(BIO_f_base64())) == 
# 205 "../apps/asn1parse.c" 3 4
                                                      ((void *)0)
# 205 "../apps/asn1parse.c"
                                                          )
                    goto end;
                BIO_push(b64, in);
                tmp = in;
            ...
            num = 0;
            for (;;) {
                if (!BUF_MEM_grow(buf, num + 
# 215 "../apps/asn1parse.c" 3 4
                                            8192
# 215 "../apps/asn1parse.c"
                                                  ))
                    goto end;
                i = BIO_read(in, &(buf->data[num]), 
# 217 "../apps/asn1parse.c" 3 4
                                                   8192
# 217 "../apps/asn1parse.c"
                                                         );
                if (i <= 0)
                    break;
                num += i;
    ...
    if (OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(osk))) {
        tmpbuf = str;
        tmplen = num;
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(osk)); i++) {
            ASN1_TYPE *atmp;
            int typ;
            j = strtol(((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(osk), (i))), 
# 235 "../apps/asn1parse.c" 3 4
                                                       ((void *)0)
# 235 "../apps/asn1parse.c"
                                                           , 0);
            if (j <= 0 || j >= tmplen) {
                BIO_printf(bio_err, "'%s' is out of range\n",
                           ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(osk), (i))));
                continue;
            }
            tmpbuf += j;
            tmplen -= j;
            ...
            ctmpbuf = tmpbuf;
            at = d2i_ASN1_TYPE(
# 245 "../apps/asn1parse.c" 3 4
                              ((void *)0)
# 245 "../apps/asn1parse.c"
                                  , &ctmpbuf, tmplen);
            ASN1_TYPE_free(atmp);
            if (!at) {
    ...
    if (derout != 
# 277 "../apps/asn1parse.c" 3 4
                 ((void *)0)
# 277 "../apps/asn1parse.c"
                     ) {
    ...
    if (!noout) {
        ...
        if (it != 
# 287 "../apps/asn1parse.c" 3 4
                 ((void *)0)
# 287 "../apps/asn1parse.c"
                     ) {
            ASN1_VALUE *value = ASN1_item_d2i(
# 288 "../apps/asn1parse.c" 3 4
                                             ((void *)0)
# 288 "../apps/asn1parse.c"
                                                 , &p, length, it);
            if (value == 
# 289 "../apps/asn1parse.c" 3 4
                        ((void *)0)
# 289 "../apps/asn1parse.c"
                            ) {
                BIO_printf(bio_err, "Error parsing item %s\n", it->sname);
                ERR_print_errors(bio_err);
                goto end;
            }
            ASN1_item_print(bio_out, value, 0, it, 
# 294 "../apps/asn1parse.c" 3 4
                                                  ((void *)0)
# 294 "../apps/asn1parse.c"
                                                      );
    ...
    if (ret != 0)
        ERR_print_errors(bio_err);
    BUF_MEM_free(buf);
    CRYPTO_free(name, "../apps/asn1parse.c", 311);
    CRYPTO_free(header, "../apps/asn1parse.c", 312);
    ASN1_TYPE_free(at);
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(osk));
    return ret;
}
...
{
    CONF *cnf = 
# 320 "../apps/asn1parse.c" 3 4
               ((void *)0)
# 320 "../apps/asn1parse.c"
                   ;
    int len;
    unsigned char *p;
    ASN1_TYPE *atyp = 
# 323 "../apps/asn1parse.c" 3 4
                     ((void *)0)
# 323 "../apps/asn1parse.c"
                         ;

    if (genconf != 
# 325 "../apps/asn1parse.c" 3 4
                  ((void *)0)
# 325 "../apps/asn1parse.c"
                      ) {
        if ((cnf = app_load_config_internal(genconf, 0)) == 
# 326 "../apps/asn1parse.c" 3 4
                                               ((void *)0)
# 326 "../apps/asn1parse.c"
                                                   )
            goto err;
        if (genstr == 
# 328 "../apps/asn1parse.c" 3 4
                     ((void *)0)
# 328 "../apps/asn1parse.c"
                         )
            genstr = NCONF_get_string(cnf, "default", "asn1");
        if (genstr == 
# 330 "../apps/asn1parse.c" 3 4
                     ((void *)0)
# 330 "../apps/asn1parse.c"
                         ) {
    ...
    NCONF_free(cnf);
    cnf = 
# 338 "../apps/asn1parse.c" 3 4
         ((void *)0)
# 338 "../apps/asn1parse.c"
             ;

    if (atyp == 
# 340 "../apps/asn1parse.c" 3 4
               ((void *)0)
# 340 "../apps/asn1parse.c"
                   )
        return -1;

    len = i2d_ASN1_TYPE(atyp, 
# 343 "../apps/asn1parse.c" 3 4
                             ((void *)0)
# 343 "../apps/asn1parse.c"
                                 );
