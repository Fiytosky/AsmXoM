...
# 145 "../apps/srp.c" 3 4
       ((void *)0)
# 145 "../apps/srp.c"
       ) ? 0 : (OPENSSL_die("assertion failed: " "srp_usersalt != NULL", "../apps/srp.c", 145), 1));
...
typedef enum OPTION_choice {
    ...
    OPT_PASSIN, OPT_PASSOUT, OPT_ENGINE, OPT_R__FIRST=1500, OPT_R_RAND, OPT_R_WRITERAND, OPT_R__LAST, OPT_PROV__FIRST=1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY, OPT_PROV__LAST
} OPTION_CHOICE;
...
# 457 "../apps/srp.c"
                ...
                row[3] = CRYPTO_strdup(user, "../apps/srp.c", 465);
                row[0] = CRYPTO_strdup("v", "../apps/srp.c", 466);
                row[4] = CRYPTO_strdup(gNid, "../apps/srp.c", 467);
...
# 473 "../apps/srp.c"
                    ...
                    || (userinfo
                        && ((row[5] = CRYPTO_strdup(userinfo, "../apps/srp.c", 475)) == 
# 475 "../apps/srp.c" 3 4
                                                                           ((void *)0)
# 475 "../apps/srp.c"
                                                                               ))
                    || !update_index(db, row)) {
                    CRYPTO_free(row[3], "../apps/srp.c", 477);
                    CRYPTO_free(row[4], "../apps/srp.c", 478);
                    CRYPTO_free(row[5], "../apps/srp.c", 479);
                    CRYPTO_free(row[0], "../apps/srp.c", 480);
                    CRYPTO_free(row[1], "../apps/srp.c", 481);
                    CRYPTO_free(row[2], "../apps/srp.c", 482);
                    goto end;
                }
                doupdatedb = 1;
            }
...
# 540 "../apps/srp.c"
                    ...
                    row[0][0] = 'v';
                    row[4] = CRYPTO_strdup(gNid, "../apps/srp.c", 550);
...
# 557 "../apps/srp.c"
                       || (userinfo
                            && ((row[5] = CRYPTO_strdup(userinfo, "../apps/srp.c", 558))
                                == 
# 559 "../apps/srp.c" 3 4
                                  ((void *)0)
# 559 "../apps/srp.c"
...
# 580 "../apps/srp.c"
    ...
    CRYPTO_free(passin, "../apps/srp.c", 623);
    CRYPTO_free(passout, "../apps/srp.c", 624);
    if (ret)
