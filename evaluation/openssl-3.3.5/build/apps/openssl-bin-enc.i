...
typedef enum OPTION_choice {
    ...
    OPT_SALTLEN, OPT_R__FIRST=1500, OPT_R_RAND, OPT_R_WRITERAND, OPT_R__LAST, OPT_PROV__FIRST=1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY, OPT_PROV__LAST
} OPTION_CHOICE;
...
const OPTIONS enc_options[] = {
    ...
    { OPT_SECTION_STR, 1, '-', "Encryption" " options:\n" },
    ...
    {OPT_MORE_STR, 0, 0, "Default: " "10000"},
    {"pbkdf2", OPT_PBKDF2, '-',
...
# 327 "../apps/enc.c"
    ...
    if (!opt_cipher(ciphername, &cipher))
        goto opthelp;
    if (cipher && (EVP_CIPHER_get_mode(cipher) == 0x10002)) {
        wrap = 1;
        streamable = 0;
    }
    if (digestname != 
...
# 625 "../apps/enc.c"
        ...
        BIO_ctrl(benc,129,0,(&ctx));

        if (wrap == 1)
            EVP_CIPHER_CTX_set_flags(ctx, 0x1);

        if (!EVP_CipherInit_ex(ctx, cipher, e, 
# 638 "../apps/enc.c" 3 4
                                              ((void *)0)
# 638 "../apps/enc.c"
                                                  , 
...
# 688 "../apps/enc.c"
    ...
    while ((int)BIO_ctrl(rbio,10,0,
# 691 "../apps/enc.c" 3 4
          ((void *)0)
# 691 "../apps/enc.c"
          ) || !(int)BIO_ctrl(rbio,2,0,
# 691 "../apps/enc.c" 3 4
                                ((void *)0)
# 691 "../apps/enc.c"
                                )) {
        ...
        if (inl <= 0)
            break;
        if (!streamable && !(int)BIO_ctrl(rbio,2,0,
# 695 "../apps/enc.c" 3 4
                           ((void *)0)
# 695 "../apps/enc.c"
                           )) {
...
# 706 "../apps/enc.c"
    ...
    ERR_print_errors(bio_err);
    CRYPTO_free(strbuf, "../apps/enc.c", 721);
    CRYPTO_free(buff, "../apps/enc.c", 722);
    BIO_free(in);
    BIO_free_all(out);
    BIO_free(benc);
    BIO_free(b64);
    ...
    BIO_free(bzstd);
    release_engine(e);
    CRYPTO_free(pass, "../apps/enc.c", 735);
    return ret;
}
...
# 750 "../apps/enc.c"
           || (EVP_CIPHER_get_flags(cipher) & 0x200000) != 0
            || EVP_CIPHER_get_mode(cipher) == 0x10001)
        return;
