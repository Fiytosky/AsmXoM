...
typedef enum OPTION_choice {
    ...
    OPT_R__FIRST=1500, OPT_R_RAND, OPT_R_WRITERAND, OPT_R__LAST, OPT_PROV__FIRST=1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY, OPT_PROV__LAST, OPT_CONFIG,
...
const OPTIONS smime_options[] = {
    ...
    { OPT_SECTION_STR, 1, '-', "Action" " options:\n" },
    ...
    { OPT_SECTION_STR, 1, '-', "Signing/Encryption" " options:\n" },
    ...
    { OPT_SECTION_STR, 1, '-', "Verification/Decryption" " options:\n" },
    ...
    { OPT_SECTION_STR, 1, '-', "Email" " options:\n" },
    ...
    { OPT_SECTION_STR, 1, '-', "Certificate chain" " options:\n" },
...
{
    CONF *conf = 
# 160 "../apps/smime.c" 3 4
                ((void *)0)
# 160 "../apps/smime.c"
                    ;
    BIO *in = 
# 161 "../apps/smime.c" 3 4
             ((void *)0)
# 161 "../apps/smime.c"
                 , *out = 
# 161 "../apps/smime.c" 3 4
...
# 161 "../apps/smime.c"
                                              ;
    EVP_PKEY *key = 
# 162 "../apps/smime.c" 3 4
                   ((void *)0)
# 162 "../apps/smime.c"
                       ;
    PKCS7 *p7 = 
# 163 "../apps/smime.c" 3 4
               ((void *)0)
# 163 "../apps/smime.c"
                   ;
    struct stack_st_OPENSSL_STRING *sksigners = 
# 164 "../apps/smime.c" 3 4
                                         ((void *)0)
# 164 "../apps/smime.c"
                                             , *skkeys = 
# 164 "../apps/smime.c" 3 4
...
# 164 "../apps/smime.c"
                                                             ;
    struct stack_st_X509 *encerts = 
# 165 "../apps/smime.c" 3 4
                             ((void *)0)
# 165 "../apps/smime.c"
                                 , *other = 
# 165 "../apps/smime.c" 3 4
...
# 166 "../apps/smime.c"
                                                   ;
    X509_STORE *store = 
# 167 "../apps/smime.c" 3 4
                       ((void *)0)
# 167 "../apps/smime.c"
                           ;
    X509_VERIFY_PARAM *vpm = 
# 168 "../apps/smime.c" 3 4
                            ((void *)0)
# 168 "../apps/smime.c"
                                ;
    EVP_CIPHER *cipher = 
# 169 "../apps/smime.c" 3 4
                        ((void *)0)
# 169 "../apps/smime.c"
                            ;
    EVP_MD *sign_md = 
# 170 "../apps/smime.c" 3 4
                     ((void *)0)
# 170 "../apps/smime.c"
                         ;
    const char *CAfile = 
# 171 "../apps/smime.c" 3 4
                        ((void *)0)
# 171 "../apps/smime.c"
                            , *CApath = 
# 171 "../apps/smime.c" 3 4
...
# 186 "../apps/smime.c"
 ...
 opthelp:
        ...
        case OPT_OUT:
            ...
            break;
        case OPT_ENCRYPT:
            if (!((operation != 0 && (operation != ((1 | 0x10)))) ? 0 * BIO_printf(bio_err, "%s: Cannot use -%s together with -%s\n", prog, operation_name((1 | 0x10)), operation_name(operation)) : (operation = ((1 | 0x10)))))
                goto end;
            break;
        case OPT_DECRYPT:
            if (!((operation != 0 && (operation != ((2 | 0x20)))) ? 0 * BIO_printf(bio_err, "%s: Cannot use -%s together with -%s\n", prog, operation_name((2 | 0x20)), operation_name(operation)) : (operation = ((2 | 0x20)))))
                goto end;
            break;
        case OPT_SIGN:
            if (!((operation != 0 && (operation != ((3 | 0x10 | 0x40)))) ? 0 * BIO_printf(bio_err, "%s: Cannot use -%s together with -%s\n", prog, operation_name((3 | 0x10 | 0x40)), operation_name(operation)) : (operation = ((3 | 0x10 | 0x40)))))
                goto end;
            break;
        case OPT_RESIGN:
            if (!((operation != 0 && (operation != ((6 | 0x20 | 0x10 | 0x40)))) ? 0 * BIO_printf(bio_err, "%s: Cannot use -%s together with -%s\n", prog, operation_name((6 | 0x20 | 0x10 | 0x40)), operation_name(operation)) : (operation = ((6 | 0x20 | 0x10 | 0x40)))))
                goto end;
            break;
        case OPT_VERIFY:
            if (!((operation != 0 && (operation != ((4 | 0x20)))) ? 0 * BIO_printf(bio_err, "%s: Cannot use -%s together with -%s\n", prog, operation_name((4 | 0x20)), operation_name(operation)) : (operation = ((4 | 0x20)))))
                goto end;
            break;
        case OPT_PK7OUT:
            if (!((operation != 0 && (operation != ((5 | 0x20 | 0x10)))) ? 0 * BIO_printf(bio_err, "%s: Cannot use -%s together with -%s\n", prog, operation_name((5 | 0x20 | 0x10)), operation_name(operation)) : (operation = ((5 | 0x20 | 0x10)))))
                goto end;
            break;
        case OPT_TEXT:
            flags |= 0x1;
...
# 291 "../apps/smime.c"
        ...
        case OPT_SIGNER:
            ...
            if (signerfile != 
# 311 "../apps/smime.c" 3 4
                             ((void *)0)
# 311 "../apps/smime.c"
                                 ) {
                if (sksigners == 
# 312 "../apps/smime.c" 3 4
                                ((void *)0)
                    
# 313 "../apps/smime.c"
                   && (sksigners = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null())) == 
# 313 "../apps/smime.c" 3 4
                                                                    ((void *)0)
# 313 "../apps/smime.c"
                                                                        )
                    goto end;
                if (OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(sksigners), ossl_check_OPENSSL_STRING_type(signerfile)) <= 0)
                    goto end;
                if (keyfile == 
# 317 "../apps/smime.c" 3 4
                              ((void *)0)
# 317 "../apps/smime.c"
                                  )
                    keyfile = signerfile;
                if (skkeys == 
# 319 "../apps/smime.c" 3 4
                             ((void *)0)
                    
# 320 "../apps/smime.c"
                   && (skkeys = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null())) == 
# 320 "../apps/smime.c" 3 4
                                                                 ((void *)0)
# 320 "../apps/smime.c"
                                                                     )
                    goto end;
...
# 324 "../apps/smime.c"
        ...
        case OPT_INKEY:
            ...
            if (keyfile != 
# 339 "../apps/smime.c" 3 4
                          ((void *)0)
# 339 "../apps/smime.c"
                              ) {
                if (signerfile == 
# 340 "../apps/smime.c" 3 4
                                 ((void *)0)
# 340 "../apps/smime.c"
                                     ) {
                    BIO_printf(bio_err,
                ...
                if (sksigners == 
# 345 "../apps/smime.c" 3 4
                                ((void *)0)
                    
# 346 "../apps/smime.c"
                   && (sksigners = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null())) == 
# 346 "../apps/smime.c" 3 4
                                                                    ((void *)0)
# 346 "../apps/smime.c"
                                                                        )
                    goto end;
                if (OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(sksigners), ossl_check_OPENSSL_STRING_type(signerfile)) <= 0)
                    goto end;
                signerfile = 
# 350 "../apps/smime.c" 3 4
                            ((void *)0)
# 350 "../apps/smime.c"
                                ;
                if (skkeys == 
# 351 "../apps/smime.c" 3 4
                             ((void *)0)
                    
# 352 "../apps/smime.c"
                   && (skkeys = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null())) == 
# 352 "../apps/smime.c" 3 4
                                                                 ((void *)0)
# 352 "../apps/smime.c"
                                                                     )
                    goto end;
...
# 402 "../apps/smime.c"
    ...
    if (!opt_cipher_any(ciphername, &cipher))
            goto opthelp;
    if (!(operation & 0x40) && (skkeys != 
# 408 "../apps/smime.c" 3 4
                                                  ((void *)0) 
# 408 "../apps/smime.c"
                                                       || sksigners != 
# 408 "../apps/smime.c" 3 4
...
# 408 "../apps/smime.c"
    ...
    if (operation & 0x40) {
        ...
        if (signerfile != 
# 424 "../apps/smime.c" 3 4
                         ((void *)0)
# 424 "../apps/smime.c"
                             ) {
            if (sksigners == 
# 425 "../apps/smime.c" 3 4
                            ((void *)0)
                
# 426 "../apps/smime.c"
               && (sksigners = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null())) == 
# 426 "../apps/smime.c" 3 4
                                                                ((void *)0)
# 426 "../apps/smime.c"
                                                                    )
                goto end;
            if (OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(sksigners), ossl_check_OPENSSL_STRING_type(signerfile)) <= 0)
                goto end;
            if (!skkeys && (skkeys = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null())) == 
# 430 "../apps/smime.c" 3 4
                                                                     ((void *)0)
# 430 "../apps/smime.c"
                                                                         )
                goto end;
...
# 437 "../apps/smime.c"
        ...
        signerfile = 
# 441 "../apps/smime.c" 3 4
                    ((void *)0)
# 441 "../apps/smime.c"
                        ;
        keyfile = 
# 442 "../apps/smime.c" 3 4
                 ((void *)0)
# 442 "../apps/smime.c"
                     ;
    } else if (operation == (2 | 0x20)) {
        if (recipfile == 
# 444 "../apps/smime.c" 3 4
                        ((void *)0) 
# 444 "../apps/smime.c"
                             && keyfile == 
# 444 "../apps/smime.c" 3 4
...
# 477 "../apps/smime.c"
        ...
        encerts = ((struct stack_st_X509 *)OPENSSL_sk_new_null());
        if (encerts == 
# 486 "../apps/smime.c" 3 4
                      ((void *)0)
# 486 "../apps/smime.c"
                          )
            goto end;
        while (*argv != 
# 488 "../apps/smime.c" 3 4
                       ((void *)0)
# 488 "../apps/smime.c"
                           ) {
            cert = load_cert_pass(*argv, 0, 1, 
# 489 "../apps/smime.c" 3 4
                  ((void *)0)
# 489 "../apps/smime.c"
                  , "recipient certificate file")
                                                          ;
            if (cert == 
# 491 "../apps/smime.c" 3 4
                       ((void *)0)
# 491 "../apps/smime.c"
                           )
                goto end;
...
# 495 "../apps/smime.c"
    ...
    if (certfile != 
# 500 "../apps/smime.c" 3 4
                   ((void *)0)
# 500 "../apps/smime.c"
                       ) {
        if (!load_certs(certfile, 0, &other, 
# 501 "../apps/smime.c" 3 4
                                            ((void *)0)
# 501 "../apps/smime.c"
                                                , "certificates")) {
    ...
    if (recipfile != 
# 507 "../apps/smime.c" 3 4
                    ((void *)0) 
# 507 "../apps/smime.c"
                         && (operation == (2 | 0x20))) {
        if ((recip = load_cert_pass(recipfile, 0, 1, 
# 508 "../apps/smime.c" 3 4
                    ((void *)0)
# 508 "../apps/smime.c"
                    , "recipient certificate file")
                                                            ) == 
# 509 "../apps/smime.c" 3 4
                                                                ((void *)0)
# 509 "../apps/smime.c"
                                                                    ) {
            ERR_print_errors(bio_err);
...
# 522 "../apps/smime.c"
    ...
    if (keyfile != 
# 525 "../apps/smime.c" 3 4
                  ((void *)0)
# 525 "../apps/smime.c"
                      ) {
        key = load_key(keyfile, keyform, 0, passin, e, "signing key");
        if (key == 
# 527 "../apps/smime.c" 3 4
                  ((void *)0)
# 527 "../apps/smime.c"
                      )
            goto end;
...
# 539 "../apps/smime.c"
        ...
        if (informat == (7 | 0x8000)) {
            ...
            p7_in = PEM_read_bio_PKCS7(in, &p7, 
# 546 "../apps/smime.c" 3 4
                                               ((void *)0)
# 546 "../apps/smime.c"
                                                   , 
# 546 "../apps/smime.c" 3 4
...
# 554 "../apps/smime.c"
        ...
        if (contfile != 
# 558 "../apps/smime.c" 3 4
                       ((void *)0)
# 558 "../apps/smime.c"
                           ) {
            BIO_free(indata);
            if ((indata = BIO_new_file(contfile, "rb")) == 
# 560 "../apps/smime.c" 3 4
                                                          ((void *)0)
# 560 "../apps/smime.c"
                                                              ) {
...
# 600 "../apps/smime.c"
            ...
            if (p7 == 
# 601 "../apps/smime.c" 3 4
                     ((void *)0)
# 601 "../apps/smime.c"
                         )
                goto end;
            if (flags & 0x2) {
                for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(other)); i++) {
                    X509 *x = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(other), (i)));
...
# 615 "../apps/smime.c" 3 4
                    ((void *)0)
# 615 "../apps/smime.c"
                    , "signer certificate");
            if (signer == 
# 616 "../apps/smime.c" 3 4
                         ((void *)0)
# 616 "../apps/smime.c"
                             )
                goto end;
...
# 619 "../apps/smime.c"
            ...
            X509_free(signer);
            signer = 
# 625 "../apps/smime.c" 3 4
                    ((void *)0)
# 625 "../apps/smime.c"
                        ;
            EVP_PKEY_free(key);
            key = 
# 627 "../apps/smime.c" 3 4
                 ((void *)0)
# 627 "../apps/smime.c"
                     ;
        }
...
# 636 "../apps/smime.c"
    ...
    BIO_free(indata);
    BIO_free_all(out);
    CRYPTO_free(passin, "../apps/smime.c", 711);
    NCONF_free(conf);
    return ret;
}
