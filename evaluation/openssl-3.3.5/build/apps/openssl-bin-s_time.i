...
const OPTIONS s_time_options[] = {
    ...
    { OPT_SECTION_STR, 1, '-', "Connection" " options:\n" },
    ...
    { OPT_SECTION_STR, 1, '-', "Certificate" " options:\n" },
...
int s_time_main(int argc, char **argv)
{
    char buf[1024 * 8];
    SSL *scon = 
# 118 "../apps/s_time.c" 3 4
               ((void *)0)
# 118 "../apps/s_time.c"
                   ;
    SSL_CTX *ctx = 
# 119 "../apps/s_time.c" 3 4
                  ((void *)0)
# 119 "../apps/s_time.c"
                      ;
    const SSL_METHOD *meth = 
# 120 "../apps/s_time.c" 3 4
                            ((void *)0)
# 120 "../apps/s_time.c"
                                ;
    char *CApath = 
# 121 "../apps/s_time.c" 3 4
                  ((void *)0)
# 121 "../apps/s_time.c"
                      , *CAfile = 
# 121 "../apps/s_time.c" 3 4
...
# 122 "../apps/s_time.c"
                                            ;
    char *www_path = 
# 123 "../apps/s_time.c" 3 4
                    ((void *)0)
# 123 "../apps/s_time.c"
                        ;
    char *host = "localhost:4433", *certfile = 
# 124 "../apps/s_time.c" 3 4
                                              ((void *)0)
# 124 "../apps/s_time.c"
                                                  , *keyfile = 
# 124 "../apps/s_time.c" 3 4
...
# 243 "../apps/s_time.c"
    ...
    if (SSL_CTX_ctrl(ctx, 123, min_version, 
# 247 "../apps/s_time.c" 3 4
       ((void *)0)
# 247 "../apps/s_time.c"
       ) == 0)
        goto end;
    if (SSL_CTX_ctrl(ctx, 124, max_version, 
# 249 "../apps/s_time.c" 3 4
       ((void *)0)
# 249 "../apps/s_time.c"
       ) == 0)
        goto end;
    ...
    if (st_bugs)
        SSL_CTX_set_options(ctx, ( ((uint64_t)1 << (uint64_t)31) | ((uint64_t)1 << (uint64_t)11) | ((uint64_t)1 << (uint64_t)4) | ((uint64_t)1 << (uint64_t)6) ));
    if (cipher != 
# 254 "../apps/s_time.c" 3 4
                 ((void *)0) 
# 254 "../apps/s_time.c"
                      && !SSL_CTX_set_cipher_list(ctx, cipher))
        goto end;
    if (ciphersuites != 
# 256 "../apps/s_time.c" 3 4
                       ((void *)0) 
# 256 "../apps/s_time.c"
    ...
    bytes_read = 0;
    finishtime = (long)time(
# 273 "../apps/s_time.c" 3 4
                           ((void *)0)
# 273 "../apps/s_time.c"
                               ) + maxtime;
    tm_Time_F(0);
    for (;;) {
        if (finishtime < (long)time(
# 276 "../apps/s_time.c" 3 4
                                   ((void *)0)
# 276 "../apps/s_time.c"
                                       ))
            break;
...
# 282 "../apps/s_time.c"
        ...
        fputc(ver, 
# 305 "../apps/s_time.c" 3 4
                  stdout
# 305 "../apps/s_time.c"
                        );
        fflush(
# 306 "../apps/s_time.c" 3 4
              stdout
# 306 "../apps/s_time.c"
                    );
...
# 352 "../apps/s_time.c"
    ...
    for (;;) {
        if (finishtime < (long)time(
# 359 "../apps/s_time.c" 3 4
                                   ((void *)0)
# 359 "../apps/s_time.c"
                                       ))
            break;

        if ((doConnection(scon, host, ctx)) == 
# 362 "../apps/s_time.c" 3 4
                                              ((void *)0)
# 362 "../apps/s_time.c"
                                                  )
            goto end;
...
# 365 "../apps/s_time.c"
        ...
        fputc(ver, 
# 389 "../apps/s_time.c" 3 4
                  stdout
# 389 "../apps/s_time.c"
                        );
        fflush(
# 390 "../apps/s_time.c" 3 4
              stdout
# 390 "../apps/s_time.c"
                    );
    }
    ...
    if (nConn > 0)
        printf
            ("%d connections in %ld real seconds, %ld bytes read per connection\n",
             nConn, (long)time(
# 400 "../apps/s_time.c" 3 4
                              ((void *)0)
# 400 "../apps/s_time.c"
                                  ) - finishtime + maxtime, bytes_read / nConn);
    else
        printf("0 connections in %ld real seconds\n",
               (long)time(
# 403 "../apps/s_time.c" 3 4
                         ((void *)0)
# 403 "../apps/s_time.c"
                             ) - finishtime + maxtime);
    ret = 0;
...
# 421 "../apps/s_time.c" 3 4
                                            ((void *)0)
# 421 "../apps/s_time.c"
                                                )
        return 
# 422 "../apps/s_time.c" 3 4
              ((void *)0)
# 422 "../apps/s_time.c"
                  ;

    if (BIO_ctrl(conn,100,0, (char *)(host)) <= 0
            || BIO_ctrl(conn,155,(0x10),
# 425 "../apps/s_time.c" 3 4
              ((void *)0)
# 425 "../apps/s_time.c"
              ) <= 0) {
        BIO_free(conn);
        return 
# 427 "../apps/s_time.c" 3 4
              ((void *)0)
# 427 "../apps/s_time.c"
                  ;
    }
    ...
    if (scon == 
# 430 "../apps/s_time.c" 3 4
               ((void *)0)
# 430 "../apps/s_time.c"
                   ) {
        serverCon = SSL_new(ctx);
        if (serverCon == 
# 432 "../apps/s_time.c" 3 4
                        ((void *)0)
# 432 "../apps/s_time.c"
                            ) {
            BIO_free(conn);
            return 
# 434 "../apps/s_time.c" 3 4
                  ((void *)0)
# 434 "../apps/s_time.c"
                      ;
        }
    ...
    if (i <= 0) {
        ...
        if (verify_args.error != 0)
            ...
            ERR_print_errors(bio_err);
        if (scon == 
# 452 "../apps/s_time.c" 3 4
                   ((void *)0)
# 452 "../apps/s_time.c"
                       )
            SSL_free(serverCon);
        return 
# 454 "../apps/s_time.c" 3 4
              ((void *)0)
# 454 "../apps/s_time.c"
                  ;
    }
