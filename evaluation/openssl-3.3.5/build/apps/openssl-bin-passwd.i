...
__attribute__((deprecated("Since OpenSSL " "3.0"))) const char *DES_options(void);
__attribute__((deprecated("Since OpenSSL " "3.0")))
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) int DES_random_key(DES_cblock *ret);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void DES_set_odd_parity(DES_cblock *key);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int DES_check_key_parity(const_DES_cblock *key);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int DES_is_weak_key(const_DES_cblock *key);
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) void DES_string_to_key(const char *str, DES_cblock *key);
__attribute__((deprecated("Since OpenSSL " "3.0")))
...
const OPTIONS passwd_options[] = {
    ...
    { OPT_SECTION_STR, 1, '-', "Cryptographic" " options:\n" },
...
{
    BIO *in = 
# 95 "../apps/passwd.c" 3 4
             ((void *)0)
# 95 "../apps/passwd.c"
                 ;
    char *infile = 
# 96 "../apps/passwd.c" 3 4
                  ((void *)0)
# 96 "../apps/passwd.c"
                      , *salt = 
# 96 "../apps/passwd.c" 3 4
...
# 230 "../apps/passwd.c"
        ...
        if (1) {
            ...
            static char *passwds_static[2] = { 
# 239 "../apps/passwd.c" 3 4
                                              ((void *)0)
# 239 "../apps/passwd.c"
                                                  , 
# 239 "../apps/passwd.c" 3 4
...
# 242 "../apps/passwd.c"
    ...
    if (in == 
# 256 "../apps/passwd.c" 3 4
             ((void *)0)
# 256 "../apps/passwd.c"
                 ) {
        
# 257 "../apps/passwd.c" 3 4
       ((void) (0))
# 257 "../apps/passwd.c"
                              ;
        
# 258 "../apps/passwd.c" 3 4
       ((void) (0))
# 258 "../apps/passwd.c"
                               ;
...
# 279 "../apps/passwd.c"
    ...
    CRYPTO_free(salt_malloc, "../apps/passwd.c", 299);
    CRYPTO_free(passwd_malloc, "../apps/passwd.c", 300);
    BIO_free(in);
    return ret;
}
# 314 "../apps/passwd.c"
...
# 353 "../apps/passwd.c"
    ...
    md = EVP_MD_CTX_new();
    if (md == 
# 376 "../apps/passwd.c" 3 4
             ((void *)0)
        
# 377 "../apps/passwd.c"
       || !EVP_DigestInit_ex(md, EVP_md5(), 
# 377 "../apps/passwd.c" 3 4
                                            ((void *)0)
# 377 "../apps/passwd.c"
                                                )
    ...
    md2 = EVP_MD_CTX_new();
    if (md2 == 
# 391 "../apps/passwd.c" 3 4
              ((void *)0)
        
# 392 "../apps/passwd.c"
       || !EVP_DigestInit_ex(md2, EVP_md5(), 
# 392 "../apps/passwd.c" 3 4
                                             ((void *)0)
# 392 "../apps/passwd.c"
                                                 )
        ...
        || !EVP_DigestUpdate(md2, passwd, passwd_len)
        || !EVP_DigestFinal_ex(md2, buf, 
# 396 "../apps/passwd.c" 3 4
                                        ((void *)0)
# 396 "../apps/passwd.c"
                                            ))
        goto err;
    ...
    if (!EVP_DigestFinal_ex(md, buf, 
# 412 "../apps/passwd.c" 3 4
                                    ((void *)0)
# 412 "../apps/passwd.c"
                                        ))
        goto err;
    ...
    for (i = 0; i < 1000; i++) {
        if (!EVP_DigestInit_ex(md2, EVP_md5(), 
# 416 "../apps/passwd.c" 3 4
                                              ((void *)0)
# 416 "../apps/passwd.c"
                                                  ))
            goto err;
        ...
        if (!EVP_DigestUpdate(md2,
                ...
                goto err;
        if (!EVP_DigestFinal_ex(md2, buf, 
# 434 "../apps/passwd.c" 3 4
                                         ((void *)0)
# 434 "../apps/passwd.c"
                                             ))
                goto err;
    ...
    EVP_MD_CTX_free(md);
    md2 = 
# 439 "../apps/passwd.c" 3 4
         ((void *)0)
# 439 "../apps/passwd.c"
             ;
    md = 
# 440 "../apps/passwd.c" 3 4
        ((void *)0)
# 440 "../apps/passwd.c"
            ;
...
# 476 "../apps/passwd.c"
 ...
 err:
    CRYPTO_free(ascii_passwd, "../apps/passwd.c", 485);
    EVP_MD_CTX_free(md2);
    EVP_MD_CTX_free(md);
    return 
# 488 "../apps/passwd.c" 3 4
          ((void *)0)
# 488 "../apps/passwd.c"
              ;
}
...
# 510 "../apps/passwd.c"
    ...
    char ascii_salt[17];
    char *ascii_passwd = 
# 516 "../apps/passwd.c" 3 4
                        ((void *)0)
# 516 "../apps/passwd.c"
                            ;
    size_t n;
    EVP_MD_CTX *md = 
# 518 "../apps/passwd.c" 3 4
                    ((void *)0)
# 518 "../apps/passwd.c"
                        , *md2 = 
# 518 "../apps/passwd.c" 3 4
...
# 519 "../apps/passwd.c"
    ...
    char *p_bytes = 
# 523 "../apps/passwd.c" 3 4
                   ((void *)0)
# 523 "../apps/passwd.c"
                       ;
    char *s_bytes = 
# 524 "../apps/passwd.c" 3 4
                   ((void *)0)
# 524 "../apps/passwd.c"
                       ;
    char *cp = 
# 525 "../apps/passwd.c" 3 4
              ((void *)0)
# 525 "../apps/passwd.c"
                  ;
...
# 586 "../apps/passwd.c"
    ...
    md = EVP_MD_CTX_new();
    if (md == 
# 609 "../apps/passwd.c" 3 4
             ((void *)0)
        
# 610 "../apps/passwd.c"
       || !EVP_DigestInit_ex(md, sha, 
# 610 "../apps/passwd.c" 3 4
                                      ((void *)0)
# 610 "../apps/passwd.c"
                                          )
        || !EVP_DigestUpdate(md, passwd, passwd_len)
    ...
    md2 = EVP_MD_CTX_new();
    if (md2 == 
# 616 "../apps/passwd.c" 3 4
              ((void *)0)
        
# 617 "../apps/passwd.c"
       || !EVP_DigestInit_ex(md2, sha, 
# 617 "../apps/passwd.c" 3 4
                                       ((void *)0)
# 617 "../apps/passwd.c"
                                           )
        || !EVP_DigestUpdate(md2, passwd, passwd_len)
...
# 639 "../apps/passwd.c"
    ...
    if (!EVP_DigestInit_ex(md2, sha, 
# 643 "../apps/passwd.c" 3 4
                                    ((void *)0)
# 643 "../apps/passwd.c"
                                        ))
        goto err;
    ...
    if (!EVP_DigestFinal_ex(md2, temp_buf, 
# 650 "../apps/passwd.c" 3 4
                                          ((void *)0)
# 650 "../apps/passwd.c"
                                              ))
        goto err;

    if ((p_bytes = CRYPTO_zalloc(passwd_len, "../apps/passwd.c", 653)) == 
# 653 "../apps/passwd.c" 3 4
                                                 ((void *)0)
# 653 "../apps/passwd.c"
                                                     )
        goto err;
...
# 660 "../apps/passwd.c"
    ...
    if (!EVP_DigestFinal_ex(md2, temp_buf, 
# 667 "../apps/passwd.c" 3 4
                                          ((void *)0)
# 667 "../apps/passwd.c"
                                              ))
        goto err;

    if ((s_bytes = CRYPTO_zalloc(salt_len, "../apps/passwd.c", 670)) == 
# 670 "../apps/passwd.c" 3 4
                                               ((void *)0)
# 670 "../apps/passwd.c"
                                                   )
        goto err;
...
# 695 "../apps/passwd.c"
    ...
    EVP_MD_CTX_free(md);
    md2 = 
# 700 "../apps/passwd.c" 3 4
         ((void *)0)
# 700 "../apps/passwd.c"
             ;
    md = 
# 701 "../apps/passwd.c" 3 4
        ((void *)0)
# 701 "../apps/passwd.c"
            ;
    CRYPTO_free(p_bytes, "../apps/passwd.c", 702);
    CRYPTO_free(s_bytes, "../apps/passwd.c", 703);
    p_bytes = 
# 704 "../apps/passwd.c" 3 4
             ((void *)0)
# 704 "../apps/passwd.c"
                 ;
    s_bytes = 
# 705 "../apps/passwd.c" 3 4
             ((void *)0)
# 705 "../apps/passwd.c"
                 ;
...
# 721 "../apps/passwd.c"
 ...
 err:
    EVP_MD_CTX_free(md2);
    EVP_MD_CTX_free(md);
    CRYPTO_free(p_bytes, "../apps/passwd.c", 772);
    CRYPTO_free(s_bytes, "../apps/passwd.c", 773);
    CRYPTO_free(ascii_passwd, "../apps/passwd.c", 774);
    return 
# 775 "../apps/passwd.c" 3 4
          ((void *)0)
# 775 "../apps/passwd.c"
              ;
}
...
{
    char *hash = 
# 782 "../apps/passwd.c" 3 4
                ((void *)0)
# 782 "../apps/passwd.c"
                    ;

    
# 784 "../apps/passwd.c" 3 4
   ((void) (0))
# 784 "../apps/passwd.c"
                         ;
    
# 785 "../apps/passwd.c" 3 4
   ((void) (0))
# 785 "../apps/passwd.c"
                                ;
...
# 798 "../apps/passwd.c" 3 4
       ((void) (0))
# 798 "../apps/passwd.c"
                           ;

        if (*salt_malloc_p == 
# 800 "../apps/passwd.c" 3 4
                             ((void *)0)
# 800 "../apps/passwd.c"
                                 )
