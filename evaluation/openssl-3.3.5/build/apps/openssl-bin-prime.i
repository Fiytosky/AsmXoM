...
opthelp:
    ...
    if (generate && !opt_check_rest_arg(
# 103 "../apps/prime.c" 3 4
                                       ((void *)0)
# 103 "../apps/prime.c"
                                           ))
        goto opthelp;
...
# 120 "../apps/prime.c"
        ...
        if (!BN_generate_prime_ex(bn, bits, safe, 
# 124 "../apps/prime.c" 3 4
                                                 ((void *)0)
# 124 "../apps/prime.c"
                                                     , 
# 124 "../apps/prime.c" 3 4
...
# 129 "../apps/prime.c"
        ...
        CRYPTO_free(s, "../apps/prime.c", 134);
    } else {
        for ( ; *argv; argv++) {
