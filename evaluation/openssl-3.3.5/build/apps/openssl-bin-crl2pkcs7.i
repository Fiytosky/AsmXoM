...
# 51 "../apps/crl2pkcs7.c"
                              ;
    PKCS7 *p7 = 
# 52 "../apps/crl2pkcs7.c" 3 4
               ((void *)0)
# 52 "../apps/crl2pkcs7.c"
                   ;
    PKCS7_SIGNED *p7s = 
# 53 "../apps/crl2pkcs7.c" 3 4
                       ((void *)0)
# 53 "../apps/crl2pkcs7.c"
                           ;
    struct stack_st_OPENSSL_STRING *certflst = 
# 54 "../apps/crl2pkcs7.c" 3 4
                                        ((void *)0)
# 54 "../apps/crl2pkcs7.c"
                                            ;
    struct stack_st_X509 *cert_stack = 
# 55 "../apps/crl2pkcs7.c" 3 4
                                ((void *)0)
# 55 "../apps/crl2pkcs7.c"
                                    ;
    struct stack_st_X509_CRL *crl_stack = 
# 56 "../apps/crl2pkcs7.c" 3 4
                                   ((void *)0)
# 56 "../apps/crl2pkcs7.c"
                                       ;
    X509_CRL *crl = 
# 57 "../apps/crl2pkcs7.c" 3 4
                   ((void *)0)
# 57 "../apps/crl2pkcs7.c"
                       ;
    char *infile = 
# 58 "../apps/crl2pkcs7.c" 3 4
                  ((void *)0)
# 58 "../apps/crl2pkcs7.c"
                      , *outfile = 
# 58 "../apps/crl2pkcs7.c" 3 4
...
# 58 "../apps/crl2pkcs7.c"
 ...
 opthelp:
        ...
        case OPT_CERTFILE:
            if ((certflst == 
# 93 "../apps/crl2pkcs7.c" 3 4
                            ((void *)0)
# 93 "../apps/crl2pkcs7.c"
                                )
                && (certflst = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null())) == 
# 94 "../apps/crl2pkcs7.c" 3 4
                                                               ((void *)0)
# 94 "../apps/crl2pkcs7.c"
                                                                   )
                goto end;
            if (!OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(certflst), ossl_check_OPENSSL_STRING_type(opt_arg())))
                goto end;
            break;
...
# 107 "../apps/crl2pkcs7.c" 3 4
                           ((void *)0)
# 107 "../apps/crl2pkcs7.c"
                               ))
        goto opthelp;
    ...
    if (!nocrl) {
        ...
        if (in == 
# 112 "../apps/crl2pkcs7.c" 3 4
                 ((void *)0)
# 112 "../apps/crl2pkcs7.c"
                     )
            goto end;

        if (informat == 4)
            crl = d2i_X509_CRL_bio(in, 
# 116 "../apps/crl2pkcs7.c" 3 4
                                      ((void *)0)
# 116 "../apps/crl2pkcs7.c"
                                          );
        else if (informat == (5 | 0x8000))
            crl = PEM_read_bio_X509_CRL(in, 
# 118 "../apps/crl2pkcs7.c" 3 4
                                           ((void *)0)
# 118 "../apps/crl2pkcs7.c"
                                               , 
# 118 "../apps/crl2pkcs7.c" 3 4
                                                 ((void *)0)
# 118 "../apps/crl2pkcs7.c"
...
# 118 "../apps/crl2pkcs7.c"
        ...
        if (crl == 
# 119 "../apps/crl2pkcs7.c" 3 4
                  ((void *)0)
# 119 "../apps/crl2pkcs7.c"
                      ) {
    ...
    if ((p7 = PKCS7_new()) == 
# 126 "../apps/crl2pkcs7.c" 3 4
                             ((void *)0)
# 126 "../apps/crl2pkcs7.c"
                                 )
        goto end;
    if ((p7s = PKCS7_SIGNED_new()) == 
# 128 "../apps/crl2pkcs7.c" 3 4
                                     ((void *)0)
# 128 "../apps/crl2pkcs7.c"
                                         )
        goto end;
    ...
    if (crl != 
# 137 "../apps/crl2pkcs7.c" 3 4
              ((void *)0)
# 137 "../apps/crl2pkcs7.c"
                  ) {
        if ((crl_stack = ((struct stack_st_X509_CRL *)OPENSSL_sk_new_null())) == 
# 138 "../apps/crl2pkcs7.c" 3 4
                                                   ((void *)0)
# 138 "../apps/crl2pkcs7.c"
                                                       )
            goto end;
        p7s->crl = crl_stack;
        OPENSSL_sk_push(ossl_check_X509_CRL_sk_type(crl_stack), ossl_check_X509_CRL_type(crl));
        crl = 
# 142 "../apps/crl2pkcs7.c" 3 4
             ((void *)0)
# 142 "../apps/crl2pkcs7.c"
                 ;
    }

    if (certflst != 
# 145 "../apps/crl2pkcs7.c" 3 4
                   ((void *)0)
# 145 "../apps/crl2pkcs7.c"
                       ) {
        if ((cert_stack = ((struct stack_st_X509 *)OPENSSL_sk_new_null())) == 
# 146 "../apps/crl2pkcs7.c" 3 4
                                                ((void *)0)
# 146 "../apps/crl2pkcs7.c"
                                                    )
            goto end;
        p7s->cert = cert_stack;

        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(certflst)); i++) {
            certfile = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(certflst), (i)));
    ...
    if (out == 
# 161 "../apps/crl2pkcs7.c" 3 4
              ((void *)0)
# 161 "../apps/crl2pkcs7.c"
                  )
        goto end;
    ...
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(certflst));
    BIO_free(in);
    BIO_free_all(out);
    PKCS7_free(p7);
    X509_CRL_free(crl);
...
# 194 "../apps/crl2pkcs7.c"
static int add_certs_from_file(struct stack_st_X509 *stack, char *certfile)
{
    BIO *in = 
# 196 "../apps/crl2pkcs7.c" 3 4
             ((void *)0)
# 196 "../apps/crl2pkcs7.c"
                 ;
    int count = 0;
    int ret = -1;
    struct stack_st_X509_INFO *sk = 
# 199 "../apps/crl2pkcs7.c" 3 4
                             ((void *)0)
# 199 "../apps/crl2pkcs7.c"
                                 ;
    X509_INFO *xi;

    in = BIO_new_file(certfile, "r");
    if (in == 
# 203 "../apps/crl2pkcs7.c" 3 4
             ((void *)0)
# 203 "../apps/crl2pkcs7.c"
                 ) {
    ...
    sk = PEM_X509_INFO_read_bio(in, 
# 209 "../apps/crl2pkcs7.c" 3 4
                                   ((void *)0)
# 209 "../apps/crl2pkcs7.c"
                                       , 
# 209 "../apps/crl2pkcs7.c" 3 4
                                         ((void *)0)
# 209 "../apps/crl2pkcs7.c"
...
# 209 "../apps/crl2pkcs7.c"
    ...
    if (sk == 
# 210 "../apps/crl2pkcs7.c" 3 4
             ((void *)0)
# 210 "../apps/crl2pkcs7.c"
                 ) {
    ...
    while (OPENSSL_sk_num(ossl_check_const_X509_INFO_sk_type(sk))) {
        xi = ((X509_INFO *)OPENSSL_sk_shift(ossl_check_X509_INFO_sk_type(sk)));
        if (xi->x509 != 
# 218 "../apps/crl2pkcs7.c" 3 4
                       ((void *)0)
# 218 "../apps/crl2pkcs7.c"
                           ) {
            OPENSSL_sk_push(ossl_check_X509_sk_type(stack), ossl_check_X509_type(xi->x509));
            xi->x509 = 
# 220 "../apps/crl2pkcs7.c" 3 4
                      ((void *)0)
# 220 "../apps/crl2pkcs7.c"
                          ;
            count++;
        }
        X509_INFO_free(xi);
    ...
    BIO_free(in);
    OPENSSL_sk_free(ossl_check_X509_INFO_sk_type(sk));
    return ret;
}
