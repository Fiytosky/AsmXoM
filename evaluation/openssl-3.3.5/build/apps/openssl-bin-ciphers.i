...
typedef enum OPTION_choice {
    ...
    OPT_SRP,
    OPT_CIPHERSUITES,
    OPT_V, OPT_UPPER_V, OPT_S, OPT_PROV__FIRST=1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY, OPT_PROV__LAST
} OPTION_CHOICE;
...
const OPTIONS ciphers_options[] = {
    ...
    { OPT_SECTION_STR, 1, '-', "Cipher specification" " options:\n" },
...
{
    SSL_CTX *ctx = 
# 90 "../apps/ciphers.c" 3 4
                  ((void *)0)
# 90 "../apps/ciphers.c"
                      ;
    SSL *ssl = 
# 91 "../apps/ciphers.c" 3 4
              ((void *)0)
# 91 "../apps/ciphers.c"
                  ;
    struct stack_st_SSL_CIPHER *sk = 
# 92 "../apps/ciphers.c" 3 4
                              ((void *)0)
# 92 "../apps/ciphers.c"
                                  ;
...
# 103 "../apps/ciphers.c"
 ...
 opthelp:
    ...
    if (opt_num_rest() == 1)
        ciphers = argv[0];
    else if (!opt_check_rest_arg(
# 179 "../apps/ciphers.c" 3 4
                                ((void *)0)
# 179 "../apps/ciphers.c"
                                    ))
        goto opthelp;
...
# 218 "../apps/ciphers.c"
    ...
    if (!verbose) {
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_SSL_CIPHER_sk_type(sk)); i++) {
            const SSL_CIPHER *c = ((const SSL_CIPHER *)OPENSSL_sk_value(ossl_check_const_SSL_CIPHER_sk_type(sk), (i)));

            if (!__builtin_expect(!!((c != 
# 230 "../apps/ciphers.c" 3 4
                ((void *)0)
# 230 "../apps/ciphers.c"
                ) != 0), 1))
                continue;
...
# 234 "../apps/ciphers.c"
        ...
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_SSL_CIPHER_sk_type(sk)); i++) {
            ...
            c = ((const SSL_CIPHER *)OPENSSL_sk_value(ossl_check_const_SSL_CIPHER_sk_type(sk), (i)));

            if (!__builtin_expect(!!((c != 
# 248 "../apps/ciphers.c" 3 4
                ((void *)0)
# 248 "../apps/ciphers.c"
                ) != 0), 1))
                continue;
