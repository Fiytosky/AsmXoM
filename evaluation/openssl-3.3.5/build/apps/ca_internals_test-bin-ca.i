...
static int do_body(X509 **xret, EVP_PKEY *pkey, X509 *x509,
                   const char *dgst, struct stack_st_OPENSSL_STRING *sigopts,
...
typedef enum OPTION_choice {
    ...
    OPT_R__FIRST=1500, OPT_R_RAND, OPT_R_WRITERAND, OPT_R__LAST, OPT_PROV__FIRST=1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY, OPT_PROV__LAST,
...
const OPTIONS ca_options[] = {
    ...
    { OPT_SECTION_STR, 1, '-', "Configuration" " options:\n" },
    ...
    { OPT_SECTION_STR, 1, '-', "Revocation" " options:\n" },
...
# 269 "../apps/ca.c"
                   ;
    DB_ATTR db_attr;
    struct stack_st_CONF_VALUE *attribs = 
# 271 "../apps/ca.c" 3 4
                                   ((void *)0)
# 271 "../apps/ca.c"
                                       ;
...
# 274 "../apps/ca.c"
                       ;
    char *configfile = default_config_file, *section = 
# 275 "../apps/ca.c" 3 4
                                                      ((void *)0)
# 275 "../apps/ca.c"
                                                          ;
...
# 288 "../apps/ca.c"
    ...
    int keyformat = 0, multirdn = 1, notext = 0, output_der = 0;
...
opthelp:
        ...
        case OPT_CERT:
            ...
            break;
        case OPT_CERTFORM:
            if (!opt_format(opt_arg(), ( (1L << 1) | (1L << 2) | (1L << 3) | (1L << 4) | (1L << 5) | (1L << 6) | (1L << 7) | (1L << 8) | (1L << 9) | (1L << 10) | (1L << 11)), &certformat))
                goto opthelp;
            break;
        case OPT_SELFSIGN:
            selfsign = 1;
...
# 413 "../apps/ca.c" 3 4
                          ((void *)0) 
# 413 "../apps/ca.c"
                               || !OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(sigopts), ossl_check_OPENSSL_STRING_type(opt_arg())))
                goto end;
            break;
        case OPT_VFYOPT:
            if (vfyopts == 
...
# 419 "../apps/ca.c" 3 4
                          ((void *)0) 
# 419 "../apps/ca.c"
                               || !OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(vfyopts), ossl_check_OPENSSL_STRING_type(opt_arg())))
                goto end;
            break;
        case OPT_NOTEXT:
            notext = 1;
...
end_of_options:
    ...
    if ((conf = app_load_config_verbose(configfile, 1)) == 
# 507 "../apps/ca.c" 3 4
                                                          ((void *)0)
# 507 "../apps/ca.c"
                                                              )
...
# 514 "../apps/ca.c"
       && (section = lookup_conf(conf, "ca", "default_ca")) == 
# 514 "../apps/ca.c" 3 4
                                                                         ((void *)0)
# 514 "../apps/ca.c"
                                                                             )
...
# 536 "../apps/ca.c"
    ...
    if (chtype != (0x1000)) {
        f = app_conf_try_string(conf, section, "utf8");
        if (f != 
# 543 "../apps/ca.c" 3 4
                ((void *)0) 
# 543 "../apps/ca.c"
    ...
    p = app_conf_try_string(conf, section, "unique_subject");
    if (p != 
# 549 "../apps/ca.c" 3 4
            ((void *)0)
# 549 "../apps/ca.c"
...
# 577 "../apps/ca.c"
       && (keyfile = lookup_conf(conf, section, "private_key")) == 
# 577 "../apps/ca.c" 3 4
                                                                     ((void *)0)
# 577 "../apps/ca.c"
                                                                         )
...
# 597 "../apps/ca.c"
           && (certfile = lookup_conf(conf, section, "certificate")) == 
# 597 "../apps/ca.c" 3 4
                                                                          ((void *)0)
# 597 "../apps/ca.c"
                                                                              )
...
# 601 "../apps/ca.c"
    ...
    f = app_conf_try_string(conf, "ca", "preserve");
    if (f != 
# 614 "../apps/ca.c" 3 4
            ((void *)0) 
# 614 "../apps/ca.c"
                 && (*f == 'y' || *f == 'Y'))
        preserve = 1;
    f = app_conf_try_string(conf, "ca", "msie_hack");
    if (f != 
# 617 "../apps/ca.c" 3 4
            ((void *)0) 
# 617 "../apps/ca.c"
    ...
    f = app_conf_try_string(conf, section, "name_opt");
    if (f != 
# 621 "../apps/ca.c" 3 4
            ((void *)0)
# 621 "../apps/ca.c"
    ...
    f = app_conf_try_string(conf, section, "cert_opt");
    if (f != 
# 630 "../apps/ca.c" 3 4
            ((void *)0)
# 630 "../apps/ca.c"
    ...
    f = app_conf_try_string(conf, section, "copy_extensions");
    if (f != 
# 639 "../apps/ca.c" 3 4
            ((void *)0)
# 639 "../apps/ca.c"
...
# 738 "../apps/ca.c"
    ...
    if (extfile) {
        if ((extfile_conf = app_load_config_internal(extfile, 0)) == 
# 760 "../apps/ca.c" 3 4
                                                        ((void *)0)
# 760 "../apps/ca.c"
                                                            ) {
...
# 799 "../apps/ca.c"
              && (dgst = lookup_conf(conf, section, "default_md")) == 
# 799 "../apps/ca.c" 3 4
                                                                        ((void *)0)
...
# 814 "../apps/ca.c"
            ...
            tmp_email_dn =
                app_conf_try_string(conf, section, "email_in_dn");
            if (tmp_email_dn != 
# 818 "../apps/ca.c" 3 4
                               ((void *)0) 
# 818 "../apps/ca.c"
...
# 824 "../apps/ca.c"
           && (policy = lookup_conf(conf, section, "policy")) == 
# 824 "../apps/ca.c" 3 4
                                                                   ((void *)0)
# 824 "../apps/ca.c"
                                                                       )
        ...
        if (app_conf_try_string(conf, section, "rand_serial") != 
# 830 "../apps/ca.c" 3 4
                                                                  ((void *)0)
# 830 "../apps/ca.c"
                                                                      ) {
...
# 856 "../apps/ca.c"
                ...
                extensions = app_conf_try_string(conf, section, "x509_extensions");
            if (extensions != 
# 858 "../apps/ca.c" 3 4
                             ((void *)0)
# 858 "../apps/ca.c"
...
# 874 "../apps/ca.c"
            ...
            startdate =
                app_conf_try_string(conf, section, "default_startdate");
        if (startdate != 
# 877 "../apps/ca.c" 3 4
                        ((void *)0) 
# 877 "../apps/ca.c"
...
# 885 "../apps/ca.c"
            ...
            enddate = app_conf_try_string(conf, section, "default_enddate");
        if (enddate != 
# 887 "../apps/ca.c" 3 4
                      ((void *)0) 
# 887 "../apps/ca.c"
...
# 887 "../apps/ca.c"
        ...
        if (days == 0) {
            if (!app_conf_try_number(conf, section, "default_days", &days))
                days = 0;
        }
        if (enddate == 
# 897 "../apps/ca.c" 3 4
...
# 917 "../apps/ca.c"
                    ...
                    CRYPTO_free(f, "../apps/ca.c", 920);
                }
            }
        }

        if ((attribs = NCONF_get_section(conf, policy)) == 
# 925 "../apps/ca.c" 3 4
                                                          ((void *)0)
# 925 "../apps/ca.c"
                                                              ) {
        ...
        if ((cert_sk = ((struct stack_st_X509 *)OPENSSL_sk_new_null())) == 
# 930 "../apps/ca.c" 3 4
                                             ((void *)0)
# 930 "../apps/ca.c"
                                                 ) {
...
# 934 "../apps/ca.c"
            ...
            if (j > 0) {
                ...
                if (!BN_add_word(serial, 1))
                    goto end;
                if (!OPENSSL_sk_push(ossl_check_X509_sk_type(cert_sk), ossl_check_X509_type(x))) {
                    BIO_printf(bio_err, "Memory allocation failure\n");
                    goto end;
                }
            }
...
# 975 "../apps/ca.c"
        ...
        if (OPENSSL_sk_num(ossl_check_const_X509_sk_type(cert_sk)) > 0) {
            if (!batch) {
                BIO_printf(bio_err,
                           "\n%d out of %d certificate requests certified, commit? [y/n]",
                           total_done, total);
                (void)(int)BIO_ctrl(bio_err,11,0,
# 1029 "../apps/ca.c" 3 4
                     ((void *)0)
# 1029 "../apps/ca.c"
                     );
                tmp[0] = '\0';
                if (fgets(tmp, sizeof(tmp), 
# 1031 "../apps/ca.c" 3 4
                                           stdin
# 1031 "../apps/ca.c"
                                                ) == 
...
# 1031 "../apps/ca.c"
            ...
            BIO_printf(bio_err, "Write out database with %d new entries\n",
                       OPENSSL_sk_num(ossl_check_const_X509_sk_type(cert_sk)));
...
# 1047 "../apps/ca.c"
                   && !save_serial(serialfile, "new", serial, 
# 1047 "../apps/ca.c" 3 4
                                                              ((void *)0)
# 1047 "../apps/ca.c"
                                                                  ))
        ...
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(cert_sk)); i++) {
            BIO *Cout = 
# 1063 "../apps/ca.c" 3 4
                       ((void *)0)
# 1063 "../apps/ca.c"
                           ;
            X509 *xi = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(cert_sk), (i)));
...
# 1109 "../apps/ca.c"
        ...
        if (OPENSSL_sk_num(ossl_check_const_X509_sk_type(cert_sk))) {
...
# 1129 "../apps/ca.c"
            ...
            crl_ext = app_conf_try_string(conf, section, "crl_extensions");
        if (crl_ext != 
# 1131 "../apps/ca.c" 3 4
                      ((void *)0)
# 1131 "../apps/ca.c"
...
# 1135 "../apps/ca.c"
           , 0x1);
            X509V3_set_nconf(&ctx, conf);
            if (!X509V3_EXT_add_nconf(conf, &ctx, crl_ext, 
# 1137 "../apps/ca.c" 3 4
                                                          ((void *)0)
# 1137 "../apps/ca.c"
                                                              )) {
        ...
        crlnumberfile = app_conf_try_string(conf, section, "crlnumber");
        if (crlnumberfile != 
# 1146 "../apps/ca.c" 3 4
                            ((void *)0)
# 1146 "../apps/ca.c"
                                ) {
            if ((crlnumber = load_serial(crlnumberfile, 
# 1147 "../apps/ca.c" 3 4
                                                       ((void *)0)
# 1147 "../apps/ca.c"
                                                           , 0, 
...
# 1192 "../apps/ca.c"
                ...
                if (!BN_hex2bn(&serial, pp[3]))
                    goto end;
                tmpser = BN_to_ASN1_INTEGER(serial, 
# 1201 "../apps/ca.c" 3 4
                                                   ((void *)0)
# 1201 "../apps/ca.c"
                                                       );
...
# 1253 "../apps/ca.c"
               && !save_serial(crlnumberfile, "new", crlnumber, 
# 1253 "../apps/ca.c" 3 4
                                                                ((void *)0)
# 1253 "../apps/ca.c"
                                                                    ))
...
# 1285 "../apps/ca.c"
    ...
    cleanse(passin);
    if (free_passin)
        CRYPTO_free(passin, "../apps/ca.c", 1315);
    BN_free(serial);
    BN_free(crlnumber);
    free_index(db);
...
# 1356 "../apps/ca.c"
        ...
        goto end;
    if ((pktmp = X509_REQ_get0_pubkey(req)) == 
# 1358 "../apps/ca.c" 3 4
                                              ((void *)0)
# 1358 "../apps/ca.c"
                                                  ) {
...
# 1414 "../apps/ca.c"
    ...
    if ((pktmp = X509_get0_pubkey(template_cert)) == 
# 1421 "../apps/ca.c" 3 4
                                                    ((void *)0)
# 1421 "../apps/ca.c"
                                                        ) {
    ...
    if ((rreq = X509_to_X509_REQ(template_cert, 
# 1439 "../apps/ca.c" 3 4
                                               ((void *)0)
# 1439 "../apps/ca.c"
                                                   , 
...
# 1553 "../apps/ca.c"
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(policy)); i++) {
        cv = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(policy), (i)));
...
# 1652 "../apps/ca.c"
    ...
    if ((ret = X509_new_ex(app_get0_libctx(), app_get0_propq())) == 
# 1661 "../apps/ca.c" 3 4
                                                                   ((void *)0)
# 1661 "../apps/ca.c"
                                                                       )
    ...
    if (BN_to_ASN1_INTEGER(serial, X509_get_serialNumber(ret)) == 
# 1664 "../apps/ca.c" 3 4
                                                                 ((void *)0)
# 1664 "../apps/ca.c"
                                                                     )
...
# 1762 "../apps/ca.c"
    ...
    row[5] = X509_NAME_oneline(X509_get_subject_name(ret), 
# 1781 "../apps/ca.c" 3 4
                                                                ((void *)0)
# 1781 "../apps/ca.c"
                                                                    , 0);
...
# 1782 "../apps/ca.c"
    ...
    if (BN_is_zero(serial))
        row[3] = CRYPTO_strdup("00", "../apps/ca.c", 1788);
    else
...
# 1791 "../apps/ca.c"
    ...
    if (row[5][0] == '\0') {
        ...
        CRYPTO_free(row[5], "../apps/ca.c", 1802);
        row[5] = CRYPTO_strdup(row[3], "../apps/ca.c", 1803);
        if (row[5] == 
# 1804 "../apps/ca.c" 3 4
                           ((void *)0)
# 1804 "../apps/ca.c"
...
# 1888 "../apps/ca.c"
    ...
    row[0] = CRYPTO_strdup("V", "../apps/ca.c", 1910);
...
# 1915 "../apps/ca.c"
                          ;
    row[4] = CRYPTO_strdup("unknown", "../apps/ca.c", 1916);
    if ((row[0] == 
# 1917 "../apps/ca.c" 3 4
                        ((void *)0)
# 1917 "../apps/ca.c"
...
# 1933 "../apps/ca.c"
    ...
    if (ok != 1) {
        for (i = 0; i < 6; i++)
            CRYPTO_free(row[i], "../apps/ca.c", 1938);
    }
    CRYPTO_free(irow, "../apps/ca.c", 1940);
...
# 1992 "../apps/ca.c"
    ...
    if (OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(sk)) == 0) {
...
# 2011 "../apps/ca.c"
    ...
    for (i = 0;; i++) {
        if (OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(sk)) <= i)
            break;

        cv = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(sk), (i)));
        type = cv->name;
...
# 2053 "../apps/ca.c"
    ...
    if ((pktmp = NETSCAPE_SPKI_get_pubkey(spki)) == 
# 2065 "../apps/ca.c" 3 4
                                                   ((void *)0)
# 2065 "../apps/ca.c"
                                                       ) {
...
# 2109 "../apps/ca.c"
                    ;
    row[5] = X509_NAME_oneline(X509_get_subject_name(x509), 
# 2110 "../apps/ca.c" 3 4
                                                                 ((void *)0)
# 2110 "../apps/ca.c"
                                                                     , 0);
    bn = ASN1_INTEGER_to_BN(X509_get0_serialNumber(x509), 
# 2111 "../apps/ca.c" 3 4
                                                         ((void *)0)
# 2111 "../apps/ca.c"
                                                             );
    if (!bn)
        goto end;
    if (BN_is_zero(bn))
        row[3] = CRYPTO_strdup("00", "../apps/ca.c", 2115);
    else
        row[3] = BN_bn2hex(bn);
    BN_free(bn);
    if (row[5] != 
...
# 2119 "../apps/ca.c"
        ...
        CRYPTO_free(row[5], "../apps/ca.c", 2121);
        row[5] = CRYPTO_strdup(row[3], "../apps/ca.c", 2122);
    }
    if ((row[5] == 
# 2124 "../apps/ca.c" 3 4
                        ((void *)0)
...
# 2133 "../apps/ca.c"
        ...
        row[0] = CRYPTO_strdup("V", "../apps/ca.c", 2139);
...
# 2144 "../apps/ca.c"
                              ;
        row[4] = CRYPTO_strdup("unknown", "../apps/ca.c", 2145);
...
# 2155 "../apps/ca.c"
        ...
        if (!TXT_DB_insert(db->db, irow)) {
            BIO_printf(bio_err, "failed to update database\n");
            BIO_printf(bio_err, "TXT_DB error number %ld\n", db->db->error);
            CRYPTO_free(irow, "../apps/ca.c", 2160);
            goto end;
        }
...
# 2165 "../apps/ca.c"
    ...
    for (i = 0; i < 6; i++)
        CRYPTO_free(row[i], "../apps/ca.c", 2201);
    return ok;
}
...
# 2240 "../apps/ca.c"
    ...
    for (i = 0; i < 6; i++) {
        CRYPTO_free(row[i], "../apps/ca.c", 2267);
    }
    return ok;
}
...
# 2296 "../apps/ca.c"
            ...
            if (!ASN1_TIME_set_string(exp_date, rrow[1])) {
                ASN1_TIME_free(a_tm);
...
# 2444 "../apps/ca.c"
                           ;
    ASN1_GENERALIZEDTIME *comp_time = 
# 2445 "../apps/ca.c" 3 4
                                     ((void *)0)
# 2445 "../apps/ca.c"
                                         ;
...
# 2460 "../apps/ca.c"
            ...
            goto end;
        if (X509_REVOKED_add1_ext_i2d(rev, 141, rtmp, 0, 0) <= 0)
            goto end;
    }

    if (rev && comp_time) {
        if (X509_REVOKED_add1_ext_i2d
            (rev, 142, comp_time, 0, 0) <= 0)
            goto end;
    }
    if (rev && hold) {
        if (X509_REVOKED_add1_ext_i2d
    ...
    CRYPTO_free(tmp, "../apps/ca.c", 2484);
...
# 2543 "../apps/ca.c"
    ...
    tmp = CRYPTO_strdup(str, "../apps/ca.c", 2545);
    if (!tmp) {
        BIO_printf(bio_err, "memory allocation failure\n");
        goto end;
    }
...
# 2632 "../apps/ca.c"
    ...
    CRYPTO_free(tmp, "../apps/ca.c", 2639);
    ASN1_GENERALIZEDTIME_free(comp_time);
