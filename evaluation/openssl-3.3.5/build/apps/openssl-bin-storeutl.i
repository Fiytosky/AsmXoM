...
typedef enum OPTION_choice {
    ...
    OPT_MD, OPT_PROV__FIRST=1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY, OPT_PROV__LAST
} OPTION_CHOICE;
...
const OPTIONS storeutl_options[] = {
    ...
    { OPT_SECTION_STR, 1, '-', "Search" " options:\n" },
...
# 73 "../apps/storeutl.c"
                                                          ;
    BIO *out = 
# 74 "../apps/storeutl.c" 3 4
              ((void *)0)
# 74 "../apps/storeutl.c"
                  ;
    ENGINE *e = 
# 75 "../apps/storeutl.c" 3 4
               ((void *)0)
# 75 "../apps/storeutl.c"
                   ;
    OPTION_CHOICE o;
...
# 81 "../apps/storeutl.c"
                                            ;
    ASN1_INTEGER *serial = 
# 82 "../apps/storeutl.c" 3 4
                          ((void *)0)
# 82 "../apps/storeutl.c"
                              ;
    unsigned char *fingerprint = 
# 83 "../apps/storeutl.c" 3 4
                                ((void *)0)
# 83 "../apps/storeutl.c"
                                    ;
    size_t fingerprintlen = 0;
    char *alias = 
# 85 "../apps/storeutl.c" 3 4
                 ((void *)0)
# 85 "../apps/storeutl.c"
                     , *digestname = 
# 85 "../apps/storeutl.c" 3 4
...
# 86 "../apps/storeutl.c" 3 4
                               ((void *)0)
# 86 "../apps/storeutl.c"
                                   ;
    EVP_MD *digest = 
# 87 "../apps/storeutl.c" 3 4
                    ((void *)0)
# 87 "../apps/storeutl.c"
                        ;
        ...
        case OPT_SEARCHFOR_CRLS:
            ...
            }
            {
                static const struct {
                    ...
                    {OPT_SEARCHFOR_CERTS, 5},
                    {OPT_SEARCHFOR_KEYS, 4},
                    {OPT_SEARCHFOR_CRLS, 6},
                };
                size_t i;
                ...
                (void)((expected != 0) ? 0 : (OPENSSL_die("assertion failed: " "expected != 0", "../apps/storeutl.c", 147), 1));
            }
            break;
...
# 157 "../apps/storeutl.c"
            ...
            subject = parse_name(opt_arg(), (0x1000), 1, "subject");
            if (subject == 
# 163 "../apps/storeutl.c" 3 4
                          ((void *)0)
# 163 "../apps/storeutl.c"
                              )
                goto end;
...
# 174 "../apps/storeutl.c"
            ...
            issuer = parse_name(opt_arg(), (0x1000), 1, "issuer");
            if (issuer == 
# 180 "../apps/storeutl.c" 3 4
                         ((void *)0)
# 180 "../apps/storeutl.c"
                             )
                goto end;
...
# 191 "../apps/storeutl.c"
            ...
            if ((serial = s2i_ASN1_INTEGER(
# 196 "../apps/storeutl.c" 3 4
                                          ((void *)0)
# 196 "../apps/storeutl.c"
                                              , opt_arg())) == 
# 196 "../apps/storeutl.c" 3 4
...
# 234 "../apps/storeutl.c"
            ...
            if ((alias = CRYPTO_strdup(opt_arg(), "../apps/storeutl.c", 239)) == 
# 239 "../apps/storeutl.c" 3 4
                                                      ((void *)0)
# 239 "../apps/storeutl.c"
                                                          ) {
...
# 313 "../apps/storeutl.c"
    ...
    EVP_MD_free(digest);
    CRYPTO_free(fingerprint, "../apps/storeutl.c", 322);
    CRYPTO_free(alias, "../apps/storeutl.c", 323);
    ASN1_INTEGER_free(serial);
    X509_NAME_free(subject);
    X509_NAME_free(issuer);
    OSSL_STORE_SEARCH_free(search);
    BIO_free_all(out);
    CRYPTO_free(passin, "../apps/storeutl.c", 329);
    release_engine(e);
    return ret;
}
...
# 365 "../apps/storeutl.c"
    ...
    for (;;) {
        ...
        int type = info == 
# 397 "../apps/storeutl.c" 3 4
                          ((void *)0) 
# 397 "../apps/storeutl.c"
                               ? 0 : OSSL_STORE_INFO_get_type(info);
        const char *infostr =
            info == 
# 399 "../apps/storeutl.c" 3 4
                   ((void *)0) 
# 399 "../apps/storeutl.c"
                        ? 
# 399 "../apps/storeutl.c" 3 4
