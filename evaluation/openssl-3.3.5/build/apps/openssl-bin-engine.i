...
# 61 "../apps/engine.c"
        ...
        *size = ((len + expand - 1) / expand) * expand;
        ...
        if (len > *size) {
            *size = ((len + expand - 1) / expand) * expand;
            p = CRYPTO_realloc(p, *size, "../apps/engine.c", 72);
            if (p == 
# 73 "../apps/engine.c" 3 4
                    ((void *)0)
# 73 "../apps/engine.c"
                        ) {
                CRYPTO_free(*buf, "../apps/engine.c", 74);
                *buf = 
# 75 "../apps/engine.c" 3 4
                      ((void *)0)
# 75 "../apps/engine.c"
                          ;
                return 0;
...
static int util_verbose(ENGINE *e, int verbose, BIO *out, const char *indent)
{
    ...
    int ret = 0;
    char *name = 
# 155 "../apps/engine.c" 3 4
                ((void *)0)
# 155 "../apps/engine.c"
                    ;
    char *desc = 
# 156 "../apps/engine.c" 3 4
                ((void *)0)
# 156 "../apps/engine.c"
                    ;
    int flags;
    int xpos = 0;
    struct stack_st_OPENSSL_STRING *cmds = 
# 159 "../apps/engine.c" 3 4
                                    ((void *)0)
# 159 "../apps/engine.c"
                                        ;
    if (!ENGINE_ctrl(e, 10, 0, 
# 160 "../apps/engine.c" 3 4
                                                         ((void *)0)
# 160 "../apps/engine.c"
                                                             , 
# 160 "../apps/engine.c" 3 4
...
# 162 "../apps/engine.c"
    ...
    cmds = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null());
    if (cmds == 
# 167 "../apps/engine.c" 3 4
               ((void *)0)
# 167 "../apps/engine.c"
                   )
        goto err;
...
# 215 "../apps/engine.c"
        ...
        CRYPTO_free(name, "../apps/engine.c", 222);
        name = 
# 223 "../apps/engine.c" 3 4
              ((void *)0)
# 223 "../apps/engine.c"
                  ;
        CRYPTO_free(desc, "../apps/engine.c", 224);
        desc = 
# 225 "../apps/engine.c" 3 4
              ((void *)0)
# 225 "../apps/engine.c"
                  ;

        num = ENGINE_ctrl(e, 12, num, 
# 227 "../apps/engine.c" 3 4
                                                                ((void *)0)
# 227 "../apps/engine.c"
                                                                    , 
# 227 "../apps/engine.c" 3 4
...
# 227 "../apps/engine.c"
    ...
    ret = 1;
 err:
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(cmds));
    CRYPTO_free(name, "../apps/engine.c", 234);
    CRYPTO_free(desc, "../apps/engine.c", 235);
    return ret;
}
...
{
    int loop, res, num = OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(cmds));
    ...
    for (loop = 0; loop < num; loop++) {
        char buf[256];
        const char *cmd, *arg;
        cmd = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(cmds), (loop)));
        res = 1;

        if ((arg = strchr(cmd, ':')) == 
# 254 "../apps/engine.c" 3 4
                                       ((void *)0)
# 254 "../apps/engine.c"
                                           ) {
            if (!ENGINE_ctrl_cmd_string(e, cmd, 
# 255 "../apps/engine.c" 3 4
                                               ((void *)0)
# 255 "../apps/engine.c"
                                                   , 0))
                res = 0;
...
int engine_main(int argc, char **argv)
{
    ...
    ENGINE *e;
    struct stack_st_OPENSSL_CSTRING *engines = ((struct stack_st_OPENSSL_CSTRING *)OPENSSL_sk_new_null());
    struct stack_st_OPENSSL_STRING *pre_cmds = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null());
    struct stack_st_OPENSSL_STRING *post_cmds = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null());
    BIO *out;
    const char *indent = "     ";
    OPTION_CHOICE o;
    char *prog;
...
# 312 "../apps/engine.c"
    ...
    prog = argv[0];
    while ((argv1 = argv[1]) != 
# 318 "../apps/engine.c" 3 4
                               ((void *)0) 
# 318 "../apps/engine.c"
                                    && *argv1 != '-') {
        OPENSSL_sk_push(ossl_check_OPENSSL_CSTRING_sk_type(engines), ossl_check_OPENSSL_CSTRING_type(argv1));
        argc--;
        argv++;
    }
    argv[0] = prog;
    ...
    while ((o = opt_next()) != OPT_EOF) {
        ...
        case OPT_T:
            ...
            break;
        case OPT_PRE:
            if (OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(pre_cmds), ossl_check_OPENSSL_STRING_type(opt_arg())) <= 0)
                goto end;
            break;
        case OPT_POST:
            if (OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(post_cmds), ossl_check_OPENSSL_STRING_type(opt_arg())) <= 0)
                goto end;
            break;
        }
    }
    ...
    for ( ; *argv; argv++) {
        ...
        OPENSSL_sk_push(ossl_check_OPENSSL_CSTRING_sk_type(engines), ossl_check_OPENSSL_CSTRING_type(*argv));
    }

    if (OPENSSL_sk_num(ossl_check_const_OPENSSL_CSTRING_sk_type(engines)) == 0) {
        for (e = ENGINE_get_first(); e != 
# 379 "../apps/engine.c" 3 4
                                         ((void *)0)
# 379 "../apps/engine.c"
                                             ; e = ENGINE_get_next(e)) {
            OPENSSL_sk_push(ossl_check_OPENSSL_CSTRING_sk_type(engines), ossl_check_OPENSSL_CSTRING_type(ENGINE_get_id(e)));
        }
    }

    ret = 0;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OPENSSL_CSTRING_sk_type(engines)); i++) {
        const char *id = ((const char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_CSTRING_sk_type(engines), (i)));
        if ((e = ENGINE_by_id(id)) != 
# 387 "../apps/engine.c" 3 4
                                     ((void *)0)
# 387 "../apps/engine.c"
                                         ) {
...
# 414 "../apps/engine.c"
                   && !append_buf(&cap_buf, &cap_size, "DSA"))
                    goto end;
                if (ENGINE_get_DH(e) != 
# 416 "../apps/engine.c" 3 4
                                       ((void *)0)
                    
# 417 "../apps/engine.c"
                   && !append_buf(&cap_buf, &cap_size, "DH"))
                    goto end;
                if (ENGINE_get_RAND(e) != 
# 419 "../apps/engine.c" 3 4
                                         ((void *)0)
...
# 420 "../apps/engine.c"
                ...
                if (fn_c == 
# 424 "../apps/engine.c" 3 4
                           ((void *)0)
# 424 "../apps/engine.c"
                               )
                    goto skip_ciphers;
                n = fn_c(e, 
# 426 "../apps/engine.c" 3 4
                           ((void *)0)
# 426 "../apps/engine.c"
                               , &nids, 0);
                for (k = 0; k < n; ++k)
 ...
 skip_ciphers:
                ...
                if (fn_d == 
# 433 "../apps/engine.c" 3 4
                           ((void *)0)
# 433 "../apps/engine.c"
                               )
                    goto skip_digests;
                n = fn_d(e, 
# 435 "../apps/engine.c" 3 4
                           ((void *)0)
# 435 "../apps/engine.c"
                               , &nids, 0);
                for (k = 0; k < n; ++k)
 ...
 skip_digests:
                ...
                if (fn_pk == 
# 442 "../apps/engine.c" 3 4
                            ((void *)0)
# 442 "../apps/engine.c"
                                )
                    goto skip_pmeths;
                n = fn_pk(e, 
# 444 "../apps/engine.c" 3 4
                            ((void *)0)
# 444 "../apps/engine.c"
                                , &nids, 0);
                for (k = 0; k < n; ++k)
 ...
 skip_pmeths:
                ...
                if (cap_buf != 
# 461 "../apps/engine.c" 3 4
                              ((void *)0) 
# 461 "../apps/engine.c"
                                   && (*cap_buf != '\0'))
                    BIO_printf(out, " [%s]\n", cap_buf);

                CRYPTO_free(cap_buf, "../apps/engine.c", 464);
            }
            if (test_avail) {
...
# 475 "../apps/engine.c"
    ...
    ERR_print_errors(bio_err);
    OPENSSL_sk_free(ossl_check_OPENSSL_CSTRING_sk_type(engines));
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(pre_cmds));
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(post_cmds));
    BIO_free_all(out);
    return ret;
}
