...
# 22 "../apps/ecparam.c" 2
# 1 "../apps/include/ec_common.h" 1
# 11 "../apps/include/ec_common.h"
static const char *point_format_options[] = {
    "uncompressed",
    "compressed",
    "hybrid",
    
# 15 "../apps/include/ec_common.h" 3 4
   ((void *)0)

# 16 "../apps/include/ec_common.h"
};
...
# 21 "../apps/include/ec_common.h" 3 4
   ((void *)0)

# 22 "../apps/include/ec_common.h"
};
# 23 "../apps/ecparam.c" 2
...
const OPTIONS ecparam_options[] = {
    ...
    { OPT_SECTION_STR, 1, '-', "Parameter" " options:\n" },
...
# 71 "../apps/ecparam.c" 3 4
                              ((void *)0)
# 71 "../apps/ecparam.c"
                                  ;
    size_t n, crv_len = EC_get_builtin_curves(
# 72 "../apps/ecparam.c" 3 4
                                             ((void *)0)
# 72 "../apps/ecparam.c"
                                                 , 0);
    ...
    for (n = 0; n < crv_len; n++) {
        ...
        if (comment == 
# 82 "../apps/ecparam.c" 3 4
                      ((void *)0)
# 82 "../apps/ecparam.c"
                          )
            comment = "CURVE DESCRIPTION NOT AVAILABLE";
        if (sname == 
# 84 "../apps/ecparam.c" 3 4
                    ((void *)0)
# 84 "../apps/ecparam.c"
                        )
            sname = "";
    ...
    CRYPTO_free(curves, "../apps/ecparam.c", 92);
    return ret;
}

int ecparam_main(int argc, char **argv)
{
    EVP_PKEY_CTX *gctx_params = 
# 98 "../apps/ecparam.c" 3 4
                               ((void *)0)
# 98 "../apps/ecparam.c"
                                   , *gctx_key = 
# 98 "../apps/ecparam.c" 3 4
...
# 99 "../apps/ecparam.c"
                                           ;
    OSSL_ENCODER_CTX *ectx_key = 
# 100 "../apps/ecparam.c" 3 4
                                ((void *)0)
# 100 "../apps/ecparam.c"
                                    , *ectx_params = 
# 100 "../apps/ecparam.c" 3 4
...
# 100 "../apps/ecparam.c"
                                                         ;
    OSSL_DECODER_CTX *dctx_params = 
# 101 "../apps/ecparam.c" 3 4
                                   ((void *)0)
# 101 "../apps/ecparam.c"
                                       ;
    ENGINE *e = 
# 102 "../apps/ecparam.c" 3 4
               ((void *)0)
# 102 "../apps/ecparam.c"
                   ;
    BIO *out = 
# 103 "../apps/ecparam.c" 3 4
              ((void *)0)
# 103 "../apps/ecparam.c"
                  ;
    char *curve_name = 
# 104 "../apps/ecparam.c" 3 4
                      ((void *)0)
# 104 "../apps/ecparam.c"
                          ;
    char *asn1_encoding = 
# 105 "../apps/ecparam.c" 3 4
                         ((void *)0)
# 105 "../apps/ecparam.c"
                             ;
    char *point_format = 
# 106 "../apps/ecparam.c" 3 4
                        ((void *)0)
# 106 "../apps/ecparam.c"
                            ;
    char *infile = 
# 107 "../apps/ecparam.c" 3 4
                  ((void *)0)
# 107 "../apps/ecparam.c"
                      , *outfile = 
# 107 "../apps/ecparam.c" 3 4
...
# 107 "../apps/ecparam.c"
                                       , *prog;
    OPTION_CHOICE o;
    int informat = (5 | 0x8000), outformat = (5 | 0x8000), noout = 0;
    int ret = 1, private = 0;
...
# 207 "../apps/ecparam.c"
        ...
        *p++ = OSSL_PARAM_construct_utf8_string("group",
                                                curve_name, 0);
        if (asn1_encoding != 
# 222 "../apps/ecparam.c" 3 4
                            ((void *)0)
# 222 "../apps/ecparam.c"
                                )
            *p++ = OSSL_PARAM_construct_utf8_string("encoding",
                                                    asn1_encoding, 0);
        if (point_format != 
# 225 "../apps/ecparam.c" 3 4
                           ((void *)0)
# 225 "../apps/ecparam.c"
                               )
...
# 251 "../apps/ecparam.c"
        ...
        if (asn1_encoding != 
# 264 "../apps/ecparam.c" 3 4
                            ((void *)0)
            
# 265 "../apps/ecparam.c"
           && !EVP_PKEY_set_utf8_string_param(
                    params_key, "encoding", asn1_encoding)) {
    ...
    if (no_seed
        && !EVP_PKEY_set_octet_string_param(params_key, "seed",
                                            
# 274 "../apps/ecparam.c" 3 4
                                           ((void *)0)
# 274 "../apps/ecparam.c"
                                               , 0)) {
    ...
    if (text
        && !EVP_PKEY_print_params(out, params_key, 0, 
# 280 "../apps/ecparam.c" 3 4
                                                     ((void *)0)
# 280 "../apps/ecparam.c"
                                                         )) {
    ...
    if (check || check_named) {
        ...
        pctx = EVP_PKEY_CTX_new_from_pkey(app_get0_libctx(), params_key,
                                          app_get0_propq());
        if (pctx == 
# 297 "../apps/ecparam.c" 3 4
                   ((void *)0) 
# 297 "../apps/ecparam.c"
                        || EVP_PKEY_param_check(pctx) <= 0) {
...
# 333 "../apps/ecparam.c" 3 4
       ((void) (0))
# 333 "../apps/ecparam.c"
                      ;
        ectx_key = OSSL_ENCODER_CTX_new_for_pkey(
                       key, ( ( 0x01 | 0x02 ) | ( 0x04 | 0x80) ),
                       outformat == 4 ? "DER" : "PEM", 
# 336 "../apps/ecparam.c" 3 4
                                                                ((void *)0)
# 336 "../apps/ecparam.c"
                                                                    , 
# 336 "../apps/ecparam.c" 3 4
