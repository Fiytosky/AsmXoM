# 0 "../engines/e_padlock.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../engines/e_padlock.c"
# 16 "../engines/e_padlock.c"
...
# 27 "../engines/e_padlock.c" 2
# 39 "../engines/e_padlock.c"
...
static ENGINE *ENGINE_padlock(void)
{
    ...
    if (eng == 
# 130 "../engines/e_padlock.c" 3 4
              ((void *)0)
# 130 "../engines/e_padlock.c"
                  ) {
        return 
# 131 "../engines/e_padlock.c" 3 4
              ((void *)0)
# 131 "../engines/e_padlock.c"
                  ;
    }
    ...
    if (!padlock_bind_helper(eng)) {
        ENGINE_free(eng);
        return 
# 136 "../engines/e_padlock.c" 3 4
              ((void *)0)
# 136 "../engines/e_padlock.c"
                  ;
    }
...
static EVP_CIPHER *_hidden_aes_256_ofb = 
# 543 "../engines/e_padlock.c" 3 4
((void *)0)
# 543 "../engines/e_padlock.c"
; static const EVP_CIPHER *padlock_aes_256_ofb(void) { if (_hidden_aes_256_ofb == 
# 543 "../engines/e_padlock.c" 3 4
((void *)0) 
# 543 "../engines/e_padlock.c"
&& ((_hidden_aes_256_ofb = EVP_CIPHER_meth_new(428, 1, 32)) == 
# 543 "../engines/e_padlock.c" 3 4
((void *)0) 
# 543 "../engines/e_padlock.c"
                ...
                int nid)
{
    ...
    default:
        ...
        *cipher = 
# 608 "../engines/e_padlock.c" 3 4
                 ((void *)0)
# 608 "../engines/e_padlock.c"
                     ;
        return 0;
    }
                     ...
                     const unsigned char *iv, int enc)
{
    ...
    unsigned long mode = EVP_CIPHER_get_mode(EVP_CIPHER_CTX_get0_cipher(ctx));

    if (key == 
# 624 "../engines/e_padlock.c" 3 4
              ((void *)0)
# 624 "../engines/e_padlock.c"
                  )
        return 0;
...
# 740 "../engines/e_padlock.c" 3 4
   ((void *)0)
# 740 "../engines/e_padlock.c"
       ,
    padlock_rand_bytes,
    
# 742 "../engines/e_padlock.c" 3 4
   ((void *)0)
# 742 "../engines/e_padlock.c"
       ,
    
# 743 "../engines/e_padlock.c" 3 4
   ((void *)0)
# 743 "../engines/e_padlock.c"
       ,
    padlock_rand_bytes,
    padlock_rand_status,
};
