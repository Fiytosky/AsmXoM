...
# 23 "../engines/e_afalg.c" 2

# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 25 "../engines/e_afalg.c" 2
...
# 27 "../engines/e_afalg.c" 2
# 1 "/usr/include/linux/version.h" 1 3 4
# 28 "../engines/e_afalg.c" 2
# 43 "../engines/e_afalg.c"
# 1 "/usr/include/linux/if_alg.h" 1 3 4
# 17 "/usr/include/linux/if_alg.h" 3 4
...
# 18 "/usr/include/linux/if_alg.h" 2 3 4
...
# 46 "../engines/e_afalg.c" 2

# 1 "/usr/include/linux/aio_abi.h" 1 3 4
# 31 "/usr/include/linux/aio_abi.h" 3 4
# 1 "/usr/include/linux/fs.h" 1 3 4
# 14 "/usr/include/linux/fs.h" 3 4
...
# 15 "/usr/include/linux/fs.h" 2 3 4

# 1 "/usr/include/linux/fscrypt.h" 1 3 4
# 37 "/usr/include/linux/fscrypt.h" 3 4
...
# 53 "/usr/include/linux/fscrypt.h" 3 4
struct fscrypt_key {
 __u32 mode;
 __u8 raw[64];
 __u32 size;
...
# 100 "/usr/include/linux/fscrypt.h" 3 4
...
# 91 "/usr/include/linux/mount.h" 3 4
...
# 281 "/usr/include/linux/fs.h" 3 4
typedef int __kernel_rwf_t;
# 32 "/usr/include/linux/aio_abi.h" 2 3 4
...
# 13 "/usr/include/linux/byteorder/little_endian.h" 3 4
...
# 14 "/usr/include/linux/byteorder/little_endian.h" 2 3 4
# 44 "/usr/include/linux/byteorder/little_endian.h" 3 4
...
# 33 "/usr/include/linux/aio_abi.h" 2 3 4
...
# 60 "/usr/include/linux/aio_abi.h" 3 4
struct io_event {
 __u64 data;
 __u64 obj;
 __s64 res;
...
# 88 "/usr/include/linux/aio_abi.h" 3 4
...
# 49 "../engines/e_afalg.c" 2


# 1 "../engines/e_afalg.h" 1
# 50 "../engines/e_afalg.h"
...
# 52 "../engines/e_afalg.c" 2
# 1 "../engines/e_afalg_err.c" 1
# 12 "../engines/e_afalg_err.c"
# 1 "../engines/e_afalg_err.h" 1
# 13 "../engines/e_afalg_err.h"
        
# 13 "../engines/e_afalg_err.c" 2



static ERR_STRING_DATA AFALG_str_reasons[] = {
    {( (((unsigned long)(0) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ), "eventfd failed"},
    {( (((unsigned long)(0) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ),
    "failed to get platform info"},
    {( (((unsigned long)(0) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ), "init failed"},
    {( (((unsigned long)(0) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ), "io setup failed"},
    {( (((unsigned long)(0) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ),
    "kernel does not support afalg"},
    {( (((unsigned long)(0) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ),
    "kernel does not support async afalg"},
    {( (((unsigned long)(0) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ), "kernel op failed"},
    {( (((unsigned long)(0) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ), "mem alloc failed"},
    {( (((unsigned long)(0) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ), "socket accept failed"},
    {( (((unsigned long)(0) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ), "socket bind failed"},
    {( (((unsigned long)(0) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ), "socket create failed"},
    {( (((unsigned long)(0) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ),
    "socket operation failed"},
    {( (((unsigned long)(0) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ), "socket set key failed"},
    {0, 
# 34 "../engines/e_afalg_err.c" 3 4
       ((void *)0)
# 34 "../engines/e_afalg_err.c"
           }
};
...
static void ERR_AFALG_error(int function, int reason, const char *file, int line)
{
    if (lib_code == 0)
        lib_code = ERR_get_next_error_library();
    (ERR_new(), ERR_set_debug("../engines/e_afalg_err.c",70,__func__), ERR_set_error)((lib_code),(reason),
# 70 "../engines/e_afalg_err.c" 3 4
   ((void *)0)
# 70 "../engines/e_afalg_err.c"
   );
    ERR_set_debug(file, line, 
# 71 "../engines/e_afalg_err.c" 3 4
                             ((void *)0)
# 71 "../engines/e_afalg_err.c"
                                 );
}
# 53 "../engines/e_afalg.c" 2
# 70 "../engines/e_afalg.c"
...
static cbc_handles cbc_handle[] = {{16, 
# 103 "../engines/e_afalg.c" 3 4
                                                     ((void *)0)
# 103 "../engines/e_afalg.c"
                                                         },
                                    {24, 
# 104 "../engines/e_afalg.c" 3 4
                                                      ((void *)0)
# 104 "../engines/e_afalg.c"
                                                          },
                                    {32, 
# 105 "../engines/e_afalg.c" 3 4
                                                      ((void *)0)
# 105 "../engines/e_afalg.c"
                                                          }};

static inline int io_setup(unsigned n, aio_context_t *ctx)
{
    return syscall(
# 109 "../engines/e_afalg.c" 3 4
                  206
# 109 "../engines/e_afalg.c"
                               , n, ctx);
}
...
{
    return syscall(
# 114 "../engines/e_afalg.c" 3 4
                  290
# 114 "../engines/e_afalg.c"
                               , n, 0);
}
...
{
    return syscall(
# 119 "../engines/e_afalg.c" 3 4
                  207
# 119 "../engines/e_afalg.c"
                                 , ctx);
}
...
{
    return syscall(
# 124 "../engines/e_afalg.c" 3 4
                  209
# 124 "../engines/e_afalg.c"
                                , ctx, n, iocb);
}
...
# 149 "../engines/e_afalg.c"
    if (sizeof(*timeout) == sizeof(struct __timespec32))
        ...
        return syscall(
# 154 "../engines/e_afalg.c" 3 4
                      208
# 154 "../engines/e_afalg.c"
        ...
        if (timeout && timeout->tv_sec == (long)timeout->tv_sec) {
            ...
            return syscall(
# 168 "../engines/e_afalg.c" 3 4
                          208
# 168 "../engines/e_afalg.c"
                                           , ctx, min, max, events, &ts32);
        } else {
            return syscall(
# 170 "../engines/e_afalg.c" 3 4
                          208
# 170 "../engines/e_afalg.c"
                                           , ctx, min, max, events, 
# 170 "../engines/e_afalg.c" 3 4
                                                                    ((void *)0)
# 170 "../engines/e_afalg.c"
...
# 175 "../engines/e_afalg.c" 3 4
   (*__errno_location ()) 
# 175 "../engines/e_afalg.c"
         = 
# 175 "../engines/e_afalg.c" 3 4
           38
# 175 "../engines/e_afalg.c"
...
static int afalg_setup_async_event_notification(afalg_aio *aio)
{
    ...
    void *custom = 
# 189 "../engines/e_afalg.c" 3 4
                  ((void *)0)
# 189 "../engines/e_afalg.c"
                      ;
    int ret;

    if ((job = ASYNC_get_current_job()) != 
# 192 "../engines/e_afalg.c" 3 4
                                          ((void *)0)
# 192 "../engines/e_afalg.c"
                                              ) {

        waitctx = ASYNC_get_wait_ctx(job);
        if (waitctx == 
# 195 "../engines/e_afalg.c" 3 4
                      ((void *)0)
# 195 "../engines/e_afalg.c"
                          ) {
            ;
            return 0;
        }
        ...
        if (ret == 0) {
            ...
            if (aio->efd == -1) {
                do { fprintf(
# 209 "../engines/e_afalg.c" 3 4
               stderr
# 209 "../engines/e_afalg.c"
               , "ALG_PERR: " "%s(%d): Failed to get eventfd : ", "../engines/e_afalg.c", 210); perror(
# 209 "../engines/e_afalg.c" 3 4
               ((void *)0)
# 209 "../engines/e_afalg.c"
               ); } while(0)
                                  ;
                ERR_AFALG_error(0, (108), "../engines/e_afalg.c", 211)
                                                ;
                return 0;
            }
            ...
            if (fcntl(aio->efd, 
# 224 "../engines/e_afalg.c" 3 4
                               4
# 224 "../engines/e_afalg.c"
                                      , 
# 224 "../engines/e_afalg.c" 3 4
                                        04000
# 224 "../engines/e_afalg.c"
        ...
        if (aio->efd == -1) {
            do { fprintf(
# 234 "../engines/e_afalg.c" 3 4
           stderr
# 234 "../engines/e_afalg.c"
           , "ALG_PERR: " "%s(%d): Failed to get eventfd : ", "../engines/e_afalg.c", 234); perror(
# 234 "../engines/e_afalg.c" 3 4
           ((void *)0)
# 234 "../engines/e_afalg.c"
           ); } while(0);
            ERR_AFALG_error(0, (108), "../engines/e_afalg.c", 235)
                                            ;
            return 0;
        }
        aio->mode = MODE_SYNC;
...
static int afalg_init_aio(afalg_aio *aio)
{
    ...
    aio->aio_ctx = 0;
    r = io_setup(1, &aio->aio_ctx);
    if (r < 0) {
        do { fprintf(
# 252 "../engines/e_afalg.c" 3 4
       stderr
# 252 "../engines/e_afalg.c"
       , "ALG_PERR: " "%s(%d): io_setup error : ", "../engines/e_afalg.c", 252); perror(
# 252 "../engines/e_afalg.c" 3 4
       ((void *)0)
# 252 "../engines/e_afalg.c"
       ); } while(0);
        ERR_AFALG_error(0, (105), "../engines/e_afalg.c", 253);
        return 0;
    }
                                ...
                                size_t len)
{
    ...
    cb->aio_nbytes = len;
    cb->aio_flags = 
# 297 "../engines/e_afalg.c" 3 4
                   (1 << 0)
# 297 "../engines/e_afalg.c"
                                  ;
    ...
    if (r < 0) {
        do { fprintf(
# 306 "../engines/e_afalg.c" 3 4
       stderr
# 306 "../engines/e_afalg.c"
       , "ALG_PERR: " "%s(%d): io_read failed : ", "../engines/e_afalg.c", 306); perror(
# 306 "../engines/e_afalg.c" 3 4
       ((void *)0)
# 306 "../engines/e_afalg.c"
       ); } while(0);
    ...
    do {
        ...
        if (r < 0) {
            if (
# 317 "../engines/e_afalg.c" 3 4
               (*__errno_location ()) 
# 317 "../engines/e_afalg.c"
                     == 
# 317 "../engines/e_afalg.c" 3 4
                        11 
# 317 "../engines/e_afalg.c"
...
# 317 "../engines/e_afalg.c"
                ...
                continue;
            do { fprintf(
# 319 "../engines/e_afalg.c" 3 4
           stderr
# 319 "../engines/e_afalg.c"
           , "ALG_PERR: " "%s(%d): read failed for event fd : ", "../engines/e_afalg.c", 319); perror(
# 319 "../engines/e_afalg.c" 3 4
           ((void *)0)
# 319 "../engines/e_afalg.c"
           ); } while(0);
        ...
        if (eval > 0) {
# 337 "../engines/e_afalg.c"
            r = io_getevents(aio->aio_ctx, 1, 1,
                             events, &timeout);
            if (r > 0) {
                ...
                if (events[0].res < 0) {
                    ...
                    if (events[0].res == -
# 349 "../engines/e_afalg.c" 3 4
                                         16 
# 349 "../engines/e_afalg.c"
                                               && retry++ < 3) {
                        r = io_read(aio->aio_ctx, 1, &cb);
                        if (r < 0) {
                            do { fprintf(
# 352 "../engines/e_afalg.c" 3 4
                           stderr
# 352 "../engines/e_afalg.c"
                           , "ALG_PERR: " "%s(%d): retry %d for io_read failed : ", "../engines/e_afalg.c", 353, retry); perror(
# 352 "../engines/e_afalg.c" 3 4
                           ((void *)0)
# 352 "../engines/e_afalg.c"
                           ); } while(0)
...
# 368 "../engines/e_afalg.c"
                        ...
                        switch (events[0].res) {
                        case -
# 379 "../engines/e_afalg.c" 3 4
                             12
# 379 "../engines/e_afalg.c"
                                   :
                            ERR_AFALG_error(0, (112), "../engines/e_afalg.c", 380);
                            ERR_add_error_data(3, "-ENOMEM ( code ", strbuf, " )");
                            break;
                        default:
                            ERR_AFALG_error(0, (112), "../engines/e_afalg.c", 384);
                ...
                do { fprintf(
# 394 "../engines/e_afalg.c" 3 4
               stderr
# 394 "../engines/e_afalg.c"
               , "ALG_PERR: " "%s(%d): io_getevents failed : ", "../engines/e_afalg.c", 394); perror(
# 394 "../engines/e_afalg.c" 3 4
               ((void *)0)
# 394 "../engines/e_afalg.c"
               ); } while(0);
...
{
    cmsg->cmsg_level = 
# 409 "../engines/e_afalg.c" 3 4
                      279
# 409 "../engines/e_afalg.c"
                             ;
    cmsg->cmsg_type = 
# 410 "../engines/e_afalg.c" 3 4
                     3
# 410 "../engines/e_afalg.c"
                               ;
    cmsg->cmsg_len = 
# 411 "../engines/e_afalg.c" 3 4
                    ((((sizeof (struct cmsghdr)) + sizeof (size_t) - 1) & (size_t) ~(sizeof (size_t) - 1)) + (
# 411 "../engines/e_afalg.c"
                    (sizeof(unsigned int))
# 411 "../engines/e_afalg.c" 3 4
                    ))
# 411 "../engines/e_afalg.c"
                                        ;
    memcpy(
# 412 "../engines/e_afalg.c" 3 4
          ((
# 412 "../engines/e_afalg.c"
          cmsg
# 412 "../engines/e_afalg.c" 3 4
          )->__cmsg_data)
# 412 "../engines/e_afalg.c"
                         , &op, (sizeof(unsigned int)));
}
                            ...
                            const unsigned int len)
{
    ...
    cmsg->cmsg_level = 
# 420 "../engines/e_afalg.c" 3 4
                      279
# 420 "../engines/e_afalg.c"
                             ;
    cmsg->cmsg_type = 
# 421 "../engines/e_afalg.c" 3 4
                     2
# 421 "../engines/e_afalg.c"
                               ;
    cmsg->cmsg_len = 
# 422 "../engines/e_afalg.c" 3 4
                    ((((sizeof (struct cmsghdr)) + sizeof (size_t) - 1) & (size_t) ~(sizeof (size_t) - 1)) + (
# 422 "../engines/e_afalg.c"
                    (sizeof(struct af_alg_iv) + (len))
# 422 "../engines/e_afalg.c" 3 4
                    ))
# 422 "../engines/e_afalg.c"
                                             ;
    aiv = (struct af_alg_iv *)
# 423 "../engines/e_afalg.c" 3 4
                             ((
# 423 "../engines/e_afalg.c"
                             cmsg
# 423 "../engines/e_afalg.c" 3 4
                             )->__cmsg_data)
# 423 "../engines/e_afalg.c"
...
{
    int ret;
    ret = setsockopt(actx->bfd, 
# 432 "../engines/e_afalg.c" 3 4
                               279
# 432 "../engines/e_afalg.c"
                                      , 
# 432 "../engines/e_afalg.c" 3 4
                                        1
# 432 "../engines/e_afalg.c"
    ...
    if (ret < 0) {
        do { fprintf(
# 434 "../engines/e_afalg.c" 3 4
       stderr
# 434 "../engines/e_afalg.c"
       , "ALG_PERR: " "%s(%d): Failed to set socket option : ", "../engines/e_afalg.c", 434); perror(
# 434 "../engines/e_afalg.c" 3 4
       ((void *)0)
# 434 "../engines/e_afalg.c"
       ); } while(0);
        ERR_AFALG_error(0, (106), "../engines/e_afalg.c", 435);
        return 0;
    }
    return 1;
}
                                ...
                                const char *ciphername)
{
    ...
    sa.salg_family = 
# 450 "../engines/e_afalg.c" 3 4
                    38
# 450 "../engines/e_afalg.c"
                          ;
    ...
    actx->bfd = socket(
# 454 "../engines/e_afalg.c" 3 4
                      38
# 454 "../engines/e_afalg.c"
                            , 
# 454 "../engines/e_afalg.c" 3 4
                              SOCK_SEQPACKET
# 454 "../engines/e_afalg.c"
    ...
    if (actx->bfd == -1) {
        do { fprintf(
# 456 "../engines/e_afalg.c" 3 4
       stderr
# 456 "../engines/e_afalg.c"
       , "ALG_PERR: " "%s(%d): Failed to open socket : ", "../engines/e_afalg.c", 456); perror(
# 456 "../engines/e_afalg.c" 3 4
       ((void *)0)
# 456 "../engines/e_afalg.c"
       ); } while(0);
        ERR_AFALG_error(0, (109), "../engines/e_afalg.c", 457);
        goto err;
    }
    ...
    if (r < 0) {
        do { fprintf(
# 463 "../engines/e_afalg.c" 3 4
       stderr
# 463 "../engines/e_afalg.c"
       , "ALG_PERR: " "%s(%d): Failed to bind socket : ", "../engines/e_afalg.c", 463); perror(
# 463 "../engines/e_afalg.c" 3 4
       ((void *)0)
# 463 "../engines/e_afalg.c"
       ); } while(0);
        ERR_AFALG_error(0, (103), "../engines/e_afalg.c", 464);
        goto err;
    }

    actx->sfd = accept(actx->bfd, 
# 468 "../engines/e_afalg.c" 3 4
                                 ((void *)0)
# 468 "../engines/e_afalg.c"
                                     , 0);
    if (actx->sfd < 0) {
        do { fprintf(
# 470 "../engines/e_afalg.c" 3 4
       stderr
# 470 "../engines/e_afalg.c"
       , "ALG_PERR: " "%s(%d): Socket Accept Failed : ", "../engines/e_afalg.c", 470); perror(
# 470 "../engines/e_afalg.c" 3 4
       ((void *)0)
# 470 "../engines/e_afalg.c"
       ); } while(0);
        ERR_AFALG_error(0, (110), "../engines/e_afalg.c", 471);
        goto err;
    }
                                 ...
                                 unsigned int enc)
{
    ...
    char cbuf[
# 497 "../engines/e_afalg.c" 3 4
             ((((
# 497 "../engines/e_afalg.c"
             (sizeof(struct af_alg_iv) + (16))
# 497 "../engines/e_afalg.c" 3 4
...
# 497 "../engines/e_afalg.c"
    ...
    cmsg = 
# 508 "../engines/e_afalg.c" 3 4
          ((size_t) (
# 508 "../engines/e_afalg.c"
          &msg
# 508 "../engines/e_afalg.c" 3 4
...
# 508 "../engines/e_afalg.c"
    ...
    cmsg = 
# 510 "../engines/e_afalg.c" 3 4
          __cmsg_nxthdr (
# 510 "../engines/e_afalg.c"
          &msg
# 510 "../engines/e_afalg.c" 3 4
          , 
# 510 "../engines/e_afalg.c"
...
# 510 "../engines/e_afalg.c"
    ...
    msg.msg_flags = 
# 517 "../engines/e_afalg.c" 3 4
                   MSG_MORE
# 517 "../engines/e_afalg.c"
                           ;
# 554 "../engines/e_afalg.c"
    msg.msg_iovlen = 1;
    msg.msg_iov = &iov;
    ...
    if (sbytes < 0) {
        do { fprintf(
# 560 "../engines/e_afalg.c" 3 4
       stderr
# 560 "../engines/e_afalg.c"
       , "ALG_PERR: " "%s(%d): sendmsg failed for cipher operation : ", "../engines/e_afalg.c", 561); perror(
# 560 "../engines/e_afalg.c" 3 4
       ((void *)0)
# 560 "../engines/e_afalg.c"
       ); } while(0)
                             ...
                             const unsigned char *iv, int enc)
{
    ...
    if (ctx == 
# 583 "../engines/e_afalg.c" 3 4
              ((void *)0) 
# 583 "../engines/e_afalg.c"
                   || key == 
# 583 "../engines/e_afalg.c" 3 4
                             ((void *)0)
# 583 "../engines/e_afalg.c"
...
# 588 "../engines/e_afalg.c" 3 4
                                          ((void *)0)
# 588 "../engines/e_afalg.c"
                                              ) {
        ;
        return 0;
    }
    ...
    if (actx == 
# 594 "../engines/e_afalg.c" 3 4
               ((void *)0)
# 594 "../engines/e_afalg.c"
                   ) {
        ;
        return 0;
    }
    ...
    if (16 != EVP_CIPHER_CTX_get_iv_length(ctx)) {
                           ...
                           const unsigned char *in, size_t inl)
{
    ...
    if (ctx == 
# 654 "../engines/e_afalg.c" 3 4
              ((void *)0) 
# 654 "../engines/e_afalg.c"
                   || out == 
# 654 "../engines/e_afalg.c" 3 4
                             ((void *)0) 
# 654 "../engines/e_afalg.c"
...
# 654 "../engines/e_afalg.c"
    ...
    if (actx == 
# 661 "../engines/e_afalg.c" 3 4
               ((void *)0) 
# 661 "../engines/e_afalg.c"
                    || actx->init_done != 0x1890671) {
    ...
    if (EVP_CIPHER_CTX_is_encrypting(ctx)) {
        memcpy(EVP_CIPHER_CTX_iv_noconst(ctx), out + (inl - 16),
               16);
    } else {
        memcpy(EVP_CIPHER_CTX_iv_noconst(ctx), nxtiv, 16);
    }
...
static int afalg_cipher_cleanup(EVP_CIPHER_CTX *ctx)
{
    ...
    if (ctx == 
# 702 "../engines/e_afalg.c" 3 4
              ((void *)0)
# 702 "../engines/e_afalg.c"
                  ) {
    ...
    actx = (afalg_ctx *) EVP_CIPHER_CTX_get_cipher_data(ctx);
    if (actx == 
# 709 "../engines/e_afalg.c" 3 4
               ((void *)0) 
# 709 "../engines/e_afalg.c"
                    || actx->init_done != 0x1890671)
        return 1;
...
static cbc_handles *get_cipher_handle(int nid)
{
    ...
    default:
        return 
# 736 "../engines/e_afalg.c" 3 4
              ((void *)0)
# 736 "../engines/e_afalg.c"
                  ;
    }
}
...
static const EVP_CIPHER *afalg_aes_cbc(int nid)
{
    ...
    if (cipher_handle == 
# 744 "../engines/e_afalg.c" 3 4
                        ((void *)0)
# 744 "../engines/e_afalg.c"
                            )
            return 
# 745 "../engines/e_afalg.c" 3 4
                  ((void *)0)
# 745 "../engines/e_afalg.c"
                      ;
    if (cipher_handle->_hidden == 
# 746 "../engines/e_afalg.c" 3 4
                                 ((void *)0)
        
# 747 "../engines/e_afalg.c"
       && ((cipher_handle->_hidden =
         EVP_CIPHER_meth_new(nid,
                             16,
                             cipher_handle->key_size)) == 
# 750 "../engines/e_afalg.c" 3 4
                                                         ((void *)0)
        
# 751 "../engines/e_afalg.c"
       || !EVP_CIPHER_meth_set_iv_length(cipher_handle->_hidden,
        ...
        cipher_handle->_hidden= 
# 765 "../engines/e_afalg.c" 3 4
                               ((void *)0)
# 765 "../engines/e_afalg.c"
                                   ;
    }
                         ...
                         const int **nids, int nid)
{
    ...
    if (cipher == 
# 775 "../engines/e_afalg.c" 3 4
                 ((void *)0)
# 775 "../engines/e_afalg.c"
                     ) {
    ...
    default:
        *cipher = 
# 787 "../engines/e_afalg.c" 3 4
                 ((void *)0)
# 787 "../engines/e_afalg.c"
                     ;
        r = 0;
    }
    return r;
...
static int bind_afalg(ENGINE *e)
{
    ...
    if (!ENGINE_set_id(e, engine_afalg_id)
        ...
        ERR_AFALG_error(0, (100), "../engines/e_afalg.c", 804);
        return 0;
    }
...
# 814 "../engines/e_afalg.c" 3 4
                                                  ((void *)0)
# 814 "../engines/e_afalg.c"
                                                      ) {
            ERR_AFALG_error(0, (100), "../engines/e_afalg.c", 815);
            return 0;
        }
    }

    if (!ENGINE_set_ciphers(e, afalg_ciphers)) {
        ERR_AFALG_error(0, (100), "../engines/e_afalg.c", 821);
        return 0;
    }

    return 1;
}
# 848 "../engines/e_afalg.c"
static int afalg_chk_platform(void)
{
    int ret;
    int i;
    ...
    ret = uname(&ut);
    if (ret != 0) {
        ERR_AFALG_error(0, (111), "../engines/e_afalg.c", 859)
                                                     ;
        return 0;
    }
    ...
    for (i = 0; i < 3 && str != 
# 865 "../engines/e_afalg.c" 3 4
                               ((void *)0)
# 865 "../engines/e_afalg.c"
                                   ; i++) {
        kver[i] = atoi(str);
        str = strtok(
# 867 "../engines/e_afalg.c" 3 4
                    ((void *)0)
# 867 "../engines/e_afalg.c"
                        , ".");
    }

    if (
# 870 "../engines/e_afalg.c" 3 4
       (((
# 870 "../engines/e_afalg.c"
       kver[0]
# 870 "../engines/e_afalg.c" 3 4
       ) << 16) + ((
# 870 "../engines/e_afalg.c"
...
# 871 "../engines/e_afalg.c"
       < 
# 871 "../engines/e_afalg.c" 3 4
         (((
# 871 "../engines/e_afalg.c"
         4
# 871 "../engines/e_afalg.c" 3 4
...
# 871 "../engines/e_afalg.c"
        ...
        fprintf(
# 872 "../engines/e_afalg.c" 3 4
       stderr
# 872 "../engines/e_afalg.c"
       , "ALG_ERR: " "ASYNC AFALG not supported this kernel(%d.%d.%d)\n", kver[0], kver[1], kver[2])
                                           ;
        fprintf(
# 874 "../engines/e_afalg.c" 3 4
       stderr
# 874 "../engines/e_afalg.c"
       , "ALG_ERR: " "ASYNC AFALG requires kernel version %d.%d.%d or later\n", 4, 1, 0)
                                       ;
        ERR_AFALG_error(0, (107), "../engines/e_afalg.c", 876)
                                                             ;
        return 0;
    }
    ...
    sock = socket(
# 882 "../engines/e_afalg.c" 3 4
                 38
# 882 "../engines/e_afalg.c"
                       , 
# 882 "../engines/e_afalg.c" 3 4
                         SOCK_SEQPACKET
# 882 "../engines/e_afalg.c"
                                       , 0);
    if (sock == -1) {
        ERR_AFALG_error(0, (109), "../engines/e_afalg.c", 884);
        return 0;
    }
    close(sock);
...
static ENGINE *engine_afalg(void)
{
    ...
    if (ret == 
# 896 "../engines/e_afalg.c" 3 4
              ((void *)0)
# 896 "../engines/e_afalg.c"
                  )
        return 
# 897 "../engines/e_afalg.c" 3 4
              ((void *)0)
# 897 "../engines/e_afalg.c"
                  ;
    if (!bind_afalg(ret)) {
        ENGINE_free(ret);
        return 
# 900 "../engines/e_afalg.c" 3 4
              ((void *)0)
# 900 "../engines/e_afalg.c"
                  ;
    }
    return ret;
}
...
void engine_load_afalg_int(void)
{
    ...
    toadd = engine_afalg();
    if (toadd == 
# 913 "../engines/e_afalg.c" 3 4
                ((void *)0)
# 913 "../engines/e_afalg.c"
                    )
        return;
    ERR_set_mark();
    ENGINE_add(toadd);
...
static int free_cbc(void)
{
    ...
    for (i = 0; i < (sizeof(afalg_cipher_nids)/sizeof((afalg_cipher_nids)[0])); i++) {
        ...
        cbc_handle[i]._hidden = 
# 946 "../engines/e_afalg.c" 3 4
                               ((void *)0)
# 946 "../engines/e_afalg.c"
                                   ;
    }
    return 1;
}
