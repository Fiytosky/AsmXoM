...
log_step "Build openssl-3.3.5 by native GCC ..."
...
log_step "Run openssl-3.3.5 in XoM environment compiled by native GCC ..."
...
log_step "Build openssl-3.3.5 by AsmXoM ..."
CONFIG_LOG="config_process.log"
...
log_step "Run openssl-3.3.5 in XoM environment compiled by AsmXoM ..."
$XOM_RUN ./apps/openssl speed sha1